...
public class HistoricoSituacaoTest extends TestManager {

	private HistoricoSituacao historicoSituacao;
	DataModelo dataModelo = new DataModelo();
	
	public HistoricoSituacaoTest() {
		try {
			historicoSituacao = new HistoricoSituacao(getConexao(), getFacadeFactoryTest());
	...
	@Test
	public void consultarHistoricosSituacao() {
		try {
			historicoSituacao.consultarPorEnumCampoConsulta(dataModelo);
