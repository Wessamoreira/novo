CREATE OR REPLACE FUNCTION public.matriculaintegralizacaocurricular(matriculaaluno character varying)
 RETURNS TABLE(matricula character varying, cargahorariatotal integer, cargahorariadisciplinaobrigatorioexigida integer, cargahorariadisciplinaobrigatoriocumprida integer, cargahorariadisciplinaoptativaexigida integer, quantidademinimadisciplinaoptativaexigida integer, cargahorariadisciplinaoptativacumprida integer, quantidadedisciplinaoptativacumprida integer, cargahorariaestagioexigido integer, cargahorariaestagiocumprido integer, cargahorariaatividadecomplementarexigido integer, cargahorariaatividadecomplementarcumprido integer, cargahorariacumprido integer, cargahorariapendente integer, percentualintegralizado numeric, percentualnaointegralizado numeric, percentualpermitiriniciarestagio numeric, cargahorariaexigidaliberarestagio integer, cargahorariacumpridaliberarestagio integer, percentualcumpridoliberarestagio numeric, percentualpendenteliberarestagio numeric, percentualpermitiriniciartcc numeric, cargahorariaexigidaliberartcc integer, cargahorariacumpridaliberartcc integer, percentualcumpridoliberartcc numeric, percentualpendenteliberartcc numeric)
 LANGUAGE plpgsql
AS $function$
begin
  return QUERY
...
+
	...
	case
		...
		case
			when (t.cargaHorariaDisciplinaObrigatorioCumprida + t.cargaHorariaAtividadeComplementarCumprido - t.cargaHorariaCumpridaTCC  - t.cargaHorariaEstagioExigido + t.cargaHorariaDisciplinaOptativaCumprida)::numeric(20,
			2) > ((((t.cargaHorariaTotal - t.cargaHorariaEstagioExigido - t.cargaHorariaExigidaTCC) * t.percentualPermitirIniciarTcc)::numeric(20,
			2)/ 100.0::numeric(20,
			2)))::numeric(20,	2) then 100.0::numeric(20,
			2)
			else 
	 (((t.cargaHorariaDisciplinaObrigatorioCumprida + t.cargaHorariaAtividadeComplementarCumprido - t.cargaHorariaCumpridaTCC  - t.cargaHorariaEstagioExigido + t.cargaHorariaDisciplinaOptativaCumprida)::numeric(20,
			2) / (((t.cargaHorariaTotal - t.cargaHorariaEstagioExigido - t.cargaHorariaExigidaTCC) * t.percentualPermitirIniciarTcc)::numeric(20,
			2)/ 100.0::numeric(20,
			2))) * 100.0::numeric(20,
			2))::numeric(20,
	...
	case
		...
		case
			...
			2) > ((((t.cargaHorariaTotal - t.cargaHorariaEstagioExigido - t.cargaHorariaExigidaTCC) * t.percentualPermitirIniciarTcc)::numeric(20,
			2)/ 100.0::numeric(20,
			2)))::numeric(20,2) then 0.0::numeric(20,
			2)
			else 
	(100.0::numeric(20,
			2) - (((t.cargaHorariaDisciplinaObrigatorioCumprida + t.cargaHorariaAtividadeComplementarCumprido - t.cargaHorariaCumpridaTCC - t.cargaHorariaEstagioExigido + t.cargaHorariaDisciplinaOptativaCumprida)::numeric(20,
			2) / (((t.cargaHorariaTotal - t.cargaHorariaEstagioExigido - t.cargaHorariaExigidaTCC) * t.percentualPermitirIniciarTcc)::numeric(20,
			2)/ 100.0::numeric(20,
			2))) * 100.0::numeric(20,
			2)))::numeric(20,2)
