...
@Controller("RelacaoEnderecoAlunoRelControle")
@Scope("viewScope")
@Lazy
public class RelacaoEnderecoAlunoRelControle extends SuperControleRelatorio {
    ...
    public RelacaoEnderecoAlunoRelControle() throws Exception {
    ...
    public void imprimirPDF() {
        ...
        try {
            registrarAtividadeUsuario(getUsuarioLogado(), "RelacaoEnderecoAlunoRelControle", "Inicializando Geração de Relatório Relação Endereço Aluno", "Emitindo Relatório");
            listaObjetos = getFacadeFactory().getRelacaoEnderecoAlunoRelFacade().criarObjeto(getTurmaVO(), getAno(), getSemestre());
            if (!listaObjetos.isEmpty()) {
                getSuperParametroRelVO().setNomeDesignIreport(RelacaoEnderecoAlunoRel.getDesignIReportRelatorio());
                getSuperParametroRelVO().setTipoRelatorioEnum(TipoRelatorioEnum.PDF);
                getSuperParametroRelVO().setSubReport_Dir(RelacaoEnderecoAlunoRel.getCaminhoBaseRelatorio());
                getSuperParametroRelVO().setNomeUsuario(getUsuarioLogado().getNome());
                getSuperParametroRelVO().setTituloRelatorio("Relação de Endereço de Alunos");
                getSuperParametroRelVO().setListaObjetos(listaObjetos);
                getSuperParametroRelVO().setCaminhoBaseRelatorio(RelacaoEnderecoAlunoRel.getCaminhoBaseRelatorio());
            ...
            registrarAtividadeUsuario(getUsuarioLogado(), "RelacaoEnderecoAlunoRelControle", "Finalizando Geração de Relatório Relação Endereço Aluno", "Emitindo Relatório");
        } catch (Exception e) {
