 ...
 *
 */
@Controller("OcorrenciaPatrimonioRelControle")
@Scope("viewScope")
@Lazy
public class OcorrenciaPatrimonioRelControle extends SuperControleRelatorio {
	...
	public OcorrenciaPatrimonioRelControle() throws Exception {
	...
	public void imprimirPDF() {
		List<OcorrenciaPatrimonioRelVO> listaObjetos = new ArrayList<OcorrenciaPatrimonioRelVO>(0);
		try {
			getFacadeFactory().getOcorrenciaPatrimonioRelInterfaceFacede().validarDados(getOcorrenciaPatrimonioRelVO(), getUnidadeEnsinoVO(), getTipoPatrimonioVO(), getLocalArmazenamentoVO());
			listaObjetos = getFacadeFactory().getOcorrenciaPatrimonioRelInterfaceFacede().criarObjeto(getOcorrenciaPatrimonioRelVO(), getUnidadeEnsinoVO(), getPatrimonioVO(), getTipoPatrimonioVO(), getLocalArmazenamentoVO(), getUsuarioLogado(), getDataInicio(), getDataFim(), getOrdenar());
			if (!listaObjetos.isEmpty()) {
				getSuperParametroRelVO().setNomeDesignIreport(getFacadeFactory().getOcorrenciaPatrimonioRelInterfaceFacede().designIReportRelatorioOcorrenciaPatrimonioRel());
				getSuperParametroRelVO().setTituloRelatorio("Relatório Ocorrência Patrimônio");
				...
				adicionarFiltroSituacaoOcorrenciaPatrimonio(getSuperParametroRelVO());
	...
	public void imprimirExcel() {
		...
		try {
			...
			listaObjetos = getFacadeFactory().getOcorrenciaPatrimonioRelInterfaceFacede().criarObjeto(getOcorrenciaPatrimonioRelVO(), getUnidadeEnsinoVO(), getPatrimonioVO(), getTipoPatrimonioVO(), getLocalArmazenamentoVO(), getUsuarioLogado(), getDataInicio(), getDataFim(), getOrdenar());
			if (!listaObjetos.isEmpty()) {
				getSuperParametroRelVO().setNomeDesignIreport("relatorio" + File.separator + "designRelatorio" + File.separator + "administrativo" + File.separator + "OcorrenciaPatrimonioExcelRel.jrxml");
				getSuperParametroRelVO().setTituloRelatorio("Relatório Ocorrência Patrimônio");
	...
	public void adicionarFiltroSituacaoOcorrenciaPatrimonio(SuperParametroRelVO superParametroRelVO) {
		superParametroRelVO.adicionarParametro("trocaLocal", getOcorrenciaPatrimonioRelVO().getTrocaLocal());
		superParametroRelVO.adicionarParametro("manutencao", getOcorrenciaPatrimonioRelVO().getManutencao());
		superParametroRelVO.adicionarParametro("separadoParaDescarte", getOcorrenciaPatrimonioRelVO().getSeparadoParaDescarte());
		superParametroRelVO.adicionarParametro("descartado", getOcorrenciaPatrimonioRelVO().getDescartado());
		superParametroRelVO.adicionarParametro("emprestimo", getOcorrenciaPatrimonioRelVO().getEmprestimo());
	}
