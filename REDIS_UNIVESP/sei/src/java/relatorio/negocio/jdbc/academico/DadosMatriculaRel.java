...
public class DadosMatriculaRel extends SuperRelatorio implements DadosMatriculaRelInterfaceFacade {
	 ...
	 * (java.lang.String)
	 */
	public List<DadosMatriculaRelVO> criarObjeto(Integer codMatriculaPeriodo, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistema, UsuarioVO usuarioVO) throws Exception {
		MatriculaPeriodoVO matriculaPeriodoVO = consultarUltimaMatriculaPeriodoDoAluno(codMatriculaPeriodo, configuracaoFinanceiroVO, usuarioVO);
	...
	private MatriculaPeriodoVO consultarUltimaMatriculaPeriodoDoAluno(Integer codMatriculaPeriodo, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception {
		// List lista =
		...
		return getFacadeFactory().getMatriculaPeriodoFacade().consultarPorChavePrimaria(codMatriculaPeriodo.intValue(), Uteis.NIVELMONTARDADOS_DADOSMINIMOS, configuracaoFinanceiroVO, usuarioVO);
	}
