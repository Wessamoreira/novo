...
public class CertificadoCursoExtensaoRel extends SuperRelatorio implements CertificadoCursoExtensaoRelInterfaceFacade {
    ...
    public List<CertificadoCursoExtensaoRelVO> criarObjeto(CertificadoCursoExtensaoRelVO certificadoCursoExtensaoRelVO, MatriculaVO matriculaVO, PeriodoLetivoVO periodoLetivoVO, TurmaVO turmaVO, String tipoLayout, String filtro, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, boolean trazerApenasDisciplinaPeriodoSelecionado, DisciplinaVO disciplinaVO, UsuarioVO usuarioVO, Boolean trazerTodasSituacoesAprovadas , ProgramacaoFormaturaVO programacaoFormaturaVO , List<CertificadoCursoExtensaoRelVO> listaCertificadoErro , List<CertificadoCursoExtensaoRelVO> listaCertificadoCursoExtensaoRelVOGerar) throws Exception {
       ...
       /* if (filtro.equals("turma")) {
        	...
        	listaMatricula = getFacadeFactory().getMatriculaFacade().executarConsultaPorTurmaCurso(turmaVO.getCodigo(), turmaVO.getCurso().getCodigo(), turmaVO.getUnidadeEnsino().getCodigo(), false, Uteis.NIVELMONTARDADOS_DADOSMINIMOS, configuracaoFinanceiroVO, usuarioVO);
...
//        string.append(" AND datafimperiodoletivo IS NOT NULL ");
	...
	private void verificarRegraEmissao(RegraEmissaoVO regraEmissao, UsuarioVO usuarioVO, CertificadoCursoExtensaoRelVO certificadoCursoExtensaoRelVO, String filtro,List<CertificadoCursoExtensaoRelVO> certificadoCursoExtensaoRelVOs ,List<CertificadoCursoExtensaoRelVO> certificadoCursoExtensaoRelVOsErro ) throws Exception {
	...
	public List<CertificadoCursoExtensaoRelVO> realizarMontagemDadosRelatorioLayoutCertificadoCursoExtensao(
		...
		certificadoCursoExtensaoRelVOsGerar = getFacadeFactory().getCertificadoCursoExtensaoRelFacade().criarObjeto(certificadoCursoExtensaoRelVO,matriculaVO, periodoLetivoVO ,turmaVO, tipoLayout, filtro, configuracaoFinanceiroVO, trazerApenasDisciplinaPeriodoSelecionado, gradeDisciplinaVO.getDisciplina(),  usuarioVO, trazerTodasSituacoesAprovadas , programacaoFormaturaVO ,listaCertificadoErro , listaCertificadoCursoExtensaoRelVOGerar);
