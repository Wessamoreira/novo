...
public enum JobsEnum {
	...
	JOB_MARCACAO_AUSENCIA_ATA_COLACAO_GRAU_NAO_ASSINADA("Job Marcação de Ausência em Ata Colação de Grau Não Assinada", "jobMarcacaoAusenciaAtaColacaoGrauNaoAssinada", "executarJobMarcacaoAusenciaAtaColacaoGrauNaoAssinada");
