 ...
 */
public class PlanoDescontoSV extends HttpServlet {
...
//			}			
			...
			List<PlanoDescontoDisponivelMatriculaVO> lista = getFacadeFactory().getPlanoDescontoDisponivelMatriculaFacade().consultarPorUnidadeEnsinoDisponivelMatricula(codUnidadeEnsino, false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, new UsuarioVO());
			// preenche o objeto
