 ...
 */
public class MatriculaConfirmadaSV extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List<MatriculaPeriodoVO> lista = getFacadeFactory().getMatriculaPeriodoFacade().consultarMatriculaPeriodo_MatriculaConfirmada();
			// preenche o objeto
			...
			while (i.hasNext()) {
				...
				my_obj_unid_cod.put("codigoAluno", obj.getMatriculaVO().getAluno().getCodigo());
				my_obj_unid_cod.put("nomeAluno", obj.getMatriculaVO().getAluno().getNome());
				my_obj_unid_cod.put("emailAluno", obj.getMatriculaVO().getAluno().getEmail());
				my_obj_unid_cod.put("matricula", obj.getMatricula());
				my_obj_unid_cod.put("situacaoMatricula", obj.getSituacaoMatriculaPeriodo());
				my_obj_unid_cod.put("turma", obj.getTurma().getIdentificadorTurma());
				my_obj_unid_cod.put("codigoUnidadeEnsino", obj.getMatriculaVO().getUnidadeEnsino().getCodigo());
				my_obj_unid_cod.put("nomeUnidadeEnsino", obj.getMatriculaVO().getUnidadeEnsino().getNome());
				my_obj_unid_cod.put("dataInscricao", obj.getData());
				my_obj_unid_cod.put("dataMatricula", obj.getData());
				my_obj_unid_cod.put("matriculaConfirmada", !obj.getSituacaoMatriculaPeriodo().equals("AT") ? "Não Confirmada" : "Confirmada");
				my_obj_unid_nome.put(obj.getMatricula(), my_obj_unid_cod.toString());
			}
