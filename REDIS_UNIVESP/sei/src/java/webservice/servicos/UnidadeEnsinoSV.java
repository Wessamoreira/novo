 ...
 */
public class UnidadeEnsinoSV extends HttpServlet {
...
//				unidadeensino = 18;
//			}			
			List<UnidadeEnsinoVO> lista = getFacadeFactory().getUnidadeEnsinoFacade().consultarPorNome("", unidadeensino, false, Uteis.NIVELMONTARDADOS_COMBOBOX, null);
			// preenche o objeto
			...
			while (i.hasNext()) {
				...
				my_obj_unid_cod.put("nome", uni.getNome());
				my_obj_unid_cod.put("codigo", uni.getCodigo());
				my_obj_unid_nome.put(uni.getNome(), my_obj_unid_cod.toString());
			}
