...
public class RpsBuilder {
	...
	public RpsBuilder withSerie(String serie) {
		LOG.debug("Serie: ", serie);		
		rpsDetalhe.getIdentificacaoRps().setSerie(serie);
		return this;
	}
...
//	}
	...
	private String convertDate(Calendar date) {
		return new DateConverter().getConverted2(date);
	}
	...
	public RpsDetalhe getRpsDetalhe() {
		return rpsDetalhe;
	}
}
