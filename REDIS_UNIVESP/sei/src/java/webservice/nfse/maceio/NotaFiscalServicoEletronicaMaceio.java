...
@Lazy
public class NotaFiscalServicoEletronicaMaceio extends ControleAcesso implements NotaFiscalServicoEletronicaInterfaceFacade {
	/**
	 * 
	 */
	...
	public NotaFiscalServicoEletronicaMaceio() throws Exception {
		super();
		setIdEntidade("NotaFiscalServicoEletronicaMaceio");
	}
	...
	public static void setIdEntidade(String idEntidade) {
		NotaFiscalServicoEletronicaMaceio.idEntidade = idEntidade;
	}
	...
	public LoteRps montarXmlEnvio(NotaFiscalSaidaVO notaFiscalSaidaVO,UsuarioVO usuarioVO) throws Exception{
		...
		rps.getInfDeclaracaoPrestacaoServico().setId("rps:"+notaFiscalSaidaVO.getNumero()+"ABCDZ");
