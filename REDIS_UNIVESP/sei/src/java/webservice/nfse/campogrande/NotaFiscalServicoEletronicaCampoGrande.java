...
import webservice.nfse.campogrande.ReqEnvioLoteRPS.Cabecalho;

@Repository
@Scope(value = "singleton")
@Lazy
@Transactional(readOnly = true)
public class NotaFiscalServicoEletronicaCampoGrande extends ControleAcesso implements NotaFiscalServicoEletronicaInterfaceFacade {
	/**
	 * 
	 */
	...
	public NotaFiscalServicoEletronicaCampoGrande() throws Exception {
		super();
		setIdEntidade("NotaFiscalServicoEletronicaCampoGrande");
	}
	...
	public static void setIdEntidade(String idEntidade) {
		NotaFiscalServicoEletronicaCampoGrande.idEntidade = idEntidade;
	}
...
//		tpRPS.getDeducoes().add(deducoes);
	...
	public String executarCriacaoAssinatura(NotaFiscalSaidaVO notaFiscalSaidaVO) throws Exception {
		...
		assinatura.append("00"+Uteis.removerCaracteresEspeciais3(notaFiscalSaidaVO.getUnidadeEnsinoVO().getInscMunicipal().replace(".", "").replace("-", ""))+"NF");
	...
	public static void validarLoteRps(NotaFiscalSaidaVO notaFiscalSaidaVO,ConfiguracaoGeralSistemaVO configuracaoRespositoriArquivo, ProgressBarVO progressBar, String autorizado, UsuarioVO usuarioVO) throws Exception {
		try {
			...
			if (notaFiscalSaidaVO.getMensagemRetorno().contains("<Sucesso>true</Sucesso>")) {
				...
				notaFiscalSaidaVO.setLinkAcesso("http://nfse.pmcg.ms.gov.br/NotaFiscal/index.php");
