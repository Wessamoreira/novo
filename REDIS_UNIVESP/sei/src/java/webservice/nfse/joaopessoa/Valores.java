...
public class Valores {
	...
	@XStreamAlias("nfse:ValorServicos")
	private Double ValorServicos;
	
	@XStreamAlias("nfse:ValorDeducoes")
	private Double ValorDeducoes;
	
	@XStreamAlias("nfse:ValorPis")
	private Double ValorPis;
	
	@XStreamAlias("nfse:ValorCofins")
	private Double ValorCofins;
	
	@XStreamAlias("nfse:ValorInss")
	private Double ValorInss;
	
	@XStreamAlias("nfse:ValorIr")
	private Double ValorIr;
	
	@XStreamAlias("nfse:ValorCsll")
	private Double ValorCsll;
	
	@XStreamAlias("nfse:OutrasRetencoes")
	private Double OutrasRetencoes;
	
	@XStreamAlias("nfse:ValorIss")
	private Double ValorIss;
	
	@XStreamAlias("nfse:Aliquota")
	private Double Aliquota;
	
	@XStreamAlias("nfse:DescontoIncondicionado")
	private Double DescontoIncondicionado;
	
	@XStreamAlias("nfse:DescontoCondicionado")
