...
public class ServicoBuilder {
	...
	public ServicoBuilder withIssRetido(SimNao simNao) {
		servico.getValores().setIssRetido(simNao);
		return this;
	}
	...
	public ServicoBuilder withBaseCalculo(double d) {
		servico.getValores().setBaseCalculo(d);
		return this;
	}

	public ServicoBuilder withValorLiquidoNfse(double d) {
		servico.getValores().setValorLiquidoNfse(d);
		return this;
	}
	...
	public ServicoBuilder withCodigoMunicipio(String i) {
	...
	public ServicoBuilder withCodigoTributacaoMunicipio(String i) {
		servico.setCodigoTributacaoMunicipio(i);
		return this;
	}
