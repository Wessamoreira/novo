...
//	private String xmlns = "http://www.abrasf.org.br/ABRASF/arquivos/nfse.xsd";
	...
	public String toString() {
		return "InfDeclaracaoPrestacaoServico [ Id=" + Id + ", IdentificacaoRps=" + IdentificacaoRps + ", status=" + status + ", DataEmissao=" + DataEmissao + ", NaturezaOperacao=" + NaturezaOperacao + ", OptanteSimplesNacional=" + OptanteSimplesNacional + ", IncentivadorCultural=" + IncentivadorCultural + ", Servico=" + Servico + ", Prestador=" + Prestador + ", Tomador=" + Tomador + ", Intermediario=" + Intermediario + "]";
	}
