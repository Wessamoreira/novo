 ...
 * 
 */
@XStreamAlias(value = "Deducao")
public class TpDeducoes {

    @XStreamAlias(value = "DeducaoPor")
    protected String deducaoPor;
    @XStreamAlias(value = "TipoDeducao")
    protected String tipoDeducao;
    @XStreamAlias(value = "CPFCNPJReferencia")
    protected String cpfcnpjReferencia;
    @XStreamAlias(value = "NumeroNFReferencia")
    protected Long numeroNFReferencia;
    @XStreamAlias(value = "ValorTotalReferencia")
    protected BigDecimal valorTotalReferencia;
    @XStreamAlias(value = "PercentualDeduzir")
    protected BigDecimal percentualDeduzir;
    @XStreamAlias(value = "ValorDeduzir")
     ...
     *     
     */
    public void setDeducaoPor(String value) {
