...
public class NotaFiscalServicoEletronicaCuritiba extends ControleAcesso implements NotaFiscalServicoEletronicaInterfaceFacade {
	/**
	 * 
	 */
	...
	public NotaFiscalServicoEletronicaCuritiba() throws Exception {
		super();
		setIdEntidade("NotaFiscalServicoEletronicaCuritiba");
	}
	...
	public static void setIdEntidade(String idEntidade) {
		NotaFiscalServicoEletronicaCuritiba.idEntidade = idEntidade;
	}
