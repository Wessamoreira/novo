...
//	private String xmlns = "http://www.abrasf.org.br/ABRASF/arquivos/nfse.xsd";
	...
	public String toString() {
		return "InfDeclaracaoPrestacaoServico [id=" + id + ", IdentificacaoRps=" + IdentificacaoRps + ", DataEmissao=" + DataEmissao + ", NaturezaOperacao=" + NaturezaOperacao + ", OptanteSimplesNacional=" + OptanteSimplesNacional + ", IncentivadorCultural=" + IncentivadorCultural + ", status=" + status + ", Servico=" + Servico + ", Prestador=" + Prestador + ", Tomador=" + Tomador + ", Intermediario=" + Intermediario + "]";
	}
}
