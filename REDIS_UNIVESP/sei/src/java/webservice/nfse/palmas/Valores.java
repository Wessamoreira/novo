...
public class Valores {
	...
	public void setAliquota(Double aliquota) {
		if(ValorServicos != null) {
			ValorIss = ValorServicos * aliquota;
		}
		Aliquota = aliquota;
	}
	...
	public String toString() {
		return "Valores [ValorServicos=" + ValorServicos + ", ValorDeducoes=" + ValorDeducoes + ", ValorPis=" + ValorPis + ", ValorCofins=" + ValorCofins + ", ValorInss=" + ValorInss + ", ValorIr=" + ValorIr + ", ValorCsll=" + ValorCsll + ", IssRetido=" + IssRetido + ", ValorIss=" + ValorIss + ", OutrasRetencoes=" + OutrasRetencoes + ", Aliquota=" + Aliquota + ", DescontoIncondicionado=" + DescontoIncondicionado + ", DescontoCondicionado=" + DescontoCondicionado + "]";
	}
}