...
public class Nfse {
	...
	public String asGerarNFSEXML(NotaFiscalSaidaVO notaFiscalSaidaVO, ConfiguracaoGeralSistemaVO configuracaoRespositoriArquivo, String Id) throws Exception {
		...
		xml = Assinador.assinarNFSeInfRpsComIDSemQuebraLinha(notaFiscalSaidaVO, configuracaoRespositoriArquivo, Uteis.removerCaracteresEspeciais3(xml), "EN", nomeArquivoXML,"");
		xml = Assinador.assinarNFSeInfRpsComIDSemQuebraLinha(notaFiscalSaidaVO, configuracaoRespositoriArquivo, Uteis.removerCaracteresEspeciais3(xml), "GerarNfseEnvio", nomeArquivoXML,"");
		if (enableValidation) {
			try {
