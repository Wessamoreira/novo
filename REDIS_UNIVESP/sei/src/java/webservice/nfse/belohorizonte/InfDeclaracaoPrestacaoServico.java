...
public class InfDeclaracaoPrestacaoServico {
	...
	public String toString() {
		return "InfDeclaracaoPrestacaoServico [Id=" + Id + ", IdentificacaoRps=" + IdentificacaoRps + ", DataEmissao=" + DataEmissao + ", NaturezaOperacao=" + NaturezaOperacao +", RegimeEspecialTributacao ="+RegimeEspecialTributacao+", OptanteSimplesNacional=" + OptanteSimplesNacional + ", IncentivadorCultural=" + IncentivadorCultural + ", status=" + status + ", Servico=" + Servico + ", Prestador=" + Prestador + ", Tomador=" + Tomador + ", Intermediario=" + Intermediario + "]";
	}
}
