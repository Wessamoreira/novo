...
public class NotaFiscalServicoEletronicaPortoAlegre extends ControleAcesso implements NotaFiscalServicoEletronicaInterfaceFacade {
	/**
	 * 
	 */
	...
	public NotaFiscalServicoEletronicaPortoAlegre() throws Exception {
		super();
		setIdEntidade("NotaFiscalServicoEletronicaPortoAlegre");
	}
	...
	public static void setIdEntidade(String idEntidade) {
		NotaFiscalServicoEletronicaPortoAlegre.idEntidade = idEntidade;
	}
	...
	public void enviarXmlEnvio(NotaFiscalSaidaVO notaFiscalSaidaVO, ConfiguracaoGeralSistemaVO configuracaoRespositoriArquivo, ProgressBarVO progressBar, String autorizado, UsuarioVO usuarioVO) throws Exception {
		try {
			...
			notaFiscalSaidaVO.setXmlEnvio(builder.withGerarNfseLoteRps(loteRps).asGerarNFSEXML(notaFiscalSaidaVO, configuracaoRespositoriArquivo, "1"+ cnpj +Uteis.preencherComZerosPosicoesVagas(notaFiscalSaidaVO.getNumeroNota(), 16)));
