...
public class HttpUtility {
     ...
     * @throws java.lang.Exception 
     */
    public static HttpResponse SendHttpWebRequest(String DataToSend, HttpVerbEnum HttpVerb, HttpContentTypeEnum HttpContentType, String ServiceEndpoint, BasicHeader[] HeaderData) throws Exception
    {
        // Define codificação
        ...
        try
        {
            ...
            responseData = EntityUtils.toString((org.apache.http.HttpEntity) entityResponse, encoding);
        }
        catch(IOException e)
        {
