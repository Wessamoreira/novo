...
*/
public interface EditoraInterfaceFacade {
	

    public EditoraVO novo() throws Exception;
    public void incluir(EditoraVO obj, UsuarioVO usuarioVO) throws Exception;
    public void alterar(EditoraVO obj, UsuarioVO usuarioVO) throws Exception;
    public void excluir(EditoraVO obj, UsuarioVO usuarioVO) throws Exception;
    public EditoraVO consultarPorChavePrimaria(Integer codigo, int nivelMontarDados, UsuarioVO usuario) throws Exception;
