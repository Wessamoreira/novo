...
public interface InscricaoCursoEventoInterfaceFacade {
	 ...
	 * @param obj  Objeto da classe <code>InscricaoCursoEventoVO</code> que será gravado no banco de dados.
	 * @exception Exception Caso haja problemas de conexão, restrição de acesso ou validação de dados.
	 */
	public void incluir(InscricaoCursoEventoVO obj) throws Exception;
	 ...
	 * @param obj    Objeto da classe <code>InscricaoCursoEventoVO</code> que será alterada no banco de dados.
	 * @exception Execption Caso haja problemas de conexão, restrição de acesso ou validação de dados.
	 */
	public void alterar(InscricaoCursoEventoVO obj) throws Exception;

	/**
	 * Operação responsável por excluir no BD um objeto da classe <code>InscricaoCursoEventoVO</code>.
	 * Sempre localiza o registro a ser excluído através da chave primária da entidade.
	 * Primeiramente verifica a conexão com o banco de dados e a permissão do usuário
	 * para realizar esta operacão na entidade.
	 * Isto, através da operação <code>excluir</code> da superclasse.
	 * @param obj    Objeto da classe <code>InscricaoCursoEventoVO</code> que será removido no banco de dados.
	...
	/**
	 * Responsável por realizar uma consulta de <code>InscricaoCursoEvento</code> através do valor do atributo 
	 * <code>codigo</code> da classe <code>CursosEvento</code>
	 * Faz uso da operação <code>montarDadosConsulta</code> que realiza o trabalho de prerarar o List resultante.
	 * @return  List Contendo vários objetos da classe <code>InscricaoCursoEventoVO</code> resultantes da consulta.
	 * @exception Exception Caso haja problemas de conexão ou restrição de acesso.
	 */
	...
	/**
	 * Responsável por realizar uma consulta de <code>InscricaoCursoEvento</code> através do valor do atributo 
	 * <code>nrInscricao</code> da classe <code>InscricaoEvento</code>
	 * Faz uso da operação <code>montarDadosConsulta</code> que realiza o trabalho de prerarar o List resultante.
	 * @return  List Contendo vários objetos da classe <code>InscricaoCursoEventoVO</code> resultantes da consulta.
	 * @exception Exception Caso haja problemas de conexão ou restrição de acesso.
	 */
	...
	/**
	 * Operação responsável por excluir todos os objetos da <code>InscricaoCursoEventoVO</code> no BD.
	 * Faz uso da operação <code>excluir</code> disponível na classe <code>InscricaoCursoEvento</code>.
	...
	/**
	 * Operação responsável por alterar todos os objetos da <code>InscricaoCursoEventoVO</code> contidos em um Hashtable no BD.
	 * Faz uso da operação <code>excluirInscricaoCursoEventos</code> e <code>incluirInscricaoCursoEventos</code> disponíveis na classe <code>InscricaoCursoEvento</code>.
	...
	/**
	 * Operação responsável por incluir objetos da <code>InscricaoCursoEventoVO</code> no BD.
	 * Garantindo o relacionamento com a entidade principal <code>eventos.InscricaoEvento</code> através do atributo de vínculo.
	...
	/**
	 * Operação responsável por localizar um objeto da classe <code>InscricaoCursoEventoVO</code>
