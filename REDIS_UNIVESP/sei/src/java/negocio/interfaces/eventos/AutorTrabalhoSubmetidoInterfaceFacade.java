...
public interface AutorTrabalhoSubmetidoInterfaceFacade {
	 ...
	 * @param obj  Objeto da classe <code>AutorTrabalhoSubmetidoVO</code> que será gravado no banco de dados.
	 * @exception Exception Caso haja problemas de conexão, restrição de acesso ou validação de dados.
	 */
	public void incluir(AutorTrabalhoSubmetidoVO obj) throws Exception;
	 ...
	 * @param obj    Objeto da classe <code>AutorTrabalhoSubmetidoVO</code> que será alterada no banco de dados.
	 * @exception Execption Caso haja problemas de conexão, restrição de acesso ou validação de dados.
	 */
	public void alterar(AutorTrabalhoSubmetidoVO obj) throws Exception;

	/**
	 * Operação responsável por excluir no BD um objeto da classe <code>AutorTrabalhoSubmetidoVO</code>.
	 * Sempre localiza o registro a ser excluído através da chave primária da entidade.
	 * Primeiramente verifica a conexão com o banco de dados e a permissão do usuário
	 * para realizar esta operacão na entidade.
	 * Isto, através da operação <code>excluir</code> da superclasse.
	 * @param obj    Objeto da classe <code>AutorTrabalhoSubmetidoVO</code> que será removido no banco de dados.
	 ...
	 * <code>evento</code> da classe <code>TrabalhoSubmetido</code>
	...
	/**
	 * Operação responsável por excluir todos os objetos da <code>AutorTrabalhoSubmetidoVO</code> no BD.
	 * Faz uso da operação <code>excluir</code> disponível na classe <code>AutorTrabalhoSubmetido</code>.
	...
	/**
	 * Operação responsável por alterar todos os objetos da <code>AutorTrabalhoSubmetidoVO</code> contidos em um Hashtable no BD.
	 * Faz uso da operação <code>excluirAutorTrabalhoSubmetidos</code> e <code>incluirAutorTrabalhoSubmetidos</code> disponíveis na classe <code>AutorTrabalhoSubmetido</code>.
	...
	/**
	 * Operação responsável por incluir objetos da <code>AutorTrabalhoSubmetidoVO</code> no BD.
	 * Garantindo o relacionamento com a entidade principal <code>eventos.TrabalhoSubmetido</code> através do atributo de vínculo.
	...
	/**
	 * Operação responsável por localizar um objeto da classe <code>AutorTrabalhoSubmetidoVO</code>
