...
*/
public interface CursosEventoInterfaceFacade {
	

    public CursosEventoVO novo() throws Exception;
    public void incluir(CursosEventoVO obj) throws Exception;
    public void alterar(CursosEventoVO obj) throws Exception;
    public void excluir(CursosEventoVO obj) throws Exception;
    public CursosEventoVO consultarPorChavePrimaria(Integer codigo,int nivelMontarDados,UsuarioVO usuario) throws Exception;
