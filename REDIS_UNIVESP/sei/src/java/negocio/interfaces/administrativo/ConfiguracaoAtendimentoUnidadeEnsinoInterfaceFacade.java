...
public interface ConfiguracaoAtendimentoUnidadeEnsinoInterfaceFacade {
	...
	void excluirConfiguracaoAtendimentoUnidadeEnsinoVO(Integer configuracaoAtendimento, UsuarioVO usuarioLogado) throws Exception;

	/**
	 * Operação responsável por alterar todos os objetos da <code>ItemTitulacaoCursoVO</code> contidos em um Hashtable no BD.
	 * Faz uso da operação <code>excluirConfiguracaoAtendimentoUnidadeEnsinoVO</code> e <code>incluirConfiguracaoAtendimentoUnidadeEnsinoVO</code> disponíveis na classe <code>ItemTitulacaoCurso</code>.
	 * @param objetos  List com os objetos a serem alterados ou incluídos no BD.
	 * @exception Exception  Erro de conexão com o BD ou restrição de acesso a esta operação.
	 */
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	void alterarConfiguracaoAtendimentoUnidadeEnsinoVO(Integer configuracaoAtendimento, List objetos, UsuarioVO usuarioLogado) throws Exception;
	 ...
	 */
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	void incluirConfiguracaoAtendimentoUnidadeEnsinoVO(Integer configuracaoAtendimento, List<ConfiguracaoAtendimentoUnidadeEnsinoVO> objetos, UsuarioVO usuarioLogado) throws Exception;

	void validarDados(ConfiguracaoAtendimentoUnidadeEnsinoVO obj) throws Exception;
	...
	ConfiguracaoAtendimentoUnidadeEnsinoVO consultarPorChavePrimaria(Integer codigoPrm, int nivelMontarDados, UsuarioVO usuario) throws Exception;
