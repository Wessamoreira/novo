...
public interface GestaoEnvioMensagemAutomaticaInterfaceFacade {
	...
	void executarEnvioMensagemRenegociacaoContaReceberAluno(NegociacaoContaReceberVO negociacaoContaReceberVO, UsuarioVO usuario) throws Exception;

	void executarEnvioMensagemRenegociacaoContaReceberGrupoDestinatario(NegociacaoContaReceberVO negociacaoContaReceberVO, GrupoDestinatariosVO grupoDestinatariosVO, UsuarioVO usuario) throws Exception;
	...
	void executarEnvioMensagemResultadoProcessoSeletivo(ResultadoProcessoSeletivoVO resultadoProcessoSeletivoVO, Integer unidadeEnsino) throws Exception;

	void executarEnvioMensagemNovaVagaBancoCurriculum(VagasVO vagasVO, Boolean enviarSomenteParaCidadeInformada, UsuarioVO usuarioVO, PersonalizacaoMensagemAutomaticaVO mensagemTemplate, List<PessoaVO> pessoaVOs) throws Exception;
	...
	void executarEnvioMensagemNotificacaoLocalAulaTurma(MapaLocalAulaTurmaVO mapaLocalAulaTurmaVO, Integer codGrupoDestinatario, UsuarioVO usuario) throws Exception;
	...
	void executarEnvioMensagemBuscaProspect(List<BuscaProspectVO> lista, PersonalizacaoMensagemAutomaticaVO mensagemTemplate, ComunicacaoInternaVO comunicacaoEnviar) throws Exception;
	...
	void executarEnvioMensagemNotificacaoProcessoSeletivo(Integer processoSeletivo, Integer unidadeEnsino, Integer itemProcSeletivoDataProva, Integer sala, TipoRelatorioEstatisticoProcessoSeletivoEnum tipoNotificacao, UsuarioVO usuarioVO) throws Exception;
	...
	void executarEnvioMensagemAprovacaoProcessoSeletivo(ResultadoProcessoSeletivoVO resultadoProcessoSeletivoVO, UsuarioVO usuario) throws Exception;
