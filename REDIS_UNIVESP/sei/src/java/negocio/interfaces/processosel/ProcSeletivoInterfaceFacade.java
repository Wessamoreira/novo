...
public interface ProcSeletivoInterfaceFacade {
	...
	public void inicializarProcSeletivoSemAgendamento(ProcSeletivoVO procSeletivoVO);
		...
		ProcSeletivoVO consultarPorDescricaoExata(String descricao, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception;

		ProcSeletivoVO inicializarDadosProcSeletivoImportacaoCandidatoInscricao(ImportarCandidatoInscricaoProcessoSeletivoVO importarCandidatoVO, UsuarioVO usuario) throws Exception;
