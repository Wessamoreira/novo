...
*/
public interface ReceitaDWInterfaceFacade {
	

    public ReceitaDWVO novo() throws Exception;
    public void incluir(ReceitaDWVO obj) throws Exception;
    public void alterar(ReceitaDWVO obj) throws Exception;
    public void excluir(ReceitaDWVO obj) throws Exception;
    public ReceitaDWVO consultarPorChavePrimaria(Integer codigo, int nivelMontarDados, UsuarioVO usuario) throws Exception;
