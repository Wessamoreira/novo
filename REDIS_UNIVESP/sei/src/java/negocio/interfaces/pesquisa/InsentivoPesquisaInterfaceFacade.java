...
*/
public interface InsentivoPesquisaInterfaceFacade {
	

    public InsentivoPesquisaVO novo() throws Exception;
    public void incluir(InsentivoPesquisaVO obj) throws Exception;
    public void alterar(InsentivoPesquisaVO obj) throws Exception;
    public void excluir(InsentivoPesquisaVO obj) throws Exception;
    public InsentivoPesquisaVO consultarPorChavePrimaria(Integer codigo,UsuarioVO usuario) throws Exception;
