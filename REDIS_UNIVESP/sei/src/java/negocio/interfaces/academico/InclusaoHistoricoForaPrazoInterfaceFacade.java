...
public interface InclusaoHistoricoForaPrazoInterfaceFacade {
	...
	MatriculaPeriodoTurmaDisciplinaVO realizarPreenchimentoDadosMatriculaPeriodoTurmaDisciplinaAdicionarPorRequerimento(RequerimentoVO requerimentoVO, boolean validarChoqueHorario, boolean validarVagasReposicao, ConfiguracaoFinanceiroVO configFin, UsuarioVO usuarioVO) throws Exception;
}
