...
public interface MatriculaPeriodoTurmaDisciplinaInterfaceFacade {
	 ...
	 *                validação de dados.
	 */
	public void incluir(MatriculaPeriodoTurmaDisciplinaVO obj, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, GradeCurricularVO gradeCurricularVO, UsuarioVO usuario) throws Exception;
	 ...
	 *                validação de dados.
	 */
	public void alterar(MatriculaPeriodoTurmaDisciplinaVO obj, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public void incluirMatriculaPeriodoTurmaDisciplinas(Integer matriculaPrm, String matricula, List<MatriculaPeriodoTurmaDisciplinaVO> objetos, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, GradeCurricularVO gradeCurricularVO, UsuarioVO usuario) throws Exception;
	...
	// cargaHoraria, Integer cargaHorariaCursada, ConfiguracaoFinanceiroVO
	 ...
	 * 
	 */
	void realizarSugestaoTurmaPraticaTeorica(MatriculaPeriodoVO matriculaPeriodoVO, MatriculaPeriodoTurmaDisciplinaVO matriculaPeriodoTurmaDisciplinaVO, DisciplinaVO disciplina, ConfiguracaoAcademicoVO configuracaoAcademicoVO, List<HorarioAlunoTurnoVO> horarioAlunoTurnoVOs, Boolean considerarVagasReposicao, UsuarioVO usuarioVO) throws Exception;
	...
	List<MatriculaPeriodoTurmaDisciplinaVO> consultarDisciplinaDoAlunoPorMatricula(String matricula, String anoSemestre, PermissaoAcessoMenuVO permissaoAcessoMenuVO, Integer matriculaPeriodoTurmaDisciplina, Boolean consultarRelatorioFacilitador, int nivelMontarDados, UsuarioVO usuario) throws SQLException, Exception;
