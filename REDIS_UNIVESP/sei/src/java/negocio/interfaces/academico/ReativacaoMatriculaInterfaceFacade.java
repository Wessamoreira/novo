...
public interface ReativacaoMatriculaInterfaceFacade {
	...
	List consultarPorRegistroAcademicoAluno(String valorConsulta, boolean controlarAcesso, int nivelMontarDados,UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception;
