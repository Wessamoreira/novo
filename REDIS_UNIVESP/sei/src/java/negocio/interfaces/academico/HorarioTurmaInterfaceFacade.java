...
public interface HorarioTurmaInterfaceFacade {
    ...
    public void incluir(HorarioTurmaVO obj, UsuarioVO usuario) throws Exception;

    public void alterar(HorarioTurmaVO obj, List<HorarioProfessorVO> horarioProfessorVOs, boolean zerarListaConcorrencia, UsuarioVO usuario) throws Exception;
	...
	void realizarEnvioEmailAlunosTurmaPadrao(HorarioTurmaVO horarioTurmaVO, PersonalizacaoMensagemAutomaticaVO msg, UsuarioVO usuarioVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, Boolean enviarPorEmail) throws Exception;

	void realizarEnvioEmailAlunosInclusaoDisciplina(HorarioTurmaVO horarioTurmaVO, PersonalizacaoMensagemAutomaticaVO msg, UsuarioVO usuarioVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, Boolean enviarPorEmail, Map<Integer, String> hashDisciplinasAlteradas) throws Exception;
	...
	void inicializarListaHorarioTurmaDisciplinaProgramada(HorarioTurmaVO horarioTurmaVO, boolean permitirProgramacaoAulaComClassroom, boolean permitirProgramacaoAulaComBlackboard, UsuarioVO usuarioVO) throws Exception;
	...
	void carregarDadosHorarioTurma(HorarioTurmaVO horarioTurmaVO, Integer professor, Integer disciplina, UsuarioVO usuario) throws Exception;
	...
	void realizarCriacaoCalendarioHorarioTurma(HorarioTurmaVO horarioTurmaVO, UsuarioVO usuario) throws Exception;
	 ...
	 * @throws Exception
	 */
	Boolean realizarVerificacaoChoqueHorarioTurmaDiaItemComHorarioTurmaOutroAnoSemestre(HorarioTurmaVO horarioTurmaVO, DisciplinaVO disciplinaBase, Date dataBase, int numeroAula, UsuarioVO usuario, boolean retornarExcecao) throws Exception;
	 ...
	 * @throws Exception
	 */
	Boolean executarVerificarDisponibilidadeHorarioMarcadoTurmaPorDia(HorarioTurmaVO horarioTurmaVO, Date dataBase, DisponibilidadeHorarioTurmaProfessorVO disponibilidadeHorarioTurmaProfessor, boolean retornarExcecao) throws Exception;
