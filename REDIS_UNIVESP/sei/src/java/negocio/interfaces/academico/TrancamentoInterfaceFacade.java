...
public interface TrancamentoInterfaceFacade {
	...
	public void incluir(TrancamentoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO, Boolean realizandoTrancamentoAutomatico) throws Exception;
	...
	public TrancamentoVO consultarPorChavePrimaria(Integer codigo, int nivelMontarDados, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception;
...
//	public List<TrancamentoVO> consultarPorNomePessoa(String valorConsulta, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public List<TrancamentoVO> consultarPorMatriculaSituacaoFinanceira(String matricula, String string, Integer i, boolean b, int nivelmontardadosDadosbasicos, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

//	public List<TrancamentoVO> consultarPorDataUnidadeEnsino(Date datainicio, Date dataFim, String unidadeEnsino, boolean b, int nivelmontardadosDadosbasicos, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
...
//	public List<TrancamentoVO> consultaRapidaPorData(Date prmIni, Date prmFim, Integer unidadeEnsino, boolean controlarAcesso, UsuarioVO usuario) throws Exception;
	...
	void incluirEDeferirRequerimento(TrancamentoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO, Boolean realizandoTrancamentoAutomatico) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<HistoricoVO> executarMontagemHistoricosParaRealizarAlteracaoSituacao(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO,  ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	void persistir(TrancamentoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception;
	...
	void persistirTrancamentoMapaRegistroAbandonoCursoTrancamentoIndividualmente(MapaRegistroEvasaoCursoMatriculaPeriodoVO mrecmp,  ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception;
	...
	void realizarDefinicaoMatriculaPeriodoRealizarTrancamento(TrancamentoVO trancamentoVO,
			ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO,
