...
public interface MatriculaPeriodoInterfaceFacade {
     ...
     */
    public void incluir(MatriculaPeriodoVO obj, MatriculaVO matriculaVO, ProcessoMatriculaCalendarioVO processoMatriculaCalendarioVO, ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuario) throws Exception;
     ...
     * @throws Exception
     */
    /*public void registrarParcelasGeradasAindaNaoPagas_ContabilizandoValorDiferencaCobrarComRelacaoValorPago(List<MatriculaPeriodoVencimentoVO> listaVctosGerados, MatriculaPeriodoVO matriculaPeriodoVO, Double valorDiferencaValorCobrarComRelacaoValorJaPago, ConfiguracaoFinanceiroVO configuracaoFinanceiro, boolean simulandoAlteracao, UsuarioVO usuarioVO) throws Exception;*/

    /*public void registrarParcelasGeradasParaFuturaGeracaoContasAReceber(List<MatriculaPeriodoVencimentoVO> listaVctosGerados, MatriculaPeriodoVO matriculaPeriodoVO,
            Double valorDiferencaValorCobrarComRelacaoValorJaPago) throws Exception;*/

    

    public SituacaoVencimentoMatriculaPeriodo processarGeracao_AlteracaoParcelaVencimentoMatricula(MatriculaPeriodoVencimentoVO parcelaMatricula, MatriculaVO matriculaVO,
            MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuario) throws Exception;
    ...
    public void inicializarDadosParaProcessarGeracaoContasReceberReferentesParcelasMatriculaPeriodo(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO,
            ProcessoMatriculaCalendarioVO processoMatriculaCalendarioVO, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception;
    ...
    public void processarGeracaoContasReceberReferentesParcelasMatriculaPeriodo(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO,
            ProcessoMatriculaCalendarioVO processoMatriculaCalendarioVO, MatriculaPeriodoVencimentoVO mesAnoReferenciaGerar, SituacaoVencimentoMatriculaPeriodo situacaoMatriculaAtualizada, ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuario, Boolean simulacao) throws Exception;
    ...
    /*public MatriculaPeriodoVencimentoVO obterVctoParcelaEspecifica(List<MatriculaPeriodoVencimentoVO> listaVctosGerados, String parcela);*/
     ...
     * @throws Exception
     */
    public Double calcularValorDiferencaValorCobrarComRelacaoValorJaPago(MatriculaVO matriculaVO, MatriculaPeriodoVencimentoVO parcelaMatricula, List<MatriculaPeriodoVencimentoVO> listaVctosGerados,
            MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuario) throws Exception;
    ...
    public void criarContaReceberBolsaCusteadaMatricula(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO, ProcessoMatriculaCalendarioVO processoMatriculaCalendarioVO,
            ConfiguracaoFinanceiroVO configFinan, MatriculaPeriodoVencimentoVO parcelaMatricula, ContaReceberVO contaReceberBaseGeracaoParcelaConvenio, UsuarioVO usuario) throws Exception;
    
    void criarContaReceberNaoPagasBolsaCusteadaMensalidades(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configFinan, MatriculaPeriodoVencimentoVO vctoGerar, UsuarioVO usuario, Boolean simulacao) throws Exception;    
     ...
     *                Caso haja problemas de conexão, restrição de acesso ou validação de dados.
     */
    public void alterar(MatriculaPeriodoVO obj, MatriculaVO matriculaVO, ProcessoMatriculaCalendarioVO processoMatriculaCalendarioVO, ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuario) throws Exception;
     ...
     *                Caso haja problemas de conexão, restrição de acesso ou validação de dados.
     */
    public void alterarMatriculaForaPrazo(MatriculaPeriodoVO obj, MatriculaVO matriculaVO, ProcessoMatriculaCalendarioVO processoMatriculaCalendarioVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, GradeCurricularVO gradeCurricularVO, UsuarioVO usuario) throws Exception;
...
//    public void incluirExcluirDisciplina(MatriculaPeriodoVO obj, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
    ...
    public List<MatriculaPeriodoVO> executarEfetivacaoMatriculasPeriodoPreMatriculadas(List<MatriculaPeriodoVO> listaPreMatriculados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
    ...
    public List consultarPorUnidadeEnsino_ProcMatricula_Matricula_Situacao(Integer unidadeEnsino, Integer procMatricula, Integer curso, Integer turno, Integer turma, String situacao,
            String matricula, boolean somenteParcelaMatricula, String situacaoPreMatricula, boolean ocorreuPrimeiraAula, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
...
//    public void transferirDisciplinasPreMatriculaParaMatriculaAtiva(MatriculaPeriodoVO obj, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
    ...
    public void alterarMatriculaPeriodoVOEspecifico(MatriculaPeriodoVO obj, MatriculaVO matricula, ProcessoMatriculaCalendarioVO processoMatriculaCalendario,
            CondicaoPagamentoPlanoFinanceiroCursoVO condicao, ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuario) throws Exception;
...
//    public void gerarMatriculaInclusaoForaPrazoLista(MatriculaVO matricula, List<MatriculaPeriodoTurmaDisciplinaVO> listaDisciplinaAdicionadaVOs, List<MatriculaPeriodoVO> lista, InclusaoHistoricoForaPrazoVO inclusaoHistoricoForaPrazoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
    ...
    public List criarContaReceberBolsaCusteadaMensalidade(ConfiguracaoFinanceiroVO configFinan, MatriculaVO matriculaVO,
            MatriculaPeriodoVO matriculaPeriodoVO, MatriculaPeriodoVencimentoVO vctoGerar, UsuarioVO usuarioVO) throws Exception;
    ...
    MatriculaPeriodoVO consultarUltimaMatriculaPeriodoPorMatriculaSituacoes(String matricula, String situacoes, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	MatriculaPeriodoVO consultarUltimaMatriculaPeriodoAtivaPreMatriculaPorMatricula(String matricula, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
        ...
        public void adicionarEValidarMatriculaPeriodoTurmaDisciplinaVO(
            ...
            TurmaVO turma,
            TurmaDisciplinaVO turmaDisciplina, List<HorarioAlunoTurnoVO> horarioAlunoTurnoVOs, Boolean considerarVagaReposicao,
            UsuarioVO usuario) throws Exception;
        ...
        public void adicionarEValidarMatriculaPeriodoTurmaDisciplinaVO(
            ...
            MatriculaPeriodoTurmaDisciplinaVO matricaPeriodoTurmaDisciplina, List<HorarioAlunoTurnoVO> horarioAlunoTurnoVOs, Boolean considerarVagaReposicao,
            UsuarioVO usuario) throws Exception;
	...
	public List<MatriculaPeriodoVO> consultaRapidaBasicaUltimaMatriculaPeriodoPorGradeCurricularAtualTransferenciaMatrizCurricular(Integer matrizCurricular, Integer unidadeEnsino, Integer nrPeriodoLetivoInicial, Integer nrPeriodoLetivoFinal, String situacaoMatricula, Integer turma, String ano, String semestre, boolean controlarAcesso, UsuarioVO usuario) throws Exception;
		...
		void executarExclusaoPreMatricula(MatriculaPeriodoVO matriculaPeriodo, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO,  List<MatriculaPeriodoVO> listaPreMatriculados, UsuarioVO usuario) throws Exception;

		List<MatriculaPeriodoVO> executarExclusaoMatriculasPeriodoPreMatriculadas(List<MatriculaPeriodoVO> listaPreMatriculados, ConfiguracaoFinanceiroVO configuracaoFinanceiro, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO,  UsuarioVO usuario) throws Exception;

		List<MatriculaPeriodoVO> executarValidacaoParaExcluirMatriculasPeriodoPreMatriculadas(List<MatriculaPeriodoVO> listaPreMatriculados, ConfiguracaoFinanceiroVO configuracaoFinanceiro, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO,  UsuarioVO usuario) throws Exception;
		...
		void realizarEstornoSituacaoMatriculaPeriodoAoEstornarContaReceber(ContaReceberVO contaReceber, ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuario) throws Exception;
		 ...
		 * @throws Exception 
		 */
		Double executarValidacaoSeraGeradoParcelaExtraRepassarMatricula(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO, ProcessoMatriculaCalendarioVO processoMatriculaCalendarioVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception;

		void atualizarSituacaoMatriculaPeriodo(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception;
	...
	List<MatriculaPeriodoVencimentoVO> gerarVencimentosMensalidades(MatriculaPeriodoVO matriculaPeriodoVO, UsuarioVO usuario) throws Exception;
...
public void removerConstraintValidacaoMatriculaPeriodo() throws Exception;
	...
	public void realizarAtivacaoMatriculaValidandoRegrasEntregaDocumentoAssinaturaContratoMatricula(String matricula, ConfiguracaoFinanceiroVO  configuracaoFinanceiroVO, Boolean retornarException, UsuarioVO usuarioVO) throws Exception ;
	...
	public void inicializarDadosDefinirDisciplinasDependenciaFuturasMatriculaPeriodo(MatriculaVO matriculaVO,
			...
			List<HorarioAlunoTurnoVO> horarioAlunoTurnoVOs, UsuarioVO usuarioLogadoClone) throws Exception;
	...
	void realizarVerificacaoOfertaDisciplinaGrupoOptativa(MatriculaVO matriculaVO,
			...
			List<HorarioAlunoTurnoVO> horarioAlunoTurnoVOs, Boolean apresentarRenovacaoOnline, UsuarioVO usuario)
			throws Exception;
	...
	MatriculaPeriodoVO consultarPorMatriculaDadosMensagemAtivacaoMatricula(String valorConsulta,
			boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO,
			UsuarioVO usuario) throws Exception;
