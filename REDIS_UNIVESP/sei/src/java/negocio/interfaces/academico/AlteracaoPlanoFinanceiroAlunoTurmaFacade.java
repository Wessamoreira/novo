...
public interface AlteracaoPlanoFinanceiroAlunoTurmaFacade {
	...
	public void alterarPlanoFinanceiroAlunoConformeDadosDaTurma(final List<AlteracaoPlanoFinanceiroAlunoTurmaVO> listaDeAlunosQueSeraoAlterados, final ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, final UsuarioVO usuarioVO, TurmaVO turmaVO, final ProgressBarVO progressBarVO) throws Exception;
