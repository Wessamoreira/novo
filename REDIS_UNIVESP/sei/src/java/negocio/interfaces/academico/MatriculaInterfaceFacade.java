...
public interface MatriculaInterfaceFacade {
	...
	public void alterar(MatriculaVO ob, ProcessoMatriculaCalendarioVO processoMatriculaCalendario, CondicaoPagamentoPlanoFinanceiroCursoVO condicao, ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuario) throws Exception;
	...
	public MatriculaVO consultarPorObjetoMatriculaAtivaOuTrancada(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List<MatriculaVO> consultarPorNomePessoaAtivaOuTrancada(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List<MatriculaVO> consultarPorNomeCursoAtivoTrancado(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorCPF(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorPessoaSituacao(Integer pessoa, String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;	

	public MatriculaVO consultarPorChavePrimaria(String matricula, Integer unidadeEnsino, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public MatriculaVO consultarAlunoPorMatricula(String prm, String tipoPessoa, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorMatricula(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorTurma_gradeCurricular(Integer turma, Integer periodoLetivo, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorTurma_periodoLetivo(Integer turma, Integer periodoLetivo, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public MatriculaVO consultarPorObjetoMatricula(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public List<MatriculaVO> consultarPorNomePessoa(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public MatriculaVO consultarPorInscricao(Integer inscricao, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List<MatriculaVO> consultarPorNomeCurso(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorData(Date prmIni, Date prmFim, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorSituacao(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorSituacaoFinanceira(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List<MatriculaVO> consultarMatriculaPorCodigoPessoa(Integer pessoa, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List<MatriculaVO> consultarPorColacaoGrau(Integer Colacao, String ColouGrau, Integer curso, List<ControleLivroRegistroDiplomaUnidadeEnsinoVO> unidadeEnsinoVOs, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public List consultarPorRequerimentoTipoRequerimento(Integer codigoRequerimento, String tipoRequerimento, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public List consultarPorTurnoTipoRequerimentoSemProgramacaoFormatura(Integer turno, String tipoRequerimento, Integer unidadeEnsino, boolean semRequerimento, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorCursoTipoRequerimentoSemProgramacaoFormatura(Integer curso, String tipoRequerimento, Integer unidadeEnsino, boolean semRequerimento, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public List consultarPorMatriculaTipoRequerimentoSemProgramacaoFormatura(String matricula, String tipoRequerimento, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorNomePessoaTipoRequerimentoSemProgramacaoFormatura(String nomePessoa, String tipoRequerimento, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorNomeCursoTipoRequerimentoSemProgramacaoFormatura(String nomeCurso, String tipoRequerimento, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public void validarConsultarRenovacaoMatriculaVisaoAluno(UsuarioVO usuario) throws Exception;

	public void incluir(MatriculaVO obj, MatriculaPeriodoVO matriculaPeriodoVO, ProcessoMatriculaCalendarioVO processoMatriculaCalendario, CondicaoPagamentoPlanoFinanceiroCursoVO condicao, ConfiguracaoFinanceiroVO configuracaoFinanceiro, ConfiguracaoGeralSistemaVO configuracaoGeralSistema, boolean transferencia, UsuarioVO usuario) throws Exception;
	...
	public List consultarPorCursoTurmaAnoSemestre(Integer curso, Integer turma, String ano, String semestre, String tipoMatricula, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, String nivelEducacional, UsuarioVO usuario) throws Exception;
	...
	public String getNumeroMatriculaPorPessoa(PessoaVO pessoa, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public List consultarPorMatriculaNivelEducacional(String valorConsulta, Integer unidadeEnsino, String nivelEducacional, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorNomePessoaNivelEducacional(String valorConsulta, Integer unidadeEnsino, String nivelEducacinoal, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorNomeCursoNivelEducacional(String valorConsulta, Integer unidadeEnsino, String nivelEducacional, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List executarConsultaPorTurmaCurso(Integer turma, Integer curso, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public Object consultarPorMatriculaCodigoCurso(String valorConsultaAluno, Integer codigo, int nivelmontardadosDadosbasicos, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorNomePessoaCodigoCurso(String valorConsultaAluno, Integer codigo, int nivelmontardadosDadosbasicos, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorMatricula(String matricula, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public List executarConsultaPorTurmaCursoGradeCurricularAnoSemestre(Integer turma, Integer curso, String ano, String semestre, Integer gradeCurriculcar, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public List consultarPorCursoTurmaAnoSemestreSituacao(Integer codigo, Integer codigo2, String ano, String semestre, String valor, String tipoMatricula, boolean b, int nivelmontardadosDadosminimos, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public MatriculaVO consultarPorObjetoMatriculaDigitadasCompleta(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public Boolean verificarAlunoEstudouSomenteNoPrimeiroPeriodo(String matricula) throws Exception;

	public MatriculaVO consultarPorObjetoMatriculaParaCancelamentoQuandoSituacaoMatriculaPeriodoAtiva(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public MatriculaVO consultarPorObjetoMatriculaSituacaoMatricula(String matricula, String situacao, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorNomePessoaSituacaoMatricula(String valorConsulta, String situacao, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;

	public List consultarPorNomeCursoSituacaoMatricula(String valorConsulta, String situacao, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
	...
	public void incluirLogExclusaoMatricula(final MatriculaVO obj, final String motivo, ConfiguracaoFinanceiroVO configuracaoFinanceiro, final UsuarioVO usuario) throws Exception;
	...
	MatriculaPeriodoVO realizarGeracaoNovaMatriculaPeriodoParaRenovacao(MatriculaVO matriculaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception;
	...
	void realizarCalculoValoresMatriculaMensalidadePeriodoAluno(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception;

	void realizarDefinicaoDadosFinanceiroMatriculaPeriodo(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, Boolean permitirRealizarMatriculaDisciplinaPreRequisito, UsuarioVO usuarioVO) throws Exception;

	void persistir(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception;
	...
	public List<MatriculaVO> consultaRapidaPorMatriculaTurmaAnoSemestreDataVencimentoContaReceber(String tipoConsulta, Integer codUnidadeEnsino, String matricula, TurmaVO turma, String ano, String semestre, Date dataVencimentoInicio, 
			Date dataVencimentoFinal, DiaSemana diaSemana, Boolean consultaContaVencida, String parcela, Optional<FiltroRelatorioFinanceiroVO> filtroRelatorioFinanceiroVO, UsuarioVO usuarioVO) throws Exception;        
...
public List<MatriculaVO> consultaRapidaPorTurmaIntegralUnidadeEnsino(TurmaVO turmaVO, boolean controlarAcesso,  UsuarioVO usuario) throws Exception;
	...
	List<MatriculaVO> consultarPorRegistroAcademicoPessoaAtivaOuTrancada(String valorConsulta, Integer unidadeEnsino,boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiro,
			UsuarioVO usuario) throws Exception;

	List<MatriculaVO> consultarPorRegistroAcademicoNivelEducacional(String valorConsulta, Integer unidadeEnsino,String nivelEducacinoal, boolean controlarAcesso, int nivelMontarDados,	ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuario) throws Exception;
	...
	void realizarCriacaoMatriculaPorTransferenciaInternaOrigemRequerimento(TransferenciaEntradaVO transferenciaEntradaVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistema,ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, Boolean apresentarVisaoAluno, ProcessoMatriculaVO processoMatriculaVO, UsuarioVO usuario) throws Exception;
	...
	void realizarRenovacaoMatriculaAutomaticaAtravesTransferenciaInterna(TransferenciaEntradaVO transferenciaEntradaVO, PeriodoLetivoVO periodoLetivoCursar , 
			Boolean apresentarVisaoAluno, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO,
	...
	List<HistoricoVO>  realizarCriacaoHistoricoApartirDisciplinasAprovadasMesmaGradeCurricularMatriculaOnline(String matricula ,
			Integer aluno , Integer gradeCurricularAtual  ,TurmaVO turmaVO, ConfiguracaoFinanceiroVO configFinanceiroVO   , NivelMontarDados nivelMontarDados ,UsuarioVO usuario) throws Exception;

	List<MatriculaVO> consultarMatriculasAlunoDiferenteMatriculaAtualPorCodigoPessoaDadosMinimos(String matricula ,Integer pessoa, boolean controlarAcesso,int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuario) throws Exception;
	...
	MatriculaVO consultarMatriculaTransferidaDestinoPorMatriculaTransferidaOrigem(String matricula,
			int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuari) throws Exception;
	...
	void realizarMontagemDadosMatriculaParaRealizacaoMatriculaOnlineProcessoSeletivo( MatriculaRSVO matriculaRSVO,MatriculaVO matriculaVO,MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception;
	...
	void realizarMontagemDadosMatriculaOnlineRealizada(MatriculaRSVO matriculaRSVO, MatriculaVO matriculaVO,
			...
			ConfiguracaoFinanceiroVO configuracaoFinanceiroVO,PeriodoChamadaProcSeletivoVO periodoChamadaProcSeletivoVO , Boolean gerarContratoValidandoDocObrigatorio, UsuarioVO usuarioVO) throws Exception;
