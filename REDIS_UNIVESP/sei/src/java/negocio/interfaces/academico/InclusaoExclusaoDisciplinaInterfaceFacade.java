...
public interface InclusaoExclusaoDisciplinaInterfaceFacade {
    ...
    public void persistir(List<DisciplinaVO> listaExclusaoDisciplina, List<MatriculaVO> listaAluno, List<MatriculaPeriodoTurmaDisciplinaVO> listaInclusaoTurmaDisciplina,
            List<MatriculaPeriodoTurmaDisciplinaVO> listaExclusaoAposPersistir, Integer periodoLetivo, String tipoBusca, String ano, String semestre, Integer turmaConsulta, String nivelEducacionalCurso, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception;
