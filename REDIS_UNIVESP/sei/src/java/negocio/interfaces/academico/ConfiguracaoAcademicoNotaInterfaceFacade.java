...
public interface ConfiguracaoAcademicoNotaInterfaceFacade {
	 ...
	 * @throws Exception
	 */
	List<ConfiguracaoAcademicaNotaVO> consultarPorConfiguracaoAcademicoNotaPermiteLancamentoNota(Integer configuracaoAcademicoVO, boolean notaRecuperacao, TipoUsoNotaEnum tipoUsoNotaEnum) throws Exception;
