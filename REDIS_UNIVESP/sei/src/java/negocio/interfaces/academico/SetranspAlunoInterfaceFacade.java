...
public interface SetranspAlunoInterfaceFacade {

	/**
	 * Operação responsável por retornar um novo objeto da classe
	 * <code>SetranspAlunoVO</code>.
	 */
	public SetranspAlunoVO novo() throws Exception;

	/**
	 * Operação responsável por incluir no banco de dados um objeto da classe
	 * <code>SetranspAlunoVO</code>. Primeiramente valida os dados (
	 * <code>validarDados</code>) do objeto. Verifica a conexão com o banco de
	 * dados e a permissão do usuário para realizar esta operacão na entidade.
	 * Isto, através da operação <code>incluir</code> da superclasse.
	 * 
	 * @param obj
	 *            Objeto da classe <code>SetranspAlunoVO</code> que será gravado
	 *            no banco de dados.
	 * @exception Exception
	 *                Caso haja problemas de conexão, restrição de acesso ou
	 *                validação de dados.
	 */
	public void incluir(SetranspAlunoVO obj) throws Exception;

	/**
	 * Operação responsável por alterar no BD os dados de um objeto da classe
	 * <code>SetranspAlunoVO</code>. Sempre utiliza a chave primária da classe
	 ...
	 * 
	 * @param obj
	 *            Objeto da classe <code>SetranspAlunoVO</code> que será
	 *            alterada no banco de dados.
	 * @exception Execption
	 *                Caso haja problemas de conexão, restrição de acesso ou
	 *                validação de dados.
	 */
	public void alterar(SetranspAlunoVO obj) throws Exception;

	/**
	 * Operação responsável por excluir no BD um objeto da classe
	 * <code>SetranspAlunoVO</code>. Sempre localiza o registro a ser excluído
	...
	/**
	 * Responsável por realizar uma consulta de <code>SetranspAluno</code>
	 ...
	 *         <code>SetranspAlunoVO</code> resultantes da consulta.
	 * @exception Execption
	 *                Caso haja problemas de conexão ou restrição de acesso.
	 */
	 ...
	 * <code>Setransp</code> Faz uso da operação
	 * <code>montarDadosConsulta</code> que realiza o trabalho de prerarar o
	 * List resultante.
	 * 
	 * @return List Contendo vários objetos da classe
	 ...
	 * <code>SetranspAlunoVO</code> através de sua chave primária.
	 * 
	 * @exception Exception
