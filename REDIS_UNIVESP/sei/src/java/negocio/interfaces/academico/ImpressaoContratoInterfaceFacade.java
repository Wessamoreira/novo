...
public interface ImpressaoContratoInterfaceFacade {
	...
	String imprimirContratoVisaoAluno(MatriculaVO matricula, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configFinanceira, ConfiguracaoGeralSistemaVO config, UsuarioVO usuarioLogado) throws Exception;

	String imprimirContratoRenovarMatricula(String tipoContrato, MatriculaVO matricula, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configFinanceira, ConfiguracaoGeralSistemaVO config, UsuarioVO usuarioLogado) throws Exception;
