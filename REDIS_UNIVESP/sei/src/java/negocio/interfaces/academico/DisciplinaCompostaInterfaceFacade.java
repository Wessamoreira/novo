...
public interface DisciplinaCompostaInterfaceFacade {
     ...
     */
    public void incluir(DisciplinaCompostaVO obj, UsuarioVO usuario) throws Exception;
     ...
     */
    public void alterar(DisciplinaCompostaVO obj, UsuarioVO usuario) throws Exception;
	...
	List<DisciplinaCompostaVO> consultarCompostaPorDisciplina(Integer disciplina, UsuarioVO usuario) throws Exception;
}
