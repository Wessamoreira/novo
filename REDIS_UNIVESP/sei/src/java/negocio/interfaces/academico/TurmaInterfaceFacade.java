...
public interface TurmaInterfaceFacade {
	...
	void processarDadosPermitinentesTurmaSelecionada(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception;
	...
	List<TurmaVO> consultarTurmaProgramacaoAula(String campoConsulta, String valorConsulta, String situacaoTurma, String tipoTurma, Integer unidadeEnsino, UsuarioVO usuarioVO) throws Exception;
		...
		/**
		 * @author Carlos Eugênio - 29/09/2016
		 * @param identificador
		 * @param curso
		 * @param unidade
		 * @param controlarAcesso
		...
		List<TurmaVO> consultarPorIdentificadorTurmaUnidadeEnsinoCondicaoRenegociacao(String valorConsulta, List<CondicaoRenegociacaoUnidadeEnsinoVO> listaCondicaoUnidadeEnsinoVOs, Integer curso, Integer turno, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception;
		...
		void realizarAtualizacaoGradeCurricularCursoIntegral(TurmaVO turmaAtual, TurmaVO turmaNovaGradeCurricular, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO, List<MatriculaPeriodoVO> listaMatriculaPeriodo);
		...
		List<TurmaRSVO> consultarTurmaPorPeriodoLetivoUnidadeEnsinoCursoTurnoParaMatriculaOnlineProcessoSeletivo(Integer aluno,
				...
				ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, RenovarMatriculaControle renovarMatriculaControle, UsuarioVO usuarioVO );
