 ...
 */
public interface RegistroTrailerInterfaceFacade {

    public RegistroTrailerVO novo() throws Exception;

    public void incluir(RegistroTrailerVO obj, UsuarioVO usuario) throws Exception;

    public void alterar(RegistroTrailerVO obj, UsuarioVO usuario) throws Exception;

    public void excluir(RegistroTrailerVO obj, UsuarioVO usuario) throws Exception;

    public RegistroTrailerVO consultarPorChavePrimaria(Integer codigo, int nivelMontarDados, UsuarioVO usuario) throws Exception;
