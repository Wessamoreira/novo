...
public interface ParcelaCondicaoPagamentoInterfaceFacade {
	 ...
	 */
	public void incluir(ParcelaCondicaoPagamentoVO obj) throws Exception;
	 ...
	 */
	public void alterar(ParcelaCondicaoPagamentoVO obj) throws Exception;
	...
	public List consultarParcelaCondicaoPagamentos(Integer codigo, int nivelmontardadosTodos) throws Exception;
