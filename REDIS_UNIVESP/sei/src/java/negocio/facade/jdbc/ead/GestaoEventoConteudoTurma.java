...
public class GestaoEventoConteudoTurma extends ControleAcesso implements GestaoEventoConteudoTurmaInterfaceFacade {
	...
	public void incluir(final GestaoEventoConteudoTurmaVO gestaoEventoConteudoTurmaVO, boolean verificarAcesso, UsuarioVO usuarioVO) throws Exception {
		try {
			...
			GestaoEventoConteudoTurma.incluir(getIdEntidade(), verificarAcesso, usuarioVO);
	...
	@Override
	public UIDataTable criarTabelaDinanica(FacesContext facesContext, GestaoEventoConteudoTurmaVO obj) {
		UIDataTable data = new  UIDataTable();;
		
		ValueExpression lista = facesContext.getApplication().getExpressionFactory().createValueExpression(facesContext.getELContext(), "#{GestaoEventoConteudoTurmaControle.conteudoUnidadePaginaRecursoEducacionalVO.gestaoEventoConteudoTurmaVO.gestaoEventoConteudoTurmaAvaliacaoPBLVOs}", Object.class); 
		data.setValueExpression("value", lista);
		data.setId("data");
		data.setVar("gestaoEventoConteudoItem");
		data.setRowKeyVar("rowAluno");
		int posicao = 1;
	...
	public void colunaID(FacesContext facesContext, UIDataTable data, int posicao){
		
		HtmlOutputText output0 = new HtmlOutputText();
	    output0.setId("outputID");
	    output0.setStyleClass("tituloCampos");
	    ValueExpression textve = facesContext.getApplication().getExpressionFactory() .createValueExpression(facesContext.getELContext(), "A#{rowAluno+1}", Object.class); 
	...
	public void colunaAlunos(FacesContext facesContext, UIDataTable data, int posicao){
		
		HtmlOutputText output0 = new HtmlOutputText();
		output0.setId("outputAlunos");
		ValueExpression textve = facesContext.getApplication().getExpressionFactory() .createValueExpression(facesContext.getELContext(), "#{gestaoEventoConteudoItem.avaliador.nome}", Object.class); 
	    output0.setValueExpression("value", textve);
	    output0.setStyleClass("tituloCampos");
