...
public class SicrediControleRemessaCNAB240  extends ControleAcesso implements ControleRemessaCNAB240LayoutInterfaceFacade {
    ...
    public void gerarHeaderArquivo(EditorOC editorOC, Comando cmd, ControleRemessaVO controleRemessaVO, UnidadeEnsinoVO unidadeEnsinoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
        String linha = "";
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "748", 1, 3, " ", false, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, controleRemessaVO.getContaCorrenteVO().getDigito(), 71, 71, "0", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 72, 72, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(Uteis.removeCaractersEspeciais(Uteis.removerAcentuacao(unidadeEnsinoVO.getRazaoSocial())), 30), 73, 102, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "SICREDI", 103, 132, " ", true, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.gethoraHHMMSS_tamanho6(controleRemessaVO.getDataGeracao()), 152, 157, "0", false, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "01600", 167, 171, "0", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 172, 191, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 192, 211, " ", true, false);
    ...
    public void gerarHeaderLote(EditorOC editorOC, Comando cmd, ControleRemessaVO controleRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, controleRemessaVO.getContaCorrenteVO().getDigito(), 72, 72, "0", false, false); // Código do Modelo Personalizado - C078
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 73, 73, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(Uteis.removeCaractersEspeciais(Uteis.removerAcentuacao(controleRemessaVO.getUnidadeEnsinoVO().getRazaoSocial())), 30), 74, 103, " ", false, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "00000000", 200, 207, " ", false, false);
    ...
    public void gerarTrailerLote(EditorOC editorOC, Comando cmd, ControleRemessaVO controleRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 93, 98, "0", false, false); // Uso Exclusivo FEBRABAN/CNAB
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 99, 115, "0", false, false); // Uso Exclusivo FEBRABAN/CNAB
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 116,123, " ", false, false); // Uso Exclusivo FEBRABAN/CNAB
    ...
    public void gerarDetalheSegmentoP(EditorOC editorOC, Comando cmd, ControleRemessaVO controleRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, ControleRemessaContaReceberVO dadosRemessaVO, String tipoOcorrenciaContaRemessa) throws Exception {
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, tipoOcorrenciaContaRemessa, 16, 17, "0", false, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, controleRemessaVO.getContaCorrenteVO().getNumero(), 24, 35, "0", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, controleRemessaVO.getContaCorrenteVO().getDigito(), 36, 36, "0", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 37, 37, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, dadosRemessaVO.getNossoNumero(), 38, 57, "0", true, false); 
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, dadosRemessaVO.getNrDocumento(), 63, 77, " ", true, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "99", 107, 108, " ", false, false);
      ...
      //JUROS DE 1 DIA DE ATRASO
        ...
        if (juroDouble > 0) {
          ...
          linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.getData(UteisData.adicionarDiasEmData(dadosRemessaVO.getDataVencimento(),1), "ddMMyyyy"), 119, 126, " ", false, false); // Data do Juros de Mora - C019
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "000", 225, 227, "", false, false);
    ...
    public void gerarDetalheSegmentoR(EditorOC editorOC, Comando cmd, ControleRemessaVO controleRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, ControleRemessaContaReceberVO dadosRemessaVO, String tipoOcorrenciaContaRemessa) throws Exception {
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.getData(dadosRemessaVO.getDataVencimento(), "ddMMyyyy"), 67, 74, " ", false, false); // Data do Juros de Mora - C019
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "200", 75, 89, "0", false, false); // Juros de Mora por Dia/Taxa - C020    	
    	linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 90, 199, " ", false, false);
    	linha = editorOC.adicionarCampoLinhaVersao2(linha, "00000000", 200, 207, "", false, false);
    	linha = editorOC.adicionarCampoLinhaVersao2(linha, "000", 208, 210, "", false, false);
    	linha = editorOC.adicionarCampoLinhaVersao2(linha, "00000", 211, 215, "", false, false);
    	linha = editorOC.adicionarCampoLinhaVersao2(linha, "0", 216, 216, "", false, false);
    	linha = editorOC.adicionarCampoLinhaVersao2(linha, "000000000000", 217, 228, "", false, false);
    	linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 229, 229, " ", false, false);
    	linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 230, 230, " ", false, false);
    	linha = editorOC.adicionarCampoLinhaVersao2(linha, "0", 231, 231, "", false, false);    
