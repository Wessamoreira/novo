 ...
 * @author Otimize-04
 */
public class BradescoControleRemessaCNAB400 extends ControleAcesso implements ControleRemessaCNAB400LayoutInterfaceFacade {

    private static final long serialVersionUID = 1L;
    private static final String PATTERN = "ddMMyy";

    public BradescoControleRemessaCNAB400() {
    }
                ...
                while (i.hasNext()) {
                    ...
                    if (dadosRemessaVO.getApresentarArquivoRemessa()) {
                    	if (dadosRemessaVO.getBaixarConta()) {
                    		...
                    		if (controleRemessaVO.getContaCorrenteVO().getCarteiraRegistrada() && controleRemessaVO.getContaCorrenteVO().getGerarRemessaSemDescontoAbatido() && dadosRemessaVO.getValorDescontoDataLimite2().doubleValue() > 0) {
	                    		controleRemessaVO.setNumeroIncremental(controleRemessaVO.getNumeroIncremental() + 1);
	                    		gerarDadosDetalheSegmentoTipo2(editorOC, cmd, dadosRemessaVO, controleRemessaVO, configuracaoFinanceiroVO, controleRemessaVO.getNumeroIncremental(), "01");
                    		}
...
//	                    	}
    ...
    public void gerarDadosHeader(EditorOC editorOC, Comando cmd, ControleRemessaVO controleRemessaVO, UnidadeEnsinoVO unidadeEnsinoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.preencherComZerosPosicoesVagas(controleRemessaVO.getContaCorrenteVO().getConvenio(), 20), 27, 46, " ", false, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "BRADESCO", 80, 94, " ", true, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.getData(new Date(), "ddMMyy"), 95, 100, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, " ", 101, 108, " ", true, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "MX", 109, 110, " ", true, false);
        //Número Remessa
        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.preencherComZerosPosicoesVagas(controleRemessaVO.getIncrementalMX().toString(), 7), 111, 117, " ", false, false);
	...
	public void gerarDadosDetalheSegmentoP(EditorOC editorOC, Comando cmd, ControleRemessaContaReceberVO dadosRemessaVO, ControleRemessaVO controleRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, int numeroSequencial, String tipoOcorrenciaContaRemessa) throws Exception {
        String linha = "";
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "1", 1, 1, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "     ", 2, 6, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, " ", 7, 7, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "     ", 8, 12, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "       ", 13, 19, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, " ", 20, 20, " ", false, false);

        linha = editorOC.adicionarCampoLinhaVersao2(linha, "0" + controleRemessaVO.getContaCorrenteVO().getCarteira() + "0"+ controleRemessaVO.getContaCorrenteVO().getAgencia().getNumeroAgencia() + controleRemessaVO.getContaCorrenteVO().getNumero() + controleRemessaVO.getContaCorrenteVO().getDigito(), 21, 37, "0", false, false);

        linha = editorOC.adicionarCampoLinhaVersao2(linha, dadosRemessaVO.getNossoNumero(), 38, 62, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "000", 63, 65, "", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "2", 66, 66, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "0200", 67, 70, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, dadosRemessaVO.getNossoNumero(), 71, 81, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, modulo11(controleRemessaVO.getContaCorrenteVO().getCarteira() + dadosRemessaVO.getNossoNumero()), 82, 82, " ", false, false);

        linha = editorOC.adicionarCampoLinhaVersao2(linha, "0000000000", 83, 92, " ", false, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "2", 106, 106, " ", false, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "000", 140, 142, " ", false, false);
        ...
        if (controleRemessaVO.getContaCorrenteVO().getHabilitarProtestoBoleto()) {
        	...
        	linha = editorOC.adicionarCampoLinhaVersao2(linha, controleRemessaVO.getContaCorrenteVO().getQtdDiasProtestoBoleto_Str(), 159, 160, " ", false, false);
        } else {
        ...
        //linha = editorOC.adicionarCampoLinhaVersao2(linha, "0", 174, 179, "0", false, false);
        ...
        //if (dadosRemessaVO.getValorDescontoDataLimite() != 0 && (dadosRemessaVO.getDataLimiteConcessaoDesconto() == null || (dadosRemessaVO.getDataLimiteConcessaoDesconto() != null && (Uteis.getData(dadosRemessaVO.getDataLimiteConcessaoDesconto()).equals(Uteis.getData(controleRemessaVO.getDataGeracao()))))) {
	        ...
	        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.preencherComZerosPosicoesVagas(Uteis.removeCaractersEspeciais(Uteis.retornarDuasCasasDecimais(new Double(Uteis.truncar(dadosRemessaVO.getValorDescontoDataLimite(), 2)).toString())), 13), 180, 192, "0", false, false);
        } else {
        	linha = editorOC.adicionarCampoLinhaVersao2(linha, "0", 174, 179, "0", false, false);
	        linha = editorOC.adicionarCampoLinhaVersao2(linha, "0", 180, 192, "0", false, false);        	
        }
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.removerAcentuacao(dadosRemessaVO.getLogradouro()) + " " + Uteis.removerAcentuacao(dadosRemessaVO.getBairro()) + " " + Uteis.removerAcentuacao(dadosRemessaVO.getCidade()) + " " + Uteis.removerAcentuacao(dadosRemessaVO.getEstado()), 275, 314, " ", true, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "            ", 315, 326, " ", false, false);
        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.removerMascara(Uteis.removerAcentuacao(dadosRemessaVO.getCep())) , 327, 331, " ", false, false);
         if(Uteis.removerMascara(dadosRemessaVO.getCep()).length()>=8){
        	linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.removerMascara(dadosRemessaVO.getCep()).substring(5, 8) , 332, 334, " ", true, false);
        }else{
        	linha = editorOC.adicionarCampoLinhaVersao2(linha, "   " , 332, 334, " ", true, false);
        }
...
//      		campo = obj.getContaCorrenteVO().getAgencia().getNumeroAgencia() + "000" + obj.getContaCorrenteVO().getConvenio() + campo;
	...
	public void processarArquivoRetorno(ControleRemessaVO controleRemessaVO, String caminho, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception {
		try {
			//ControleCobrancaVO controleCobrancaVO, String caminho, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO
	...
	private void processarHeader(String linha, RegistroHeaderVO header) throws Exception {
        ...
        header.setCodigoEmpresa(Uteis.getValorInteiro(linha.substring(26, 46)));
	...
	private RegistroDetalheVO processarRegistroTransacao(String linha, RegistroDetalheVO detalhe, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO, RegistroHeaderVO header) throws Exception {
        ...
        detalhe.setCedenteNumeroAgencia(linha.substring(24, 29));
        detalhe.setCedenteNumeroConta(linha.substring(29, 36));
        ...
        detalhe.setIndicadorRateioCredito(linha.substring(104, 105));
        ...
        detalhe.setIdentificacaoTituloBanco(linha.substring(116, 146));
