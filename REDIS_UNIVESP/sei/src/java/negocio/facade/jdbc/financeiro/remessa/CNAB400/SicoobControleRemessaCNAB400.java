 ...
 * @author Otimize-04
 */
public class SicoobControleRemessaCNAB400 extends ControleAcesso implements ControleRemessaCNAB400LayoutInterfaceFacade {

    private static final String PATTERN = "ddMMyy";

    public SicoobControleRemessaCNAB400() {
    }
    ...
    public void gerarDadosTransacao2(EditorOC editorOC, Comando cmd, ControleRemessaContaReceberVO dadosRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, int numeroSequencial, ControleRemessaVO controleRemessaVO, String codMovRemessa) throws Exception {
        try {
    	String linha = "";
        //TIPO DE REGISTRO
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, " ", 79, 85, " ", false, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, " ", 96, 105, " ", false, false);        
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "2", 106, 106, "0", false, false);        
        ...
        //CÓDIGO DO BANCO
        linha = editorOC.adicionarCampoLinhaVersao2(linha, Bancos.SICOOB.getNumeroBanco(), 140, 142, "0", false, false);
        //AGÊNCIA COBRADORA
...
//        linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.preencherComZerosPosicoesVagas(Uteis.removeCaractersEspeciais(Uteis.retornarDuasCasasDecimais("0.01")), 13), 161, 173, " ", false, false);
        ...
        linha = editorOC.adicionarCampoLinhaVersao2(linha, "2", 173, 173, " ", false, false);
		...
		try {
			...
			while ((linha = reader.readLine()) != null) {
				...
				case 0:
					...
					break;
				case 1:
					RegistroDetalheVO registroDetalheVO = processarRegistroDetalhe(linha, new RegistroDetalheVO(),
							configuracaoFinanceiroVO, usuarioVO);
					if (registroDetalheVO != null) {
						controleRemessaVO.getRegistroDetalheRetornoVOs().add(registroDetalheVO);
					}
					break;
				case 9:
