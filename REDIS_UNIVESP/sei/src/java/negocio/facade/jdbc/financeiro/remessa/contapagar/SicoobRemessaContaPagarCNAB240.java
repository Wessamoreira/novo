...
import negocio.interfaces.financeiro.remessa.ControleRemessaContaPagarCNAB240LayoutInterfaceFacade;
 ...
 */
public class SicoobRemessaContaPagarCNAB240 extends ControleRemessaContaPagarLayoutImpl implements ControleRemessaContaPagarLayoutInterfaceFacade {
			...
			controleRemessaVO.setNumeroIncremental(controleRemessaVO.getNumeroIncremental()+ 1);
		     ...
		     for (ContaPagarControleRemessaContaPagarVO remessaContaPagarVO : mapaRemessaContaPagarVO.getListaRemessaContaPagar()) {
		    	validarDadosParaTodosSegmento(remessaContaPagarVO);
		     	...
		     	}else if(remessaContaPagarVO.getTipoLancamentoContaPagar().isLiquidacaoTituloCarteiraCobrancaSicoob()
	...
	private void gerarDadosHeaderArquivo(EditorOC editorOC, Comando cmd, ControleRemessaContaPagarVO controleRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		...
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.preencherComZerosPosicoesVagas(String.valueOf(controleRemessaVO.getIncrementalMX()), 6), 158, 163, " ", false, false);
		// Numero da Versao do Layout
		linha = editorOC.adicionarCampoLinhaVersao2(linha, "087", 164, 166, " ", false, false);
	...
	private void gerarDadosHeaderLote(EditorOC editorOC, Comando cmd, ControleRemessaContaPagarVO controleRemessaVO, MapaRemessaLoteContaPagarVO mapaRemessaContaPagar, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		...
		linha = editorOC.adicionarCampoLinhaVersao2(linha, "045", 14, 16, " ", false, false);
		// filler espaco em branco
		...
		//Logradouro
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(controleRemessaVO.getUnidadeEnsinoVO().getEndereco(), 30), 143, 172, " ", true, false);
		//Número
		linha = editorOC.adicionarCampoLinhaVersao2(linha, "", 173, 177, "0", true, false);
		//Complemento
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(controleRemessaVO.getUnidadeEnsinoVO().getEnderecoCompleto(), 15), 178, 192, " ", true, false);
		//Cidade
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(controleRemessaVO.getUnidadeEnsinoVO().getCidade().getNome(), 20), 193, 212, " ", true, false);
		//CEP
	...
	private void gerarDetalheSegmentoA(EditorOC editorOC, Comando cmd, ControleRemessaContaPagarVO controleRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, ContaPagarControleRemessaContaPagarVO dadosRemessaVO) throws Exception {
		...
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.removeCaractersEspeciais(dadosRemessaVO.getBancoRecebimento().getNrBanco().trim()), 21, 23, "0", false, false);
		...
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.removeCaractersEspeciais(dadosRemessaVO.getContaPagar().getDigitoAgenciaRecebimento().trim()), 29, 29, " ", false, false);
		...
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.removerMascara(dadosRemessaVO.getNrDocumento()), 135, 154, "0", false, false);
		...
		if(dadosRemessaVO.getTipoLancamentoContaPagar().isTransferencia() 
				&& ((dadosRemessaVO.getModalidadeTransferenciaBancariaEnum().isTed() && (!Uteis.isAtributoPreenchido(dadosRemessaVO.getTipoContaEnum()) || (Uteis.isAtributoPreenchido(dadosRemessaVO.getTipoContaEnum()) && dadosRemessaVO.getTipoContaEnum().equals(TipoContaEnum.CREDITO_EM_CONTA_CORRENTE)))) 
						|| (dadosRemessaVO.getModalidadeTransferenciaBancariaEnum().isDoc() && !dadosRemessaVO.getFinalidadeDocEnum().isDocPoupanca()))) {
			linha = editorOC.adicionarCampoLinhaVersao2(linha, "CC", 225, 226, " ", false, false);
		}else if(dadosRemessaVO.getTipoLancamentoContaPagar().isTransferencia() 
				&& ((dadosRemessaVO.getModalidadeTransferenciaBancariaEnum().isDoc() && dadosRemessaVO.getFinalidadeDocEnum().isDocPoupanca()) 
						|| (dadosRemessaVO.getModalidadeTransferenciaBancariaEnum().isTed() && Uteis.isAtributoPreenchido(dadosRemessaVO.getTipoContaEnum()) && dadosRemessaVO.getTipoContaEnum().equals(TipoContaEnum.CREDITO_EM_CONTA_POUPANCA)))){
	...
	private void gerarDetalheSegmentoB(EditorOC editorOC, Comando cmd, ControleRemessaContaPagarVO controleRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, ContaPagarControleRemessaContaPagarVO dadosRemessaVO) throws Exception {
		...
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(dadosRemessaVO.getLogradouroFavorecido(), 30), 33, 62, " ", true, false);
		//Número do Local do Favorecido 
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(dadosRemessaVO.getNumeroEnderecoFavorecido(), 5), 63, 67, " ", true, false);
		//Complemento do Local Favorecido
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(dadosRemessaVO.getComplementoFavorecido(), 15), 68, 82, " ", true, false);
		//Bairro do Favorecido
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(dadosRemessaVO.getBairroFavorecido(), 15), 83, 97, " ", true, false);
        //Cidade do Favorecido
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(dadosRemessaVO.getCidadeFavorecido(), 20), 98, 117, " ", true, false);
        //CEP do Favorecido
		...
		//Estado do Favorecido
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(dadosRemessaVO.getEstadoFavorecido(), 2), 126, 127, " ", true, false);
		//Data de Vencimento
		...
		//5 = Emite Aviso Somente para o Favorecido
		//6 = Emite Aviso para o Remetente e Favorecido
		linha = editorOC.adicionarCampoLinhaVersao2(linha, "0", 226, 226, " ", false, false);
	...
	private void gerarDetalheSegmentoJ52(EditorOC editorOC, Comando cmd, ControleRemessaContaPagarVO controleRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, ContaPagarControleRemessaContaPagarVO dadosRemessaVO) throws Exception {
		...
		//Nome do Favorecido
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(controleRemessaVO.getUnidadeEnsinoVO().getRazaoSocial(), 40), 36, 75, " ", true, false);
		...
		// nome Cedente
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(dadosRemessaVO.getNomeFavorecido(), 40), 92, 131, " ", false, false);
	...
	private void gerarDetalheSegmentoN(EditorOC editorOC, Comando cmd, ControleRemessaContaPagarVO controleRemessaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, ContaPagarControleRemessaContaPagarVO dadosRemessaVO) throws Exception {
		...
		linha = editorOC.adicionarCampoLinhaVersao2(linha, Uteis.copiarDelimitandoTamanhoDoTexto(dadosRemessaVO.getNomeFavorecido(), 30), 58, 87, " ", true, false);
		// Data do Pagamento
	...
	private void processarDetalheLoteArquivoRetorno(String linha, ControleCobrancaPagarVO obj, UsuarioVO usuarioVO) throws Exception {
		...
		if(registroDetalhe.getCodigoSegmentoRegistroLote().equals("A") 
			...
			/*if(Uteis.isAtributoPreenchido(registroDetalhe.getNossoNumeroContaAgrupada())){
				getFacadeFactory().getControleRemessaContaPagarFacade().executarGeracaoContaPagarRegistrosArquivoAgrupados(obj,registroDetalhe,registroHeaderLote ,usuarioVO);				
