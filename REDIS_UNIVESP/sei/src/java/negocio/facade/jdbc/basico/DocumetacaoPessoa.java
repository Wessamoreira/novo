...
//            }
     ...
     */
    public static DocumetacaoPessoaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        DocumetacaoPessoaVO obj = new DocumetacaoPessoaVO();
    ...
    public static DocumetacaoPessoaVO montarDadosPersonalizado(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        DocumetacaoPessoaVO obj = new DocumetacaoPessoaVO();
        obj.setCodigo(new Integer(dadosSQL.getInt("codigo")));
        obj.getTipoDeDocumentoVO().setCodigo(new Integer(dadosSQL.getInt("tipoDocumento")));
...
//                    obj.getArquivoVO().setPastaBaseArquivoEnum(PastaBaseArquivoEnum.DOCUMENTOS_TMP);
     ...
     *                Erro de conexão com o BD ou restrição de acesso a esta operação.
     */
    public static List consultarDocumetacaoPessoas(Integer pessoa, int nivelMontarDados, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
        ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
    ...
    public static void montarDadosArquivo(DocumetacaoPessoaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    public static void montarDadosArquivoVerso(DocumetacaoPessoaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    public static void montarDadosTipoDeDocumento(DocumetacaoPessoaVO obj, UsuarioVO usuario) throws Exception {
    ...
    public static void montarDadosUsuario(DocumetacaoPessoaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
