...
//			Cidade.incluir(getIdEntidade(), true, usuarioVO);
	 ...
	 *         resultantes da consulta.
	 */
	public static List<CidadeVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 *         montados.
	 */
	public static CidadeVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		CidadeVO obj = new CidadeVO();
		obj.setCodigo(new Integer(dadosSQL.getInt("codigo")));
		obj.setNome(dadosSQL.getString("nome"));
