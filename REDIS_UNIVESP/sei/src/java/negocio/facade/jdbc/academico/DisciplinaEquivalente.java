...
public class DisciplinaEquivalente extends ControleAcesso implements DisciplinaEquivalenteInterfaceFacade {
	 ...
	 */
	public static DisciplinaEquivalenteVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
		DisciplinaEquivalenteVO obj = new DisciplinaEquivalenteVO();
	 ...
	 */
	public static void montarDadosEquivalente(DisciplinaEquivalenteVO obj, UsuarioVO usuario) throws Exception {
	...
	public List consultarDisciplinaEquivalentes(Integer disciplina, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
		...
		while (resultado.next()) {
			objetos.add(DisciplinaEquivalente.montarDados(resultado, usuario));
		}
		return objetos;
	}
