...
public class PendenciaLiberacaoMatricula extends ControleAcesso implements PendenciaLiberacaoMatriculaInterfaceFacade {
    ...
    public PendenciaLiberacaoMatriculaVO consultarOutraPendenciaExistente(String matricula, Integer codigoPendenciaLiberacaoMatricula, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
    	StringBuilder sb = new StringBuilder();
    	sb.append("SELECT ");
    	sb.append(" pendenciaLiberacaoMatricula.*, usuarioSolicitacao.nome as \"usuarioSolicitacao.nome\" ");
        sb.append(" FROM pendenciaLiberacaoMatricula ");   
    ...
    private PendenciaLiberacaoMatriculaVO montarDados(SqlRowSet rs, int nivelMontarDados, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception{
	...
	public void indeferirLiberacaoPendenciaMatricula(PendenciaLiberacaoMatriculaVO obj, CancelamentoVO cancelamentoVO, UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
		...
		getFacadeFactory().getCancelamentoFacade().incluir(cancelamentoVO, configuracaoGeralSistemaVO, configuracaoFinanceiroVO, usuario, false);
		
		if(verificarSeOutraPendenciaExistente(obj.getMatricula().getMatricula(), obj.getCodigo())){
			PendenciaLiberacaoMatriculaVO outraPendenciaLiberacaoMatricula = consultarOutraPendenciaExistente(obj.getMatricula().getMatricula(), obj.getCodigo(), usuario, configuracaoFinanceiroVO);
	...
	public void deferirLiberacaoPendenciaMatricula(PendenciaLiberacaoMatriculaVO obj, MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistema) throws Exception{
		...
		if(!verificarSeOutraPendenciaExistente(obj.getMatricula().getMatricula(), obj.getCodigo())){
			...
			getFacadeFactory().getMatriculaPeriodoFacade().alterar(matriculaPeriodoVO, matriculaVO, matriculaPeriodoVO.getProcessoMatriculaCalendarioVO(), configuracaoFinanceiroVO, usuario);
		}
		
	}
	
	public static void montarDadosMatricula(PendenciaLiberacaoMatriculaVO obj, int nivelMontarDados, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
