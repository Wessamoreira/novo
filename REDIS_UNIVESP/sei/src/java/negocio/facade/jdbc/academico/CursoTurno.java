...
public class CursoTurno extends ControleAcesso implements CursoTurnoInterfaceFacade {
	 ...
	 */
	public static CursoTurnoVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
		CursoTurnoVO obj = new CursoTurnoVO();
	 ...
	 */
	public static void montarDadosTurno(CursoTurnoVO obj, UsuarioVO usuario) throws Exception {
	...
	public List consultarCursoTurnos(Integer curso, boolean controleAcesso, UsuarioVO usuario) throws Exception {
		...
		while (resultado.next()) {
			objetos.add(CursoTurno.montarDados(resultado, usuario));
		}
		return objetos;
	}
