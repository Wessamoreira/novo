...
public class TransferenciaSaida extends ControleAcesso implements TransferenciaSaidaInterfaceFacade {
	...
	public void incluir(final TransferenciaSaidaVO obj, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistema) throws Exception {
		try {
			validarDados(obj, configuracaoGeralSistema);
			TransferenciaSaida.incluir(getIdEntidade(), true, usuario);
			...
			alterarSituacaoAcademicaMatriculaTransferenciaSaida(obj, configuracaoFinanceiroVO, usuario);
	 ...
	 */
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	private void alterarSituacaoAcademicaMatriculaTransferenciaSaida(TransferenciaSaidaVO obj, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {		
		if (!obj.getMatricula().getCurso().getIntegral()) {		
			MatriculaPeriodoVO matriculaPeriodoVO = getFacadeFactory().getMatriculaPeriodoFacade().consultarUltimaMatriculaPeriodoPorMatriculaSituacoes(obj.getMatricula().getMatricula(), "'AT', 'PR'", false, Uteis.NIVELMONTARDADOS_COMBOBOX, configuracaoFinanceiroVO, usuario);
			...
			getFacadeFactory().getTrancamentoFacade().alterarSituacaoAcademicaMatricula(matriculaPeriodoVO, obj.getHistoricoVOs(), obj.getCodigoRequerimento(), obj.getData(), OrigemFechamentoMatriculaPeriodoEnum.TRANSFERENCIA_SAIDA, obj.getCodigo(), false, false, configuracaoFinanceiroVO, true, true, usuario);
			...
			List listaMatriculaPeriodoVO = getFacadeFactory().getMatriculaPeriodoFacade().consultarMatriculaPeriodoPorMatriculaSituacoes(obj.getMatricula().getMatricula(), "'AT', 'PR'", false, Uteis.NIVELMONTARDADOS_COMBOBOX, configuracaoFinanceiroVO, usuario);
	 ...
	 */
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void alterar(final TransferenciaSaidaVO obj, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistema) throws Exception {
		try {
			validarDados(obj, configuracaoGeralSistema);
			TransferenciaSaida.alterar(getIdEntidade(), true, usuario);
	...
	public void excluir(TransferenciaSaidaVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			TransferenciaSaida.excluir(getIdEntidade(), true, usuarioVO);
	...
	public TransferenciaSaidaVO consultarPorMatricula(String matricula, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
		...
		if (tabelaResultado.next()) {
			retorno = montarDados(tabelaResultado, Uteis.NIVELMONTARDADOS_DADOSBASICOS, null, usuario);
		}
		return retorno;
	}
	 ...
	 */
	@Override
	public List<TransferenciaSaidaVO> consultarPorAluno(String valorConsulta, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
	...
	public List<TransferenciaSaidaVO> consultarPorDataUnidadeEnsino(Date prmIni, Date prmFim, String unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
	 ...
	 *         <code>TransferenciaSaidaVO</code> resultantes da consulta.
	 */
	public static List<TransferenciaSaidaVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public static TransferenciaSaidaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		TransferenciaSaidaVO obj = new TransferenciaSaidaVO();
	...
	public static void montarDadosRequerimento(TransferenciaSaidaVO obj, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public static void montarDadosResponsavelAutorizacao(TransferenciaSaidaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public static void montarDadosMatricula(TransferenciaSaidaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 *                procurado.
	 */
	public TransferenciaSaidaVO consultarPorChavePrimaria(Integer codigoPrm, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
	 ...
	 */
	@Override
	public void persistir(final TransferenciaSaidaVO obj, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistema, UsuarioVO usuario) throws Exception {
		if (obj.getNovoObj()) {
			incluir(obj, configuracaoFinanceiroVO, usuario, configuracaoGeralSistema);
		} else {
			alterar(obj, configuracaoFinanceiroVO, usuario, configuracaoGeralSistema);
		}
	}
...
//		}
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void realizarEstornoTransferenciaSaida(TransferenciaSaidaVO transferenciaSaidaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception{
		TransferenciaSaida.verificarPermissaoFuncionalidadeUsuario("PermiteEstornarTransferenciaSaida", usuarioVO);		
		try{ 
			...
			MatriculaPeriodoVO matriculaPeriodoVO = getFacadeFactory().getMatriculaPeriodoFacade().consultarUltimaMatriculaPeriodoPorMatriculaAnoSemestre(transferenciaSaidaVO.getMatricula().getMatricula(), false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, configuracaoFinanceiroVO, usuarioVO);
