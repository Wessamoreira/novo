...
public class TransferenciaEntradaDisciplinasAproveitadas extends ControleAcesso implements TransferenciaEntradaDisciplinasAproveitadasInterfaceFacade {
	 ...
	 */
	public static List<TransferenciaEntradaDisciplinasAproveitadasVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public static TransferenciaEntradaDisciplinasAproveitadasVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		TransferenciaEntradaDisciplinasAproveitadasVO obj = new TransferenciaEntradaDisciplinasAproveitadasVO();
	...
	public static void montarDadosDisciplina(TransferenciaEntradaDisciplinasAproveitadasVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 *                operação.
	 */
	public static List<TransferenciaEntradaDisciplinasAproveitadasVO> consultarTransferenciaEntradaDisciplinasAproveitadass(Integer transferenciaEntrada, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		...
		while (tabelaResultado.next()) {
			...
			novoObj = TransferenciaEntradaDisciplinasAproveitadas.montarDados(tabelaResultado, nivelMontarDados, usuario);
			objetos.add(novoObj);
		}
		return objetos;
	}
