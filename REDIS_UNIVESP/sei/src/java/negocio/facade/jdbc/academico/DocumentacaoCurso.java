...
public class DocumentacaoCurso extends ControleAcesso implements DocumentacaoCursoInterfaceFacade {
	 ...
	 */
	public static DocumentacaoCursoVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
		DocumentacaoCursoVO obj = new DocumentacaoCursoVO();
	 ...
	 */
	public static List consultarDocumentacaoCursos(MatriculaVO matricula, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
		...
		while (resultado.next()) {
			objetos.add(DocumentacaoCurso.montarDados(resultado, usuario));
		}
		return objetos;
	}
	...
	public static void montarDadosTipoDeDocumento(DocumentacaoCursoVO obj, UsuarioVO usuario) throws Exception {
