...
public class DisciplinaPreRequisito extends ControleAcesso implements DisciplinaPreRequisitoInterfaceFacade {
	 ...
	 */
	public static List<DisciplinaPreRequisitoVO> montarDadosConsulta(SqlRowSet tabelaResultado, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public static DisciplinaPreRequisitoVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
		DisciplinaPreRequisitoVO obj = new DisciplinaPreRequisitoVO();
	 ...
	 */
	public static void montarDadosPreRequisito(DisciplinaPreRequisitoVO obj, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public static List<DisciplinaPreRequisitoVO> consultarDisciplinaPreRequisitos(Integer gradeDisciplina, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
		...
		while (resultado.next()) {
			objetos.add(DisciplinaPreRequisito.montarDados(resultado, usuario));
		}
		return objetos;
	}
	...
	public static List<DisciplinaPreRequisitoVO> consultarDisciplinaCompostaPreRequisitos(Integer gradeDisciplinaComposta, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
		List<DisciplinaPreRequisitoVO> objetos = new ArrayList<DisciplinaPreRequisitoVO>(0);
...
//		}
	...
	public static List<DisciplinaPreRequisitoVO> consultarGrupoOptativaPreRequisitos(Integer gradeCurricularGrupoOptativaDisciplina, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
		List<DisciplinaPreRequisitoVO> objetos = new ArrayList<DisciplinaPreRequisitoVO>(0);
