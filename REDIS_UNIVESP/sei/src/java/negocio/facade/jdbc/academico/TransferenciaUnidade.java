...
import negocio.interfaces.academico.TransferenciaUnidadeInterfaceFacade;
...
public class TransferenciaUnidade extends ControleAcesso implements TransferenciaUnidadeInterfaceFacade {
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	private void alterarSituacaoAcademicaMatriculaParaTransferenciaInterna(MatriculaPeriodoVO matriculaPeriodoOrigem, TransferenciaUnidadeVO transferenciaUnidadeVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
...
//			}
		...
		getFacadeFactory().getTrancamentoFacade().alterarSituacaoAcademicaMatriculaPeriodo(matriculaPeriodoOrigem, historicoVOs, new Date(), OrigemFechamentoMatriculaPeriodoEnum.TRANSFERENCIA_INTERNA, transferenciaUnidadeVO.getCodigo(), configuracaoFinanceiroVO, usuario);
	}
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void carregarPlanoFinanceiroAluno(MatriculaPeriodoVO matriculaPeriodoOrigem, MatriculaPeriodoVO matriculaPeriodoDestino, MatriculaVO matriculaVoNova, Boolean transferirDescontos, ConfiguracaoFinanceiroVO configuracaoFinanceiroPadraoSistema, UsuarioVO usuario) throws Exception {
		try {
			List ordemDesconto = null;
			getFacadeFactory().getMatriculaPeriodoFacade().inicializarPlanoFinanceiroAlunoMatriculaPeriodo(matriculaVoNova, matriculaPeriodoDestino, matriculaVoNova.getPlanoFinanceiroAluno(), true, usuario);
			...
			getFacadeFactory().getMatriculaFacade().calcularTotalDesconto(matriculaVoNova, matriculaPeriodoDestino, ordemDesconto, usuario, configuracaoFinanceiroPadraoSistema);
		} catch (Exception e) {
			throw e;
		}
	}
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void carregarPlanoFinanceiroMatriculaPeriodoOrigemParaNovaMatricula(MatriculaPeriodoVO matriculaPeriodoOrigem, MatriculaVO matriculaVoNova, UsuarioVO usuario) throws Exception {
		matriculaPeriodoOrigem.getMatriculaVO().setPlanoFinanceiroAluno(getFacadeFactory().getPlanoFinanceiroAlunoFacade().consultarPorMatriculaPeriodo(matriculaPeriodoOrigem.getCodigo(), false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuario));
		// Preencher dados planoFinanceiroAluno matriculaPeriodoDestino com
		// dados do planoFinanceiroAluno da matriculaPeriodoOrigem
		matriculaVoNova.getPlanoFinanceiroAluno().setOrdemDescontoAluno(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getOrdemDescontoAluno());
		matriculaVoNova.getPlanoFinanceiroAluno().setOrdemDescontoAlunoValorCheio(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getOrdemDescontoAlunoValorCheio());
		matriculaVoNova.getPlanoFinanceiroAluno().setOrdemPlanoDesconto(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getOrdemPlanoDesconto());
		matriculaVoNova.getPlanoFinanceiroAluno().setOrdemPlanoDescontoValorCheio(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getOrdemPlanoDescontoValorCheio());
		matriculaVoNova.getPlanoFinanceiroAluno().setOrdemConvenio(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getOrdemConvenio());
		matriculaVoNova.getPlanoFinanceiroAluno().setOrdemConvenioValorCheio(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getOrdemConvenioValorCheio());
		matriculaVoNova.getPlanoFinanceiroAluno().setOrdemDescontoProgressivo(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getOrdemDescontoProgressivo());
		matriculaVoNova.getPlanoFinanceiroAluno().setOrdemDescontoProgressivoValorCheio(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getOrdemDescontoProgressivoValorCheio());
		matriculaVoNova.getPlanoFinanceiroAluno().setTipoDescontoMatricula(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getTipoDescontoMatricula());
		matriculaVoNova.getPlanoFinanceiroAluno().setPercDescontoMatricula(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getPercDescontoMatricula());
		matriculaVoNova.getPlanoFinanceiroAluno().setValorDescontoMatricula(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getValorDescontoMatricula());
		matriculaVoNova.getPlanoFinanceiroAluno().setTipoDescontoParcela(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getTipoDescontoParcela());
		matriculaVoNova.getPlanoFinanceiroAluno().setPercDescontoParcela(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getPercDescontoParcela());
		matriculaVoNova.getPlanoFinanceiroAluno().setValorDescontoParcela(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getValorDescontoParcela());
		matriculaVoNova.getPlanoFinanceiroAluno().setItemPlanoFinanceiroAlunoVOs(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getItemPlanoFinanceiroAlunoVOs());
		matriculaVoNova.getPlanoFinanceiroAluno().setItemPlanoFinanceiroAlunoVOs(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getItemPlanoFinanceiroAlunoVOs());
		Ordenacao.ordenarLista(matriculaVoNova.getPlanoFinanceiroAluno().getItemPlanoFinanceiroAlunoVOs(), "ordenacao");
		matriculaVoNova.getPlanoFinanceiroAluno().setDescontoProgressivoPrimeiraParcela(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getDescontoProgressivoPrimeiraParcela());
		matriculaVoNova.getPlanoFinanceiroAluno().setDescontoValidoAteDataParcela(matriculaPeriodoOrigem.getMatriculaVO().getPlanoFinanceiroAluno().getDescontoValidoAteDataParcela());
		matriculaVoNova.getPlanoFinanceiroAluno().setJustificativa(matriculaVoNova.getPlanoFinanceiroAluno().getJustificativa() + "\nDescontos Transferência de Unidade Matrícula: " + matriculaPeriodoOrigem.getMatriculaVO().getMatricula() + " Unidade: " + matriculaPeriodoOrigem.getMatriculaVO().getUnidadeEnsino().getNome());
	}

	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void gravarMatricula(MatriculaPeriodoVO matriculaPeriodoVoDestino, MatriculaVO matriculaVoNova, ConfiguracaoFinanceiroVO configuracaoFinanceiroPadraoSistema, ConfiguracaoGeralSistemaVO configuracaoGeralSistema, UsuarioVO usuario) throws Exception {
		try {
			if (matriculaVoNova.getIsAtiva()) {
				...
				if (!matriculaVoNova.getMatriculaJaRegistrada()) {
					getFacadeFactory().getMatriculaFacade().incluir(matriculaVoNova, matriculaPeriodoVoDestino, matriculaPeriodoVoDestino.getProcessoMatriculaCalendarioVO(), matriculaVoNova.getPlanoFinanceiroAluno().getCondicaoPagamentoPlanoFinanceiroCursoVO(), configuracaoFinanceiroPadraoSistema, configuracaoGeralSistema, true, usuario);
				}
			} else {
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void isentarContasReceberMatriculaDestino(MatriculaPeriodoVO matriculaPeriodoVoOrigem, MatriculaPeriodoVO matriculaPeriodoVoDestino, MatriculaVO matriculaVoNova, ConfiguracaoFinanceiroVO configuracaoFinanceiroPadraoSistema, UsuarioVO usuario) throws Exception {
		getFacadeFactory().getMatriculaPeriodoFacade().liberarContasTransferenciaUnidade(matriculaVoNova, matriculaPeriodoVoOrigem, matriculaPeriodoVoDestino, matriculaPeriodoVoDestino.getProcessoMatriculaCalendarioVO(), usuario, configuracaoFinanceiroPadraoSistema, usuario);
	}
	...
	public void incluir(final TransferenciaUnidadeVO obj, UsuarioVO usuario) throws Exception {
		try {
			validarDados(obj);
			TransferenciaUnidade.incluir(getIdEntidade(), true, usuario);
	...
	@Override
	public Boolean imprimirContratoTransferenciaUnidade(Integer transferenciaUnidade, Integer codigoTexto, ConfiguracaoFinanceiroVO configuracaoFinanceiro, UsuarioVO usuarioLogado) throws Exception {
		try {
			TransferenciaUnidadeVO transferenciaUnidadeVO = consultarPorChavePrimaria(transferenciaUnidade, false, usuarioLogado);
			MatriculaVO obj = getFacadeFactory().getMatriculaFacade().consultarPorChavePrimaria(transferenciaUnidadeVO.getMatriculaVoDestino().getMatricula(), transferenciaUnidadeVO.getMatriculaVoDestino().getUnidadeEnsino().getCodigo(), Uteis.NIVELMONTARDADOS_DADOSENTIDADESUBORDINADAS, configuracaoFinanceiro, usuarioLogado);
			...
			String contratoPronto  = texto.substituirTagsTextoPadraoContratoMatricula(null, obj,  obj.getMatriculaPeriodoVOAtiva().getMatriculaPeriodoVencimentoVOs(), obj.getMatriculaPeriodoVOAtiva(), plano, listaPlanoDescontoVO, dc, usuarioLogado);
			HttpServletRequest request = (HttpServletRequest) context().getExternalContext().getRequest();
