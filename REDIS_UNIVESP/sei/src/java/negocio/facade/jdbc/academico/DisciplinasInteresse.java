...
public class DisciplinasInteresse extends ControleAcesso implements DisciplinasInteresseInterfaceFacade {
     ...
     */
    public static DisciplinasInteresseVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
        DisciplinasInteresseVO obj = new DisciplinasInteresseVO();
     ...
     */
    public static void montarDadosDisciplina(DisciplinasInteresseVO obj, UsuarioVO usuario) throws Exception {
    ...
    //    DisciplinasInteresse.excluir(getIdEntidade(), verificarAcesso, usuario);
     ...
     */
    public static List consultarDisciplinasInteresses(Integer professor, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
        ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
        ...
        while (resultado.next()) {
            objetos.add(DisciplinasInteresse.montarDados(resultado, usuario));
        }
        return objetos;
    }
