...
public class Trancamento extends ControleAcesso implements TrancamentoInterfaceFacade {
	...
	public void alterarSituacaoAcademicaMatricula(MatriculaPeriodoVO matriculaPeriodoVO, List<HistoricoVO> historicoVOs, RequerimentoVO requerimentoVO, Date data, OrigemFechamentoMatriculaPeriodoEnum origem, Integer codigoOrigemFechamentoMatriculaPeriodo, boolean alunoTransferidoUnidade, boolean relativoAbandonoDeCurso, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO,Boolean inativarUsuarioLdap , Boolean inativarUsuarioBlackBoard  , UsuarioVO usuario) throws Exception {
		...
		alterarSituacaoAcademicaMatriculaPeriodo(matriculaPeriodoVO, historicoVOs, data, origem, codigoOrigemFechamentoMatriculaPeriodo, configuracaoFinanceiroVO, usuario);		
	 ...
	 */
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void alterarSituacaoAcademicaMatriculaPeriodo(MatriculaPeriodoVO matriculaPeriodoVO, List<HistoricoVO> historicoVOs, Date data, OrigemFechamentoMatriculaPeriodoEnum origem, Integer codigoOrigemFechamentoMatriculaPeriodo, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
...
//			getFacadeFactory().getMatriculaDWFacade().incluir(matriculaDWVO, usuario);
	 ...
	 */
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void incluir(final TrancamentoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO, Boolean realizandoTrancamentoAutomatico) throws Exception {
		try {
			...
			if (Uteis.isAtributoPreenchido(usuarioVO)) {
				Trancamento.incluir(getIdEntidade(), realizandoTrancamentoAutomatico ? false : true, usuarioVO);
			}
...
//					sqlInserir.setBoolean(++i, obj.getTrancamentoRelativoAbondonoCurso().booleanValue());
			...
			alterarSituacaoAcademicaMatriculaTrancamento(obj, configuracaoGeralSistemaVO, configuracaoFinanceiroVO, usuarioVO, realizandoTrancamentoAutomatico);
	...
	public void alterar(final TrancamentoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuarioVO) throws Exception {
		try {
			validarDados(obj, configuracaoGeralSistemaVO);
			// alterarSituacaoRequerimento(obj);
			Trancamento.alterar(getIdEntidade(), true, usuarioVO);
...
//					sqlAlterar.setBoolean(++i, obj.getTrancamentoRelativoAbondonoCurso());
	...
	public void excluir(TrancamentoVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			Trancamento.excluir(getIdEntidade(), true, usuarioVO);
	 ...
	 */
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	private void alterarSituacaoAcademicaMatriculaTrancamento(TrancamentoVO trancamentoVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario, Boolean realizandoTrancamentoAutomatico) throws Exception {
		...
		if(!Uteis.isAtributoPreenchido(trancamentoVO.getMatriculaPeriodoVO().getCodigo())){			
			...
			mpBase.setCodigo(mp);
			getFacadeFactory().getMatriculaPeriodoFacade().carregarDados(mpBase, NivelMontarDados.BASICO, configuracaoFinanceiroVO, usuario);			
			executarVerificacaoEGeracaoMatriculaPeriodoSemestrePosteriorMapaRegistroAbandonoCursoTrancamento(trancamentoVO, mpBase, configuracaoFinanceiroVO, usuario);
		...
		alterarSituacaoAcademicaMatriculaPeriodo(trancamentoVO.getMatriculaPeriodoVO(), trancamentoVO.getHistoricoVOs(), trancamentoVO.getData(), origem, trancamentoVO.getCodigo(), configuracaoFinanceiroVO, usuario);
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	@Override
	public void incluirEDeferirRequerimento(final TrancamentoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO, Boolean realizandoTrancamentoAutomatico) throws Exception {
		incluir(obj, configuracaoGeralSistemaVO, configuracaoFinanceiroVO, usuarioVO, realizandoTrancamentoAutomatico);
//		alterarSituacaoAcademicaMatriculaTrancamento(obj, configuracaoGeralSistemaVO, configuracaoFinanceiroVO, usuarioVO, );
	}
	 ...
	 *                Caso haja problemas de conexão ou restrição de acesso.
	 */
//	public List<TrancamentoVO> consultarPorNomePessoa(String valorConsulta, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
...
//	public List<TrancamentoVO> consultarPorTurma(String valorConsulta, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
//		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
...
//	}
	 ...
	 *                Caso haja problemas de conexão ou restrição de acesso.
	 */
//	public List<TrancamentoVO> consultarPorTipoJustificativa(String valorConsulta, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
//		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
...
//	}
	 ...
	 *                Caso haja problemas de conexão ou restrição de acesso.
	 */
//	public List<TrancamentoVO> consultarPorCodigoRequerimento(Integer valorConsulta, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
//		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
...
//	}
	 ...
	 *                Caso haja problemas de conexão ou restrição de acesso.
	 */
//	public List<TrancamentoVO> consultarPorMatriculaMatricula(String valorConsulta, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
//		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
...
//	public List<TrancamentoVO> consultarPorNomeAluno(String valorConsulta, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
//		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
...
//	public TrancamentoVO consultaRapidaPorMatricula(String valorConsulta, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuarioVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
...
//		return montarDados(resultado, nivelMontarDados, usuarioVO, configuracaoFinanceiroVO);
//	}
...
//	}
	...
	public List<TrancamentoVO> consultarPorMatriculaSituacaoFinanceira(String matricula, String situacaoFinanceira, Integer limite, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
		StringBuilder sqlStr = new StringBuilder();
	 ...
	 *                Caso haja problemas de conexão ou restrição de acesso.
	 */
//	public List<TrancamentoVO> consultarPorSituacao(String valorConsulta, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
//		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
...
//	}
	 ...
	 *                Caso haja problemas de conexão ou restrição de acesso.
	 */
//	public List<TrancamentoVO> consultarPorData(Date prmIni, Date prmFim, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
//		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
...
//	public List<TrancamentoVO> consultarPorDataUnidadeEnsino(Date prmIni, Date prmFim, String unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
//		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
...
//	}
	...
	public TrancamentoVO consultarPorCodigoRequerimento(Integer codigoPrm, int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
	 ...
	 *                Caso haja problemas de conexão ou restrição de acesso.
	 */
//	public List<TrancamentoVO> consultarPorCodigo(Integer valorConsulta, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
//		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
...
//	}
	 ...
	 * @return List Contendo vários objetos da classe <code>TrancamentoVO</code> resultantes da consulta.
	 */
	public static List<TrancamentoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
	 ...
	 */
	public static TrancamentoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
		TrancamentoVO obj = new TrancamentoVO();
...
//		obj.setTrancamentoRelativoAbondonoCurso(dadosSQL.getBoolean("trancamentoRelativoAbondonoCurso"));
		...
		montarDadosRequerimento(obj, nivelMontarDados, usuario, configuracaoFinanceiroVO);
	...
	public static void montarDadosRequerimento(TrancamentoVO obj, int nivelMontarDados, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
	 ...
	 */
	public static void montarDadosResponsavelAutorizacao(TrancamentoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public static void montarDadosMatricula(TrancamentoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public TrancamentoVO consultarPorChavePrimaria(Integer codigoPrm, int nivelMontarDados, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
		ControleAcesso.consultar(getIdEntidade(), false, usuario);
	...
	public void carregarDados(TrancamentoVO obj, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		carregarDados(obj, NivelMontarDados.TODOS, configuracaoFinanceiroVO, usuario);
	}

	public void carregarDados(TrancamentoVO obj, NivelMontarDados nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
	...
	private void montarDadosCompleto(TrancamentoVO obj, SqlRowSet dadosSQL, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		obj.setCodigo(dadosSQL.getInt("codigo"));
		obj.setData(dadosSQL.getDate("data"));
		obj.setDescricao(dadosSQL.getString("descricao"));
		obj.setSituacao(dadosSQL.getString("situacao"));
...
//		obj.setTrancamentoRelativoAbondonoCurso(dadosSQL.getBoolean("trancamentorelativoabandonocurso"));
	...
	public List<TrancamentoVO> montarDadosConsultaCompleta(SqlRowSet tabelaResultado, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		List<TrancamentoVO> vetResultado = new ArrayList<TrancamentoVO>(0);
		while (tabelaResultado.next()) {
			TrancamentoVO obj = new TrancamentoVO();
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void persistir(final TrancamentoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception {
		if (obj.isNovoObj()) {
			incluir(obj, configuracaoGeralSistemaVO, configuracaoFinanceiroVO, usuarioVO, false);
		} else {
	 ...
	 */
	@Override
	public List<HistoricoVO> executarMontagemHistoricosParaRealizarAlteracaoSituacao(MatriculaVO matriculaVO, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception {
		if(matriculaPeriodoVO == null || !Uteis.isAtributoPreenchido(matriculaPeriodoVO.getCodigo())){
			matriculaPeriodoVO = getFacadeFactory().getMatriculaPeriodoFacade().consultarUltimaMatriculaPeriodoPorMatriculaSituacoes(matriculaVO.getMatricula(), "'AT', 'PR'", false, Uteis.NIVELMONTARDADOS_COMBOBOX, configuracaoFinanceiroVO, usuarioVO);
		}
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void executarVerificacaoEGeracaoMatriculaPeriodoSemestrePosteriorMapaRegistroAbandonoCursoTrancamento(TrancamentoVO trancamentoVO, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception {
		if (!getFacadeFactory().getMatriculaPeriodoFacade().executarVerificacaoExisteMatriculaPeriodoRenovadaPorAnoSemestreEvasao(matriculaPeriodoVO.getCodigo(), trancamentoVO.getAno(), trancamentoVO.getSemestre(), false, usuarioVO)) {
			realizarMontagemMatriculaPeriodoEvasao(trancamentoVO, matriculaPeriodoVO, configuracaoFinanceiroVO, usuarioVO);
		} else {
			MatriculaPeriodoVO matriculaPeriodo = getFacadeFactory().getMatriculaPeriodoFacade().consultarPorMatriculaSemestreAno(matriculaPeriodoVO.getMatricula(), trancamentoVO.getSemestre(), trancamentoVO.getAno(), false, NivelMontarDados.BASICO.getValor(), configuracaoFinanceiroVO, usuarioVO);
	...
	private void realizarMontagemMatriculaPeriodoEvasao(TrancamentoVO trancamentoVO, MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception {
	...
	public void persistirTrancamentoMapaRegistroAbandonoCursoTrancamento(List<MatriculaPeriodoVO> matriculaPeriodoVOs, String tipoTrancamento, ProgressBarVO progressBarVO, UsuarioVO usuarioVO) throws Exception {
		...
		for (MatriculaPeriodoVO matriculaPeriodoVO : matriculaPeriodoVOs) {
			if (matriculaPeriodoVO.getMatriculaVO().getAlunoSelecionado()) {
				...
				//persistirTrancamentoMapaRegistroAbandonoCursoTrancamentoIndividualmente(matriculaPeriodoVO, tipoTrancamento, configuracaoGeralSistemaVOs.get(matriculaPeriodoVO.getMatriculaVO().getUnidadeEnsino().getCodigo()), configuracaoFinanceiroVOs.get(matriculaPeriodoVO.getMatriculaVO().getUnidadeEnsino().getCodigo()), usuarioVO);
			}
		}
	}
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void persistirTrancamentoMapaRegistroAbandonoCursoTrancamentoIndividualmente(MapaRegistroEvasaoCursoMatriculaPeriodoVO mrecmp, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception {
		...
		executarVerificacaoEGeracaoMatriculaPeriodoSemestrePosteriorMapaRegistroAbandonoCursoTrancamento(mrecmp.getTrancamentoVO(), mrecmp.getMatriculaPeriodoVO(), configuracaoFinanceiroVO, usuarioVO);		
		configuracaoGeralSistemaVO.setPermiteTrancamentoSemRequerimento(true);
		mrecmp.getTrancamentoVO().setUltimaMatriculaPeriodoVO(getFacadeFactory().getMatriculaPeriodoFacade().consultarUltimaMatriculaPeriodoPorMatriculaSituacoes(mrecmp.getTrancamentoVO().getMatricula().getMatricula(), "'AT', 'PR', 'PC', 'AC', 'TR', 'ER'", false, Uteis.NIVELMONTARDADOS_COMBOBOX, configuracaoFinanceiroVO, usuarioVO));
		persistir(mrecmp.getTrancamentoVO(), configuracaoGeralSistemaVO, configuracaoFinanceiroVO, usuarioVO);
	...
	@Override
	public void realizarDefinicaoMatriculaPeriodoRealizarTrancamento(TrancamentoVO trancamentoVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception{
		...
		trancamentoVO.setUltimaMatriculaPeriodoVO(getFacadeFactory().getMatriculaPeriodoFacade().consultarUltimaMatriculaPeriodoPorMatriculaSituacoes(trancamentoVO.getMatricula().getMatricula(), "'AT', 'PR', 'PC', 'AC', 'TR', 'ER', 'FI', 'TS', 'CA', 'TI'", false, Uteis.NIVELMONTARDADOS_COMBOBOX, configuracaoFinanceiroVO, usuarioVO));
		...
		if(((trancamentoVO.getUltimaMatriculaPeriodoVO().getCodigo().equals(trancamentoVO.getMatriculaPeriodoVO().getCodigo())) || 
			...
			boolean existePendenciaFinanceira = getFacadeFactory().getContaReceberFacade().consultarExistenciaPendenciaFinanceiraMatricula(trancamentoVO.getMatricula().getMatricula(), usuarioVO);
		...
		if(Uteis.isAtributoPreenchido(trancamentoVO.getMatriculaPeriodoVO().getCodigo())){
			trancamentoVO.setHistoricoVOs(executarMontagemHistoricosParaRealizarAlteracaoSituacao(trancamentoVO.getMatricula(), trancamentoVO.getMatriculaPeriodoVO(), configuracaoFinanceiroVO, usuarioVO));
			...
			trancamentoVO.setHistoricoVOs(executarMontagemHistoricosParaRealizarAlteracaoSituacao(trancamentoVO.getMatricula(), trancamentoVO.getUltimaMatriculaPeriodoVO(), configuracaoFinanceiroVO, usuarioVO));
		}
		
	}	
	
	public static void montarDadosResponsavelEstorno(TrancamentoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
