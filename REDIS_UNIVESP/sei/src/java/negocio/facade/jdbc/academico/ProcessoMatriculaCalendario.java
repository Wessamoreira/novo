...
import negocio.interfaces.academico.ProcessoMatriculaCalendarioInterfaceFacade;
...
@Scope("singleton")
@Lazy
public class ProcessoMatriculaCalendario extends ControleAcesso implements ProcessoMatriculaCalendarioInterfaceFacade {
...
//        getFacadeFactory().getProcessoMatriculaCalendarioLogFacade().preencherIncluirProcessoMatriculaCalendarioLog(processoMatriculaVO, obj, "alteração", usuario);
     ...
     */
    public static ProcessoMatriculaCalendarioVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        ProcessoMatriculaCalendarioVO obj = new ProcessoMatriculaCalendarioVO();
     ...
     */
    public static void montarDadosUnidadeEnsinoCurso(ProcessoMatriculaCalendarioVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    public static void montarDadosPeriodoLetivoAtivoUnidadeEnsinoCurso(ProcessoMatriculaCalendarioVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
...
//            getFacadeFactory().getProcessoMatriculaCalendarioLogFacade().preencherIncluirProcessoMatriculaCalendarioLog(processoMatriculaVO, obj, "exclusão", usuario);
     ...
     */
    public static List consultarProcessoMatriculaCalendarios(Integer processoMatricula, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        ProcessoMatriculaCalendario.consultar(getIdEntidade(), controlarAcesso, usuario);
        ...
        while (resultado.next()) {
            objetos.add(ProcessoMatriculaCalendario.montarDados(resultado, nivelMontarDados, usuario));
        }
        return objetos;
    }
