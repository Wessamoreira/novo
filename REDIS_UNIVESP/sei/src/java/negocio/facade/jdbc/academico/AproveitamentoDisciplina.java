...
public class AproveitamentoDisciplina extends ControleAcesso implements AproveitamentoDisciplinaInterfaceFacade {
	...
	public void incluir(final AproveitamentoDisciplinaVO obj, boolean controleAcesso, UsuarioVO usuario,
		...
		try {
			...
			AproveitamentoDisciplina.incluir(getIdEntidade(), controleAcesso, usuario);
	...
	public void alterarSituacaoHistoricoConcessaoCreditoDisciplina(AproveitamentoDisciplinaVO obj,
			List<ConcessaoCreditoDisciplinaVO> concessaoCreditoDisciplinaVOs, String matricula,
	...
	public void alterarSituacaoHistoricoConcessaoCargaHorariaDisciplina(AproveitamentoDisciplinaVO obj,
			List<ConcessaoCargaHorariaDisciplinaVO> concessaoCargaHorariaDisciplinaVOs, String matricula,
			Integer matriculaPeriodo, UsuarioVO usuario) throws Exception {
	...
	public void verificarAlunoAprovadoDisciplina(HistoricoVO historico, String matricula, Integer matriculaPeriodo,
			UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
	...
	public List consultarHistoricoAlunoDisciplina(String matricula, Integer disciplina, boolean controlarAcesso,
		...
		List hist = getFacadeFactory().getHistoricoFacade().consultarPorMatriculaDisciplinaSituacao(matricula,
				disciplina, false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, configuracaoFinanceiroVO, usuario);
		return hist;
	}
	...
	public AproveitamentoDisciplinaVO montarDadosTransferenciaInternaPeloCodigoRequerimento(Integer requerimento,
			Integer unidadeEnsino, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO)
			throws Exception {
		RequerimentoVO requerimentoVO = getFacadeFactory().getRequerimentoFacade()
				.consultarPorChavePrimariaFiltrandoPorUnidadeEnsino(requerimento, "TI", unidadeEnsino, false,
						Uteis.NIVELMONTARDADOS_TODOS, usuario, configuracaoFinanceiroVO);
	...
	public List consultarTodosTiposPorData(Date prmIni, Date prmFim, String unidadeEnsino, boolean controlarAcesso,
			int nivelMontarDados, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario)
			throws Exception {
		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
	...
	public List<DisciplinasAproveitadasVO> buscarDisciplinaSeremAproveitadaTransferenciaInterna(String matricula,
			Integer curso, UsuarioVO usuario, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
		...
		List<HistoricoVO> historicoVOs = getFacadeFactory().getHistoricoFacade()
				.consultarHistoricoParaAproveitamentoNaTransferenciaInterna(matricula, curso,
						Uteis.NIVELMONTARDADOS_DADOSMINIMOS, configuracaoFinanceiroVO, usuario);
	 ...
	 */
	public static List montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados,
	 ...
	 */
	public static AproveitamentoDisciplinaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados,
			ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		AproveitamentoDisciplinaVO obj = new AproveitamentoDisciplinaVO();
		...
		if (nivelMontarDados == Uteis.NIVELMONTARDADOS_DADOSCONSULTA) {
			montarDadosRequerimento(obj, Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuario, configuracaoFinanceiroVO);
	 ...
	 */
	public static void montarDadosMatriculaPeriodo(AproveitamentoDisciplinaVO obj, int nivelMontarDados,
			ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuario) throws Exception {
		if (obj.getMatriculaPeriodo().getCodigo().intValue() == 0) {
			return;
		}
		obj.setMatriculaPeriodo(getFacadeFactory().getMatriculaPeriodoFacade().consultarPorChavePrimaria(
				obj.getMatriculaPeriodo().getCodigo(), Uteis.NIVELMONTARDADOS_DADOSBASICOS, configuracaoFinanceiroVO,
				usuario));
	}

	public static void montarDadosUnidadeEnsino(AproveitamentoDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario)
			throws Exception {
		if (obj.getUnidadeEnsino().getCodigo().intValue() == 0) {
			return;
		}
	...
	public static void montarDadosPessoa(AproveitamentoDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario)
			throws Exception {
		if (obj.getPessoa().getCodigo().intValue() == 0) {
			return;
		}
	...
	public static void montarDadosResponsavelAutorizacao(AproveitamentoDisciplinaVO obj, int nivelMontarDados,
			UsuarioVO usuario) throws Exception {
		if (obj.getResponsavelAutorizacao().getCodigo().intValue() == 0) {
			return;
		}
	...
	public static void montarDadosRequerimento(AproveitamentoDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario,
			ConfiguracaoFinanceiroVO configuracaoFinanceiroVO) throws Exception {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public static void montarDadosMatricula(AproveitamentoDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario)
			throws Exception {
	...
	public static void montarDadosCurso(AproveitamentoDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario)
			throws Exception {
	...
	public static void montarDadosCidade(AproveitamentoDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario)
			throws Exception {
	...
	public static void montarDadosTurno(AproveitamentoDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario)
			throws Exception {
	...
	// nivelMontarDados));
	// }
	public static void montarDadosGradeCurricular(AproveitamentoDisciplinaVO obj, int nivelMontarDados,
			UsuarioVO usuario) throws Exception {
	...
	public static void montarDadosPeriodoLetivo(AproveitamentoDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario)
			throws Exception {
	...
	public void inicializarDadosAdicionarConcessaoCreditoDisciplina(AproveitamentoDisciplinaVO obj,
			ConcessaoCreditoDisciplinaVO concessaoCreditoDisciplinaVO, UsuarioVO usuarioLogado) throws Exception {
		if (obj.getCodigo() != 0) {
	...
	public void adicionarConcessaoCreditoDisciplina(AproveitamentoDisciplinaVO obj,
			ConcessaoCreditoDisciplinaVO concessaoCreditoDisciplinaVO, UsuarioVO usuarioLogado) throws Exception {
		inicializarDadosAdicionarConcessaoCreditoDisciplina(obj, concessaoCreditoDisciplinaVO, usuarioLogado);
	...
	public void inicializarDadosAdicionarConcessaoCargaHorariaDisciplina(AproveitamentoDisciplinaVO obj,
			ConcessaoCargaHorariaDisciplinaVO concessaoCargaHorariaDisciplinaVO, UsuarioVO usuarioLogado)
			throws Exception {
		if (obj.getCodigo() != 0) {
	...
	public void excluirComBaseNaMatriculaPeriodo(Integer matriculaPeriodo,
		...
		try {
			List<AproveitamentoDisciplinaVO> aproveitamentoDisciplinaVOs = consultarPorMatriculaPeriodo(
					matriculaPeriodo, Uteis.NIVELMONTARDADOS_DADOSBASICOS, configuracaoFinanceiroVO, usuario);
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void excluirComBaseNaMatricula(String matricula, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO,
			UsuarioVO usuario) throws Exception {
		try {
	...
	private void inicializarDadosBasicosNovoAproveitamento(DisciplinasAproveitadasVO novaDisciplinasAproveitadaVO,
		...
		if (aproveitamentoDisciplinasEntreMatriculasVO.getTipoAproveitamentoDisciplinasEntreMatriculas().equals("CO")) {
			...
			inicializarDadosBasicosNovoAproveitamentoConcessaoCredito(novaDisciplinasAproveitadaVO,
					aproveitamentoDisciplinasEntreMatriculasVO, novaConcessaoCreditoDisciplinaVO, usuario);
			getFacadeFactory().getAproveitamentoDisciplinaFacade().adicionarConcessaoCreditoDisciplina(
					aproveitamentoDisciplinasEntreMatriculasVO.getAproveitamentoDisciplinaVO(),
					novaConcessaoCreditoDisciplinaVO, usuario);
		}
		...
		if (aproveitamentoDisciplinasEntreMatriculasVO.getTipoAproveitamentoDisciplinasEntreMatriculas().equals("CH")) {
			...
			inicializarDadosBasicosNovoAproveitamentoConcessaoCargaHoraria(novaDisciplinasAproveitadaVO,
					aproveitamentoDisciplinasEntreMatriculasVO, novaConcessaoCargaHorariaDisciplinaVO, usuario);
	...
	private void inicializarDadosBasicosNovoAproveitamentoConcessaoCredito(
			DisciplinasAproveitadasVO novaDisciplinasAproveitadaVO,
			AproveitamentoDisciplinasEntreMatriculasVO aproveitamentoDisciplinasEntreMatriculasVO,
			ConcessaoCreditoDisciplinaVO novaConcessaoCreditoDisciplinaVO, UsuarioVO usuario) {
	...
	private void inicializarDadosBasicosNovoAproveitamentoConcessaoCargaHoraria(
			DisciplinasAproveitadasVO novaDisciplinasAproveitadaVO,
			AproveitamentoDisciplinasEntreMatriculasVO aproveitamentoDisciplinasEntreMatriculasVO,
			ConcessaoCargaHorariaDisciplinaVO novaConcessaoCargaHorariaDisciplinaVO, UsuarioVO usuario) {
	...
	public void realizarGeracaoAproveitamentoDisciplinaAutomaticoPorRequerimento(RequerimentoVO requerimento, UsuarioVO usuarioVO) throws Exception{		
		AproveitamentoDisciplinaVO objDeferido = consultarPorCodigoRequerimento(requerimento.getCodigo(), Uteis.NIVELMONTARDADOS_TODOS, getAplicacaoControle().getConfiguracaoFinanceiroVO(0), usuarioVO);
		if(Uteis.isAtributoPreenchido(objDeferido)) {
			...
			alterar(objDeferido, usuarioVO, getAplicacaoControle().getConfiguracaoFinanceiroVO(0));
		}else {
			objDeferido.setResponsavelAutorizacao(usuarioVO);
			objDeferido.setMatricula(requerimento.getMatricula());
			objDeferido.setMatriculaPeriodo(getFacadeFactory().getMatriculaPeriodoFacade().consultarUltimaMatriculaPeriodoPorMatriculaAnoSemestre(objDeferido.getMatricula().getMatricula(), false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getAplicacaoControle().getConfiguracaoFinanceiroVO(0), usuarioVO));
			...
			objDeferido.setGradeCurricular(objDeferido.getMatricula().getMatriculaComHistoricoAlunoVO().getGradeCurricularComHistoricoAlunoVO().getGradeCurricularVO());
			realizarPreenchimentoRequerimentoAproveitamentoDisciplinaAutomaticoPorRequerimento(objDeferido, requerimento, usuarioVO);
			incluir(objDeferido, false, usuarioVO, getAplicacaoControle().getConfiguracaoFinanceiroVO(0));
		}
	}
