...
//    }
     ...
     */
    public static TurmaAberturaVO montarDados(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        TurmaAberturaVO obj = new TurmaAberturaVO();
    ...
    public static void montarDadosUsuario(TurmaAberturaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
...
//        }
     ...
     *                operação.
     */
    public static List<TurmaAberturaVO> consultarTurmaAberturas(Integer turma, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        TurmaAbertura.consultar(getIdEntidade(), controlarAcesso, usuario);
        ...
        while (tabelaResultado.next()) {
            ...
            novoObj = TurmaAbertura.montarDados(tabelaResultado, nivelMontarDados, usuario);
            objetos.add(novoObj);
        }
        return objetos;
    }
    ...
    public static List<TurmaAberturaVO> consultarTurmaBaseAberturas(Integer turma, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        TurmaAbertura.consultar(getIdEntidade(), controlarAcesso, usuario);
