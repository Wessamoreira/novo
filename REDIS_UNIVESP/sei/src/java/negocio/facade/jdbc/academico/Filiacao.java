...
public class Filiacao extends ControleAcesso implements FiliacaoInterfaceFacade {
	...
	public List<FiliacaoVO> incluirFiliacaoConformeTipoProspect(ProspectsVO prospectsVO , List<FiliacaoVO> filiacaoPessoa , String tipoFiliacao) throws Exception{
	...
	public List<FiliacaoVO> executarValidacaoFiliacaoExistenciaPaiMae(ProspectsVO prospectPessoa ,List<FiliacaoVO> filiacaoPessoa) throws Exception{
