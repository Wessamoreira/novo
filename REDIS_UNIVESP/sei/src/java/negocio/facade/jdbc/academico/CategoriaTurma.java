...
public class CategoriaTurma extends ControleAcesso implements CategoriaTurmaInterfaceFacade {
    ...
    public void incluir(final CategoriaTurmaVO obj,UsuarioVO usuario) throws Exception {
        try {
            ...
            CategoriaTurma.incluir(getIdEntidade(), true, usuario);
    ...
    public void alterar(final CategoriaTurmaVO obj,UsuarioVO usuario) throws Exception {
        try {
            //validarUnicidade(obj,usuario);
            CategoriaTurmaVO.validarDados(obj);
            CategoriaTurma.alterar(getIdEntidade(), true, usuario);
    ...
    public void excluir(CategoriaTurmaVO obj, UsuarioVO usuarioVO) throws Exception {
        try {
            CategoriaTurma.excluir(getIdEntidade(), true, usuarioVO);
     ...
     */
    public static CategoriaTurmaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        CategoriaTurmaVO obj = new CategoriaTurmaVO();
    ...
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public static void montarDadosTurma(CategoriaTurmaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    public static void montarDadosTipoCategoria(CategoriaTurmaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
