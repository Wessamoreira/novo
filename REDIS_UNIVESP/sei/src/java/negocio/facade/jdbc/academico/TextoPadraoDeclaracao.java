...
public class TextoPadraoDeclaracao extends ControleAcesso implements TextoPadraoDeclaracaoInterfaceFacade {
    ...
    public void incluir(final TextoPadraoDeclaracaoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuario) throws Exception {
        try {
            TextoPadraoDeclaracao.incluir(getIdEntidade(), true, usuario);
...
//					}
    ...
    public void alterar(final TextoPadraoDeclaracaoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuario) throws Exception {
        try {
            TextoPadraoDeclaracao.alterar(getIdEntidade(), true, usuario);
            TextoPadraoDeclaracaoVO.validarDados(obj);
...
//					}
    ...
    public void excluir(TextoPadraoDeclaracaoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuario) throws Exception {
        try {
            TextoPadraoDeclaracao.excluir(getIdEntidade(), true, usuario);
...
//        	sqlStr += "AND (TextoPadraoDeclaracao.tipo not in('AC')) ";
     ...
     */
    public static TextoPadraoDeclaracaoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        ...
        obj.setTextoPadraoDeclaracaofuncionarioVOs(TextoPadraoDeclaracaoFuncionario.consultarTextoPadraoDeclaracaoFuncionario(obj.getCodigo(), false, usuario));		
        return obj;
    }
     ...
     */
    public static void montarDadosResponsavelDefinicao(TextoPadraoDeclaracaoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getResponsavelDefinicao().getCodigo().intValue() == 0) {
    ...
    public static void montarDadosUnidadeEnsino(TextoPadraoDeclaracaoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
