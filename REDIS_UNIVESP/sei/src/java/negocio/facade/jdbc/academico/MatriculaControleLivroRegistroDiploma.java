...
import negocio.interfaces.academico.MatriculaControleLivroRegistroDiplomaInterfaceFacade;
...
@Scope("singleton")
@Lazy
public class MatriculaControleLivroRegistroDiploma extends ControleAcesso implements MatriculaControleLivroRegistroDiplomaInterfaceFacade {
    ...
    */
    ...
    public void gravarMatriculaRegistroLivro(List<MatriculaControleLivroRegistroDiplomaVO> matriculaControleLivroRegistroDiploma, UsuarioVO usuario) throws Exception {
		...
		while (i.hasNext()) {
			...
			getFacadeFactory().getControleLivroFolhaReciboFacade().alterar(obj.getControleLivroFolhaRecibo(), usuario);
			excluir(obj);
			incluir(obj);
		}
    }
    ...
    */
    public static MatriculaControleLivroRegistroDiplomaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        MatriculaControleLivroRegistroDiplomaVO obj = new MatriculaControleLivroRegistroDiplomaVO();
    ...
    */
    public static void montarDadosControleLivroFolhaRecibo(MatriculaControleLivroRegistroDiplomaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getControleLivroFolhaRecibo().getCodigo().intValue() == 0) {
     ...
     * @param obj  Objeto no qual será montado os dados consultados.
    */
    public static void montarDadosMatricula(MatriculaControleLivroRegistroDiplomaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
