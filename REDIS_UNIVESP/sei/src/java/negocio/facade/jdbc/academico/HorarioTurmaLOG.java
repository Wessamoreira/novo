...
import negocio.interfaces.academico.HorarioTurmaLOGInterfaceFacade;
...
@Scope("singleton")
@Lazy
public class HorarioTurmaLOG extends ControleAcesso implements HorarioTurmaLOGInterfaceFacade {
    ...
    @Override
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    public void realizarCriacaoLogHorarioTurma(HorarioTurmaVO horarioTurmaVO, UsuarioVO usuarioLogado, String acao, String resultadoAcao) throws Exception {
        HorarioTurmaLOGVO log = new HorarioTurmaLOGVO();
        log.setHorarioTurma(horarioTurmaVO);
        log.setAcao(acao);
        log.setData(new Date());
