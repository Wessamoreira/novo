...
public class PoliticaDivulgacaoMatriculaOnlinePublicoAlvo extends ControleAcesso implements PoliticaDivulgacaoMatriculaOnlinePublicoAlvoInterfaceFacade {
	...
	public static PoliticaDivulgacaoMatriculaOnlinePublicoAlvoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, List<UnidadeEnsinoVO> listaUnidadeEnsino, UsuarioVO usuario) throws Exception {
