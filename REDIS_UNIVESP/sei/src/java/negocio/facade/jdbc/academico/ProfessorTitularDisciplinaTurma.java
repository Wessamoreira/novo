...
import negocio.interfaces.academico.ProfessorTitularDisciplinaTurmaInterfaceFacade;
...
public class ProfessorTitularDisciplinaTurma extends ControleAcesso implements ProfessorTitularDisciplinaTurmaInterfaceFacade {
...
//		verificarPermissaoUsuarioFuncionalidade("RegistroAulaAlterarCargaHoraria");
	...
	public void validarConsultaDoUsuario(UsuarioVO usuario) throws Exception {
		ProfessorTitularDisciplinaTurma.consultar(getIdEntidade(), true, usuario);
	}
	...
	public List<PessoaVO> montarListaProfessorRegistroAula(HorarioTurmaVO obj, ProfessorTitularDisciplinaTurmaVO professorTitularDisciplinaTurmaVO, UsuarioVO usuario) {
		...
		try {		
			List<Integer> professores = getFacadeFactory().getHorarioTurmaFacade().consultarProfessorLecionaDisciplina(obj, professorTitularDisciplinaTurmaVO.getDisciplina().getCodigo());
	 ...
	 *         consulta.
	 */
	public static List<ProfessorTitularDisciplinaTurmaVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public static ProfessorTitularDisciplinaTurmaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		ProfessorTitularDisciplinaTurmaVO obj = new ProfessorTitularDisciplinaTurmaVO();
	 ...
	 */
	public static void montarDadosTurma(ProfessorTitularDisciplinaTurmaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public static void montarDadosProfessor(ProfessorTitularDisciplinaTurmaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public static void montarDadosRapidoProfessor(ProfessorTitularDisciplinaTurmaVO obj, UsuarioVO usuario) throws Exception {
		if (obj.getProfessor().getPessoa().getCodigo().intValue() == 0) {
			obj.setProfessor(new FuncionarioVO());
			return;
		}
	...
	public static void montarDadosDisciplina(ProfessorTitularDisciplinaTurmaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
