...
public class CursoCoordenador extends ControleAcesso implements CursoCoordenadorInterfaceFacade {
    ...
    public List<CursoCoordenadorVO> consultarPorCodigoCurso(Integer valorConsulta, boolean verificarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        ControleAcesso.consultar(getIdEntidade(), verificarAcesso, usuario);
    ...
    public static List<CursoCoordenadorVO> consultarCursoCoordenadors(Integer curso, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
        ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
        ...
        while (resultado.next()) {
            objetos.add(CursoCoordenador.montarDados(resultado, usuario));
        }
        return objetos;
    }
     ...
     * @return List Contendo vários objetos da classe <code>CursoCoordenadorVO</code> resultantes da consulta.
     */
    public static List<CursoCoordenadorVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     */
    public static CursoCoordenadorVO montarDados(SqlRowSet dadosSQL, CursoCoordenadorVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    public static CursoCoordenadorVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
        CursoCoordenadorVO obj = new CursoCoordenadorVO();
        obj.setCodigo(dadosSQL.getInt("codigo"));
        obj.getFuncionario().setCodigo(dadosSQL.getInt("funcionario"));
        obj.getCurso().setCodigo(dadosSQL.getInt("curso"));
     ...
     */
    public static void montarDadosTurma(CursoCoordenadorVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     *            Objeto no qual será montado os dados consultados.
     */
    public static void montarDadosCurso(CursoCoordenadorVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    public static void montarDadosUnidadeEnsino(CursoCoordenadorVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    public static void montarDadosFuncionario(CursoCoordenadorVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    public List<CursoCoordenadorVO> consultarCursoCoordenadors(Integer curso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        ...
        CursoCoordenadorVO obj = null;
        while (resultado.next()) {
            objetos.add(CursoCoordenador.montarDados(resultado, obj, nivelMontarDados, usuario));
        }
        return objetos;
    }
