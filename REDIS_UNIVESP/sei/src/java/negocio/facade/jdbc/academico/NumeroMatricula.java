...
public class NumeroMatricula extends ControleAcesso implements NumeroMatriculaInterfaceFacade {
    ...
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    public static String gerarNumeroMatricula(MatriculaVO matriculaVO, int anoData) throws Exception {
...
//        String matricula = numeroMatriculaVO.gerarNumeroMatricula(anoData);
    ...
    public static SqlRowSet consultarAnoSemestreGeracaoNumeroMatricula(Integer unidadeEnsinoCurso, Integer processoMatricula) {
