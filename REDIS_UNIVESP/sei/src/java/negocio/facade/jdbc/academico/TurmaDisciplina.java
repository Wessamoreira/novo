...
public class TurmaDisciplina extends ControleAcesso implements TurmaDisciplinaInterfaceFacade {
	 ...
	 */
	public static List<TurmaDisciplinaVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public static TurmaDisciplinaVO montarDados(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		TurmaDisciplinaVO obj = new TurmaDisciplinaVO();
	 ...
	 */
	public static TurmaDisciplinaVO montarDadosComGradeDisciplina(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		TurmaDisciplinaVO obj = new TurmaDisciplinaVO();
		obj.setCodigo(new Integer(tabelaResultado.getInt("codigo")));
		obj.setTurma(new Integer(tabelaResultado.getInt("turma")));
	...
	public static void montarDadosDisciplina(TurmaDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public static void montarDadosDisciplinaEquivalenteTurmaAgrupada(TurmaDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public List<TurmaDisciplinaVO> consultarTurmaDisciplinas(Integer turma, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		TurmaDisciplina.consultar(getIdEntidade(), controlarAcesso, usuario);
		...
		while (tabelaResultado.next()) {
			...
			novoObj = TurmaDisciplina.montarDados(tabelaResultado, nivelMontarDados, usuario);
			objetos.add(novoObj);
		}
		return objetos;
	}
