...
public class MaterialCurso extends ControleAcesso implements MaterialCursoInterfaceFacade {
     ...
     * @return List Contendo vários objetos da classe <code>MaterialCursoVO</code> resultantes da consulta.
     */
    public static List<MaterialCursoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados) throws Exception {
     ...
     */
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    public static MaterialCursoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados) throws Exception {
    ...
    public static void montarDadosArquivo(MaterialCursoVO obj) throws Exception {
