...
public class TextoPadraoDeclaracaoFuncionario extends ControleAcesso {
     ...
     */
    public static TextoPadraoDeclaracaoFuncionarioVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
        TextoPadraoDeclaracaoFuncionarioVO obj = new TextoPadraoDeclaracaoFuncionarioVO();
    ...
    public static void montarDadosFuncionario(TextoPadraoDeclaracaoFuncionarioVO obj, UsuarioVO usuario) throws Exception {
     ...
     * @exception Exception  Erro de conexão com o BD ou restrição de acesso a esta operação.
     */
    public static List consultarTextoPadraoDeclaracaoFuncionario(Integer textoPadraoDeclaracao, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
        return consultarTextoPadraoDeclaracaoFuncionario(textoPadraoDeclaracao, controlarAcesso, false, usuario);
    }

    public static List consultarTextoPadraoDeclaracaoFuncionario(Integer textoPadraoDeclaracao, boolean controlarAcesso, boolean funcionario, UsuarioVO usuario) throws Exception {
        TextoPadraoDeclaracaoFuncionario.consultar(getIdEntidade(), controlarAcesso, usuario);
        ...
        while (resultado.next()) {
            ...
            novoObj = TextoPadraoDeclaracaoFuncionario.montarDados(resultado, usuario);
            objetos.add(novoObj);
        }
        return objetos;
    }
