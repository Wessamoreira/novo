...
//            TurnoVO.validarPeriodoIntervalo(obj);
            Turno.incluir(getIdEntidade(), verificarAcesso, usuarioVO);
    ...
    public void alterar(final TurnoVO obj, Boolean verificarAcesso, UsuarioVO usuarioVO) throws Exception {
        try {
            validarDados(obj);
//            TurnoVO.validarPeriodoIntervalo(obj);
            Turno.alterar(getIdEntidade(), verificarAcesso, usuarioVO);
    ...
    public void excluir(TurnoVO obj, Boolean verificarAcesso, UsuarioVO usuarioVO) throws Exception {
        try {
            Turno.excluir(getIdEntidade(), verificarAcesso, usuarioVO);
     ...
     * @return  List Contendo vários objetos da classe <code>TurnoVO</code> resultantes da consulta.
     */
    public static List<TurnoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados) throws Exception {
     ...
     */
    public static TurnoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados) throws Exception {
