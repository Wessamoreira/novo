	...
	public void persistir(List<TurmaDisciplinaNotaTituloVO> turmaDisciplinaNotaTituloVOs, List<HistoricoVO> listaHistoricoVOs, TurmaVO turmaLancamentoNotaVO, UsuarioVO usuarioVO, FiltroRelatorioAcademicoVO filtroRelatorioAcademicoVO, boolean trazerAlunosTransferenciaMatriz, boolean permiteLancarNotaDisciplinaComposta) throws Exception {
		for(TurmaDisciplinaNotaTituloVO turmaDisciplinaNotaTituloVO: turmaDisciplinaNotaTituloVOs){			
			if(!turmaDisciplinaNotaTituloVO.getTitulo().trim().isEmpty()){				
				alterar(turmaDisciplinaNotaTituloVO, listaHistoricoVOs, turmaLancamentoNotaVO, usuarioVO, filtroRelatorioAcademicoVO, trazerAlunosTransferenciaMatriz, permiteLancarNotaDisciplinaComposta);
			}else {				
...
//	}
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void incluir(final TurmaDisciplinaNotaTituloVO turmaDisciplinaNotaTituloVO, List<HistoricoVO> listaHistoricoVOs, TurmaVO turmaLancamentoNotaVO, final UsuarioVO usuarioVO, FiltroRelatorioAcademicoVO filtroRelatorioAcademicoVO, boolean trazerAlunosTransferenciaMatriz, boolean permiteLancarNotaDisciplinaComposta) throws Exception {
		...
		if(!turmaDisciplinaNotaTituloVO.getTurmaDisciplinaNotaTituloVOs().isEmpty()){
			...
			persistir(turmaDisciplinaNotaTituloVO.getTurmaDisciplinaNotaTituloVOs(), listaHistoricoVOs, turmaLancamentoNotaVO, usuarioVO, filtroRelatorioAcademicoVO, trazerAlunosTransferenciaMatriz, permiteLancarNotaDisciplinaComposta);
		}
...
//			lista = getFacadeFactory().getHistoricoFacade().consultaRapidaHistoricoPorDisciplinaTurmaAnoSemestreSituacaoMatSituacaoHist(turmaDisciplinaNotaTituloVO.getDisciplinaVO().getCodigo(), turmaLancamentoNotaVO, turmaDisciplinaNotaTituloVO.getAno(), turmaDisciplinaNotaTituloVO.getSemestre(),false, turmaDisciplinaNotaTituloVO.getConfiguracaoAcademicoVO(), Uteis.NIVELMONTARDADOS_TODOS, filtroRelatorioAcademicoVO, usuarioVO, trazerAlunosTransferenciaMatriz, permiteLancarNotaDisciplinaComposta);
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void alterar(TurmaDisciplinaNotaTituloVO turmaDisciplinaNotaTituloVO, List<HistoricoVO> listaHistoricoVOs, TurmaVO turmaLancamentoNotaVO, UsuarioVO usuarioVO, FiltroRelatorioAcademicoVO filtroRelatorioAcademicoVO, boolean trazerAlunosTransferenciaMatriz, boolean permiteLancarNotaDisciplinaComposta) throws Exception {
		...
		if(getConexao().getJdbcTemplate().update(new PreparedStatementCreator() {
			...
			incluir(turmaDisciplinaNotaTituloVO, listaHistoricoVOs, turmaLancamentoNotaVO, usuarioVO, filtroRelatorioAcademicoVO, trazerAlunosTransferenciaMatriz, permiteLancarNotaDisciplinaComposta);
			return;
		}
		if(!turmaDisciplinaNotaTituloVO.getTurmaDisciplinaNotaTituloVOs().isEmpty()){
			for(TurmaDisciplinaNotaTituloVO tituloVO: turmaDisciplinaNotaTituloVO.getTurmaDisciplinaNotaTituloVOs()){
