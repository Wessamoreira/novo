...
//					A PARTIR NOTA 31 
	 ...
	 *         <code>ConfiguracaoAcademicoVO</code> resultantes da consulta.
	 */
	public static List<ConfiguracaoAcademicoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public static ConfiguracaoAcademicoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		ConfiguracaoAcademicoVO obj = new ConfiguracaoAcademicoVO();
...
//		A PARTIR NOTA 31
	...
	public static void montarDadosConfiguracoes(ConfiguracaoAcademicoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getConfiguracoesVO().getCodigo().intValue() == 0) {
...
//		}	
	...
	@Override
	public List<SelectItem> montarListaSelectItemOpcoesDeNotas(ConfiguracaoAcademicoVO ca, boolean somenteNotaTipoLancamento, TipoUsoNotaEnum tipoUsoNota) {
	...
	@Override
	public List<SelectItem> consultarVariavelTituloConfiguracaoAcademicoPorTipoUsoNota(TipoUsoNotaEnum tipoUsoNotaEnum, UsuarioVO usuarioVO) {
		StringBuilder sb = new StringBuilder();
		...
		SqlRowSet tabelaResultado = getConexao().getJdbcTemplate().queryForRowSet(sb.toString(), tipoUsoNotaEnum.name());
		List<SelectItem> lista = new ArrayList<SelectItem>(0);
		lista.add(new SelectItem("", ""));
		while (tabelaResultado.next()) {
