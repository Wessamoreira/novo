...
public class PerfilAcesso extends ControleAcesso implements PerfilAcessoInterfaceFacade {
	...
	public void incluir(final PerfilAcessoVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			...
			PerfilAcesso.incluir(getIdEntidade(), true, usuarioVO);
	...
	public void alterar(final PerfilAcessoVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			PerfilAcessoVO.validarDados(obj);
			PerfilAcesso.alterar(getIdEntidade(), true, usuarioVO);
	...
	public void excluir(PerfilAcessoVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			PerfilAcesso.excluir(getIdEntidade(), true, usuarioVO);
	...
	@Override
	public PerfilAcessoVO consultarPorChavePrimaria(Integer valorConsulta, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		ControleAcesso.consultar(getIdEntidade(), controlarAcesso, usuario);
		return getAplicacaoControle().getPerfilAcessoVO(valorConsulta, usuario);
	}
	 ...
	 *         <code>PerfilAcessoVO</code> resultantes da consulta.
	 */
	public static List<PerfilAcessoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados) throws Exception {
	 ...
	 */
	public static PerfilAcessoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados) throws Exception {
		PerfilAcessoVO obj = new PerfilAcessoVO();
		obj.setNovoObj(Boolean.FALSE);
