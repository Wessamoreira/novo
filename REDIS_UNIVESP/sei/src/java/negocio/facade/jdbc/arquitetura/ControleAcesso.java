...
public abstract class ControleAcesso extends SuperFacadeJDBC implements ControleAcessoInterfaceFacade {
	...
	public static Boolean verificarAcessoMenu(String idEntidade, UsuarioVO usuario) throws Exception {
		return verificarPermissaoOperacao(usuario.getPerfilAcesso().getCodigo(), idEntidade, null);
	}

	public static Boolean verificarAcessoMenuUnificaoPerfil(String idEntidade, UsuarioVO usuario) throws Exception {
	 ...
	 *                Caso haja problemas de conexão ou restrição de acesso a esta operação.
	 */
	public static void emitirRelatorio(String idEntidade, boolean verificarAcesso, UsuarioVO usuario) throws Exception {
	 ...
	 *                Caso haja problemas de conexão ou restrição de acesso a esta operação.
	 */
	public static void verificarPermissaoUsuarioFuncionalidade(String funcionalidade, UsuarioVO usuario) throws Exception {
	...
	public static void verificarPermissaoUsuarioFuncionalidadeComUsuarioVO(String funcionalidade, UsuarioVO usuario) throws Exception {
		// SuperFacadeJDBC.verificarPermissaoUsuarioFuncionalidade(funcionalidade);
	...
	public static void verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico(String funcionalidade, UsuarioVO usuario) throws Exception {
		// SuperFacadeJDBC.verificarPermissaoUsuarioFuncionalidade(funcionalidade);
	...
	public static void verificarPermissaoUsuarioFuncionalidadeComPerfilUsuarioVOEspecifico(String funcionalidade, UsuarioVO usuario) throws Exception {
		// SuperFacadeJDBC.verificarPermissaoUsuarioFuncionalidade(funcionalidade);
	...
	public static void verificarPermissaoUsuarioFuncionalidadeComPerfilUsuarioVOEspecifico(PerfilAcessoPermissaoEnumInterface perfilAcessoEnum, UsuarioVO usuario) throws AcessoException {
		try {
	...
	public static Boolean verificarPermissaoFuncionalidadeUsuario(String funcionalidade, UsuarioVO usuario) throws Exception {
	 ...
	 * @return boolean true caso exista liberação para uso da operação neste perfil de acesso.
	 */
	public static boolean verificarPermissaoOperacao(Integer perfilAcesso, String nomeEntidade, Integer operacao)  {
	...
	public static boolean verificarPermissaoOperacao(String nomeEntidade, Integer operacao, UsuarioVO usuarioVO) {
		try {
	...
	public static boolean verificarPermissaoOperacaoUnificacaoPerfil(Integer usuario, String nomeEntidade, Integer operacao) {
		String operStr = null;
		if (operacao == null) {
			operStr = "";
		} else {
	...
	public static UsuarioVO verificarLoginUsuarioEmailInstitucional(String emailInstitucional, int nivelMontarDados) throws Exception {
	...
	public static UsuarioVO verificarLoginAdministrador(String username, String senha, boolean encriptar) throws Exception {
	...
	public static UsuarioVO verificarLoginUsuarioSimulacaoSuporte(String username, String senha, boolean encriptar, int nivelMontarDados) throws Exception {
	...
	public static UsuarioVO verificarLoginUsuarioSimulacaoVisaoAluno(Integer codigoPessoa, Boolean exceptionUsuarioNaoExistente) throws Exception {
	...
	public static UsuarioVO montarDadosUsuarioLogado(SqlRowSet dadosSQL, int nivelMontarDados) {
		UsuarioVO obj = new UsuarioVO();
...
//			}
	...
	private static boolean verificarPermissaoUsuarioComUsuario(String nomeEntidade, int operacao, UsuarioVO usuario) throws Exception {
	...
	private static boolean verificarPermissaoUsuarioComUsuarioEspecifico(String nomeEntidade, int operacao, UsuarioVO usuario) throws Exception {
		PerfilAcessoVO perfil = null;
		if (!usuario.getIsApresentarVisaoAdministrativa()) {
			perfil = usuario.getPerfilAcesso();
		} else if (usuario.getUsuarioPerfilAcessoVOs().isEmpty() && usuario.getPerfilAcesso() != null) {
	...
	private static boolean verificarPermissaoFuncionalidadeComUsuarioEspecifico(String nomeEntidade, int operacao, UsuarioVO usuario) throws Exception {
		PerfilAcessoVO perfil = null;
	...
	public static boolean verificarPermissaoFuncionalidadePorUsernameSenhaUnidadeEnsino(String funcionalidade, String username, String senha, Integer unidadeEnsino, Boolean retornarExcexao) throws Exception {
	...
	public static void verificarCompetenciaBloqueadaParaRegistrosEntidade(
			SuperVO obj, String operacao, Date novaDataVerificar, Date dataVerificarAnterior, Integer codigoUnidadeEnsino, Integer codigoCaixa, TipoOrigemHistoricoBloqueioEnum tipoOrigemHistoricoBloqueio, UsuarioVO usuario) throws Exception {
		verificarCompetenciaBloqueadaParaRegistrosEntidade(obj, operacao, novaDataVerificar, dataVerificarAnterior, null, null, codigoUnidadeEnsino, codigoCaixa, tipoOrigemHistoricoBloqueio, usuario);		
	}
	
	public static void verificarCompetenciaBloqueadaParaRegistrosEntidade(
			SuperVO obj, String operacao, Date novaDataVerificar,  List<Integer> listaCodigosUnidadesEnsino, Integer codigoCaixa, TipoOrigemHistoricoBloqueioEnum tipoOrigemHistoricoBloqueio, UsuarioVO usuario) throws Exception {
		verificarCompetenciaBloqueadaParaRegistrosEntidade(obj, operacao, novaDataVerificar, null, null, null, listaCodigosUnidadesEnsino, codigoCaixa, tipoOrigemHistoricoBloqueio, usuario);		
	}	
	
	public static void verificarCompetenciaBloqueadaParaRegistrosEntidade(
			SuperVO obj, String operacao, Date novaDataVerificar, Integer codigoUnidadeEnsino, TipoOrigemHistoricoBloqueioEnum tipoOrigemHistoricoBloqueio, UsuarioVO usuario) throws Exception {
		verificarCompetenciaBloqueadaParaRegistrosEntidade(obj, operacao, novaDataVerificar, null, null, null, codigoUnidadeEnsino, null, tipoOrigemHistoricoBloqueio, usuario);		
	}	

	public static void verificarCompetenciaBloqueadaParaRegistrosEntidade(
			SuperVO obj, String operacao, Date novaDataVerificar, Date novaDataCompVerificar, Integer codigoUnidadeEnsino, TipoOrigemHistoricoBloqueioEnum tipoOrigemHistoricoBloqueio, UsuarioVO usuario) throws Exception {
		verificarCompetenciaBloqueadaParaRegistrosEntidade(obj, operacao, novaDataVerificar, null, novaDataCompVerificar, null, codigoUnidadeEnsino, null, tipoOrigemHistoricoBloqueio, usuario);		
	}

	public static void verificarCompetenciaBloqueadaParaRegistrosEntidade(
			SuperVO obj, String operacao, Date novaDataVerificar, Date dataVerificarAnterior, Date novaDataCompVerificar, Date novaDataCompVerificarAnterior, Integer codigoUnidadeEnsino, Integer codigoCaixa, TipoOrigemHistoricoBloqueioEnum tipoOrigemHistoricoBloqueio, UsuarioVO usuario) throws Exception {
		List<Integer> listaCodigosUnidadesEnsino = new ArrayList<Integer>();
		listaCodigosUnidadesEnsino.add(codigoUnidadeEnsino);
		verificarCompetenciaBloqueadaParaRegistrosEntidade(obj, operacao, novaDataVerificar, dataVerificarAnterior, novaDataCompVerificar, novaDataCompVerificarAnterior, listaCodigosUnidadesEnsino, codigoCaixa, tipoOrigemHistoricoBloqueio, usuario);		
	}
	
	public static void verificarCompetenciaBloqueadaParaRegistrosEntidade(
			SuperVO obj, String operacao, Date novaDataVerificar, Date dataVerificarAnterior, List<Integer> listaCodigosUnidadesEnsino, Integer codigoCaixa, TipoOrigemHistoricoBloqueioEnum tipoOrigemHistoricoBloqueio, UsuarioVO usuario) throws Exception {
		verificarCompetenciaBloqueadaParaRegistrosEntidade(obj, operacao, novaDataVerificar, dataVerificarAnterior, null, null, listaCodigosUnidadesEnsino, codigoCaixa, tipoOrigemHistoricoBloqueio, usuario);		
	}	
	
	public static void verificarCompetenciaBloqueadaParaRegistrosEntidade(
			SuperVO obj, String operacao, Date novaDataVerificar, Date dataVerificarAnterior, Date novaDataCompVerificar, Date novaDataCompVerificarAnterior, List<Integer> listaCodigosUnidadesEnsino, Integer codigoCaixa, TipoOrigemHistoricoBloqueioEnum tipoOrigemHistoricoBloqueio, UsuarioVO usuario) throws Exception {
		if (!obj.getVerificouBloqueioPorFechamentoMes()) {
			String strOperacao = "IGUAL";
			FechamentoMesVO fechamentoMesVO = getFacadeFactory().getFechamentoMesFacade().verificarCompetenciaFechada(novaDataVerificar, novaDataCompVerificar, tipoOrigemHistoricoBloqueio, listaCodigosUnidadesEnsino, codigoCaixa, usuario); 
			if (fechamentoMesVO == null) {
				...
				if ((dataVerificarAnterior != null) && (!dataVerificarAnterior.equals(novaDataVerificar))) {
					fechamentoMesVO = getFacadeFactory().getFechamentoMesFacade().verificarCompetenciaFechada(dataVerificarAnterior, novaDataCompVerificar, tipoOrigemHistoricoBloqueio, listaCodigosUnidadesEnsino, codigoCaixa, usuario); 
					if (fechamentoMesVO != null) { 
	...
	protected boolean verificarPermissaoVisualizarAlunoTR_CA(UsuarioVO usuario) {
		try {
			ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("LancamentoNotaa_VisualizarMatriculaTR_CA", usuario);
			return true;
		} catch (Exception e) {
			return false;
		}
	...
	protected boolean verificarPermiteLancarNotaDisciplinaComposta(UsuarioVO usuario) {
		try {
			return ControleAcesso.verificarPermissaoFuncionalidadeUsuario("PermiteLancarNotaDisciplinaComposta",usuario);
		} catch (Exception e) {
			return false;
		}
	}
	...
	public static UsuarioVO verificarLoginUsuarioParaControleFalhaLogin(String username) throws Exception {
		try {
	...
	public static void realizarMovimentacaoContasCaixaFechada(String funcionalidade, UsuarioVO usuario) throws Exception {
		if (!verificarPermissaoUsuarioComUsuarioEspecifico(funcionalidade, Uteis.ALTERAR, usuario)) {
			String nomeUsuario = "";
			nomeUsuario = " " + usuario.getNome().toUpperCase();
			String msgErro = "USUÁRIO " + nomeUsuario + " não possui permissão para a funcionalidade " + tratarTituloPermissao(funcionalidade, usuario);
