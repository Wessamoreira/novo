...
//        montarDadosPessoa(obj, usuario);
    ...
    public static void montarDadosPessoa(FormacaoExtraCurricularVO obj, UsuarioVO usuario) throws Exception {
     ...
     * @exception Exception  Erro de conexão com o BD ou restrição de acesso a esta operação.
     */
    public static List consultarFormacaoExtraCurricular(Integer pessoa, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
        return consultarFormacaoExtraCurricular(pessoa, controlarAcesso, false, usuario);
    }

    public static List consultarFormacaoExtraCurricular(Integer pessoa, boolean controlarAcesso, boolean funcionario, UsuarioVO usuario) throws Exception {
        FormacaoExtraCurricular.consultar(getIdEntidade(), controlarAcesso, usuario);
