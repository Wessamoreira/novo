...
import negocio.facade.jdbc.faturamento.nfe.UnidadeEnsinoCursoValoresGinfes;
...
public class UnidadeEnsinoCurso extends ControleAcesso implements UnidadeEnsinoCursoInterfaceFacade {
	 ...
	 *         <code>UnidadeEnsinoCursoVO</code> resultantes da consulta.
	 */
	public static List<UnidadeEnsinoCursoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public static UnidadeEnsinoCursoVO montarDados(SqlRowSet dadosSQL, UnidadeEnsinoCursoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public static void montarDadosTurno(UnidadeEnsinoCursoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public static void montarDadosCurso(UnidadeEnsinoCursoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	@Override
	public UnidadeEnsinoCursoVO inicializarDadosUnidadeEnsinoCursoImportarCandidatoProcSeletivo(ImportarCandidatoInscricaoProcessoSeletivoVO importarCandidatoVO, UsuarioVO usuario) throws Exception {
		UnidadeEnsinoCursoVO obj = new UnidadeEnsinoCursoVO();
		obj.setUnidadeEnsino(importarCandidatoVO.getUnidadeEnsinoVO().getCodigo());
		obj.getCurso().setCodigo(importarCandidatoVO.getCursoVO().getCodigo());
		obj.getTurno().setCodigo(importarCandidatoVO.getTurnoVO().getCodigo());
		obj.setSituacaoCurso("AT");
		incluir(obj, usuario);
		return obj;
	}
