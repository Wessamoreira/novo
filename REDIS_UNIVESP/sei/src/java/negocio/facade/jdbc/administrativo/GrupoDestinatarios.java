...
import negocio.interfaces.administrativo.GrupoDestinatariosInterfaceFacade;

@Repository
@Scope("singleton")
@Lazy
public class GrupoDestinatarios extends ControleAcesso implements GrupoDestinatariosInterfaceFacade {
	...
	public static List<GrupoDestinatariosVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public static GrupoDestinatariosVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		GrupoDestinatariosVO obj = new GrupoDestinatariosVO();
	...
	public static void montarDadosResponsavelCadastro(GrupoDestinatariosVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getResponsavelCadastro().getCodigo().intValue() == 0) {
