...
public class Departamento extends ControleAcesso implements DepartamentoInterfaceFacade {
	...
	public void incluir(final DepartamentoVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			...
			Departamento.incluir(getIdEntidade(), true, usuarioVO);
			final String sql = "INSERT INTO Departamento( nome, departamentoSuperior, responsavel, unidadeEnsino, faleConosco, codigocontabil, nomecontabil, nivelContabil, controlaEstoque, configuracaoLdap ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ? , ? ) returning codigo";
	...
	public void alterar(final DepartamentoVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			DepartamentoVO.validarDados(obj);
			Departamento.alterar(getIdEntidade(), true, usuarioVO);
	...
	public void excluir(DepartamentoVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			Departamento.excluir(getIdEntidade(), true, usuarioVO);
	...
	public static List<DepartamentoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public static DepartamentoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public static void montarDadosResponsavel(DepartamentoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getResponsavel().getCodigo().intValue() == 0) {
	...
	public static void montarDadosUnidadeEnsino(DepartamentoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getUnidadeEnsino().getCodigo().intValue() == 0) {
	...
	public static void montarDadosDepartamentoSuperior(DepartamentoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getDepartamentoSuperior().getCodigo().intValue() == 0) {
