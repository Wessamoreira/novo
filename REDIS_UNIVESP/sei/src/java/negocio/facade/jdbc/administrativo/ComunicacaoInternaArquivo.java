...
public class ComunicacaoInternaArquivo extends ControleAcesso implements ComunicacaoInternaArquivoInterfaceFacade {
     ...
     */
    public static ComunicacaoInternaArquivoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        ComunicacaoInternaArquivoVO obj = new ComunicacaoInternaArquivoVO();
    ...
    public static void montarDadosArquivo(ComunicacaoInternaArquivoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getArquivoAnexo().getCodigo().intValue() == 0) {
