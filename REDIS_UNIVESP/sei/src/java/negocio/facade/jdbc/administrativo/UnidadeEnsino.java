...
public class UnidadeEnsino extends ControleAcesso implements UnidadeEnsinoInterfaceFacade {
	...
	public void incluir(final UnidadeEnsinoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuario) throws Exception {
		try {
			...
			UnidadeEnsino.incluir(getIdEntidade(), true, usuario);
...
//					}
					...
					if (obj.getConfiguracaoNotaFiscalVO() != null && obj.getConfiguracaoNotaFiscalVO().getCodigo().intValue() != 0) {
						sqlInserir.setInt(42, obj.getConfiguracaoNotaFiscalVO().getCodigo());
					} else {
	...
	public void alterar(final UnidadeEnsinoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuario) throws Exception {
		try {
			UnidadeEnsinoVO.validarDados(obj);
			salvarLogoUnidadeEnsino(obj, configuracaoGeralSistemaVO);
			UnidadeEnsino.alterar(getIdEntidade(), true, usuario);
...
//					}
	...
	public void alterarCoordenadoresTCC(final UnidadeEnsinoVO obj, UsuarioVO usuario) throws Exception {
		try {
			ControleAcesso.alterar("CoordenadorTCC", true, usuario);
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void atualizarUnidadeEnsinoDadosConfiguracaoContabil(ConfiguracaoContabilVO conf, UsuarioVO usuario) throws Exception {
		try {
			conf.getUnidadeEnsinoVOs()
			.stream()
			.filter(UnidadeEnsinoVO::getFiltrarUnidadeEnsino)
			.forEach(p->{
				StringBuilder sqlStr = new StringBuilder();
				sqlStr.append(" UPDATE UnidadeEnsino set ");
				sqlStr.append(" ConfiguracaoContabil = ").append(conf.getCodigo()).append(", ");
				sqlStr.append(" codigoIntegracaoContabil = '").append(p.getCodigoIntegracaoContabil()).append("' ");
				sqlStr.append(" WHERE codigo = ").append(p.getCodigo()).append(" ");
			...
			StringBuilder sqlStr = new StringBuilder();
			sqlStr.append(" UPDATE UnidadeEnsino set ");
			sqlStr.append(" ConfiguracaoContabil = null, ");
			sqlStr.append(" codigoIntegracaoContabil = null");
			sqlStr.append(" WHERE codigo in(").append(UteisTexto.converteListaEntidadeCampoCodigoParaString(conf.getUnidadeEnsinoVOs().stream().filter(p->!p.getFiltrarUnidadeEnsino()).collect(Collectors.toList()))).append(")");
			sqlStr.append(adicionarUsuarioLogadoComoComentarioParaLogTrigger(usuario));
			getConexao().getJdbcTemplate().update(sqlStr.toString());
		} catch (Exception e) {
			throw e;
	...
	public void excluir(UnidadeEnsinoVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			UnidadeEnsino.excluir(getIdEntidade(), true, usuarioVO);
...
//		obj.getContaCorrentePadraoVO().setNumero(dadosSQL.getString("contaCorrentePadrao.numero"));
	...
	private void montarDadosCompleto(UnidadeEnsinoVO obj, SqlRowSet dadosSQL, boolean isAplicacao, UsuarioVO usuarioVO) throws Exception {
		...
		if (Uteis.isAtributoPreenchido(dadosSQL.getString("unidadeensino.tipoAutorizacaoEnum"))) {
			obj.setTipoAutorizacaoEnum(TipoAutorizacaoCursoEnum.valueOf(dadosSQL.getString("unidadeensino.tipoAutorizacaoEnum")));
		}
		...
		if (dadosSQL.getString("unidadeensino.tipoAutorizacaoRecredenciamento") != null) {
			obj.setTipoAutorizacaoRecredenciamento(TipoAutorizacaoCursoEnum.valueOf(dadosSQL.getString("unidadeensino.tipoAutorizacaoRecredenciamento")));
		}
		...
		if (dadosSQL.getString("unidadeensino.tipoAutorizacaoRenovacaoRecredenciamento") != null) {
			obj.setTipoAutorizacaoRenovacaoRecredenciamento(TipoAutorizacaoCursoEnum.valueOf(dadosSQL.getString("unidadeensino.tipoAutorizacaoRenovacaoRecredenciamento")));
		}
		if (dadosSQL.getString("unidadeensino.tipoAutorizacaoCredenciamentoRegistradora") != null) {
			obj.setTipoAutorizacaoCredenciamentoRegistradora(TipoAutorizacaoCursoEnum.valueOf(dadosSQL.getString("unidadeensino.tipoAutorizacaoCredenciamentoRegistradora")));
		}
		...
		if (dadosSQL.getString("unidadeensino.tipoAutorizacaoEAD") != null) {
			obj.setTipoAutorizacaoEAD(TipoAutorizacaoCursoEnum.valueOf(dadosSQL.getString("unidadeensino.tipoAutorizacaoEAD")));
		}
		...
		if (dadosSQL.getString("unidadeensino.tipoAutorizacaoRecredenciamentoEAD") != null) {
			obj.setTipoAutorizacaoRecredenciamentoEAD(TipoAutorizacaoCursoEnum.valueOf(dadosSQL.getString("unidadeensino.tipoAutorizacaoRecredenciamentoEAD")));
		}
		...
		if (dadosSQL.getString("unidadeensino.tipoAutorizacaoRenovacaoRecredenciamentoEAD") != null) {
			obj.setTipoAutorizacaoRenovacaoRecredenciamentoEAD(TipoAutorizacaoCursoEnum.valueOf(dadosSQL.getString("unidadeensino.tipoAutorizacaoRenovacaoRecredenciamentoEAD")));
		}
...
//		montarDadosContaCorrente(obj, nivelMontarDados, usuario);
	...
	public static void montarDadosDiretorGeral(UnidadeEnsinoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getDiretorGeral().getCodigo().intValue() == 0) {
	...
	public static void montarDadosResponsavelCobrancaUnidade(UnidadeEnsinoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getResponsavelCobrancaUnidade().getCodigo().intValue() == 0) {
	...
	public static void montarDadosResponsavelNotificacaoAlteracaoCronogramaAula(UnidadeEnsinoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getResponsavelNotificacaoAlteracaoCronogramaAula().getCodigo().intValue() == 0) {
...
//	}
	...
	public static void montarDadosCoordenadorTCC(UnidadeEnsinoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getCoordenadorTCC().getCodigo().intValue() == 0) {
	 ...
	 */
	public static void montarDadosCidade(UnidadeEnsinoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public static void montarDadosConfiguracoes(UnidadeEnsinoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getConfiguracoes().getCodigo().intValue() == 0) {
			return;
		}
...
//		return (obj);
	...
	public UnidadeEnsinoVO consultarPorTurma(Integer turma, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		UnidadeEnsino.consultar(getIdEntidade(), controlarAcesso, usuario);
		StringBuilder sqlStr = new StringBuilder("");
	...
	public List<UnidadeEnsinoVO> consultarPorUsuarioNomeEntidadePermissao(String nomeEntidade, String permissao, int nivelMontarDados, boolean controlarAcesso, UsuarioVO usuarioVO) throws Exception {
		UnidadeEnsino.consultar(getIdEntidade(), controlarAcesso, usuarioVO);
		StringBuilder sqlStr = new StringBuilder();
	...
	public List<UnidadeEnsinoVO> consultarPorUsuario(UsuarioVO usuarioVO) throws Exception {
		...
		try {
			ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("Requerimento_consultarTodasUnidades", usuarioVO);
			possuiPermissaoUnidade = Boolean.TRUE;
		} catch (Exception e) {

		}
		try {
			ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("Requerimento_consultarRequerimentoOutroDepartamentoMesmoTramiteTodasUnidades", usuarioVO);
			possuiPermissaoConsultarRequerimentoOutroDepartamentoMesmoTramiteTodasUnidades = Boolean.TRUE;
		} catch (Exception e) {

		}
		try {
			ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("Requerimento_consultarRequerimentoOutrosResponsaveisMesmoDepartamentoTodasUnidades", usuarioVO);
	...
	public UnidadeEnsinoVO consultarSeExisteUnidadeMatrizParaExpedicaoDiploma(  Boolean controlarAcesso , UsuarioVO usuario) throws Exception {	
	 ...
	 private void montarCabecalhoExcelVagaOfertada(UteisExcel uteisExcel, XSSFSheet sheet){
	    ...
	    public List<UnidadeEnsinoVO> importarPlanilhaUnidadeEnsinoVagaOfertada(FileUploadEvent uploadEvent, UsuarioVO usuario) throws Exception {
	        String extensao = uploadEvent.getUploadedFile().getName().substring(uploadEvent.getUploadedFile().getName().lastIndexOf(".") + 1).toLowerCase();
	        ...
	        if (extensao.equals("xlsx")) {
	        	xssfWorkbook = new XSSFWorkbook(uploadEvent.getUploadedFile().getInputStream());
	            mySheetXlsx = xssfWorkbook.getSheetAt(0);
	            rowMax = mySheetXlsx.getLastRowNum();
	        } else if (extensao.equals("xls")) {
	        	hssfWorkbook = new HSSFWorkbook(uploadEvent.getUploadedFile().getInputStream());
