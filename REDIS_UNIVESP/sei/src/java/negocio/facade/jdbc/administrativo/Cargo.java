...
public class Cargo extends ControleAcesso implements CargoInterfaceFacade {
    ...
    public void incluir(final CargoVO obj, UsuarioVO usuarioVO) throws Exception {
        try {
            ...
            Cargo.incluir(getIdEntidade(), true, usuarioVO);
    ...
    public void alterar(final CargoVO obj, UsuarioVO usuarioVO) throws Exception {
        try {
            CargoVO.validarDados(obj);
            Cargo.alterar(getIdEntidade(), true, usuarioVO);
    ...
    public void excluir(CargoVO obj, UsuarioVO usuarioVO) throws Exception {
        try {
            Cargo.excluir(getIdEntidade(), true, usuarioVO);
     ...
     * @return  List Contendo vários objetos da classe <code>CargoVO</code> resultantes da consulta.
     */
    public static List<CargoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados,UsuarioVO usuario) throws Exception {
     ...
     */
    public static CargoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados,UsuarioVO usuario) throws Exception {
        CargoVO obj = new CargoVO();
        obj.setNovoObj(Boolean.FALSE);
    ...
    public static void montarDadosDepartamento(CargoVO obj, int nivelMontarDados,UsuarioVO usuario) throws Exception {
