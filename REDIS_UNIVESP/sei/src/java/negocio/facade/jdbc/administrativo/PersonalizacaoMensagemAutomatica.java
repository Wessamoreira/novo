...
public class PersonalizacaoMensagemAutomatica extends ControleAcesso implements PersonalizacaoMensagemAutomaticaInterfaceFacade {
	...
	public static List<PersonalizacaoMensagemAutomaticaVO> montarDadosConsulta(SqlRowSet tabelaResultado, UsuarioVO usuario) throws Exception {
	...
	public static PersonalizacaoMensagemAutomaticaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public void incluir(final PersonalizacaoMensagemAutomaticaVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			PersonalizacaoMensagemAutomatica.incluir(getIdEntidade(), true, usuarioVO);
	...
	public void alterar(final PersonalizacaoMensagemAutomaticaVO obj, UsuarioVO usuarioVO) throws Exception {
		try {
			PersonalizacaoMensagemAutomatica.alterar(getIdEntidade(), true, usuarioVO);
