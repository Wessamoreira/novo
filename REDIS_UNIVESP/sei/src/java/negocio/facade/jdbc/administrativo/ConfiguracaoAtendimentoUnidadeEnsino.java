...
public class ConfiguracaoAtendimentoUnidadeEnsino extends ControleAcesso implements ConfiguracaoAtendimentoUnidadeEnsinoInterfaceFacade {
	 ...
	 */
	public static ConfiguracaoAtendimentoUnidadeEnsinoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     */
    public static void montarDadosUnidadeEnsino(ConfiguracaoAtendimentoUnidadeEnsinoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
