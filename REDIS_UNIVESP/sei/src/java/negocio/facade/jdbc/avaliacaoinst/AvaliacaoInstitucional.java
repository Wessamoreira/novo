...
public class AvaliacaoInstitucional extends ControleAcesso implements AvaliacaoInstitucionalInterfaceFacade {
    ...
    public void incluir(final AvaliacaoInstitucionalVO obj, final UsuarioVO usuarioVO) throws Exception {
        try {
            ...
            AvaliacaoInstitucional.incluir(getIdEntidade(), true, usuarioVO);
    ...
    public void alterar(final AvaliacaoInstitucionalVO obj, UsuarioVO usuario) throws Exception {
        try {
            ...
            AvaliacaoInstitucionalVO.validarDados(obj);
            AvaliacaoInstitucional.alterar(getIdEntidade(), true, usuario);
    ...
    public void excluir(AvaliacaoInstitucionalVO obj, UsuarioVO usuario) throws Exception {
        try {
            AvaliacaoInstitucional.excluir(getIdEntidade(), true, usuario);
     ...
     * <code>AvaliacaoInstitucionalVO</code> resultantes da consulta.
     */
    public static List<AvaliacaoInstitucionalVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados,
                                                                     UsuarioVO usuario) throws Exception {
     ...
     */
    public static AvaliacaoInstitucionalVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario)
            throws Exception {
        AvaliacaoInstitucionalVO obj = new AvaliacaoInstitucionalVO();
     ...
     */
    public static void montarDadosResponsavel(AvaliacaoInstitucionalVO obj, int nivelMontarDados, UsuarioVO usuario)
            throws Exception {
     ...
     * @param obj Objeto no qual será montado os dados consultados.
     */
    public static void montarDadosQuestionario(AvaliacaoInstitucionalVO obj, int nivelMontarDados, UsuarioVO usuario)
            throws Exception {
        if (obj.getQuestionarioVO().getCodigo().intValue() == 0) {
     ...
     * @param obj Objeto no qual será montado os dados consultados.
     */
    public static void montarDadosUnidadeEnsino(AvaliacaoInstitucionalVO obj, int nivelMontarDados, UsuarioVO usuario)
            throws Exception {
     ...
     * @param obj Objeto no qual será montado os dados consultados.
     */
    public static void montarDadosCargo(AvaliacaoInstitucionalVO obj, int nivelMontarDados, UsuarioVO usuario)
            throws Exception {
     ...
     * @param obj Objeto no qual será montado os dados consultados.
     */
    public static void montarDadosDepartamento(AvaliacaoInstitucionalVO obj, int nivelMontarDados, UsuarioVO usuario)
            throws Exception {
     ...
     * @param obj Objeto no qual será montado os dados consultados.
     */
    public static void montarDadosCargoAvaliado(AvaliacaoInstitucionalVO obj, int nivelMontarDados, UsuarioVO usuario)
            throws Exception {
     ...
     * @param obj Objeto no qual será montado os dados consultados.
     */
    public static void montarDadosDepartamentoAvaliado(AvaliacaoInstitucionalVO obj, int nivelMontarDados,
                                                       UsuarioVO usuario) throws Exception {
     ...
     * @param obj Objeto no qual será montado os dados consultados.
     */
    public static void montarDadosCurso(AvaliacaoInstitucionalVO obj, int nivelMontarDados, UsuarioVO usuario)
            throws Exception {
     ...
     * @param obj Objeto no qual será montado os dados consultados.
     */
    public static void montarDadosTurma(AvaliacaoInstitucionalVO obj, int nivelMontarDados, UsuarioVO usuario)
            throws Exception {
     ...
     * @param obj Objeto no qual será montado os dados consultados.
     */
    public static void montarDadosDisciplina(AvaliacaoInstitucionalVO obj, int nivelMontarDados, UsuarioVO usuario)
            throws Exception {
