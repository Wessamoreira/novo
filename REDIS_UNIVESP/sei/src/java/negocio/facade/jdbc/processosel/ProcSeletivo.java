...
public class ProcSeletivo extends ControleAcesso implements ProcSeletivoInterfaceFacade {
    ...
    public void incluir(final ProcSeletivoVO obj, UsuarioVO usuarioVO) throws Exception {
        try {
            ...
            ProcSeletivo.incluir(getIdEntidade(), true, usuarioVO);
    ...
    public void alterar(final ProcSeletivoVO obj, UsuarioVO usuarioVO) throws Exception {
        try {
            ProcSeletivoVO.validarDados(obj);
            validarDadosMediaMinimaAprovacao(obj);
            ProcSeletivo.alterar(getIdEntidade(), true, usuarioVO);
     ...
     * @return List Contendo vários objetos da classe <code>ProcSeletivoVO</code> resultantes da consulta.
     */
    public static List<ProcSeletivoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        List<ProcSeletivoVO> vetResultado = new ArrayList<ProcSeletivoVO>();
        while (tabelaResultado.next()) {
     ...
     */
    public static ProcSeletivoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        ProcSeletivoVO obj = new ProcSeletivoVO();
     ...
     */
    public static void montarDadosResponsavel(ProcSeletivoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    public static void montarDadosQuestionario(ProcSeletivoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
...
//        }
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public ProcSeletivoVO inicializarDadosProcSeletivoImportacaoCandidatoInscricao(ImportarCandidatoInscricaoProcessoSeletivoVO importarCandidatoVO, UsuarioVO usuario) throws Exception {
		ProcSeletivoVO procVO = getFacadeFactory().getProcSeletivoFacade().consultarPorDescricaoExata(importarCandidatoVO.getProcSeletivoVO().getDescricao(), false, Uteis.NIVELMONTARDADOS_COMBOBOX, usuario);
