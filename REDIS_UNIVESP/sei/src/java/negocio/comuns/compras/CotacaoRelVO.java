...
public class CotacaoRelVO {
	...
	public CotacaoRelVO(CompraVO compraVO, CotacaoVO cotacao, FornecedorVO fornecedorVO, ProdutoServicoVO produto, String formaPagamento, String unidadeEnsino, Long quantidade, BigDecimal precoUnitario, BigDecimal precoTotal) {
	...
	public String getProdutoCategoriaProduto() {
		return this.cotacao.getCategoriaProduto().getNome();
	}
	...
	public String getFornecedorCPF() {
		return fornecedorVO.getCPF();
	}
	
	public String getFornecedorTipoEmpresa() {
		return fornecedorVO.getTipoEmpresa();
	}
