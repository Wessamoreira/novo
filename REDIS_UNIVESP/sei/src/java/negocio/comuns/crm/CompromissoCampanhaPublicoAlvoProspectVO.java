 ...
 * @see SuperVO
 */
public class CompromissoCampanhaPublicoAlvoProspectVO extends SuperVO {
...
//    private Boolean compromissoParalizado;
    ...
    /**
    * Atributo Transiente usado para alteração do consultor da agenda
    */
   private CompromissoAgendaPessoaHorarioVO compromissoAgendaPessoaHorarioVO;
   private FuncionarioVO consultorAtual;
   private Boolean alterarConsultorPadraoProspect;
     ...
     */
    public CompromissoCampanhaPublicoAlvoProspectVO() {
        super();
    }
    
    public CompromissoCampanhaPublicoAlvoProspectVO clone() throws CloneNotSupportedException{
    	CompromissoCampanhaPublicoAlvoProspectVO obj = (CompromissoCampanhaPublicoAlvoProspectVO) super.clone();
        obj.setCodigo(0);
        obj.setNovoObj(true);
     ...
     */
    public static void validarDados(CompromissoCampanhaPublicoAlvoProspectVO obj) throws ConsistirException, Exception {
        ...
        if (Integer.parseInt(obj.getHora().substring(0, 2)) > 23) {
            throw new Exception(UteisJSF.internacionalizar("msg_CompromissoAgendaPessoaHorario_horaInvalida"));
        }
        
        if (Integer.parseInt(obj.getHora().substring(3, 5)) >= 60) {
            throw new Exception(UteisJSF.internacionalizar("msg_CompromissoAgendaPessoaHorario_minutoInvalido"));
        }
    ...
    public Boolean getIsTipoCompromissoContato() {
        if (getTipoCompromisso().equals(TipoCompromissoEnum.CONTATO)) {
            return true;
        }
        return false;
    }
    ...
    public Boolean getPermitirAlteracaoCompromisso() {
        if (!getCompromissoRealizado() && !getCompromissoRealizadoComRemarcacao() && !getCompromissoRealizadoComInsucessoContato()) {
            return true;
        }
        return false;
    }
	...
	public void setRealizado(Boolean realizado) {
        ...
        public String getImagemTipoContato() {
            if (this.getTipoContato().equals(TipoContatoEnum.EMAIL)) {
                return "./resources/imagens/tipoContatoEmail.png";
            }
            if (this.getTipoContato().equals(TipoContatoEnum.VISITA)) {
                return "./resources/imagens/tipoContatoVisita.png";
            }
            return "./resources/imagens/tipoContatoTelefone.png";
        }
	...
	public boolean getCompromissoFoiReagendado() {
		if (!Uteis.getData(this.getDataInicialCompromisso()).equals(Uteis.getData(this.getDataCompromisso()))) {
			return true;
		}
		return false;
	}
	...
	public void reagendarCompromissoParaDataFutura(Date dataReagendar, UsuarioVO usuarioLogado) {
	    ...
	    String historico = "Compromisso reagendado em " + dataHoje + " para " + 
	                       Uteis.getData(dataReagendar) + " por " + usuarioLogado.getNome();
	...
	public FuncionarioVO getConsultorAtual() {
		if(consultorAtual == null){
			consultorAtual =  new FuncionarioVO();
		}
		return consultorAtual;
	}

	public void setConsultorAtual(FuncionarioVO consultorAtual) {
