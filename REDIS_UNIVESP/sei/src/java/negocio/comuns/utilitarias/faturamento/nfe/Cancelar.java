...
public class Cancelar {
    ...
    public static String A1(String codigoIBGEEstado, String caminhoXml, String chave, String protocolo, String motivoCancelamento, String cnpj, ConfiguracaoGeralSistemaVO conSistemaVO, ConfiguracaoNotaFiscalVO conNotaFiscalVO, UsuarioVO usuarioLogado) throws Exception{
        ...
        dadosEnvio.montarDadosEventoCancelamento(chave, cnpj, motivoCancelamento, protocolo);
