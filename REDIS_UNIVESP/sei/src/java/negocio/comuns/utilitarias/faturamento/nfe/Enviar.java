...
public class Enviar {
    ...
    public static String A1(String codigoIBGEEstado, String caminhoXml, NfeVO nfe, ConfiguracaoGeralSistemaVO conSistemaVO, ConfiguracaoNotaFiscalVO conNotaFiscalVO, UsuarioVO usuarioLogado) throws Exception {
        ...
        dadosEnvio.montarDadosEnviar(nfe);
