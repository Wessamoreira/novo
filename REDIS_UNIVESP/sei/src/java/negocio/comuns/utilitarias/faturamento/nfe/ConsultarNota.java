...
public class ConsultarNota {
    ...
    public static String ConsularNota(String codigoIBGEEstado, String chave, ConfiguracaoGeralSistemaVO conSistemaVO, ConfiguracaoNotaFiscalVO conNotaFiscalVO, UsuarioVO usuarioLogado) throws Exception {
        ...
        dadosEnvio.montarDadosConsultarNota(chave);
