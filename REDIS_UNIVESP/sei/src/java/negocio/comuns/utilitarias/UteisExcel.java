...
public class UteisExcel {
	...
	public CellStyle preencherLayoutTexto() {
		...
		textoCellStyle.setAlignment(CellStyle.ALIGN_CENTER);
		textoCellStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
		textoCellStyle.setBorderRight(CellStyle.BORDER_THIN);
		textoCellStyle.setBorderBottom(CellStyle.BORDER_THIN);
		textoCellStyle.setBorderLeft(CellStyle.BORDER_THIN);
	...
	public CellStyle preencherLayoutMoeda() {
		...
		moedaCellStyle.setAlignment(CellStyle.ALIGN_CENTER);
		moedaCellStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
		moedaCellStyle.setBorderRight(CellStyle.BORDER_THIN);
		moedaCellStyle.setBorderBottom(CellStyle.BORDER_THIN);
		moedaCellStyle.setBorderLeft(CellStyle.BORDER_THIN);
	...
	public void realizarGeracaoTopoPadraoRelatorio(HSSFWorkbook workbook, HSSFSheet worksheet, String caminhoLogo, RelatorioSEIDecidirVO relatorioSEIDecidirVO, Integer qtdeColunaExcel, String descricao) throws Exception {
		int qtdeColuna = 0;
		int colunaImagem = -1;
		...
		if (Uteis.isAtributoPreenchido(descricao)) {
			...
			textbox1.setVerticalAlignment(HSSFCellStyle.ALIGN_CENTER);
			textbox1.setHorizontalAlignment(HSSFCellStyle.ALIGN_CENTER);
		}
	...
	public void realizarGeracaoTopoPadraoRelatorio(XSSFWorkbook workbook, XSSFSheet worksheet, String caminhoLogo, RelatorioSEIDecidirVO relatorioSEIDecidirVO, Integer qtdeColunaExcel, String descricao) throws Exception {
		int qtdeColuna = 0;
		int colunaImagem = -1;
		double widthColumn = 0;
		int pictureIndex = realizarImportacaoImagemExcel(workbook, caminhoLogo);
