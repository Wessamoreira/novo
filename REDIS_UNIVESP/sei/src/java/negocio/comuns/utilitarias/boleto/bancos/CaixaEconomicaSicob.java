...
public class CaixaEconomicaSicob implements BoletoBanco, Serializable {
...
//    	XXXXXXXX - Código fornecido pela Agência
    	...
    	String campo = "82" + boleto.getNossoNumero() + boleto.getAgencia() + boleto.getNumConvenio() + boleto.getCedente();
     ...
     * @param boleto
     */
    public CaixaEconomicaSicob(JBoletoBean boleto) {
        this.boleto = boleto;
    }
