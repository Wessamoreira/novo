...
public class ItauLayoutCNAB240 extends LayoutBancosImpl implements LayoutBancos {

    private RegistroArquivoVO registroArquivoVO;
    private static final String PATTERN = "ddMMyy";

    public ItauLayoutCNAB240() {
    }

    public ItauLayoutCNAB240(RegistroArquivoVO registroArquivo) {
    ...
    private void processarHeader(String linha, RegistroHeaderVO header) throws Exception {
    	...
    	header.setDigitoConta(Uteis.getValorString(linha.substring(71,72)));
    ...
    private RegistroDetalheVO processarRegistroDetalheSegmentoT(String linha, RegistroDetalheVO detalhe, ConfiguracaoFinanceiroVO configuracaoFinanceiroVO, UsuarioVO usuarioVO) throws Exception {
        ...
        detalhe.setIdentificacaoTituloEmpresa(linha.substring(40, 48));
                ...
                switch (registro) {
                    ...
                    case 3:
                    	...
                    	if (segmento.equalsIgnoreCase("T")) {
                    		...
                    		getRegistroArquivoVO().getRegistroDetalheVOs().add(processarRegistroDetalheSegmentoU(linha, registroProvisorio, configuracaoFinanceiroVO, usuarioVO));
                    	}
