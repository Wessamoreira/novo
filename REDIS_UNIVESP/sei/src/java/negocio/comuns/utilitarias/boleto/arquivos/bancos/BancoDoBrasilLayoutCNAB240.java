...
public class BancoDoBrasilLayoutCNAB240 extends LayoutBancosImpl implements LayoutBancos {
    ...
    public BancoDoBrasilLayoutCNAB240() {
    }

    public BancoDoBrasilLayoutCNAB240(RegistroArquivoVO registroArquivo) {
    ...
    private void processarRegistroDetalheSegmentoT(String linha, RegistroDetalheVO detalhe) throws Exception {
        ...
        detalhe.setIdentificacaoTituloBanco(linha.substring(37, 44));
        detalhe.setIdentificacaoTituloEmpresa(linha.substring(44, 54));
