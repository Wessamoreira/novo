...
public class CaixaEconomica implements BoletoBanco, Serializable {
    ...
    private String getCampoLivre() {
        ...
        //return boleto.getNossoNumero() + boleto.getAgencia() + boleto.getCarteira() + boleto.getNumConvenio();
    	String campo = boleto.getCodigoCedenteDigitoVerificadorCodigoCedenteCaixa(boleto.getCedente()) + boleto.getNossoNumero().substring(0, 3)
                + boleto.getCarteira() + boleto.getNossoNumero().substring(3, 6) + "4" + boleto.getNossoNumero().substring(6);
        campo = campo + boleto.getDigitoVerificadorCampoLivreCaixaEconomica(campo);
        return campo;
    }
