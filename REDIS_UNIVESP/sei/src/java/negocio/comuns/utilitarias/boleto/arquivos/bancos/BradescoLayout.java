...
public class BradescoLayout extends LayoutBancosImpl implements LayoutBancos, Serializable {

    private RegistroArquivoVO registroArquivoVO;
    private static final String PATTERN = "ddMMyy";

    public BradescoLayout() {
    }

    public BradescoLayout(RegistroArquivoVO registroArquivo) {
            ...
            while ((linha = reader.readLine()) != null) {
                ...
                switch (registro) {
                    ...
                    case 1:
                        ...
                        getRegistroArquivoVO().getRegistroHeader().setNumeroConta(Uteis.getValorInteiro(linha.substring(29, 36)));
                        getRegistroArquivoVO().getRegistroHeader().setDigitoConta(linha.substring(36, 37));
                        break;
                    case 9:
