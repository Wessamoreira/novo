...
public class Safra implements BoletoBanco, Serializable {
    ...
    public Safra(JBoletoBean boleto) {
        this.boleto = boleto;
    }

    private String getCampoLivre() {

        String campo = "7" + boleto.getAgencia() + boleto.getContaCorrente() + boleto.getDvContaCorrente() + boleto.getNossoNumero() + "2";
    ...
    private String getCampo3() {
        String campo = getCampoLivre().substring(15, getCampoLivre().length() >= 25? 25:getCampoLivre().length());
    ...
    public String getCodigoBarras() {
        String campo = getNumero() + String.valueOf(boleto.getMoeda()) + getCampo4()
                + boleto.getFatorVencimento() + boleto.getValorTitulo() + "7"+ boleto.getAgencia()
                + boleto.getContaCorrente() + boleto.getDvContaCorrente()
                + boleto.getNossoNumero()  + "2";
        return campo;
    }
