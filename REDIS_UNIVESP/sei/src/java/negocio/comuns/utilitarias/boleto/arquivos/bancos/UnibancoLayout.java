...
/**
 * Implementacao do layout do unibanco
 * 
 * @author Diego
 * 
 */
...
public class UnibancoLayout extends LayoutBancosImpl implements LayoutBancos, Serializable {

    private RegistroArquivoVO registroArquivoVO;
    private static final String PATTERN = "ddMMyy";

    public UnibancoLayout() {
    }

    public UnibancoLayout(RegistroArquivoVO registroArquivo) {
