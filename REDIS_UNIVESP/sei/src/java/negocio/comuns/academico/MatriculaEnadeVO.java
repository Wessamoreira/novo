...
public class MatriculaEnadeVO extends SuperVO{
	...
	private TEnumCondicaoEnade condicaoEnade;
	...
	public TEnumCondicaoEnade getCondicaoEnade() {
		return condicaoEnade;
	}
	
	public void setCondicaoEnade(TEnumCondicaoEnade condicaoEnade) {
		this.condicaoEnade = condicaoEnade;
	}
	
	public String getCondicaoEnade_Apresentar() {
		if (getCondicaoEnade() != null) {
			if (getCondicaoEnade().equals(TEnumCondicaoEnade.INGRESSANTE)) {
				return "Ingressante";
			} else if (getCondicaoEnade().equals(TEnumCondicaoEnade.CONCLUINTE)) {
				return "Concluinte";
			} else {
				return "Nenhum";
			}
