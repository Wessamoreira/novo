...
public class AbonoFaltaVO extends SuperVO {
     ...
     */
    public List<DisciplinaAbonoVO> getDisciplinaAbonoVOs() {
        if (disciplinaAbonoVOs == null) {
            disciplinaAbonoVOs = new ArrayList<DisciplinaAbonoVO>(0);
        }
        return disciplinaAbonoVOs;
    }

    /**
     * @param disciplinaAbonoVOs
     *            the disciplinaAbonoVOs to set
     */
    public void setDisciplinaAbonoVOs(List<DisciplinaAbonoVO> disciplinaAbonoVOs) {
        this.disciplinaAbonoVOs = disciplinaAbonoVOs;
    }
