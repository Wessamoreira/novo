...
public class DocumentoAssinadoVO extends SuperVO implements Serializable {
	...
	private Integer codigoRejeitarAtaColacaoGrau;
	
	public Integer getCodigoRejeitarAtaColacaoGrau() {
		if (codigoRejeitarAtaColacaoGrau == null) {
			codigoRejeitarAtaColacaoGrau = 0;
		}
		return codigoRejeitarAtaColacaoGrau;
	}
	
	public void setCodigoRejeitarAtaColacaoGrau(Integer codigoRejeitarAtaColacaoGrau) {
		this.codigoRejeitarAtaColacaoGrau = codigoRejeitarAtaColacaoGrau;
	}
}
