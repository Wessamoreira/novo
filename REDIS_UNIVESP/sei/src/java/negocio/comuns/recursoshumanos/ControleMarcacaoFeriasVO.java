 ...
 * @see SuperVO
 */
public class ControleMarcacaoFeriasVO extends SuperVO {
	...
	private ContraChequeVO adiantamentoFerias;
	private ContraChequeVO reciboFerias;
	...
	public ContraChequeVO getAdiantamentoFerias() {
		if (adiantamentoFerias == null) {
			adiantamentoFerias = new ContraChequeVO();
		}
		return adiantamentoFerias;
	}

	public void setAdiantamentoFerias(ContraChequeVO adiantamentoFerias) {
		this.adiantamentoFerias = adiantamentoFerias;
	}

	public ContraChequeVO getReciboFerias() {
		if (reciboFerias == null) {
			reciboFerias = new ContraChequeVO();
		}
		return reciboFerias;
	}

	public void setReciboFerias(ContraChequeVO reciboFerias) {
		this.reciboFerias = reciboFerias;
	}
}