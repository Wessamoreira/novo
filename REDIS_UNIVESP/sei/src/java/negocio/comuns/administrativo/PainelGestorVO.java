...
public class PainelGestorVO extends SuperVO {
    ...
    /**
     * Atributos Abaixo Utilizado no Painel Gestor Financeiro - Grafico Receitas X Despesas Efetivadas
     */
      private List<LegendaGraficoVO> legendaGraficoReceitaDespesaVOs;
    
    private List<LegendaGraficoVO> legendaGraficoAcademicoFinanceiroVOs;
    private String coresLegendaGraficoAcademicoFinanceiro;
    
    /**
     * Atributos Abaixo Utilizado no Gráfico de Categoria de Despesa
     */
    private List<LegendaGraficoVO> legendaGraficoCategoriaDespesaVOs;
...
//    private Date dataFinalPorCategoriaDespesa;
	 ...
	 */
	private List<LegendaGraficoVO> legendaGraficoConsumoVO;;
    ...
    public List<LegendaGraficoVO> getLegendaGraficoAcademicoFinanceiroVOs() {
        if (legendaGraficoAcademicoFinanceiroVOs == null) {
            legendaGraficoAcademicoFinanceiroVOs = new ArrayList<LegendaGraficoVO>(0);
        }
        return legendaGraficoAcademicoFinanceiroVOs;
    }

    public void setLegendaGraficoAcademicoFinanceiroVOs(List<LegendaGraficoVO> legendaGraficoAcademicoFinanceiroVOs) {
        this.legendaGraficoAcademicoFinanceiroVOs = legendaGraficoAcademicoFinanceiroVOs;
    }
...
//    }
    ...
    public List<LegendaGraficoVO> getLegendaGraficoReceitaDespesaVOs() {
        if (legendaGraficoReceitaDespesaVOs == null) {
            legendaGraficoReceitaDespesaVOs = new ArrayList<LegendaGraficoVO>(0);
        }
        return legendaGraficoReceitaDespesaVOs;
    }

    public void setLegendaGraficoReceitaDespesaVOs(List<LegendaGraficoVO> legendaGraficoReceitaDespesaVOs) {
        this.legendaGraficoReceitaDespesaVOs = legendaGraficoReceitaDespesaVOs;
    }

  

    
    public List<LegendaGraficoVO> getLegendaGraficoCategoriaDespesaVOs() {
        if(legendaGraficoCategoriaDespesaVOs == null){
            legendaGraficoCategoriaDespesaVOs = new ArrayList<LegendaGraficoVO>(0);
        }
        return legendaGraficoCategoriaDespesaVOs;
    }

    
    public void setLegendaGraficoCategoriaDespesaVOs(List<LegendaGraficoVO> legendaGraficoCategoriaDespesaVOs) {
        this.legendaGraficoCategoriaDespesaVOs = legendaGraficoCategoriaDespesaVOs;
    }
...
public List<LegendaGraficoVO> getLegendaGraficoConsumoVO() {
		if (legendaGraficoConsumoVO == null) {
			legendaGraficoConsumoVO = new ArrayList<LegendaGraficoVO>(0);
		}
		return legendaGraficoConsumoVO;
	}

	public void setLegendaGraficoConsumoVO(List<LegendaGraficoVO> legendaGraficoConsumoVO) {
		this.legendaGraficoConsumoVO = legendaGraficoConsumoVO;
	}
