...
public class CargoVO extends SuperVO {
	...
	private ProgressaoSalarialVO progressaoSalarial;
	...
	public ProgressaoSalarialVO getProgressaoSalarial() {
		if (progressaoSalarial == null)
			progressaoSalarial = new ProgressaoSalarialVO();
		return progressaoSalarial;
	}

	public void setProgressaoSalarial(ProgressaoSalarialVO progressaoSalarial) {
