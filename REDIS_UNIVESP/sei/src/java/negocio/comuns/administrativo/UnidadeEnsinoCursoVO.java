...
public class UnidadeEnsinoCursoVO extends SuperVO {
    ...
    private List<UnidadeEnsinoCursoValoresGinfesVO> listaUnidadeEnsinoCursoValoresGinfes;
	...
	public List<UnidadeEnsinoCursoValoresGinfesVO> getListaUnidadeEnsinoCursoValoresGinfes() {
		if(listaUnidadeEnsinoCursoValoresGinfes == null) {
			listaUnidadeEnsinoCursoValoresGinfes = new ArrayList<>();
		}
		return listaUnidadeEnsinoCursoValoresGinfes;
	}

	public void setListaUnidadeEnsinoCursoValoresGinfes(List<UnidadeEnsinoCursoValoresGinfesVO> listaUnidadeEnsinoCursoValoresGinfes) {
		this.listaUnidadeEnsinoCursoValoresGinfes = listaUnidadeEnsinoCursoValoresGinfes;
	}	
