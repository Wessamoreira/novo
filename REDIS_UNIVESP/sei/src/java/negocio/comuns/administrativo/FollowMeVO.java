...
public class FollowMeVO extends SuperVO {
    ...
    private List<FollowMeRelVO> followMeRelVOs;
    ...
    public List<FollowMeRelVO> getFollowMeRelVOs() {
        if(followMeRelVOs == null){
            followMeRelVOs = new ArrayList<FollowMeRelVO>(0);
        }
        return followMeRelVOs;
    }

    
    public void setFollowMeRelVOs(List<FollowMeRelVO> followMeRelVOs) {
        this.followMeRelVOs = followMeRelVOs;
    }
