...
public class PainelGestorMonitoramentoCRMVO {
	...
	private TipoFiltroMonitamentoCrmProspectEnum tipoFiltroMonitamentoCrmProspectEnum;
	...
	public List<ProspectsVO> getProspectsVOs() {
		if (prospectsVOs == null) {
			prospectsVOs = new ArrayList<ProspectsVO>(0);
		}
		return prospectsVOs;
	}
	...
	public TipoFiltroMonitamentoCrmProspectEnum getTipoFiltroMonitamentoCrmProspectEnum() {
		return tipoFiltroMonitamentoCrmProspectEnum;
	}

	public void setTipoFiltroMonitamentoCrmProspectEnum(TipoFiltroMonitamentoCrmProspectEnum tipoFiltroMonitamentoCrmProspectEnum) {
		this.tipoFiltroMonitamentoCrmProspectEnum = tipoFiltroMonitamentoCrmProspectEnum;
	}
