...
public class ConfiguracaoGeralSistemaVO extends SuperVO {
    ...
    private PerfilEconomicoVO perfilEconomicoPadrao;
...
//    private String descricaoRegraComissionamentoCRM;
   ...
   private TextoPadraoDeclaracaoVO textoPadraoDadosSensiveisLGPD;  
    ...
    public PerfilEconomicoVO getPerfilEconomicoPadrao() {
        if (perfilEconomicoPadrao == null) {
            perfilEconomicoPadrao = new PerfilEconomicoVO();
        }
        return perfilEconomicoPadrao;
    }

    public void setPerfilEconomicoPadrao(PerfilEconomicoVO perfilEconomicoPadrao) {
        this.perfilEconomicoPadrao = perfilEconomicoPadrao;
    }
