 ...
 * Dados do curso
 * 
 * <p>Classe Java de TDadosCurso complex type.
 * 
 ...
 *         &lt;element name="Enfase" type="{http://portal.mec.gov.br/diplomadigital/arquivos-em-xsd}TString" maxOccurs="unbounded" minOccurs="0"/>
...
public class TDadosCurso {
    ...
    @XmlElement(name = "Enfase")
    protected List<String> enfase;
    ...
    /**
     * Gets the value of the enfase property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the enfase property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEnfase().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getEnfase() {
        if (enfase == null) {
            enfase = new ArrayList<String>();
        }
        return this.enfase;
    }
