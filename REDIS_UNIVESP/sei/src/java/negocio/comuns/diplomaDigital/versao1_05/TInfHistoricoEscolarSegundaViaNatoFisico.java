...
/**
 * Tipo que define o conjunto de informações referentes a um Histórico Escolar Digital para segundas vias Nato Físicos
 * 
 * <p>Classe Java de TInfHistoricoEscolarSegundaViaNatoFisico complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="TInfHistoricoEscolarSegundaViaNatoFisico">
 *   &lt;complexContent>
...
@XmlType(name = "TInfHistoricoEscolarSegundaViaNatoFisico", propOrder = {
    "aluno",
    "dadosCurso",
    "dadosCursoNSF",
    "iesEmissora",
...
public class TInfHistoricoEscolarSegundaViaNatoFisico {
