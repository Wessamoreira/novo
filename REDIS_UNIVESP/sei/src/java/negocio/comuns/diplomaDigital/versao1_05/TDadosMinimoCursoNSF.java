...
/**
 * Dados mínimos do curso para IES emissoras que não fazem parte do sistema federal de regulação
 * 
 * <p>Classe Java de TDadosMinimoCursoNSF complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="TDadosMinimoCursoNSF">
 *   &lt;complexContent>
...
@XmlType(name = "TDadosMinimoCursoNSF", propOrder = {
    "nomeCurso",
    "codigoCursoEMEC",
    "semCodigoCursoEMEC",
    "habilitacao",
...
public class TDadosMinimoCursoNSF {
