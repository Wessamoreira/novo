...
@XmlType(name = "TDocumentoHistoricoEscolarFinal", propOrder = {
    "infHistoricoEscolar",
    "signature"
})
@XmlRootElement(name = "DocumentoHistoricoEscolarFinal")
public class TDocumentoHistoricoEscolarFinal extends TDocumentoHistoricoEscolarDigital {
