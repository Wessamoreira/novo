...
/**
 * Tipo Diploma Digital para emissão de diplomas por força de decisão Judicial
 * 
 * <p>Classe Java de TDadosDiplomaPorDecisaoJudicial complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="TDadosDiplomaPorDecisaoJudicial">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Diplomado" type="{http://portal.mec.gov.br/diplomadigital/arquivos-em-xsd}TDadosDiplomadoPorDecisaoJudicial"/>
 *         &lt;element name="DataConclusao" type="{http://portal.mec.gov.br/diplomadigital/arquivos-em-xsd}TData" minOccurs="0"/>
 *         &lt;element name="DadosCurso" type="{http://portal.mec.gov.br/diplomadigital/arquivos-em-xsd}TDadosCursoPorDecisaoJudicial"/>
 ...
 *         &lt;element name="DeclaracoesEmissoraAcercaProcesso" type="{http://portal.mec.gov.br/diplomadigital/arquivos-em-xsd}TDeclaracoesAcercaProcesso" minOccurs="0"/>
...
@XmlType(name = "TDadosDiplomaPorDecisaoJudicial", propOrder = {
    "diplomado",
    "dataConclusao",
    "dadosCurso",
    "dadosIesOriginalCursoPTA",
    "iesEmissora",
    "declaracoesEmissoraAcercaProcesso",
    "assinantes",
    "signature"
})
public class TDadosDiplomaPorDecisaoJudicial {

    @XmlElement(name = "Diplomado", required = true)
    protected TDadosDiplomadoPorDecisaoJudicial diplomado;
    @XmlElement(name = "DataConclusao")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar dataConclusao;
    @XmlElement(name = "DadosCurso", required = true)
    protected TDadosCursoPorDecisaoJudicial dadosCurso;
    ...
    @XmlElement(name = "DeclaracoesEmissoraAcercaProcesso")
    protected TDeclaracoesAcercaProcesso declaracoesEmissoraAcercaProcesso;
     ...
     * @return
     *     possible object is
     *     {@link TDadosDiplomadoPorDecisaoJudicial }
     *     
     */
    public TDadosDiplomadoPorDecisaoJudicial getDiplomado() {
        return diplomado;
    }
     ...
     *     
     */
    public void setDiplomado(TDadosDiplomadoPorDecisaoJudicial value) {
     ...
     * @return
     *     possible object is
     *     {@link TDadosCursoPorDecisaoJudicial }
     *     
     */
    public TDadosCursoPorDecisaoJudicial getDadosCurso() {
        return dadosCurso;
    }
     ...
     *     
     */
    public void setDadosCurso(TDadosCursoPorDecisaoJudicial value) {
    ...
    /**
     * Obtém o valor da propriedade declaracoesEmissoraAcercaProcesso.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public TDeclaracoesAcercaProcesso getDeclaracoesEmissoraAcercaProcesso() {
        return declaracoesEmissoraAcercaProcesso;
    }

    /**
     * Define o valor da propriedade declaracoesEmissoraAcercaProcesso.
     * 
     * @param value
     *     allowed object is
     *     {@link TDeclaracoesAcercaProcesso }
     *     
     */
    public void setDeclaracoesEmissoraAcercaProcesso(TDeclaracoesAcercaProcesso value) {
        this.declaracoesEmissoraAcercaProcesso = value;
    }
