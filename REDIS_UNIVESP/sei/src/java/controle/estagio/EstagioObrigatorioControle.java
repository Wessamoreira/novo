...
public class EstagioObrigatorioControle extends QuestionarioRespostaControle {
	...
	public void postConstructInicializarMenuEstagio() {
		try {
			...
			setPermiteIncluirEstagioAluno(ControleAcesso.verificarPermissaoOperacao("EstagioAluno", 1, getUsuarioLogado()));
		} catch (Exception e) {
	...
	public void inicializarOperacaoEstagioComDocumentoAssinadoEmLote() {
		try {	
			...
			setOncompleteModal("RichFaces.$('panelOperacoesEstagioEmLote').show();");
			inicializarMensagemVazia();
		} catch (Exception e) {
	...
	public void realizarInicioProgressBarOperacaoEstagioLote() {
		try {
			setOncompleteModal("RichFaces.$('panelOperacoesEstagioEmLote').hide();");
	...
	public void executarOperacaoEstagioEmLoteSelecionados() {
		try {
			...
			if (consistirException.existeErroListaMensagemErro()) {
				...
				setOncompleteModal("RichFaces.$('panelOperacoesEstagioEmLoteLogs').show();");
			} else {
	...
	public void realizarInicializacaoEstornoIndefericaoEstagio() {
		try {
			...
			setOncompleteModalEstagio("RichFaces.$('panelEstornoEstagio').show(); ");
		} catch (Exception e) {
			setOncompleteModalEstagio(Constantes.EMPTY);
			setMensagemDetalhada(MSG_TELA.msg_erro.name(), e.getMessage(), e, getUsuarioLogado(), "", "", true);
		}
...
//			}
	...
	public void scrollerListenerPessoaItem(DataScrollEvent dataScrollerEvent) {
		try {
			getDataModeloGrupoPessoaItem().setPaginaAtual(dataScrollerEvent.getPage());
			getDataModeloGrupoPessoaItem().setPage(dataScrollerEvent.getPage());
	...
	public void realizarPreVisualizacaoTermoEstagio() {
		try {
			...
			setOncompleteModalEstagio("RichFaces.$('panelVisualizarTermoEstagio').show(); ");
			inicializarMensagemVazia();
		} catch (Exception e) {
			setOncompleteModalEstagio(Constantes.EMPTY);
			setMensagemDetalhada(MSG_TELA.msg_erro.name(), e.getMessage(), e, getUsuarioLogado(), "", "", true);
	...
	public void isVerificarPermissaoDesabilitarRespostaChecklist() {
		try {
			if(getUsuarioLogado().isUsuarioFacilitador()){
				...
				ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComPerfilUsuarioVOEspecifico(PerfilAcessoPermissaoEstagioEnum.PERMITIR_RESPONDER_CHECKLIST_ESTAGIO_OBRIGATORIO, getUsuarioLogado());
				setDesabilitarRespostaChecklist(false);
			}
		} catch (Exception e) {
	...
	public void isPermiteEstornoIndeferimentoEstagio() {
		try {
			if(getUsuarioLogado().isUsuarioFacilitador()) {
				...
				ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComPerfilUsuarioVOEspecifico(PerfilAcessoPermissaoEstagioEnum.PERMITIR_ESTORNAR_INDEFERIMENTO_ESTAGIO_OBRIGATORIO, getUsuarioLogado());
				setPermitirEstornoIndeferimentoEstagio(true);
			}
		} catch (Exception e) {
	...
	public void isPermiteEstornoDeferimentoEstagio() {
		try {
			if(getUsuarioLogado().isUsuarioFacilitador()) {
				...
				ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComPerfilUsuarioVOEspecifico(PerfilAcessoPermissaoEstagioEnum.PERMITIR_ESTORNAR_DEFERIMENTO_ESTAGIO_OBRIGATORIO, getUsuarioLogado());
				setPermitirEstornoDeferimentoEstagio(true);
			}
		} catch (Exception e) {
	...
	public void isPermiteEstornoCorrecaoEstagio() {
		try {
			if(getUsuarioLogado().isUsuarioFacilitador()) {
				...
				ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComPerfilUsuarioVOEspecifico(PerfilAcessoPermissaoEstagioEnum.PERMITIR_ESTORNAR_CORRECAO_ESTAGIO_OBRIGATORIO, getUsuarioLogado());
				setPermitirEstornoCorrecaoEstagio(true);
			}
		} catch (Exception e) {
	...
	public void isPermitirDeferimentoEstagio() {
		try {
			if(getUsuarioLogado().isUsuarioFacilitador()) {
				...
				ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComPerfilUsuarioVOEspecifico(PerfilAcessoPermissaoEstagioEnum.PERMITIR_DEFERIMENTO_ESTAGIO_OBRIGATORIO, getUsuarioLogado());
				setPermitirDeferirEstagio(true);	
			}
		} catch (Exception e) {
	...
	public void isPermitirIndeferimentoEstagio() {
		try {
			if(getUsuarioLogado().isUsuarioFacilitador()) {
				...
				ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComPerfilUsuarioVOEspecifico(PerfilAcessoPermissaoEstagioEnum.PERMITIR_INDEFERIMENTO_ESTAGIO_OBRIGATORIO, getUsuarioLogado());
	...
	public void isPermiteCorrigirFormularioEstagio() {
		try {
			if(getUsuarioLogado().isUsuarioFacilitador()) {
				...
				ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComPerfilUsuarioVOEspecifico(PerfilAcessoPermissaoEstagioEnum.PERMITIR_CORRIGIR_FORMULARIO_ESTAGIO_OBRIGATORIO, getUsuarioLogado());
				setPermitirCorrigirFormularioEstagio(true);
			}
		} catch (Exception e) {
	...
	public void  inicializarDadosModalNotificarAssinaturaConcedente() {
		try {
			   ...
			   inicializarMensagemVazia();
			   setOncompleteModalEnviarNotificacaoAssinaturaConcedente("RichFaces.$('panelNotificarConcedenteAssinaturaPendente').show(); ");
		}catch (Exception e) {
			setMensagemDetalhada(MSG_TELA.msg_erro.name(), e.getMessage(), e, getUsuarioLogado(), "", "", true);
		}
	}
	...
	public void realizarNotificarPendenciaAssinatura() {
		try {			
			...
			setOncompleteModalEnviarNotificacaoAssinaturaConcedente("RichFaces.$('panelNotificarConcedenteAssinaturaPendente').hide(); ");
