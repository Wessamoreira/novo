...
public class RequerimentoControle extends HistoricoAlunoRelControle implements Serializable {
	...
	private List<RequerimentoResumoOperacaoLoteVO> resumoOperacaoLoteTransferenciaInternaPorUnidadeEnsino;
	private List<RequerimentoResumoOperacaoLoteVO> resumoOperacaoLoteTransferenciaInternaPorUnidadeEnsinoCurso;
	...
	public void executarVisualizacaoFichaAluno() throws Exception {
		...
		requ = getFacadeFactory().getRequerimentoFacade().consultarPorChavePrimaria(requ.getCodigo(), Uteis.NIVELMONTARDADOS_DADOSMINIMOS, getUsuarioLogado(), getConfiguracaoFinanceiroVO());
	...
	public void verificaPermissaoBotaoAproveitamentoTransfExter() {
		try {
			ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("Requerimento_ApresentarBotaoAproveitamento", getUsuarioLogado());
		...
		try {
			ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("Requerimento_ApresentarBotaoTransfExterna", getUsuarioLogado());
	...
	public void verificaPermissaoBotaoMatricula() {
		try {
			ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("Requerimento_ApresentarBotaoMatricula", getUsuarioLogado());
	...
	public List consultarMatriculaAluno() throws Exception {
		List listaResultado = getFacadeFactory().getMatriculaFacade().consultarMatriculaPorCodigoPessoa(getUsuarioLogado().getPessoa().getCodigo(), getUnidadeEnsinoLogado().getCodigo(), false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUsuarioLogado());
	...
	public String gravar() {
		try {
			...
			if(requerimentoVO.getTipoRequerimento().getIsTipoTransferenciaInterna() && requerimentoVO.getTipoRequerimento().getValidarVagasPorNumeroComputadoresUnidadeEnsino()) {
				getFacadeFactory().getRequerimentoFacade().persistirSicronizadoRequerimento(getRequerimentoVO(), getRequerimentoHistoricoVO(), Boolean.FALSE, getRequerimentoVO().getExigePagamento(), getConfiguracaoGeralPadraoSistema(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUnidadeEnsinoLogado(), getUsuarioLogado());
			}else {
				getFacadeFactory().getRequerimentoFacade().persistirRequerimento(getRequerimentoVO(), getRequerimentoHistoricoVO(), Boolean.FALSE, getRequerimentoVO().getExigePagamento(), getConfiguracaoGeralPadraoSistema(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUnidadeEnsinoLogado(), getUsuarioLogado());
			}
	...
	public void gravarVisaoAluno() throws Exception {
		...
		try {
			...
			if(requerimentoVO.getTipoRequerimento().getIsTipoTransferenciaInterna() && requerimentoVO.getTipoRequerimento().getValidarVagasPorNumeroComputadoresUnidadeEnsino()) {
				getFacadeFactory().getRequerimentoFacade().persistirSicronizadoRequerimento(getRequerimentoVO(), getRequerimentoHistoricoVO(), Boolean.TRUE, getRequerimentoVO().getExigePagamento(), getConfiguracaoGeralPadraoSistema(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUnidadeEnsinoLogado(), getUsuarioLogado());
			}else {
				getFacadeFactory().getRequerimentoFacade().persistirRequerimento(getRequerimentoVO(), getRequerimentoHistoricoVO(), Boolean.TRUE, getRequerimentoVO().getExigePagamento(), getConfiguracaoGeralPadraoSistema(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUnidadeEnsinoLogado(), getUsuarioLogado());
			}
				if (getRequerimentoVO().getTipoRequerimento().getMensagemAlerta().trim().isEmpty()) {
		...
		try {
			if (requerimentoVO.getSituacaoFinanceira().equals("PE")) {
				...
				if (requerimentoVO.isNovoObj().booleanValue()) {
					getFacadeFactory().getRequerimentoFacade().incluir(requerimentoVO, getUsuarioLogado(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getConfiguracaoGeralPadraoSistema());
				} else {
	...
	public String registrarRecebimentoDoc() {
		try {
			...
			getFacadeFactory().getRequerimentoFacade().registrarRecebimentoDoc(requerimentoVO, getUsuarioLogado(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getConfiguracaoGeralPadraoSistema());
	...
	public String receberBoleto() {
		try {
			if (getRequerimentoVO().getSituacaoFinanceira().equals("PE")) {
				getFacadeFactory().getRequerimentoFacade().receberBoleto(requerimentoVO, getUsuarioLogado(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getConfiguracaoGeralPadraoSistema());
				requerimentoVO.setSituacao("EX");
				ContaReceberVO contaReceberVO;
				contaReceberVO = getFacadeFactory().getContaReceberFacade().consultarPorChavePrimaria(requerimentoVO.getContaReceber(), false, Uteis.NIVELMONTARDADOS_TODOS, getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUsuarioLogado());
...
//					MatriculaPeriodoVO matPer = getFacadeFactory().getMatriculaPeriodoFacade().consultaUltimaMatriculaPeriodoPorMatriculaConsultaBasica(visaoAluno.getMatricula().getMatricula(), false, Uteis.NIVELMONTARDADOS_TODOS, configuracaoFinanceiroVO, getUsuarioLogado());
	...
	public String excluir() {
		try {
			...
			if (getIsPermiteExcluir()) {
				getFacadeFactory().getRequerimentoFacade().excluir(requerimentoVO, getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUsuarioLogado(), getConfiguracaoGeralPadraoSistema(), true);
				if(getUsuarioLogado().getIsApresentarVisaoAluno() || getUsuarioLogado().getIsApresentarVisaoPais()) {
					novoVisaoAluno();
				}else {
					novo();
...
//			}
			...
			// getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUsuarioLogado());
	 ...
	 * apresentados no ComboBox correspondente
	 */
	public List consultarContaCorrenteComboBox() throws Exception {
		List lista = getFacadeFactory().getContaCorrenteFacade().consultarContaCorrenteComboBox(getUsuarioLogado().getCodigo(), false, getUsuarioLogado());
		return lista;
	}
	...
	public void deferirEspecifico(RequerimentoVO requerimentoVO, boolean retornarExcecao) throws Exception {
		...
		try {
			...
			getRequerimentoVO().getTipoRequerimento().setTipoRequerimentoDepartamentoVOs(getFacadeFactory().getTipoRequerimentoDepartamentoFacade().consultarPorCodigoTipoRequerimento(getRequerimentoVO().getTipoRequerimento().getCodigo(), false, getUsuarioLogado()));
			setRequerimentoHistoricoVO(getFacadeFactory().getRequerimentoFacade().realizarVerificacaoRequerimentoHistoricoAtualPossueQuestionarioResponder(getRequerimentoVO(), getUsuarioLogado()));
			getFacadeFactory().getRequerimentoFacade().deferirRequerimento(getRequerimentoVO(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()),getRequerimentoHistoricoVO(),getUsuarioLogado());
			this.enviarEmailAlunoSobreTramiteRequerimento();
	...
	public void verificarExisteSolicitacaoRequerimento() throws Exception {
		if (getRequerimentoVO().getTipoRequerimento().getTipo().equals("CA") || getRequerimentoVO().getTipoRequerimento().getTipo().equals("TR") || getRequerimentoVO().getTipoRequerimento().getTipo().equals("RM") || getRequerimentoVO().getTipoRequerimento().getTipo().equals("TI")) {
			getFacadeFactory().getRequerimentoFacade().verificarExisteSolicitacaoRequerimento(getRequerimentoVO(), getUsuarioLogado(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()));
		}
	}
...
//				getAplicacaoControle().realizarEscritaTextoDebug(AssuntoDebugEnum.GERAL, "requerimentoOperacaoLote"+ getUsuarioLogado().getUsername());
				...
				getFacadeFactory().getRequerimentoFacade().realizarGeracaoResumoOperacaoLote(((List<RequerimentoVO>) getControleConsultaOtimizado().getListaConsulta()), getRequerimentoConsVO().getTipoRequerimento(), getResumoOperacaoLoteTransferenciaInternaPorUnidadeEnsino(), getResumoOperacaoLoteTransferenciaInternaPorUnidadeEnsinoCurso());
...
//			getAplicacaoControle().realizarEscritaTextoDebug(AssuntoDebugEnum.GERAL, "consultarOtimizadoRequerimento1"+ getUsuarioLogado().getUsername());
	...
	public void imprimirDeclaracaoVisaoAluno(ImpressaoContratoVO contratoGravar, RequerimentoVO requerimento, Boolean persistirDocumentoAssinado, ConfiguracaoGeralSistemaVO config) throws Exception {		
			...
			if(texto.getTipo().equals("CE") && requerimento.getTipoRequerimento().getIsCertificadoModular()){
				...
				setCaminhoRelatorio(getFacadeFactory().getRequerimentoFacade().realizarImpressaoDeclaracaoRequerimento(requerimento, contratoGravar, contratoGravar, getConfiguracaoGeralPadraoSistema(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(requerimento.getUnidadeEnsino().getCodigo()), texto, persistirDocumentoAssinado, getUsuarioLogado()));
			}
	...
	public void realizarRecebimentoCartaoCredito() {
		...
		try {
			...
			getFacadeFactory().getNegociacaoRecebimentoFacade().realizarRecebimentoCartaoCreditoMatriculaRenovacaoOnline(getNegociacaoRecebimentoVO(), getNegociacaoRecebimentoVO().getMatricula(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUsuarioLogado());
			...
			setRequerimentoVO(getFacadeFactory().getRequerimentoFacade().consultarPorChavePrimaria(getRequerimentoVO().getCodigo(), Uteis.NIVELMONTARDADOS_TODOS, getUsuarioLogado(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo())));
	...
	public void consultarContaReceberAlunoRequerimento() {
		try {
			...
			contaReceberVO = getFacadeFactory().getContaReceberFacade().consultarPorChavePrimaria(getRequerimentoVO().getContaReceber(), false, Uteis.NIVELMONTARDADOS_TODOS, getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUsuarioLogado());
			...
			contaReceberNegociacaoRecebimentoVO.setValorTotal(contaReceberVO.getCalcularValorFinal(getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUsuarioLogado()));
	...
	public void realizarRecebimentoBoletoBancario() {
		try {
			List<BoletoBancarioRelVO> boletoBancarioRelVOs = getFacadeFactory().getBoletoBancarioRelFacade().emitirRelatorioLista(false, getRequerimentoVO().getContaReceber(), getRequerimentoVO().getMatricula().getMatricula(), "", "", "", 0, 0, null, null, 0, "aluno", 0, getUsuarioLogado(), "boletoAluno", 0, getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUsuarioLogado().getPessoa().getCodigo(), false, null, null);
	...
	public void realizarAlteracaoRequerimentoParaEmExecucao() throws Exception{
		UsuarioVO usuarioVerif = ControleAcesso.verificarLoginUsuario(getUsuarioLiberarOperacaoFuncionalidade(), getSenhaLiberarOperacaoFuncionalidade(), true, Uteis.NIVELMONTARDADOS_TODOS);
		ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("PermitirVoltarRequerimentoExecucao", usuarioVerif);
...
//		setRequerimentoVO(null);
	...
	public void montarUltimaMatriculaPeriodoAluno() {
		if(Uteis.isAtributoPreenchido(getRequerimentoVO().getMatricula().getMatricula()) && !Uteis.isAtributoPreenchido(getRequerimentoVO().getMatriculaPeriodoVO())) {
			try {
				...
				getRequerimentoVO().setMatriculaPeriodoVO(getFacadeFactory().getMatriculaPeriodoFacade().consultarUltimaMatriculaPeriodoAtivaPorMatricula(getRequerimentoVO().getMatricula().getMatricula(), false, Uteis.NIVELMONTARDADOS_TODOS, getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUsuarioLogado()));				
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public void autenticarUsuario() {
		try {
            UsuarioVO usuarioVerif = ControleAcesso.verificarLoginUsuario(this.getUsuarioLiberarRequerimentoForaDoPrazo().getUsername(), this.getUsuarioLiberarRequerimentoForaDoPrazo().getSenha(), true, Uteis.NIVELMONTARDADOS_TODOS);
	...
	public void verificarPermissaoAbrirRequerimentoForaDoPrazo(UsuarioVO usuario){
		try {
			ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("PermitirAbrirRequerimentoForaPrazo", usuario);
	...
	public void verificarPermissaoEnviarDepartamentoAnterior() {
		try {
			ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("Requerimento_PermitirEnviarDepartamentoAnterior", getUsuarioLogado());
			if (getRequerimentoVO().getCodigo().intValue() > 0) {
	...
	public Boolean getPermiteDeferir() {
		if(permiteDeferir == null){
			try{
				Requerimento.excluir("Requerimento_PermitirDeferir", getUsuarioLogado());
				permiteDeferir = true;
			}catch(Exception e){
	...
	public Boolean getPermiteIndeferir() {
		if(permiteIndeferir == null){
			try{
				Requerimento.excluir("Requerimento_PermitirIndeferir", getUsuarioLogado());
	...
	public Boolean getPermiteImprimirComprovante() {
		if(permiteImprimirComprovante == null){
			try{
				Requerimento.excluir("Requerimento_PermitirImprimirComprovante", getUsuarioLogado());
	...
	public Boolean getPermiteImprimirRequerimento() {
		if(permiteImprimirRequerimento == null){
			try{
				Requerimento.excluir("Requerimento_PermitirImprimirRequerimento", getUsuarioLogado());
	...
	public Boolean getPermiteExcluir() {
		if(permiteExcluir == null){	
				try{
					Requerimento.excluir("Requerimento", getUsuarioLogado());
					permiteExcluir = true;
				}catch(Exception e){
	...
	public Boolean getPermiteNovo() {
		if(permiteNovo == null){
			try{
				if(getRequerimentoVO().isNovoObj()){
					Requerimento.incluir("Requerimento", getUsuarioLogado());
				}
				permiteNovo = true;
			}catch(Exception e){
				permiteNovo = false;
		...
		if(permiteGravar == null){
			try{
				if(getRequerimentoVO().isNovoObj()){
					...
					Requerimento.alterar("Requerimento", getUsuarioLogado());
				}
				permiteGravar = true;
			}catch(Exception e){
				permiteGravar = false;
	...
	public Boolean getPermiteIncluirDisciplina() {
		if(permiteIncluirDisciplina == null){
			try{
				ControleAcesso.incluir("InclusaoExclusaoDisciplina", getUsuarioLogado());
	...
	public Boolean getPermiteIniciarRequerimento() {
		if(permiteIniciarRequerimento == null){
			try{
				ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("Requerimento_ApresentarIniciarRequerimento", getUsuarioLogado());
	...
	public Boolean getPermiteConsultar() {
		if(permiteConsultar == null){
			try{
				Requerimento.consultar("Requerimento", true, getUsuarioLogado());
...
//			FacesContext.getCurrentInstance().responseComplete();
	...
	public void realizarAutorizacaoPagamentoRequerimento() {		
		if(getPermitirAutorizarPagamento()) {
			...
			try {
				...
				Requerimento.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("RequerimentoPermitirAutorizarPagamento", usuarioVO);
	...
	public void realizarAutorizacaoPagamentoRequerimentoComUsuario(UsuarioVO usuarioVO) {
		try {
			getFacadeFactory().getRequerimentoFacade().realizarAutorizacaoPagamentoRequerimento(getRequerimentoVO(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), usuarioVO);
	...
	public void realizarDeferimentoSolicitacaoIsencaoTaxa() {
		if(getPermitirUsuarioDeferirIndeferirSolicitacaoIsencaoTaxa()) {
			...
			try {
				UsuarioVO usuarioVO = Requerimento.verificarLoginUsuario(usuarioLiberarOperacaoFuncionalidade, senhaLiberarOperacaoFuncionalidade, true, Uteis.NIVELMONTARDADOS_TODOS);
				Requerimento.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("Requerimento_permitirUsuarioDeferirIndeferirSolicitacaoIsencaoTaxa", usuarioVO);
	...
	private void gravarDeferimentoIndeferimentoSolicitacaoIsencaoTaxa(SituacaoSolicitacaoIsencaoTaxaRequerimentoEnum situacaoSolicitacaoIsencaoTaxaRequerimentoEnum, UsuarioVO usuarioVO) {
		try{
			...
			getFacadeFactory().getRequerimentoFacade().realizarRegistroDeferimentoIndeferimentoSolicitacaoIsencaoTaxa(getRequerimentoVO(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), usuarioVO);
	...
	public Boolean getPermitirUsuarioDeferirIndeferirSolicitacaoIsencaoTaxa() {
		if (permitirUsuarioDeferirIndeferirSolicitacaoIsencaoTaxa == null) {			
			try{
				ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("Requerimento_permitirUsuarioDeferirIndeferirSolicitacaoIsencaoTaxa", getUsuarioLogado());
	...
	public void selecionarTurmaReposicao() {
		try {
			...
			getFacadeFactory().getRequerimentoFacade().realizarValidacaoChoqueHorarioEVagaTurmaRequerimentoReposicao(getRequerimentoVO(), getConfiguracaoFinanceiroPrevilegiandoUnidadeEnsino(getRequerimentoVO().getUnidadeEnsino().getCodigo()), getUsuarioLogado());			
	...
	public void realizarVerificacaoPermissaoConsultarRequerimentosProprioUsuario() {
		try {
			ControleAcesso.verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("RequerimentoPermitirConsultarIncluirRequerimentoApenasProprioUsuario", getUsuarioLogado());
	...
	public void verificarPermissaoAlterarObservacaoIncluidaPeloRequerente() {
		try {
			 if(ControleAcesso.verificarPermissaoFuncionalidadeUsuario("RequerimentoPermitirAlterarObservacaoIncluidaPeloRequerente", getUsuarioLogado())) {
	...
	public void verificarPermissaoRequerenteAnexarArquivo() {
		try {
			 if(ControleAcesso.verificarPermissaoFuncionalidadeUsuario("RequerimentoPermitirRequerenteAnexarArquivo", getUsuarioLogado())) {
	...
	public void verificarPermissaoRequerenteVisualizarTramite() {
		try {
			 if(ControleAcesso.verificarPermissaoFuncionalidadeUsuario("RequerimentoPermitirRequerenteVisualizarTramite", getUsuarioLogado())) {
	...
	public void verificarPermissaoRequerenteInteragirTramite() {
		try {
			 if(ControleAcesso.verificarPermissaoFuncionalidadeUsuario("RequerimentoPermitirRequerenteInteragirTramite", getUsuarioLogado())) {
