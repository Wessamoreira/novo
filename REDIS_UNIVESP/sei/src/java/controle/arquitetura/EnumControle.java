...
import negocio.comuns.academico.enumeradores.*;
...
import negocio.comuns.compras.FornecedorVO.enumCampoConsultaFornecedor;
...
import negocio.comuns.crm.enumerador.MotivoInsucessoEnum;
...
import negocio.comuns.crm.enumerador.tipoConsulta.TipoConsultaComboCampanhaEnum;
...
import negocio.comuns.faturamento.nfe.NaturezaOperacaoVO.enumCampoConsultaNaturezaOperacao;
import negocio.comuns.faturamento.nfe.NotaFiscalEntradaVO.enumCampoConsultaNotaFiscalEntrada;
import negocio.comuns.faturamento.nfe.enumeradores.CSTPISCOFINSEnum;
...
import negocio.comuns.financeiro.CentroResultadoVO.enumCampoConsultaCentroResultado;
import negocio.comuns.financeiro.ContaPagarVO.enumCampoConsultaContaPagar;
...
import negocio.comuns.recursoshumanos.enumeradores.TipoPensaoDependenteEnum;
...
public class EnumControle extends SuperControle implements Serializable {
	...
	public List<SelectItem> getComboboxTipoSituacaoReferenteVagaEnum() {

		if (tipoSituacaoReferenteVagaEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			tipoSituacaoReferenteVagaEnum = montarCombobox(SituacaoReferenteVagaEnum.values(), Obrigatorio.NAO);
		}
		return tipoSituacaoReferenteVagaEnum;
	}

	public List<SelectItem> getComboboxTipoUploadEnum() {

		if (tipoUploadEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			tipoUploadEnum = montarCombobox(TipoUploadEnum.values(), Obrigatorio.SIM);
		}
		return tipoUploadEnum;
	}
	...
	public List<SelectItem> getComboboxNivelExperienciaCargoEnum() {

		if (comboboxNivelExperienciaCargoEnumPt == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxNivelExperienciaCargoEnumPt = montarCombobox(NivelExperienciaCargoEnum.values(), Obrigatorio.NAO);
		}
		return comboboxNivelExperienciaCargoEnumPt;
	}

	public List<SelectItem> getTipoConsultaComboMetaEnum() {
		// List<SelectItem> lista = new ArrayList<SelectItem>(0);
		// if (validarLocalidade("en", "US")) {
		// if (tipoConsultaComboMetaEnumEn == null) {
		// tipoConsultaComboMetaEnumEn =
		// montarCombobox(TipoConsultaComboMetaEnum.values(),
		// ObrigatorioEnum.NAO);
		// }
		// }
		// if (validarLocalidadeDefault("pt", "BR")) {
		if (tipoConsultaComboMetaEnumPt == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			tipoConsultaComboMetaEnumPt = montarCombobox(TipoConsultaComboMetaEnum.values(), Obrigatorio.SIM);
		}
		// }
		return tipoConsultaComboMetaEnumPt;
	}

	public List<SelectItem> getComboboxTipoMetaEnum() {
		// List<SelectItem> lista = new ArrayList<SelectItem>(0);
		// if (validarLocalidade("en", "US")) {
		// if (comboboxTipoMetaEnumEn == null) {
		// comboboxTipoMetaEnumEn = montarCombobox(TipoMetaEnum.values(),
		// ObrigatorioEnum.NAO);
		// }
		// }
		// if (validarLocalidadeDefault("pt", "BR")) {
		// if (comboboxTipoMetaEnumPt == null) {
		// comboboxTipoMetaEnumPt = montarCombobox(TipoMetaEnum.values(),
		// ObrigatorioEnum.NAO);
		// }
		// }
		if (comboboxTipoMetaEnumPt == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoMetaEnumPt = montarCombobox(TipoMetaEnum.values(), Obrigatorio.NAO);
		}
		// }
		return comboboxTipoMetaEnumPt;
	}
	...
	public List<SelectItem> getComboboxTipoCompromissoEnum() {

		if (comboboxTipoCompromissoEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoCompromissoEnum = montarCombobox(TipoCompromissoEnum.values(), Obrigatorio.SIM);
		}
		return comboboxTipoCompromissoEnum;
	}

	public List<SelectItem> getComboboxTipoContatoEnum() {

		if (comboboxTipoContatoEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoContatoEnum = montarCombobox(TipoContatoEnum.values(), Obrigatorio.NAO);
		}
		return comboboxTipoContatoEnum;
	}
	...
	public List<SelectItem> getTipoConsultaComboWorkflowEnum() {
		// List<SelectItem> lista = new ArrayList<SelectItem>(0);
		// if (validarLocalidade("en", "US")) {
		// if (tipoConsultaComboWorkflowEnumEn == null) {
		// tipoConsultaComboWorkflowEnumEn =
		// montarCombobox(TipoConsultaComboWorkflowEnum.values(),
		// ObrigatorioEnum.NAO);
		// }
		// }

		if (tipoConsultaComboWorkflowEnumPt == null) {
			tipoConsultaComboWorkflowEnumPt = montarCombobox(TipoConsultaComboWorkflowEnum.values(), Obrigatorio.NAO);
		}

		return tipoConsultaComboWorkflowEnumPt;
	}

	public List<SelectItem> getTipoConsultaComboCursoInteresseEnum() {
		if (tipoConsultaComboCursoInteresseEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			tipoConsultaComboCursoInteresseEnum = montarCombobox(TipoConsultaComboCursoInteresseEnum.values(), Obrigatorio.SIM);
		}
		return tipoConsultaComboCursoInteresseEnum;
	}

	public List<SelectItem> getTipoConsultaComboProspectsEnum() {
		if (tipoConsultaComboProspectsEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			tipoConsultaComboProspectsEnum = montarCombobox(TipoConsultaComboProspectsEnum.values(), Obrigatorio.SIM);
		}
		return tipoConsultaComboProspectsEnum;
	}

	public List<SelectItem> getComboboxRendaProspectEnum() {
		if (comboboxRendaProspectEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxRendaProspectEnum = montarCombobox(RendaProspectEnum.values(), Obrigatorio.NAO);
		}
		return comboboxRendaProspectEnum;
	}

	public List<SelectItem> getComboboxFormacaoAcademicaProspectEnum() {
		if (comboboxFormacaoAcademicaProspectEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxFormacaoAcademicaProspectEnum = montarCombobox(FormacaoAcademicaProspectEnum.values(), Obrigatorio.NAO);
		}
		return comboboxFormacaoAcademicaProspectEnum;
	}

	public List<SelectItem> getComboboxTipoEmpresaProspectEnum() {
		if (comboboxTipoEmpresaProspectEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoEmpresaProspectEnum = montarCombobox(TipoEmpresaProspectEnum.values(), Obrigatorio.NAO);
		}
		return comboboxTipoEmpresaProspectEnum;
	}

	public List<SelectItem> getComboboxTipoProspectEnum() {
		if (comboboxTipoProspectEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoProspectEnum = montarCombobox(TipoProspectEnum.values(), Obrigatorio.NAO);
		}
		return comboboxTipoProspectEnum;
	}
	...
	public List<SelectItem> getComboboxSexoEnum() {
		if (comboboxSexoEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxSexoEnum = montarCombobox(SexoEnum.values(), Obrigatorio.NAO);
		}
	...
	public List<SelectItem> getTipoCampanhaEnum() {
		if (tipoCampanhaEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			tipoCampanhaEnum = montarCombobox(TipoCampanhaEnum.values(), Obrigatorio.SIM);
		}
		return tipoCampanhaEnum;
	}

	public List<SelectItem> getTipoOrigemCadastroProspectEnum() {
		if (tipoOrigemCadastroProspectEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			tipoOrigemCadastroProspectEnum = montarCombobox(TipoOrigemCadastroProspectEnum.values(), Obrigatorio.SIM);
		}
		return tipoOrigemCadastroProspectEnum;
	}

	public List<SelectItem> getTipoSituacaoWorkflowEnum() {
		if (tipoSituacaoWorkflowEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			tipoSituacaoWorkflowEnum = montarCombobox(TipoSituacaoWorkflowEnum.values(), Obrigatorio.SIM);
		}
	...
	public List<SelectItem> getComboboxTipoNaturezaOperacaoEnum() {
		if (comboboxTipoNaturezaOperacaoEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoNaturezaOperacaoEnum = montarCombobox(TipoNaturezaOperacaoEnum.values(), Obrigatorio.SIM);
		}

		return comboboxTipoNaturezaOperacaoEnum;
	}
	...
	public List<SelectItem> getComboboxTipoProdutoServicoEnum() {
		if (comboboxTipoProdutoServicoEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoProdutoServicoEnum = montarCombobox(TipoProdutoServicoEnum.values(), Obrigatorio.SIM);
		}

		return comboboxTipoProdutoServicoEnum;
	}

	public List<SelectItem> getComboboxTipoNotaFiscalEntradaEnum() {
		if (comboboxTipoNotaFiscalEntradaEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoNotaFiscalEntradaEnum = montarCombobox(TipoNotaFiscalEntradaEnum.values(), Obrigatorio.SIM);
		}

		return comboboxTipoNotaFiscalEntradaEnum;
	}

	public List<SelectItem> getComboboxTipoOrigemDestinoNaturezaOperacaoEnum() {
		if (comboboxTipoOrigemDestinoNaturezaOperacaoEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoOrigemDestinoNaturezaOperacaoEnum = montarCombobox(TipoOrigemDestinoNaturezaOperacaoEnum.values(), Obrigatorio.SIM);
		}

		return comboboxTipoOrigemDestinoNaturezaOperacaoEnum;
	}	
	...
	public List<SelectItem> getComboboxTipoAutorizacaoRequisicaoEnum() {
		if (comboboxTipoAutorizacaoRequisicaoEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoAutorizacaoRequisicaoEnum = montarCombobox(TipoAutorizacaoRequisicaoEnum.values(), Obrigatorio.SIM);
		}
		
		return comboboxTipoAutorizacaoRequisicaoEnum;
	}

	public List<SelectItem> getComboboxTipoCriacaoContaPagarEnum() {
		if (comboboxTipoCriacaoContaPagarEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxTipoCriacaoContaPagarEnum = montarCombobox(TipoCriacaoContaPagarEnum.values(), Obrigatorio.SIM);
		}

		return comboboxTipoCriacaoContaPagarEnum;
	}
	...
	public List<SelectItem> getTipoConsultaComboCampanhaEnum() {
		if (tipoConsultaComboCampanhaEnumPt == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			tipoConsultaComboCampanhaEnumPt = montarCombobox(TipoConsultaComboCampanhaEnum.values(), Obrigatorio.SIM);
		}
		return tipoConsultaComboCampanhaEnumPt;
	}

	public List<SelectItem> getComboboxControleSituacaoProspectPipelineEnum() {
		if (comboboxControleSituacaoProspectPipelineEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxControleSituacaoProspectPipelineEnum = montarCombobox(SituacaoProspectPipelineControleEnum.values(), Obrigatorio.NAO);
		}
		return comboboxControleSituacaoProspectPipelineEnum;
	}

	public List<SelectItem> getTipoInteracaoEnum() {
		if (tipoInteracaoEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			tipoInteracaoEnum = montarCombobox(TipoInteracaoEnum.values(), Obrigatorio.SIM);
		}
		return tipoInteracaoEnum;
	}

	public List<SelectItem> getComboboxMotivoInsucessoEnum() {
		if (comboboxMotivoInsucessoEnum == null || !getLocale().equals(localeCombobox)) {
			localeCombobox = getLocale();
			comboboxMotivoInsucessoEnum = montarCombobox(MotivoInsucessoEnum.values(), Obrigatorio.NAO);
		}
		return comboboxMotivoInsucessoEnum;
	}

	public List<SelectItem> getTipoConsultaComboConfiguracaoRankingEnum() {
		if (tipoConsultaComboConfiguracaoRankingEnumPt == null) {
			tipoConsultaComboConfiguracaoRankingEnumPt = montarCombobox(TipoConsultaComboConfiguracaoRankingEnum.values(), Obrigatorio.NAO);
		}

		return tipoConsultaComboConfiguracaoRankingEnumPt;
	}
	...
	public List<SelectItem> getComboboxFormaEntradaPatrimonioEnum() {
		if (comboboxFormaEntradaPatrimonioEnum == null) {
			comboboxFormaEntradaPatrimonioEnum = UtilPropriedadesDoEnum.getListaSelectItemDoEnum(FormaEntradaPatrimonioEnum.class, "name", "valorApresentar", true);
		}
		return comboboxFormaEntradaPatrimonioEnum;
	}
	...
	public List<SelectItem> getComboboxSexoEnumCrm() {
		if (comboboxSexoEnumCrm == null) {
			comboboxSexoEnumCrm = new ArrayList<SelectItem>(0);
			comboboxSexoEnumCrm.add(new SelectItem("", ""));
			comboboxSexoEnumCrm.add(new SelectItem(SexoEnum.F.name(), "Feminino"));
			comboboxSexoEnumCrm.add(new SelectItem(SexoEnum.M.name(), "Masculino"));
		}
		return comboboxSexoEnumCrm;
	}
	...
	public List<SelectItem> getComboboxTipoSituacaoWorkflowEnum() {
		if (comboboxTipoSituacaoWorkflowEnum == null) {
			comboboxTipoSituacaoWorkflowEnum = UtilPropriedadesDoEnum.getListaSelectItemDoEnum(TipoSituacaoWorkflowEnum.class, false);
		}
		return comboboxTipoSituacaoWorkflowEnum;
	}
	...
	public List<SelectItem> getComboboxCSTPISCOFINSEnum() {
		if (comboboxCSTPISCOFINSEnum == null) {
			comboboxCSTPISCOFINSEnum = UtilPropriedadesDoEnum.getListaSelectItemDoEnum(CSTPISCOFINSEnum.class, "valorApresentar", "valorApresentar", false);
		}
		return comboboxCSTPISCOFINSEnum;
	}
	...
	public List<SelectItem> getComboboxTipoGeracaoIntegracaoContabilEnum() {
		if (comboboxTipoGeracaoIntegracaoContabilEnum == null) {
			comboboxTipoGeracaoIntegracaoContabilEnum = montarCombobox(TipoGeracaoIntegracaoContabilEnum.values(), Obrigatorio.SIM);
		}
		return comboboxTipoGeracaoIntegracaoContabilEnum;
	}
	...
	public List<SelectItem> getTipoConsultaComboCentroResultado() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(enumCampoConsultaCentroResultado.DESCRICAO_CENTRO_RESULTADO.name(), "Descrição Centro Resultado"));
		itens.add(new SelectItem(enumCampoConsultaCentroResultado.IDENTIFICADOR_CENTRO_RESULTADO.name(), "Identificador Centro Resultado"));
		itens.add(new SelectItem(enumCampoConsultaCentroResultado.DESCRICAO_CENTRO_RESULTADO_SUPERIOR.name(), "Descrição Centro Resultado Superior"));
		return itens;
	}

	public List<SelectItem> getTipoConsultaComboNaturezaOperacao() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(enumCampoConsultaNaturezaOperacao.NOME.name(), "Nome"));
		itens.add(new SelectItem(enumCampoConsultaNaturezaOperacao.CODIGONATUREZAOPERACAO.name(), "Código Natureza Operação"));
		itens.add(new SelectItem(enumCampoConsultaNaturezaOperacao.TIPONATURECAOPERACAO.name(), "Tipo Natureza Operação"));
		itens.add(new SelectItem(enumCampoConsultaNaturezaOperacao.CODIGO.name(), "Código"));
		return itens;
	}

	public List<SelectItem> getTipoConsultaComboFornecedor() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(enumCampoConsultaFornecedor.NOME.name(), "Nome"));
		itens.add(new SelectItem(enumCampoConsultaFornecedor.RAZAOSOCIAL.name(), "Razão Social"));
		itens.add(new SelectItem(enumCampoConsultaFornecedor.CPF.name(), "CPF"));
		itens.add(new SelectItem(enumCampoConsultaFornecedor.CNPJ.name(), "CNPJ"));
		itens.add(new SelectItem(enumCampoConsultaFornecedor.RG.name(), "RG"));
		return itens;
	}
	...
	public List<SelectItem> getTipoConsultaComboCategoriaDespesa() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(enumCampoConsultaCategoriaDespesa.DESCRICAO.name(), "Descrição"));
		itens.add(new SelectItem(enumCampoConsultaCategoriaDespesa.IDENTIFICADOR_CENTRO_DESPESA.name(), "Identificador Centro Despesa"));
		return itens;
	}
	
	public List<SelectItem> getTipoConsultaComboContaPagar() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(enumCampoConsultaContaPagar.FAVORECIDO.name(), "Favorecido - Período"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.NUMERO_NOTA_FISCAL_ENTRADA.name(), "Nº Nota Fiscal Entrada"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.CODIGO.name(), "Número (Código)"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.CATEGORIA_DESPESA.name(), "Categoria de Despesa"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.CODIGO_PAGAMENTO.name(), "Código do Pagamento"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.TURMA.name(), "Turma"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.DEPARTAMENTO.name(), "Departamento"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.NR_DOCUMENTO.name(), "Nrº Documento"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.CNPJ_FORNECEDOR.name(), "CNPJ Fornecedor"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.CODIGO_NOTA_FISCAL_ENTRADA.name(), "Código Nota Fiscal Entrada"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.VALOR.name(), "Valor"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.FAIXA_VALOR.name(), "Faixa de Valor"));
		itens.add(new SelectItem(enumCampoConsultaContaPagar.CODIGO_CONTRATO_DESPESA.name(), "Código Contrato de Despesa"));
		
		return itens;
		
	}
	
	public List<SelectItem> getComboboxTipoConsultaGestaoContasPagar() {
		if(comboboxTipoConsultaGestaoContasPagar == null) {
			comboboxTipoConsultaGestaoContasPagar = new ArrayList<>();
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.FAVORECIDO.name(), "Favorecido"));
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.CPF_FAVORECIDO.name(), "CPF Favorecido"));
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.CNPJ_FORNECEDOR.name(), "CNPJ Favorecido"));
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.TIPO_ORIGEM.name(), "Tipo Origem"));
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.NR_DOCUMENTO.name(), "Nrº Documento"));
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.CODIGO.name(), "Número (Código)"));
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.CODIGO_PAGAMENTO.name(), "Código do Pagamento"));
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.TURMA.name(), "Turma"));
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.DEPARTAMENTO.name(), "Departamento"));
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.NUMERO_NOTA_FISCAL_ENTRADA.name(), "Nº Nota Fiscal Entrada"));
			comboboxTipoConsultaGestaoContasPagar.add(new SelectItem(enumCampoConsultaContaPagar.CODIGO_NOTA_FISCAL_ENTRADA.name(), "Código Nota Fiscal Entrada"));
		}
		return comboboxTipoConsultaGestaoContasPagar;
	}
	...
	public List<SelectItem> getTipoConsultaComboNotaFiscalEntrada() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(enumCampoConsultaNotaFiscalEntrada.NUMERO.name(), "Número"));
		itens.add(new SelectItem(enumCampoConsultaNotaFiscalEntrada.FORNECEDOR.name(), "Fornecedor"));
		itens.add(new SelectItem(enumCampoConsultaNotaFiscalEntrada.UNIDADEENSINO.name(), "Unidade Ensino"));
		itens.add(new SelectItem(enumCampoConsultaNotaFiscalEntrada.CODIGO.name(), "Código"));
	...
	public List<SelectItem> getComboboxLocalIncidenciaEnum() {
		if (comboboxLocalIncidenciaEnum == null)
			comboboxLocalIncidenciaEnum = montarCombobox(LocalIncidenciaEnum.values(), Obrigatorio.SIM);
		return comboboxLocalIncidenciaEnum;
	}
	...
	public List<SelectItem> getComboboxTipoLancamentoFolhaPagamentoEnum() {
		if (comboboxTipoLancamentoFolhaPagamentoEnum == null) {
			comboboxTipoLancamentoFolhaPagamentoEnum = new ArrayList<>();
			comboboxTipoLancamentoFolhaPagamentoEnum.add(new SelectItem("TODOS", "Todos"));	

			comboboxTipoLancamentoFolhaPagamentoEnum.addAll(montarCombobox(TipoLancamentoFolhaPagamentoEnum.values(), Obrigatorio.SIM));
		}
		
		return comboboxTipoLancamentoFolhaPagamentoEnum;
	}

	public List<SelectItem> getComboboxTipoEventoFolhaPagamentoEnum() {
		if (comboboxTipoEventoFolhaPagamentoEnum == null)
			comboboxTipoEventoFolhaPagamentoEnum = montarCombobox(TipoEventoFolhaPagamentoEnum.values(), Obrigatorio.SIM);
		return comboboxTipoEventoFolhaPagamentoEnum;
	}
	...
	public List<SelectItem> getTipoConsultaComboEventoFixoCargoFuncionario() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaEventoFixoCargoFuncionario.FUNCIONARIO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_Funcionario")));
		itens.add(new SelectItem(EnumCampoConsultaEventoFixoCargoFuncionario.MATRICULA_FUNCIONARIO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_MatriculaFuncionario")));
		itens.add(new SelectItem(EnumCampoConsultaEventoFixoCargoFuncionario.MATRICULA_CARGO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_MatriculaCargo")));
		itens.add(new SelectItem(EnumCampoConsultaEventoFixoCargoFuncionario.CARGO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_Cargo")));
		return itens;
	}
	
	public List<SelectItem> getTipoConsultaComboEnumCampoConsultaHoraAtividadeExtraClasseProfessor() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaHoraAtividadeExtraClasseProfessor.FUNCIONARIO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_Funcionario")));
		itens.add(new SelectItem(EnumCampoConsultaHoraAtividadeExtraClasseProfessor.MATRICULA_FUNCIONARIO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_MatriculaFuncionario")));
		itens.add(new SelectItem(EnumCampoConsultaHoraAtividadeExtraClasseProfessor.MATRICULA_CARGO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_MatriculaCargo")));
		return itens;
	}
	
	public List<SelectItem> getTipoConsultaComboNivelSalarial() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaNivelSalarial.DESCRICAO.name(), UteisJSF.internacionalizar("enum_TipoConsultaComboArtefatoAjudaEnum_DESCRICAO")));
		itens.add(new SelectItem(EnumCampoConsultaNivelSalarial.VALOR.name(), UteisJSF.internacionalizar("enum_TipoEventoFolhaPagamentoEnum_VALOR")));
		return itens;
	}
	
	public List<SelectItem> getTipoConsultaComboTipoEmprestimo() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaTipoEmprestimo.DESCRICAO.name(), UteisJSF.internacionalizar("enum_TipoEmprestimoEnum_DESCRICAO")));
		itens.add(new SelectItem(EnumCampoConsultaTipoEmprestimo.BANCO.name(), UteisJSF.internacionalizar("enum_TipoEmprestimoEnum_BANCO")));
		itens.add(new SelectItem(EnumCampoConsultaTipoEmprestimo.CODIGO.name(), UteisJSF.internacionalizar("enum_TipoEmprestimoEnum_CODIGO")));
		return itens;
	}

	public List<SelectItem> getTipoConsultaComboLinhaTransporte() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaParametroValeTransporte.DESCRICAO.name(), UteisJSF.internacionalizar("enum_LinhaTransporteEnum_DESCRICAO")));
		itens.add(new SelectItem(EnumCampoConsultaParametroValeTransporte.CODIGO.name(), UteisJSF.internacionalizar("enum_LinhaTransporteEnum_CODIGO")));
		return itens;
	}	
	public List<SelectItem> getTipoConsultaComboSecaoFolhaPagamento() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaSecaoFolhaPagamento.DESCRICAO.name(), UteisJSF.internacionalizar("enum_TipoConsultaComboSecaoFolhaPagamentoEnum_DESCRICAO")));
		itens.add(new SelectItem(EnumCampoConsultaSecaoFolhaPagamento.IDENTIFICADOR.name(), UteisJSF.internacionalizar("enum_TipoConsultaComboSecaoFolhaPagamentoEnum_IDENTIFICADOR")));
		return itens;
	}
	
	public List<SelectItem> getTipoConsultaComboFaixaSalarial() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaFaixaSalarial.DESCRICAO.name(), UteisJSF.internacionalizar("enum_TipoConsultaComboArtefatoAjudaEnum_DESCRICAO")));
		itens.add(new SelectItem(EnumCampoConsultaFaixaSalarial.VALOR.name(), UteisJSF.internacionalizar("enum_TipoEventoFolhaPagamentoEnum_VALOR")));
		return itens;
	}
	
	public List<SelectItem> getTipoConsultaComboProgressaoSalarial() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaProgressaoSalarial.DESCRICAO.name(), UteisJSF.internacionalizar("enum_TipoConsultaComboArtefatoAjudaEnum_DESCRICAO")));
		return itens;
	}
	
	public List<SelectItem> getComboboxTipoPensaoDependenteEnum() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(TipoPensaoDependenteEnum.PENSAO_JUDICIAL.name(), UteisJSF.internacionalizar("enum_TipoPensaoDependenteEnum_PensaoJudicial")));
		return itens;
	}

	public List<SelectItem> getTipoConsultaComboCompetencioFolhaPagamento() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaCompetencia.CODIGO.name(), UteisJSF.internacionalizar("enum_TipoConsultaComboSecaoFolhaPagamentoEnum_CODIGO")));
		return itens;
	}
	
	public List<SelectItem> getSituacoesTiposAdvertenciasEnum() {
		List<SelectItem> itens = new ArrayList<>();
	...
	public List<SelectItem> getComboboxPesquisaPorCodigoENome() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaSecaoFolhaPagamento.DESCRICAO.name(), UteisJSF.internacionalizar("enum_TipoConsultaComboSecaoFolhaPagamentoEnum_DESCRICAO")));
		itens.add(new SelectItem(EnumCampoConsultaSecaoFolhaPagamento.CODIGO.name(), UteisJSF.internacionalizar("enum_TipoConsultaComboSecaoFolhaPagamentoEnum_CODIGO")));
		return itens;
	}
	
	public List<SelectItem> getTipoContratacaoComissionadosEnum() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem("", ""));
		itens.add(new SelectItem(TipoContratacaoComissionadoEnum.ADMISSAO.name(), TipoContratacaoComissionadoEnum.ADMISSAO.getValorApresentar()));
		itens.add(new SelectItem(TipoContratacaoComissionadoEnum.CONCURSO.name(), TipoContratacaoComissionadoEnum.CONCURSO.getValorApresentar()));
		itens.add(new SelectItem(TipoContratacaoComissionadoEnum.NOMEACAO.name(), TipoContratacaoComissionadoEnum.NOMEACAO.getValorApresentar()));
		itens.add(new SelectItem(TipoContratacaoComissionadoEnum.MUDANCA_CARGO.name(), TipoContratacaoComissionadoEnum.MUDANCA_CARGO.getValorApresentar()));
		itens.add(new SelectItem(TipoContratacaoComissionadoEnum.ADEQUACAO_TABELA_SALARIAL.name(), TipoContratacaoComissionadoEnum.ADEQUACAO_TABELA_SALARIAL.getValorApresentar()));
		itens.add(new SelectItem(TipoContratacaoComissionadoEnum.PROGRESSAO_SALARIAL.name(), TipoContratacaoComissionadoEnum.PROGRESSAO_SALARIAL.getValorApresentar()));
		itens.add(new SelectItem(TipoContratacaoComissionadoEnum.OUTROS.name(), TipoContratacaoComissionadoEnum.OUTROS.getValorApresentar()));
		return itens;
	}
	...
	public List<SelectItem> getTipoConsultaContraCheque() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaContraCheque.FUNCIONARIO.name(), UteisJSF.internacionalizar("enum_ContraChequeEnum_FUNCIONARIO")));
		itens.add(new SelectItem(EnumCampoConsultaContraCheque.CARGO.name(), UteisJSF.internacionalizar("enum_ContraChequeEnum_CARGO")));
		itens.add(new SelectItem(EnumCampoConsultaContraCheque.MATRICULA.name(), UteisJSF.internacionalizar("enum_ContraChequeEnum_MATRICULA")));
		itens.add(new SelectItem(EnumCampoConsultaContraCheque.MATRICULA_CARGO.name(), UteisJSF.internacionalizar("enum_ContraChequeEnum_MATRICULA_CARGO")));
		return itens;
	}
	...
	public List<SelectItem> getTipoConsultaComboTipoTransporte() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaTipoTransporte.DESCRICAO.name(), UteisJSF.internacionalizar("enum_TipoTransporteEnum_DESCRICAO")));
		itens.add(new SelectItem(EnumCampoConsultaTipoTransporte.CODIGO.name(), UteisJSF.internacionalizar("enum_TipoTransporteEnum_CODIGO")));
		return itens;
	}
	...
	public List<SelectItem> getTipoConsultaComboEventoEmprestimoCargoFuncionario() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaEventoFixoCargoFuncionario.FUNCIONARIO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_Funcionario")));
		itens.add(new SelectItem(EnumCampoConsultaEventoFixoCargoFuncionario.MATRICULA_FUNCIONARIO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_MatriculaFuncionario")));
		itens.add(new SelectItem(EnumCampoConsultaEventoFixoCargoFuncionario.MATRICULA_CARGO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_MatriculaCargo")));
	...
	public List<SelectItem> getComboboxJobsEnum() {
		if (comboboxJobsEnum == null) {
			comboboxJobsEnum = new ArrayList<SelectItem>();
			
			comboboxJobsEnum = UtilPropriedadesDoEnum.getListaSelectItemDoEnum(JobsEnum.class, "name", "name", false);
		}
		return comboboxJobsEnum;
	}
	...
	public List<SelectItem> getComboboxCategoriaEventoFolhaPagamentoEnum() {
		if (comboboxCategoriaEventoFolhaPagamentoEnum == null)
			comboboxCategoriaEventoFolhaPagamentoEnum = montarComboboxSemOpcaoDeNenhum(CategoriaEventoFolhaEnum.values(), Obrigatorio.NAO);
		return comboboxCategoriaEventoFolhaPagamentoEnum;
	}
	...
	public List<SelectItem> getComboboxTipoEventoMediaEnum() {
		if (comboboxTipoEventoMediaEnum == null)
			comboboxTipoEventoMediaEnum = montarCombobox(TipoEventoMediaEnum.values(), Obrigatorio.SIM);
		return comboboxTipoEventoMediaEnum;
	}
	...
	public List<SelectItem> getComboboxTipoEntidadeSindicalEnum() {
		if (comboboxTipoEntidadeSindicalEnum == null)
			comboboxTipoEntidadeSindicalEnum = montarCombobox(TipoEntidadeSindicalEnum.values(), Obrigatorio.SIM);
		return comboboxTipoEntidadeSindicalEnum;
	}
	...
	public List<SelectItem> getComboboxSituacaoMarcacaoFeriasEnum() {
		if (comboboxSituacaoMarcacaoFeriasEnum == null)
			comboboxSituacaoMarcacaoFeriasEnum = montarComboboxSemOpcaoDeNenhum(SituacaoMarcacaoFeriasEnum.values(), Obrigatorio.NAO);
		return comboboxSituacaoMarcacaoFeriasEnum;
	}
	...
	public List<SelectItem> getSituacaoMarcacaoFerias() {
		List<SelectItem> itens = new ArrayList<>();
		itens = SituacaoMarcacaoFeriasEnum.getValorSituacaoMarcacaoFeriasEnum();
		itens.add(new SelectItem("TODOS", "Todos"));
		return itens;
	}

	public List<SelectItem> getTipoConsultaComboFuncionarioDaTelaDeMarcacaoDeFerias() {
		List<SelectItem> itens = new ArrayList<>();
		itens.add(new SelectItem(EnumCampoConsultaEventoFixoCargoFuncionario.FUNCIONARIO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_Funcionario")));
		itens.add(new SelectItem(EnumCampoConsultaEventoFixoCargoFuncionario.MATRICULA_CARGO.name(), UteisJSF.internacionalizar("enum_ConsultaEventoFixoCargoFuncionario_MatriculaCargo")));
		return itens;
	 ...
	 * @return
	 */
	public List<SelectItem> getComboboxNaturezaEventoFolhaPagamentoEnum() {
		if (comboboxNaturezaEventoFolhaPagamentoEnum == null)
			comboboxNaturezaEventoFolhaPagamentoEnum = montarComboboxSemOpcaoDeNenhum(NaturezaEventoFolhaPagamentoEnum.values(), Obrigatorio.NAO);
		return comboboxNaturezaEventoFolhaPagamentoEnum;
	}

	public List<SelectItem> getComboboxTipoAfastamentoFuncionarioEnum() {
		if (comboboxTipoAfastamentoFuncionarioEnum== null)
			comboboxTipoAfastamentoFuncionarioEnum = montarComboboxSemOpcaoDeNenhum(TipoAfastamentoEnum.values(), Obrigatorio.NAO);
		return comboboxTipoAfastamentoFuncionarioEnum;
	}

	public List<SelectItem> getComboboxMotivoAfastamentoFuncionarioEnum() {
		if (comboboxMotivoAfastamentoFuncionarioEnum == null)
			comboboxMotivoAfastamentoFuncionarioEnum = montarComboboxSemOpcaoDeNenhum(MotivoAfastamentoEnum.values(), Obrigatorio.NAO);
		return comboboxMotivoAfastamentoFuncionarioEnum;
	}

	public List<SelectItem> getComboboxTipoMovimentoPensaoEnum() {
		if (comboboxTipoMovimentoPensaoEnum == null)
			comboboxTipoMovimentoPensaoEnum = montarComboboxSemOpcaoDeNenhum(TipoMovimentoPensaoEnum.values(), Obrigatorio.NAO);
		return comboboxTipoMovimentoPensaoEnum;
	}
	
	public List<SelectItem> getComboboxNaturezaOperacaoEnum() {
		if (comboboxNaturezaOperacaoEnum == null)
			comboboxNaturezaOperacaoEnum = montarComboboxSemOpcaoDeNenhum(NaturezaOperacaoEnum.values(), Obrigatorio.NAO);
		return comboboxNaturezaOperacaoEnum;
	}
	
	public List<SelectItem> getComboboxRegimeEspecialTributacaoEnum() {
		if (comboboxRegimeEspecialTributacaoEnum == null)
			comboboxRegimeEspecialTributacaoEnum = montarComboboxSemOpcaoDeNenhum(RegimeEspecialTributacaoEnum.values(), Obrigatorio.NAO);
		return comboboxRegimeEspecialTributacaoEnum;
	}
	...
	public List<SelectItem> getComboboxMotivoMudancaSecao() {
		if (comboboxMotivoMudancaSecao == null)
			comboboxMotivoMudancaSecao = montarComboboxSemOpcaoDeNenhum(MotivoMudancaCargoEnum.values(), Obrigatorio.NAO);
		return comboboxMotivoMudancaSecao;
	}
	public List<SelectItem> getComboboxMotivoMudancaSalarial() {
		if (comboboxMotivoMudancaSalarial == null)
			comboboxMotivoMudancaSalarial = montarComboboxSemOpcaoDeNenhum(MotivoMudancaCargoEnum.values(), Obrigatorio.NAO);
		return comboboxMotivoMudancaSalarial;
	}
	public List<SelectItem> getComboboxMotivoMudancaCargo() {
		if (comboboxMotivoMudancaCargo == null)
			comboboxMotivoMudancaCargo = montarComboboxSemOpcaoDeNenhum(TipoContratacaoComissionadoEnum.values(), Obrigatorio.NAO);
		return comboboxMotivoMudancaCargo;
	}

	public List<SelectItem> getComboboxRescisao() {
		if (comboboxRescisao == null) {
			comboboxRescisao = montarComboboxSemOpcaoDeNenhum(EnumCampoConsultaRescisao.values(), Obrigatorio.SIM);
		}
		return comboboxRescisao;
	}
	...
	public List<SelectItem> getComboboxTipoDemissao() {
		if (comboboxTipoDemissao == null) {
			comboboxTipoDemissao = montarCombobox(TipoDemissaoEnum.values(), Obrigatorio.SIM);
		}
		return comboboxTipoDemissao;
	}
	...
	public List<SelectItem> getComboboxMotivoDemissao() {
		if (comboboxMotivoDemissao == null) {
			comboboxMotivoDemissao = montarCombobox(MotivoDemissaoEnum.values(), Obrigatorio.SIM);
		}
		return comboboxMotivoDemissao;
	}
	...
	public List<SelectItem> getComboboxTipoEventoMediaRescisao() {
		if (comboboxTipoEventoMediaRescisao == null) {
			comboboxTipoEventoMediaRescisao = montarCombobox(TipoEventoMediaRescisaoEnum.values(), Obrigatorio.SIM);
		}
		return comboboxTipoEventoMediaRescisao;
	}
	...
	public List<SelectItem> getComboboxCategoriaDespesaEnum() {
		if (comboboxCategoriaDespesaEnum == null) {
			comboboxCategoriaDespesaEnum = montarCombobox(CategoriaDespesaVO.enumCampoConsultaCategoriaDespesa.values(), Obrigatorio.SIM);
		}
		return comboboxCategoriaDespesaEnum;
	}
	...
	public List<SelectItem> getComboboxFormaPagamentoEnum() {
		if (comboboxFormaPagamentoEnum == null) {
			comboboxFormaPagamentoEnum = montarCombobox(FormaPagamentoVO.enumCampoConsultaFormaPagamento.values(), Obrigatorio.SIM);
		}
		return comboboxFormaPagamentoEnum; 
	}
...
//			comboboxPermitirCartaoEnum = montarCombobox(PermitirCartaoEnum.values(), Obrigatorio.SIM);
	...
	public List<SelectItem> getComboboxAmbienteEnum() {
		if (comboboxAmbienteEnum == null) {
			comboboxAmbienteEnum = montarCombobox(AmbienteEnum.values(), Obrigatorio.SIM);
		}
		return comboboxAmbienteEnum;
	}
	...
	public List<SelectItem> getListaSelectItemCalendarioPor() {
		if (listaSelectItemCalendarioPor == null) {
			listaSelectItemCalendarioPor = montarComboboxSemOpcaoDeNenhum(EnumCampoCalendarioPor.values(), Obrigatorio.SIM);
		}
