...
@Controller("MatriculaLiberacaoControle")
@Scope("viewScope")
@Lazy
public class MatriculaLiberacaoControle extends SuperControle implements Serializable {
    ...
    public MatriculaLiberacaoControle() throws Exception {
    ...
    public void prepararParaLiberarMatriculaComPendenciasFinanceiras() {
        setUsernameLiberarRenovacaoComDebitosFinanceiros("");
        setSenhaLiberarRenovacaoComDebitosFinanceiros("");
    }

    public void executarVerificacaoUusuarioPodeLiberarMatriculaComPendenciasFinanceiras() {
        try {
            UsuarioVO usuarioVerif = ControleAcesso.verificarLoginUsuario(this.getUsernameLiberarRenovacaoComDebitosFinanceiros(), this.getSenhaLiberarRenovacaoComDebitosFinanceiros(), true, Uteis.NIVELMONTARDADOS_TODOS);
            verificarPermissaoUsuarioLiberarMatriculaComPendenciasFinanceiras(usuarioVerif, "Matricula_AutorizarRenovacaoComDebito");
            getMatriculaVO().setDataLiberacaoPendenciaFinanceira(new Date());
            getMatriculaVO().setResponsavelLiberacaoPendenciaFinanceira(getUsuarioLogadoClone());
            getFacadeFactory().getMatriculaFacade().alterarDataLiberacaoPendenciaFinanceira(getMatriculaVO().getMatricula(), getMatriculaVO().getDataLiberacaoPendenciaFinanceira(), getMatriculaVO().getResponsavelLiberacaoPendenciaFinanceira().getCodigo(), getUsuarioLogado());
    ...
    /**
     * @param usernameLiberarRenovacaoComDebitosFinanceiros the usernameLiberarRenovacaoComDebitosFinanceiros to set
     */
    ...
    /**
     * @param senhaLiberarRenovacaoComDebitosFinanceiros the senhaLiberarRenovacaoComDebitosFinanceiros to set
     */
