	...
	public void alterarOrdemApresentacaoQuestaoListaExercicio(DropEvent dropEvent) {
		try {
			if (dropEvent.getDragValue() instanceof QuestaoListaExercicioVO && dropEvent.getDropValue() instanceof QuestaoListaExercicioVO) {
				getFacadeFactory().getListaExercicioFacade().alterarOrdemApresentacaoQuestaoListaExercicio(getListaExercicioVO(), (QuestaoListaExercicioVO) dropEvent.getDragValue(), (QuestaoListaExercicioVO) dropEvent.getDropValue());
				limparMensagem();
			}
		} catch (Exception e) {
			setMensagemDetalhada("msg_erro", e.getMessage(), Uteis.ERRO);
