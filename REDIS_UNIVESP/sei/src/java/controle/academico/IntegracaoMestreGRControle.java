...
//		getProgressBarIntegracaoMestreGR().setStatus("Convertendo Registros Em Lote");
	...
	public void realizarInicioProgressBarGerarLote() {
		try {
			...
			getProgressBarIntegracaoMestreGR().iniciar(0L, 2, "Consultando dados para geração do lote", true, this,
					"gerarLoteIntegracao");
			if (getTipoLote().equals(OperacaoTempoRealMestreGREnum.TURMA_2CH)) {
				setOncompleteModal("RichFaces.$('panelLoteIntegracaoAlunoSegundaChamada').hide()");
			} else if (getTipoLote().equals(OperacaoTempoRealMestreGREnum.TURMA)) {
				setOncompleteModal("RichFaces.$('panelLoteIntegracaoAluno').hide()");
			} else if (getTipoLote().equals(OperacaoTempoRealMestreGREnum.TURMA_EXAME)) {
				setOncompleteModal("RichFaces.$('panelLoteIntegracaoAlunoExame').hide()");
			}
		} catch (Exception e) {
			getProgressBarIntegracaoMestreGR().encerrarForcado();
	...
	public void scrollerListenerRegistroIntegracaoLote(DataScrollEvent DataScrollEvent) throws Exception {
		getControleConsultaRegistroIntegracaoLote().setPaginaAtual(DataScrollEvent.getPage());
		getControleConsultaRegistroIntegracaoLote().setPage(DataScrollEvent.getPage());
		consultarRegistroIntegracaoLote();
	}
	...
	public void scrollerListenerErroIntegracaoLote(DataScrollEvent DataScrollEvent) throws Exception {
		getControleConsultaErroRegistroIntegracaoLote().setPaginaAtual(DataScrollEvent.getPage());
		getControleConsultaErroRegistroIntegracaoLote().setPage(DataScrollEvent.getPage());
		consultarErroLote();
	}
	...
	public void scrollerListenerLogIntegracaoLote(DataScrollEvent DataScrollEvent) throws Exception {
		getControleConsultaLogRegistroIntegracaoLote().setPaginaAtual(DataScrollEvent.getPage());
		getControleConsultaLogRegistroIntegracaoLote().setPage(DataScrollEvent.getPage());
		consultarLogsAlunos();
	}

	public void scrollerListenerIntegracaoLote(DataScrollEvent DataScrollEvent) throws Exception {
		getControleConsultaIntegracaoLote().setPaginaAtual(DataScrollEvent.getPage());
		getControleConsultaIntegracaoLote().setPage(DataScrollEvent.getPage());
		consultarLoteItem();
	}
	...
	public void consultarIntegracaoLote(String tipoLote) {
		...
		if (validarFiltros(getAnoLote(), getSemestre(), getBimestre())) {
			...
			switch (getTipoLote()) {
			case TURMA:
				setOncompleteModal("RichFaces.$('panelLoteIntegracaoAluno').show()");
				break;
			case TURMA_2CH:
				setOncompleteModal("RichFaces.$('panelLoteIntegracaoAlunoSegundaChamada').show()");
				break;
			case TURMA_EXAME:
				setOncompleteModal("RichFaces.$('panelLoteIntegracaoAlunoExame').show()");
				break;
	...
	public void consultarIntegracaoLogAlunos() {
		...
		if (validarFiltros(getAnoLote(), getSemestre(), getBimestre())) {
			...
			getControleConsultaLogRegistroIntegracaoLote().setPage(1);
			consultarLogsAlunos();
			setOncompleteModal("RichFaces.$('panelLoteIntegracaoLogAluno').show()");
		}
	}
