...
//    }
    ...
    public String consultar() {
        try {
            ...
            if (getControleConsulta().getCampoConsulta().equals("matricula")) {
                ...
                MatriculaVO obj = getFacadeFactory().getMatriculaFacade().consultarPorObjetoMatricula(getControleConsulta().getValorConsulta(), this.getUnidadeEnsinoLogado().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getConfiguracaoFinanceiroPadraoSistema(), getUsuarioLogado());
            ...
            if (getControleConsulta().getCampoConsulta().equals("nomePessoa")) {
                registrarAtividadeUsuario(getUsuarioLogado(), "HistoricoControle", "Inicializando Consultar Histórico", "Consultando");
                objs = getFacadeFactory().getMatriculaFacade().consultarPorNomePessoa(getControleConsulta().getValorConsulta(), this.getUnidadeEnsinoLogado().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getConfiguracaoFinanceiroPadraoSistema(), getUsuarioLogado());
                registrarAtividadeUsuario(getUsuarioLogado(), "HistoricoControle", "Finalizando Consultar Histórico", "Consultando");
            }
            if (getControleConsulta().getCampoConsulta().equals("nomeCurso")) {
                registrarAtividadeUsuario(getUsuarioLogado(), "HistoricoControle", "Inicializando Consultar Histórico", "Consultando");
                objs = getFacadeFactory().getMatriculaFacade().consultarPorNomeCurso(getControleConsulta().getValorConsulta(), this.getUnidadeEnsinoLogado().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getConfiguracaoFinanceiroPadraoSistema(), getUsuarioLogado());
                registrarAtividadeUsuario(getUsuarioLogado(), "HistoricoControle", "Finalizando Consultar Histórico", "Consultando");
            }
            if (getControleConsulta().getCampoConsulta().equals("data")) {
                registrarAtividadeUsuario(getUsuarioLogado(), "HistoricoControle", "Inicializando Consultar Histórico", "Consultando");
                Date valorData = Uteis.getDate(getControleConsulta().getValorConsulta());
                objs = getFacadeFactory().getMatriculaFacade().consultarPorData(Uteis.getDateTime(valorData, 0, 0, 0), Uteis.getDateTime(valorData, 23, 59, 59), this.getUnidadeEnsinoLogado().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getConfiguracaoFinanceiroPadraoSistema(), getUsuarioLogado());
                registrarAtividadeUsuario(getUsuarioLogado(), "HistoricoControle", "Finalizando Consultar Histórico", "Consultando");
            }
            if (getControleConsulta().getCampoConsulta().equals("situacao")) {
                registrarAtividadeUsuario(getUsuarioLogado(), "HistoricoControle", "Inicializando Consultar Histórico", "Consultando");
                objs = getFacadeFactory().getMatriculaFacade().consultarPorSituacao(getControleConsulta().getValorConsulta(), this.getUnidadeEnsinoLogado().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getConfiguracaoFinanceiroPadraoSistema(), getUsuarioLogado());
                registrarAtividadeUsuario(getUsuarioLogado(), "HistoricoControle", "Finalizando Consultar Histórico", "Consultando");
            }
    ...
    public void montarListaSelectPeriodosLetivos(String prm) throws Exception {
        ...
        while (i.hasNext()) {
            ...
            MatriculaPeriodo.montarDadosPeriodoLetivoMatricula(obj, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado());
    ...
    public List consultarMatriculaPeriodo(String matricula) throws Exception {
        List lista = getFacadeFactory().getMatriculaPeriodoFacade().consultarMatriculaPeriodos(matricula, false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getConfiguracaoFinanceiroPadraoSistema(), getUsuarioLogado());
        return lista;
    }
    ...
    public void montarListaSelectItemDisciplinas(String prm) throws Exception {
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                MatriculaPeriodoTurmaDisciplina.montarDadosDisciplina(obj, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado());
    ...
    public List consultarDisciplinasPorNome(String nomePrm) throws Exception {
        ...
        if (periodoLetivo.intValue() != 0) {
            ...
            MatriculaPeriodoVO matriculaPeriodo = getFacadeFactory().getMatriculaPeriodoFacade().consultarPorMatriculaPeriodoLetivoSemestreAno(getMatricula().getMatricula(), periodoLetivo, semestre, ano, false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getConfiguracaoFinanceiroPadraoSistema(), getUsuarioLogado());
    ...
    public void montarListaHistoricoAluno() {
        try {
            ...
            if (getDisciplina().intValue() != 0) {
                HistoricoVO histVO = getFacadeFactory().getHistoricoFacade().consultarPorMatricula_matriculaPeriodo_Disciplina(getMatricula().getMatricula(), matriculaPeriodo.getCodigo(), getDisciplina(), false, Uteis.NIVELMONTARDADOS_TODOS, getConfiguracaoFinanceiroPadraoSistema(), getUsuarioLogado());
    ...
    public void adicionarDisciplinaHistoricoVO(MatriculaPeriodoVO matriculaPeriodo) throws Exception {
        ...
        while (i.hasNext()) {
            ...
            if (!item.getValue().equals(0)) {
                HistoricoVO histVO = getFacadeFactory().getHistoricoFacade().consultarPorMatricula_matriculaPeriodo_Disciplina(getMatricula().getMatricula(), matriculaPeriodo.getCodigo(), (Integer) item.getValue(), false, Uteis.NIVELMONTARDADOS_TODOS, getConfiguracaoFinanceiroPadraoSistema(), getUsuarioLogado());
