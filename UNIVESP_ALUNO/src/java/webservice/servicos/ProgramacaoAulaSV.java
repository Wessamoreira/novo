 ...
 */
public class ProgramacaoAulaSV extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Integer codUnid = Integer.parseInt(unidadeEnsino);
//			String turma = request.getParameter("codturma");
//			Integer codTurma = Integer.parseInt(turma);
//			String disciplina = request.getParameter("coddisciplina");
//			Integer codDisciplina = Integer.parseInt(disciplina);

//			List<HorarioTurmaVO> lista = getFacadeFactory().getHorarioTurmaFacade().consultarPorUnidadeEnsino(codUnid);
			// preenche o objeto
//			Iterator i = lista.iterator();
			JSONObject my_obj_unid_nome = new JSONObject();
//			while (i.hasNext()) {
//				JSONObject my_obj_unid_cod = new JSONObject();
//				HorarioTurmaVO horario = (HorarioTurmaVO) i.next();
//				my_obj_unid_cod.put("codigoModulo", horario.getCodigo());
//				my_obj_unid_cod.put("codigoTurma", horario.getTurma().getCodigo());
//				my_obj_unid_cod.put("nomeDisciplina", horario.getDisciplina().getNome());
//				my_obj_unid_cod.put("codigoDisciplina", horario.getDisciplina().getCodigo());
//				my_obj_unid_cod.put("dataInicio", Uteis.getData(horario.getDiaInicio()));
//				my_obj_unid_cod.put("dataTermino", Uteis.getData(horario.getDiaFim()));
//				my_obj_unid_cod.put("nomeProfessor", horario.getProfessor().getNome());
//				my_obj_unid_nome.put(horario.getCodigo().toString(), my_obj_unid_cod.toString().replace("\\", "").replace("\"{", "{").replace("}\"", "}"));
//			}
