 ...
 */
public class TurmaSV extends HttpServlet {
...
//					my_obj_unid_cod.put("codigoPlanoFinanceiro", uni.getPlanoFinanceiroCurso().getCodigo());
//					my_obj_unid_cod.put("descricaoPlanoFinanceiro", uni.getPlanoFinanceiroCurso().getDescricao());
