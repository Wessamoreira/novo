 ...
 */
public class CondicaoPagamentoTurmaSV extends HttpServlet {
	 ...
	 */
	public CondicaoPagamentoTurmaSV() {
		super();
...
//			List<CondicaoPagamentoPlanoFinanceiroCursoVO> lista = getFacadeFactory().getCondicaoPagamentoPlanoFinanceiroCursoFacade().consultarPorCodigoPlanoFinanceiroCurso(turmaVO.getPlanoFinanceiroCurso().getCodigo(), "AT", false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, null);
			// preenche o objeto
...
//				my_obj_unid_nome.put(uni.getDescricao(), my_obj_unid_cod.toString().replace("\\", "").replace("\"{", "{").replace("}\"", "}"));				
//			}
