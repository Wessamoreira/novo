 ...
 */
public class CursoSV extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			UnidadeEnsinoVO unidade = getFacadeFactory().getUnidadeEnsinoFacade().consultarPorChavePrimaria(codUnidadeEnsino, false, Uteis.NIVELMONTARDADOS_COMBOBOX, null);
			List<UnidadeEnsinoCursoVO> lista = getFacadeFactory().getUnidadeEnsinoCursoFacade().consultarPorCodigoUnidadeEnsino(codUnidadeEnsino, false, Uteis.NIVELMONTARDADOS_DADOSCONSULTA, null);
			// preenche o objeto
			...
			while (i.hasNext()) {
				...
				my_obj_unid_cod.put("codigoTurno", uni.getTurno().getCodigo());
				my_obj_unid_cod.put("nomeTurno", uni.getTurno().getNome());
				my_obj_unid_cod.put("nivelEducacional", uni.getCurso().getNivelEducacional());
				my_obj_unid_nome.put(uni.getCurso().toString(), my_obj_unid_cod.toString().replace("\\", "").replace("\"{", "{").replace("}\"", "}"));
			}
