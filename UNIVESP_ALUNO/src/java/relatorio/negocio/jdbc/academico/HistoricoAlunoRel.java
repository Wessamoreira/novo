...
public class HistoricoAlunoRel extends SuperRelatorio implements HistoricoAlunoRelInterfaceFacade {
	...
	public HistoricoAlunoRelVO criarObjeto(HistoricoAlunoRelVO historicoAlunoRelVO, MatriculaVO matriculaVO, GradeCurricularVO gradeCurricularVO, FiltroRelatorioAcademicoVO filtroRelatorioAcademicoVO, int ordem, String observacaoComplementar, String observacaoComplementarIntegralizado, String tipoConsulta, String tipoLayout, Boolean utilizarCidadeUnidadeMatriz, Date dataExpedicaoDiploma, Boolean apresentarInstituicaoDisciplinaAproveitada, Boolean apresentarDisciplinaAnoSemestreTransferenciaGrade, Boolean apresentarDisciplinaForaGrade, UsuarioVO usuarioVO, Boolean filtroDisciplinasACursar, Boolean desconsiderarSituacaoMatriculaPeriodo, Boolean apresentarObservacaoTransferenciaMatrizCurricular, String observacaoTransferenciaMatrizCurricular, boolean apresentarApenasUltimoHistoricoDisciplina, boolean considerarCargaHorariaCursadaIgualCargaHorariaPrevista, boolean apresentarApenasProfessorTitulacaoTurmaOrigem, String regraApresentacaoProfessorDisciplinaAproveitamento, Boolean dataInicioTerminoAlteracoesCadastrais, ConfiguracaoLayoutHistoricoVO configuracaoLayoutHistoricoVO, Boolean xmlDiploma) throws Exception {
		...
		gradeCurricularVO = getFacadeFactory().getGradeCurricularFacade().consultarPorChavePrimaria(gradeCurricularVO.getCodigo(), Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuarioVO);
		boolean gradeAtualAluno = matriculaVO.getGradeCurricularAtual().getCodigo().equals(gradeCurricularVO.getCodigo());// getFacadeFactory().getGradeCurricularFacade().consultarGradeCurricularUltimaMatriculaPeriodo(matriculaVO.getMatricula(),
																															...
																															// usuarioVO);
		getFacadeFactory().getUnidadeEnsinoFacade().carregarDados(matriculaVO.getUnidadeEnsino(), NivelMontarDados.TODOS, usuarioVO);
		...
		getFacadeFactory().getCursoFacade().carregarDados(matriculaVO.getCurso(), NivelMontarDados.BASICO, usuarioVO);
...
//			List<HistoricoGradeMigradaEquivalenteVO> historicoGradeMigradaEquivalenteVOs = getFacadeFactory().consultarPorMatriculaHistoricoGradeMigradaEquivalenteTransferidasGrade(matricula, gradeAtual, usuarioVO);
...
//					historicoAlunoDisciplinaRelVO.setDataFimAula(datas.get("datatermino"));
	...
	private void definirApresentacaoProfessorAproveitamentoDisciplina(HistoricoAlunoDisciplinaRelVO historicoAlunoDisciplinaRelVO, MatriculaVO matriculaVO, HistoricoVO historicoVO, Boolean apresentarApenasProfessorTitulacaoTurmaOrigem, Boolean posGraduacao, String tipoLayout, String regraApresentacaoProfessorDisciplinaAproveitamento, UsuarioVO usuarioVO, ConfiguracaoLayoutHistoricoVO configuracaoLayoutHistoricoVO, Boolean xmlDiploma) throws Exception {
		if (regraApresentacaoProfessorDisciplinaAproveitamento.equals("PROFESSOR_APROVEITAMENTO_DISCIPLINA")) {
			...
			if (!Uteis.isAtributoPreenchido(historicoAlunoDisciplinaRelVO.getProfessor())) {
				FuncionarioVO funcionarioVO = consultarNomeProfessorTitularMinistrouAula(matriculaVO.getMatricula(), historicoVO.getDisciplina().getCodigo(), "", matriculaVO.getUnidadeEnsino().getCodigo(), historicoVO.getAnoHistorico(), historicoVO.getSemestreHistorico(), usuarioVO);
				if (Uteis.isAtributoPreenchido(funcionarioVO)) {
					historicoAlunoDisciplinaRelVO.setProfessor(funcionarioVO.getPessoa().getNome());
...
//			}
		...
		getFacadeFactory().getPessoaFacade().montarDadosNaturalidade(obj, usuarioVO);
		...
		getFacadeFactory().getPessoaFacade().montarDadosNacionalidade(obj, usuarioVO);
...
//			historicoAlunoRelVO.setAreaConhecimentoCurso(obj.getAreaConhecimento().getNome());
	...
	private FuncionarioVO consultarNomeProfessorTitularMinistrouAula(String matricula, Integer disciplina, String nomeProfessor, Integer unidadeEnsino, String ano, String semestre, UsuarioVO usuarioVO) throws Exception {
		FuncionarioVO funcionarioVO = new FuncionarioVO();
//		funcionarioVO = getFacadeFactory().getFuncionarioFacade().consultarProfessorComAulaProgramadaPorMatriculaDisciplinaNome(matricula, disciplina, nomeProfessor, unidadeEnsino, ano, semestre, false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuarioVO);
	...
	@Override
	public HistoricoAlunoRelVO criarObjeto(HistoricoAlunoRelVO historicoAlunoRelVO, MatriculaVO matriculaVO,
			GradeCurricularVO gradeCurricularVO, int ordem, String observacaoComplementar,
			String observacaoComplementarIntegralizado, String campoFiltroPor, String tipoLayout,
			Boolean utilizarUnidadeEnsinoMatriz, Date dataExpedicaoDiploma,
			Boolean apresentarInstituicaoDisciplinaAproveitada,
			Boolean apresentarDisciplinaAnoSemestreTransferenciaGrade, Boolean apresentarDisciplinaForaGrade,
			UsuarioVO usuarioVO, Boolean filtroDisciplinasACursar, Boolean desconsiderarSituacaoMatriculaPeriodo,
			Boolean apresentarObservacaoTransferenciaMatrizCurricular, String observacaoTransferenciaMatrizCurricular,
			boolean apresentarApenasUltimoHistoricoDisciplina,
			boolean considerarCargaHorariaCursadaIgualCargaHorariaPrevista,
			boolean apresentarApenasProfessorTitulacaoTurmaOrigem,
			String regraApresentacaoProfessorDisciplinaAproveitamento, Boolean dataInicioTerminoAlteracoesCadastrais,
			ConfiguracaoLayoutHistoricoVO configuracaoLayoutHistoricoVO) throws Exception {
	...
	public HistoricoAlunoRelVO criarObjeto(HistoricoAlunoRelVO historicoAlunoRelVO, MatriculaVO matriculaVO,
			GradeCurricularVO gradeCurricularVO, int ordem, String observacaoComplementar,
			String observacaoComplementarIntegralizado, String tipoConsulta, String tipoLayout,
			Boolean utilizarCidadeUnidadeMatriz, Date dataExpedicaoDiploma,
			Boolean apresentarInstituicaoDisciplinaAproveitada,
			Boolean apresentarDisciplinaAnoSemestreTransferenciaGrade, Boolean apresentarDisciplinaForaGrade,
			UsuarioVO usuarioVO, Boolean filtroDisciplinasACursar, Boolean desconsiderarSituacaoMatriculaPeriodo,
			Boolean apresentarObservacaoTransferenciaMatrizCurricular, String observacaoTransferenciaMatrizCurricular,
			...
			boolean apresentarApenasProfessorTitulacaoTurmaOrigem,
			String regraApresentacaoProfessorDisciplinaAproveitamento, Boolean dataInicioTerminoAlteracoesCadastrais,
			ConfiguracaoLayoutHistoricoVO configuracaoLayoutHistoricoVO, Boolean xmlDiploma) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
}