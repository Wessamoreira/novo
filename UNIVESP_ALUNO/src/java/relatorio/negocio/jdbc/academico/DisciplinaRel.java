...
public class DisciplinaRel extends SuperRelatorio implements DisciplinaRelInterfaceFacade {
    ...
    public  GradeCurricularVO montarDadosPeriodoLetivo(SqlRowSet dadosSQL, PeriodoLetivoVO periodoLetivo, DisciplinaVO disciplinaVO, UsuarioVO usuario) throws Exception {
