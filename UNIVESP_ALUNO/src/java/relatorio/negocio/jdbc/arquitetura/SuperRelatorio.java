...
public class SuperRelatorio extends ControleAcesso {
	 ...
	 *                esta operação.
	 */
	public void emitirRelatorio(String idEntidade, boolean verificarAcesso, UsuarioVO usuarioVO) throws Exception {
		super.emitirRelatorio(idEntidade, verificarAcesso, usuarioVO);
	}
