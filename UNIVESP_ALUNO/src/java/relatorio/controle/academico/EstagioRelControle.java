...
//						getTipoCurso(), getAno(), getSemestre(),  getTrazerTodosEstagiosAluno(), getTipoLayout(), getPeriodoLetivoDe(), getPeriodoLetivoAte(),
...
//						getUnidadeEnsinoVOs(), getCursoVOs(), getTurnoVOs(), getTurmaVO(), getListaConsultaDisciplina(),
//						getEmpresaVO(), getAreaProfissionalVOs(), getMatriculaVO(), getSituacao(), getTipoEstagioEnum(),
//						getTipoCurso(), getAno(), getSemestre(), 
...
//	}	
	...
	public void gravarDadosPadroesEmissaoRelatorio(){
		try{
			getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(getTipoCurso(), "", "tipoCurso", getUsuarioLogado());
			getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(getAno(), "", "ano", getUsuarioLogado());
			getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(getSemestre(), "", "semestre", getUsuarioLogado());
			getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(Uteis.getData(getFiltroRelatorioAcademicoVO().getDataInicio()), "", "dataInicio", getUsuarioLogado());
			getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(Uteis.getData(getFiltroRelatorioAcademicoVO().getDataTermino()), "", "dataTermino", getUsuarioLogado());
			getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(getSituacao(), "", "situacao", getUsuarioLogado());
			getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(getTipoEstagioEnum() == null ? "" : getTipoEstagioEnum().name(), "", "tipoEstagioEnum", getUsuarioLogado());
			getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(getApresentarNotaDisciplina().toString(), "", "apresentarNotaDisciplina", getUsuarioLogado());
			getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(getTrazerTodosEstagiosAluno().toString(), "", "trazerTodosEstagiosAluno", getUsuarioLogado());
			getFacadeFactory().getLayoutPadraoFacade().persistirFiltroSituacaoAcademica( "", getUsuarioLogado());
			getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(getTipoLayout(), "", "tipoLayout", getUsuarioLogado());
			if(getPeriodoLetivoDe() != null){
				getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(getPeriodoLetivoDe().toString(), "", "periodoLetivoDe", getUsuarioLogado());
			}else{
				getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2("", "", "periodoLetivoDe", getUsuarioLogado());
			}
			if(getPeriodoLetivoAte() != null){
				getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2(getPeriodoLetivoAte().toString(), "", "periodoLetivoAte", getUsuarioLogado());
			}else{
				getFacadeFactory().getLayoutPadraoFacade().persistirLayoutPadrao2("", "", "periodoLetivoDe", getUsuarioLogado());
			}
		}catch(Exception e){
