    ...
    public void consultarDadosDoAlunoPelaMatricula() {
        try {
            if(!getMatriculaPeriodoVO().getMatriculaVO().getMatricula().equals("0")){
                setMatriculaPeriodoVO(getFacadeFactory().getMatriculaPeriodoFacade().consultarUltimaMatriculaPeriodoAtivaPorMatricula(getMatriculaPeriodoVO().getMatriculaVO().getMatricula(), false, Uteis.NIVELMONTARDADOS_DADOSMINIMOS, getUsuarioLogado()));
            }
