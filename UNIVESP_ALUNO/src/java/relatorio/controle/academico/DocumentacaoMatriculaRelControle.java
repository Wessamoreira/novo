...
public class DocumentacaoMatriculaRelControle extends SuperControleRelatorio {
    ...
    public void imprimirPlanoEstudoPDF(Integer matriculaPeriodo, Integer configuracaoGeralSistema, String nomeUnidadeEnsino) {
        ...
        try {
            ...
            listaObjetos = getFacadeFactory().getDadosMatriculaRelFacade().criarObjeto(matriculaPeriodo, configuracaoGeralSistemaVO, getUsuarioLogado());
    ...
    public void imprimirComprovanteMatriculaPDF(MatriculaVO matriculaVO, String nivelEducacional, Integer matriculaPeriodo, Integer tipoLayout) {
        ...
        try {
            ...
            listaObjetos = getFacadeFactory().getComprovanteRenovacaoMatriculaRelFacade().criarObjeto(matriculaPeriodo, matriculaVO.getMatricula(), getUsuarioLogado());
            if (!listaObjetos.isEmpty()) {
                getSuperParametroRelVO().setTituloRelatorio(titulo);
                getSuperParametroRelVO().setNomeDesignIreport(design);
                getSuperParametroRelVO().setTipoRelatorioEnum(TipoRelatorioEnum.PDF);
    ...
    public void imprimirComprovanteMatriculaPDFMatriculaExterna(MatriculaVO matriculaVO, String nivelEducacional, Integer matriculaPeriodo, Integer tipoLayout, String unidadeEnsino, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO,  UsuarioVO usuarioVO) {
        String titulo = null;
        String design = null;
        String nomeRelatorio = null;
        ...
        try {
            ...
            listaObjetos = getFacadeFactory().getComprovanteRenovacaoMatriculaRelFacade().criarObjeto(matriculaPeriodo, matriculaVO.getMatricula(), usuarioVO);
            if (!listaObjetos.isEmpty()) {
                getSuperParametroRelVO().setTituloRelatorio(titulo);
                getSuperParametroRelVO().setNomeDesignIreport(design);
                getSuperParametroRelVO().setTipoRelatorioEnum(TipoRelatorioEnum.PDF);
    ...
    public String gerarContratoPDFMatriculaExterna(MatriculaVO matriculaVO,MatriculaPeriodoVO matriculaPeriodoVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO,  UsuarioVO usuarioVO, MatriculaRSVO matriculaRSVO)  throws Exception {
		...
		try {
			return getFacadeFactory().getImpressaoContratoFacade().imprimirContrato("MA", impressaoContratoVO, getConfiguracaoGeralPadraoSistema(),  usuarioVO);
		} catch (Exception e) {
