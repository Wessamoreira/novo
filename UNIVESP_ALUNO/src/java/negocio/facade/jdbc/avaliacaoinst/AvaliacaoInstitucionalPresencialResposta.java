...
//                    sqlAlterar.setTimestamp(1, Uteis.getDataJDBCTimestamp(obj.getDataCriacao()));
     ...
     */
    public  AvaliacaoInstitucionalPresencialRespostaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        AvaliacaoInstitucionalPresencialRespostaVO obj = new AvaliacaoInstitucionalPresencialRespostaVO();
     ...
     */
    public  void montarDadosResponsavel(AvaliacaoInstitucionalPresencialRespostaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
...
//    }
     ...
     * @param obj  Objeto no qual será montado os dados consultados.
     */
    public  void montarDadosUnidadeEnsino(AvaliacaoInstitucionalPresencialRespostaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     * @param obj  Objeto no qual será montado os dados consultados.
     */
    public  void montarDadosCurso(AvaliacaoInstitucionalPresencialRespostaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     * @param obj  Objeto no qual será montado os dados consultados.
     */
    public  void montarDadosTurma(AvaliacaoInstitucionalPresencialRespostaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     * @param obj  Objeto no qual será montado os dados consultados.
     */
    public  void montarDadosDisciplina(AvaliacaoInstitucionalPresencialRespostaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
