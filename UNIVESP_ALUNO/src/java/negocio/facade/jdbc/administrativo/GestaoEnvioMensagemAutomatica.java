...
public class GestaoEnvioMensagemAutomatica extends ControleAcesso implements GestaoEnvioMensagemAutomaticaInterfaceFacade {
	 ...
	 *            - Usuario Logado
	 * @throws Exception
	 *             - Podera Lanar um Exception para a Camada Chamadora.
	 */
...
//			throw new Exception("Para que a notificao seja enviada para os alunos convocados,  necessrio que a mensagem NOTIFICAO CONVOCAO ENADE, seja habilitada na tela PERSONALIZAO MENSAGEM AUTOMTICA.");
//		}
...
//		}
	 ...
	 */
	@Override
	public void executarEnvioMensagemRenegociacaoContaReceberAluno(UsuarioVO usuario) throws Exception {
...
//		}
	...
	@Override
	public void executarEnvioMensagemRenegociacaoContaReceberGrupoDestinatario(GrupoDestinatariosVO grupoDestinatariosVO, UsuarioVO usuario) throws Exception {
...
//		}
	...
	public String obterMensagemFormatadaMensagemRenegociacaoContaReceberAluno( final String mensagemTemplate) {
		String mensagemTexto = mensagemTemplate;
...
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.DATA_RENEGOCIACAO.name(), negociacaoContaReceberVO.getData_Apresentar());
	...
	public String obterMensagemFormatadaMensagemRenegociacaoContaReceberGrupoDestinatario( PessoaVO destinatario, final String mensagemTemplate) {
		String mensagemTexto = mensagemTemplate;
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.NOME_ALUNO.name(), negociacaoContaReceberVO.getPessoa().getNome());
...
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.DATA_RENEGOCIACAO.name(), negociacaoContaReceberVO.getData_Apresentar());
	...
	public String obterMensagemFormatadaMensagemConsultorContatosDia( final String mensagemTemplate) {
		String mensagemTexto = mensagemTemplate;
...
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.QUANTIDADE_CONTATOS.name(), obj.getQuantidadeContatos().toString());
	...
	public String obterMensagemFormatadaMensagemBuscaProspect(final String mensagemTemplate) {
		String mensagemTexto = mensagemTemplate;
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.NOME_ALUNO.name(), bp.getProspect().getNome());
	...
	public String obterMensagemFormatadaMensagemBoletoAluno(final String mensagemTemplate) {
		String mensagemTexto = mensagemTemplate;
...
//					mensagemEditada = mensagemEditada.replaceAll(TagsMensagemAutomaticaEnum.AVALIACAO_MOTIVO_ATENDIMENTO.name(), " No foi informado o motivo, pois a mesma foi avaliada por e-mail. ");
//					mensagemSMSEditada = mensagemSMSEditada.replaceAll(TagsMensagemAutomaticaEnum.AVALIACAO_MOTIVO_ATENDIMENTO.name(), " No foi informado o motivo, pois a mesma foi avaliada por e-mail. ");
//				} else {
...
//		}
	...
	public void realizarBloqueioMatriculaAlunoInadimplente(Integer codigoUnidade) {
		...
		registroExecucaoJobVO.setNome("Job Suspenso Matrcula Aluno Inadimplente.");
		int x = 0;
		try {
...
//		}
	...
	public String obterMensagemFormatadaMensagemAvisoDesconto( final String mensagemTemplate) {
//		String mensagemTexto = mensagemTemplate;
...
//			listaContaReceber.append("<p>Descrio dos Descontos abaixo:</p>");
...
//		}
	...
	public void executarEnvioMensagemAlunoDocumentoDeferido(MatriculaVO matricula, List<DocumetacaoMatriculaVO> documentos, UsuarioVO usuario) throws Exception {
		...
		if (mensagemTemplate != null && !mensagemTemplate.getDesabilitarEnvioMensagemAutomatica()) {
			...
			throw new Exception("No foi encontrado um modelo de mensagem habilitado no sistema.");
		}
	}
...
//				} catch (Exception e) {
//					mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.OPCAO_LINGUA_ESTRANGEIRA.name(), "No informado.");
//				}
//			} else {
//				mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.OPCAO_LINGUA_ESTRANGEIRA.name(), inscricaoVO.getOpcaoLinguaEstrangeira().getNome());
//			}
...
//		}
		...
		if (inscricaoVO.getCursoOpcao1().getCodigo() > 0) {
			...
			cursosInscritos.append(" <strong>1 Opo: ").append(inscricaoVO.getCursoOpcao1().getCurso().getNome()).append(" - ").append(inscricaoVO.getCursoOpcao1().getTurno().getNome()).append("</strong>");
			cursosInscritos.append("</li>");
		}
		if (inscricaoVO.getCursoOpcao2().getCodigo() > 0) {
			...
			cursosInscritos.append("<li>");
			cursosInscritos.append(" <strong>2 Opo: ").append(inscricaoVO.getCursoOpcao2().getCurso().getNome()).append(" - ").append(inscricaoVO.getCursoOpcao2().getTurno().getNome()).append("</strong>");
			cursosInscritos.append("</li>");
		}
		if (inscricaoVO.getCursoOpcao3().getCodigo() > 0) {
			...
			cursosInscritos.append("<li>");
			cursosInscritos.append(" <strong>3 Opo: ").append(inscricaoVO.getCursoOpcao3().getCurso().getNome()).append(" - ").append(inscricaoVO.getCursoOpcao3().getTurno().getNome()).append("</strong>");
			cursosInscritos.append("</li>");
		}
...
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.CURSOS_INSCRITOS.name(), cursosInscritos.toString());
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.SUPPORTS)
	@Override
	public void executarEnvioMensagemNovaVagaBancoCurriculum( Boolean enviarSomenteParaCidadeInformada, UsuarioVO usuarioVO, PersonalizacaoMensagemAutomaticaVO mensagemTemplate, List<PessoaVO> pessoaVOs) throws Exception {
		// PersonalizacaoMensagemAutomaticaVO mensagemTemplate =
	...
	public String obterMensagemFormatadaMensagemNovaVagaBancoCurriculum( PessoaVO pessoaVO, final String mensagemTemplate) {
//		String mensagemTexto = mensagemTemplate;
...
//			vagasVO.setCargo("Dados no informados pela empresa");
//		}
...
//			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.NOME_PARCEIRO.name(), "<No Disponvel>");
//		} else {
...
//			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.NUMERO_VAGA.name(), "Dados no informados pela empresa");
//		} else {
...
//			vagasVO.setEscolaridadeRequerida("Dados no informados pela empresa");
//		}
...
//			vagasVO.setConhecimentoEspecifico("Dados no informados pela empresa");
//		}
...
//			vagasVO.setPrincipalAtividadeCargo("Dados no informados pela empresa");
//		}
...
//			if (vagasVO.getViagem().booleanValue()) {
//				disponibilidade += "| Mudanas";
//			} else {
//				disponibilidade += "Mudanas";
//			}
//		}
//		if (disponibilidade.equals("")) {
//			disponibilidade = "Dados no informados pela empresa";
//		}
...
//		}
//		if (software.equals("")) {
//			software = "Dados no informados pela empresa";
//		}
...
//			idioma += "Ingls, nvel: " + vagasVO.getNivel_Apresentar(vagasVO.getInglesNivel());
//		}
//		if (vagasVO.getEspanhol().booleanValue()) {
//			if (idioma.equals("")) {
//				idioma += "Espanhol, nvel: " + vagasVO.getNivel_Apresentar(vagasVO.getEspanholNivel());
//			} else {
//				idioma += "| Espanhol, nvel: " + vagasVO.getNivel_Apresentar(vagasVO.getEspanholNivel());
//			}
//		}
...
//			if (idioma.equals("")) {
//				idioma += "Francs, nvel: " + vagasVO.getNivel_Apresentar(vagasVO.getFrancesNivel());
//			} else {
//				idioma += "| Francs, nvel: " + vagasVO.getNivel_Apresentar(vagasVO.getFrancesNivel());
//			}
//		}
//		if (idioma.equals("")) {
//			idioma = "Dados no informados pela empresa";
//		}
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.IDIOMA.name(), idioma);
//		if (vagasVO.getBeneficios().equals("")) {
//			vagasVO.setBeneficios("Dados no informados pela empresa");
//		}
...
//			vagasVO.setHorarioTrabalho("Dados no informados pela empresa");
//		}
...
//			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.SALARIO.name(), "Dados no informados pela empresa");
//		} else {
//			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.SALARIO.name(), vagasVO.getSalario_Apresentar());
//		}
//		if (vagasVO.getNumeroVagas().toString().trim().equals("")) {
//			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.NR_VAGA.name(), "Dados no informados pela empresa");
//		} else {
...
//		}
	...
	private void preencherMensagemNotificacaoNaoLacamentoNota(PersonalizacaoMensagemAutomaticaVO mensagemTemplate,  ComunicacaoInternaVO comunicacao, ConfiguracaoGeralSistemaVO config, UsuarioVO usuarioVO) throws Exception {
		comunicacao.setAssunto(mensagemTemplate.getAssunto());
		comunicacao.setCaminhoImagemPadraoCima(mensagemTemplate.getCaminhoImagemPadraoCima());
		comunicacao.setCaminhoImagemPadraoBaixo(mensagemTemplate.getCaminhoImagemPadraoBaixo());
		comunicacao.setCopiaFollowUp(mensagemTemplate.getCopiaFollowUp());
...
//		comunicacao.setComunicadoInternoDestinatarioVOs(obterListaDestinatarios(notificacaoRegistroAulaNaoLancadaVO.getProfessor(), mensagemTemplate.getEnviarCopiaPais()));
	...
	public String obterMensagemFormatadaMensagemNotificacaoLocalAulaTurmaAluno(PessoaVO aluno, final String mensagemTemplate) {
//		String mensagemTexto = mensagemTemplate;
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.NOME_ALUNO.name(), aluno.getNome());
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.NOME_PROFESSOR.name());
...
//		return mensagemTexto;
	...
	public String obterMensagemFormatadaMensagemNotificacaoLocalAulaTurmaProfessor( final String mensagemTemplate) {
//		String mensagemTexto = mensagemTemplate;
	...
	public void executarEnvioMensagemAniversarianteDia() throws Exception {
		...
		if ((mensagemTemplate != null && !mensagemTemplate.getDesabilitarEnvioMensagemAutomatica())) {
			...
			while (rs.next()) {
				...
				comunicacao.setCodigo(0);
				comunicacao.getComunicadoInternoDestinatarioVOs().clear();
				comunicacao.setAssunto("Feliz Aniversrio");
				comunicacao.setCaminhoImagemPadraoCima(mensagemTemplate.getCaminhoImagemPadraoCima());
				comunicacao.setCaminhoImagemPadraoBaixo(mensagemTemplate.getCaminhoImagemPadraoBaixo());
				comunicacao.setCopiaFollowUp(mensagemTemplate.getCopiaFollowUp());
...
//							    trabalhoConclusaoCursoVO.getMatriculaPeriodoTurmaDisciplina().getMatricula(), 
...
//		}
	...
	public void executarEnvioMensagemAprovacaoOrientador(TrabalhoConclusaoCursoVO trabalhoConclusaoCursoVO, UsuarioVO usuario) throws Exception {
		MatriculaVO matriculaVO = getFacadeFactory().getMatriculaFacade().consultarPorChavePrimaria(trabalhoConclusaoCursoVO.getMatriculaPeriodoTurmaDisciplina().getMatricula(), 0, Uteis.NIVELMONTARDADOS_COMBOBOX, null);
...
//		}
	...
	public String obterMensagemFormatadaMensagemAlunosBaixaFrequencia( final String mensagemTemplate) {
		String mensagemTexto = mensagemTemplate;
...
//		}
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.SUPPORTS)
	@Override
	public void executarEnvioMensagemNotificacaoProcessoSeletivo(Integer processoSeletivo, Integer unidadeEnsino, Integer itemProcSeletivoDataProva, Integer sala,  UsuarioVO usuarioVO) throws Exception {
//		PersonalizacaoMensagemAutomaticaVO mensagemTemplate = null;
//		try {
...
//			}
//			if (mensagemTemplate == null) {
//				throw new Exception("Mensagem Personalizada para Notificao de Processo Seletivo no foi gerada!");
//			}
//			if (mensagemTemplate.getDesabilitarEnvioMensagemAutomatica()) {
//				throw new Exception(mensagemTemplate.getAssunto() + " no est habilitada!");
//			} else {
//				ConfiguracaoGeralSistemaVO config = getFacadeFactory().getConfiguracaoGeralSistemaFacade().consultarConfiguraoesEnvioEmail();
...
//		if (inscricaoVO.getCursoOpcao2().getCurso().getCodigo() > 0) {
//			cursosInscritos.append("<li>");
//			cursosInscritos.append(" <strong>2 Opo: ").append(inscricaoVO.getCursoOpcao1().getCurso().getNome()).append(" - ").append(inscricaoVO.getCursoOpcao2().getTurno().getNome()).append("</strong>");
//			cursosInscritos.append("</li>");
//		}
//		if (inscricaoVO.getCursoOpcao3().getCurso().getCodigo() > 0) {
//			cursosInscritos.append("<li>");
//			cursosInscritos.append(" <strong>3 Opo: ").append(inscricaoVO.getCursoOpcao1().getCurso().getNome()).append(" - ").append(inscricaoVO.getCursoOpcao3().getTurno().getNome()).append("</strong>");
//			cursosInscritos.append("</li>");
//		}
//		cursosInscritos.append("</ul>");
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.CURSOS_INSCRITOS.name(), cursosInscritos.toString());
//		return mensagemTexto;
	...
	@Override
	public void executarEnvioMensagemAprovacaoProcessoSeletivo(UsuarioVO usuario) throws Exception {
//		PersonalizacaoMensagemAutomaticaVO mensagemTemplate;
...
//		}
	...
	public String obterMensagemFormatadaMensagemNovaAtividadeDiscursiva(AtividadeDiscursivaVO atividadeDiscursiva, MatriculaPeriodoTurmaDisciplinaVO matriculaPeriodoTurmaDisciplinaVO, final String mensagemTemplate) {
		...
		if (atividadeDiscursiva.getTurmaDisciplinaDefinicoesTutoriaOnlineEnum().isProgramacaoAula()) {
			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.PERIODO_ATIVIDADE_DISCURSIVA.name(), Uteis.getData(atividadeDiscursiva.getDataLiberacao(), "dd/MM/yyyy HH:mm") + " at " + Uteis.getData(atividadeDiscursiva.getDataLimiteEntrega(), "dd/MM/yyyy HH:mm") + ".");
		} else {
			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.PERIODO_ATIVIDADE_DISCURSIVA.name(), atividadeDiscursiva.getQtdDiasParaConclusao() + " dia(s) aps o inco do estudo Online. ");
		}
	...
	public void executarEnvioMensagemNotificacaoNovaInteraaoAtividadeDiscursiva(AtividadeDiscursivaInteracaoVO atividadeDiscursivaInteracaoVO, UsuarioVO usuario) throws Exception {
		...
		if (mensagemTemplate != null && !mensagemTemplate.getDesabilitarEnvioMensagemAutomatica()) {
			...
			if (Uteis.isAtributoPreenchido(pessoaVO2)) {
				mensagemEditada = obterMensagemFormatadaMensagemNotificacaoNovaInteraaoAtividadeDiscursiva(pessoaVO2.getNome(), atividadeDiscursivaInteracaoVO.getDataInteracao(), mensagemTemplate.getMensagem());
				mensagemSMSEditada = obterMensagemFormatadaMensagemNotificacaoNovaInteraaoAtividadeDiscursiva(pessoaVO2.getNome(), atividadeDiscursivaInteracaoVO.getDataInteracao(), mensagemTemplate.getMensagemSMS());
			}
			comunicacaoEnviar.setMensagem(mensagemEditada);
			if (!mensagemTemplate.getDesabilitarEnvioMensagemSMSAutomatica()) {
				comunicacaoEnviar.setMensagemSMS(mensagemSMSEditada);
	...
	public String obterMensagemFormatadaMensagemNotificacaoNovaInteraaoAtividadeDiscursiva(String nome, Date dataInteracao, final String mensagemTemplate) throws Exception {
		String mensagemTexto = mensagemTemplate;
	...
	private String obterMensagemFormatadaNotificacaoRespondenteAvaliacaoInstitucional(AvaliacaoInstitucionalAnaliticoRelVO avaliacaoInstitucionalAnaliticoRelVO, AvaliacaoInstitucionalVO avaliacaoInstitucionalVO, String mensagemTemplate) {
		...
		if(avaliacaoInstitucionalVO.getAvaliacaoUltimoModulo()) {
			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.DATA_INICIO_AVALIACAO_INSTITUCIONAL.name(), avaliacaoInstitucionalVO.getDataInicio_Apresentar()+" s "+avaliacaoInstitucionalVO.getHoraInicio()+"h ");
			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.DATA_TERMINO_AVALIACAO_INSTITUCIONAL.name(), Uteis.getData(Uteis.obterDataAvancada(new Date(), avaliacaoInstitucionalVO.getDiasDisponivel())) +" s "+avaliacaoInstitucionalVO.getHoraFim()+"h ");
		}else {
	...
	public String obterMensagemFormatadaMensagemGsuiteCriacaoConta(PessoaGsuiteVO pessoaGsuite, ConfiguracaoGeralSistemaVO config, final String mensagemTemplate) {
		...
		if(config.getGerarSenhaCpfAluno() || pessoaGsuite.getPessoaVO().getFuncionario()) {
			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.SENHA_GSUITE.name(), "Sua senha temporria  os nmeros do seu cpf.");	
		}else {
			mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.SENHA_GSUITE.name(), "Sua senha temporria  os nmeros da sua matrcula.");
		}
		return mensagemTexto;
	}
	...
	public void enviarMensagemAvisoErroPagamentoCartaoCredito(UsuarioVO usuarioVO) throws Exception {
...
//		}
	...
	public void enviarMensagemAvisoSucessoPagamentoCartaoCredito( UsuarioVO usuarioVO) throws Exception {
...
//		mensagemTexto = mensagemTexto.replaceAll(TagsMensagemAutomaticaEnum.TURMA.name(), estagioVO.getMatriculaVO().getTurma().getIdentificadorTurma());
	...
	@Override
	public void executarEnvioMensagemNotificacaoLocalAulaTurma(Integer codGrupoDestinatario, UsuarioVO usuario)
			throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public void executarEnvioMensagemBuscaProspect(PersonalizacaoMensagemAutomaticaVO mensagemTemplate,
			ComunicacaoInternaVO comunicacaoEnviar) throws Exception {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void executarEnvioMensagemCobrancaAlunoInadimplentePeriodico(Integer codigoUnidade,
			Integer codigoConfiguracoes) throws Exception {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void executarEnvioMensagemCobrancaAlunoInadimplente(Integer codigoUnidade, Integer codigoConfiguracoes)
			throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public void executarEnvioMensagemNotificacaoNovaInteraçaoAtividadeDiscursiva(
			AtividadeDiscursivaInteracaoVO atividadeDiscursivaInteracaoVO, UsuarioVO usuario) throws Exception {
		// TODO Auto-generated method stub
