...
@Scope("singleton")
@Lazy
public class FuncionarioCargo extends ControleAcesso   {
...
//                 }
   ...
   /* public List<FuncionarioCargoVO> consultarTodosFuncionariosCargoAtivo(int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     */
    public  FuncionarioCargoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario)
			throws Exception {
		FuncionarioCargoVO obj = new FuncionarioCargoVO();
		obj.setNovoObj(Boolean.FALSE);
...
//		obj.montarCentroCusto(obj.getFuncionarioVO());
    ...
    public  void montarUnidadeEnsino(FuncionarioCargoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getUnidade().getCodigo().intValue() == 0) {
	...
	public  void montarDadosCargo(FuncionarioCargoVO obj, int nivelMontarDados, UsuarioVO usuario)
			throws Exception {
		if (obj.getCargo().getCodigo().intValue() == 0) {
...
//			}
	...
	private  void validarDadosDuplicidadeFuncionarioCargo(FuncionarioCargoVO obj) throws ConsistirException {
	...
	private  int consultarDadosTotalFuncionarioCargoPorMatricula(FuncionarioCargoVO obj) {
		StringBuilder sql = new StringBuilder();
