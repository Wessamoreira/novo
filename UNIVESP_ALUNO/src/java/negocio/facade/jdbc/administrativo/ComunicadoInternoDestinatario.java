...
public class ComunicadoInternoDestinatario extends ControleAcesso implements ComunicadoInternoDestinatarioInterfaceFacade {
     ...
     */
    public  ComunicadoInternoDestinatarioVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        ComunicadoInternoDestinatarioVO obj = new ComunicadoInternoDestinatarioVO();
     ...
     */
    public  void montarDadosDestinatario(ComunicadoInternoDestinatarioVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getDestinatario().getCodigo().intValue() == 0) {
...
//            }
     ...
     * @exception Exception  Erro de conexão com o BD ou restrição de acesso a esta operação.
     */
    public  List consultarComunicadoInternoDestinatarios(Integer comunicadoInterno, int nivelMontarDados, UsuarioVO usuario) throws Exception {
