...
//		arquivoVO.setNome(
//				new Date().getTime() + "_" + usuarioVO.getCodigo() + "." + upload.getFile().getFileExtension());
...
//		arquivoVO.setExtensao(upload.getFile().getFileExtension());
...
//			}
	...
	public void uploadLogoTopo(ConfiguracaoAparenciaSistemaVO configuracaoAparenciaSistemaVO, FileUploadEvent upload,
		...
		String nomeImagem = String.valueOf(new Date().getTime()) + upload.getFile().getFileName().substring(
				upload.getFile().getFileName().lastIndexOf("."), upload.getFile().getFileName().length());
