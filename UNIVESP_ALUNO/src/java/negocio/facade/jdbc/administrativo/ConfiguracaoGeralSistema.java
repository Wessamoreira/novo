...
//		montarDadosPerfilEconomicoPadrao(obj, nivelMontarDados, usuario);
	...
	public  void montarDadosCertificadoParaDocumento(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public  void montarDadosPerfilPadraoCandidato(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPerfilPadraoCandidato().getCodigo().intValue() == 0) {
	...
	public  void montarDadosPerfilPadraoPais(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPerfilPadraoPais().getCodigo().intValue() == 0) {
	...
	public  void montarDadosPerfilPadraoOuvidoria(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPerfilPadraoOuvidoria().getCodigo().intValue() == 0) {
	...
	public  void montarDadosConfiguracoes(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getConfiguracoesVO().getCodigo().intValue() == 0) {
...
//	}
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosPerfilPadraoProfessor(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPerfilPadraoProfessorGraduacao().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosPerfilPadraoProfessorExtensao(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPerfilPadraoProfessorExtensao().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosPerfilPadraoCoordenador(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPerfilPadraoCoordenador().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosPerfilPadraoAluno(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPerfilPadraoAluno().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosVisaoPadraoCandidato(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getVisaoPadraoCandidato().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosVisaoPadraoProfessor(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getVisaoPadraoProfessor().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosVisaoPadraoCoordenador(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getVisaoPadraoCoordenador().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosVisaoPadraoAluno(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getVisaoPadraoAluno().getCodigo().intValue() == 0) {
	...
	public  void montarDadosVisaoPadraoPais(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getVisaoPadraoPais().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosPerfilPadraoParceiro(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPerfilPadraoParceiro().getCodigo().intValue() == 0) {
	...
	public  void montarDadosResponsavelPadraoComunicadoInterno(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public  void montarDadosFuncionarioRespAlteracaoDados(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getFuncionarioRespAlteracaoDados().getCodigo().intValue() == 0) {
	...
	public  void montarDadosMotivoPadraoAbandonoCurso(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getMotivoPadraoAbandonoCurso().getCodigo().intValue() == 0) {
	...
	public  void montarDadosMotivoPadraoCancelamentoPreMatriculaCalouro(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
...
//		return "";
    ...
    public  void montarDadosMotivoPadraoCancelamentoMatriculaPorOutraMatricula(ConfiguracaoGeralSistemaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
