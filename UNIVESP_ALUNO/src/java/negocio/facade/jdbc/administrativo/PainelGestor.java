...
public class PainelGestor extends ControleAcesso implements PainelGestorInterfaceFacade {
	 ...
	 * 
	 */
	public void executarInicializacaoDadoFinanceiroPainelGestor(PainelGestorVO painelGestorVO, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino,  String filtrarPeriodoPor) throws Exception {
		try {
...
//			painelGestorVO.getLegendaGraficoReceitaDespesaVOs().clear();
	...
	public void executarDetalhamentoReceitaDoMesPorMesAnoETipoOrigemSituacaoTipoMapareceitaTipoDesconto(PainelGestorVO painelGestorVO, PainelGestorContaReceberMesAnoVO painelGestorContaReceberMesAnoVO, String tipoOrigem, String situacao, String tipoMapaReceita, String tipoDesconto, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino,  Integer codigoCurso, Integer codigoTurma, String filtarPeriodoPor) throws Exception {
		...
		validarDadosUnidadeEnsino(unidadeEnsinoVOs);
		consultarDetalhamentoContaReceberDoMesPorMesAnoTipoOrigem(painelGestorContaReceberMesAnoVO, mes, ano, tipoOrigem, situacao, tipoMapaReceita, tipoDesconto, unidadeEnsinoVOs, dataInicio, dataTermino,  codigoCurso, codigoTurma, filtarPeriodoPor);
		...
		if (tipoDesconto.equals("CONVENIO") || tipoDesconto.equals("INSTITUICAO") || tipoDesconto.equals("PROGRESSIVO")) {
			consultarDadosFinanceiroDetalhamentoDesconto(painelGestorVO, painelGestorContaReceberMesAnoVO, mes, ano, tipoOrigem, situacao, tipoMapaReceita, tipoDesconto, unidadeEnsinoVOs, dataInicio, dataTermino,  filtarPeriodoPor);
		}
	}

	public void consultarDetalhamentoContaReceberDoMesPorMesAnoTipoOrigem(PainelGestorContaReceberMesAnoVO painelGestorContaReceberMesAnoVO, int mes, int ano, String tipoOrigem, String situacao, String tipoMapaReceita, String tipoDesconto, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino,   Integer codigoCurso, Integer codigoTurma, String filtarPeriodoPor) throws Exception {
...
//		}
	...
	public void consultarDadosFinanceiroDetalhamentoDesconto(PainelGestorVO painelGestorVO, PainelGestorContaReceberMesAnoVO painelGestorContaReceberMesAnoVO, int mes, int ano, String tipoOrigem, String situacao, String tipoMapaReceita, String tipoDesconto, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino,  String filtrarPeriodoPor) throws Exception {
		if (tipoMapaReceita.equals("FLUXO_CAIXA")) {
...
//		}
	 ...
	 * @author CarlosEugenio
	 */
	public void consultarMapaReceitaPorCompetenciaPainelGestorFinanceiroPorNivelEducacional(PainelGestorVO painelGestorVO, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino, TipoNivelEducacional tipoNivelEducacional, String mesAno,  String filtrarPeriodoPor) throws Exception {
	...
	public void consultarMapaReceitaPorFluxoCaixaPainelGestorFinanceiroPorNivelEducacional(PainelGestorVO painelGestorVO, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino, TipoNivelEducacional tipoNivelEducacional, String mesAno) throws Exception {
		painelGestorVO.getPainelGestorContaReceberFluxoCaixaMesAnoVOs().clear();
		StringBuilder sb = new StringBuilder();
		sb.append(" select receitaNoMes, descontoNoMes, acrescimo, ");
		sb.append(" descontoconvenio, descontoinstituicao, valorDescontoprogressivo, descontoaluno, descontorecebimento, descontorateio, ");
	...
	public void consultarMapaReceitaPorFluxoCaixaPainelGestorFinanceiroPorTurma(PainelGestorVO painelGestorVO, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino, TipoNivelEducacional tipoNivelEducacional,  Integer codigoCurso) throws Exception {
		painelGestorVO.getPainelGestorContaReceberFluxoCaixaMesAnoVOs().clear();
		StringBuilder sb = new StringBuilder();
		sb.append(" select receitaNoMes, descontoNoMes, acrescimo, ");
		sb.append(" descontoconvenio, descontoinstituicao, valorDescontoprogressivo, descontoaluno, descontorecebimento, descontorateio, ");
	 ...
	 * @throws Exception
	 */
	public void executarInicializacaoDadosMapaReceitaPorTurma(PainelGestorVO painelGestorVO, String tipoMapaReceita, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino, TipoNivelEducacional tipoNivelEducacional, String mesAno,  Integer codigoCurso, String filtrarPeriodoPor) throws Exception {
		if (!mesAno.isEmpty()) {
		...
		if (tipoMapaReceita.equals("COMPETENCIA")) {
			...
			consultarDadosMapaReceitaPorTurma(painelGestorVO.getPainelGestorPorNivelEducacionalVO(), unidadeEnsinoVOs, dataInicio, dataTermino, tipoNivelEducacional,  codigoCurso, filtrarPeriodoPor);
		} else {
			consultarMapaReceitaPorFluxoCaixaPainelGestorFinanceiroPorTurma(painelGestorVO.getPainelGestorPorNivelEducacionalVO(), unidadeEnsinoVOs, dataInicio, dataTermino, tipoNivelEducacional,  codigoCurso);
		}
	}

	public void executarInicializacaoDadosMapaReceitaPorNivelEducacional(PainelGestorVO painelGestorVO, String tipoMapaReceita, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino, TipoNivelEducacional tipoNivelEducacional, String mesAno,  String filtrarPeriodoPor) throws Exception {
		if (!mesAno.isEmpty()) {
			String mes = mesAno.substring(0, mesAno.indexOf("/"));
			String ano = mesAno.substring(mesAno.indexOf("/") + 1, mesAno.length());
			dataInicio = Uteis.gerarDataDiaMesAno(1, Integer.valueOf(mes), Integer.valueOf(ano));
		...
		if (tipoMapaReceita.equals("COMPETENCIA")) {
			consultarMapaReceitaPorCompetenciaPainelGestorFinanceiroPorNivelEducacional(painelGestorVO.getPainelGestorPorNivelEducacionalVO(), unidadeEnsinoVOs, dataInicio, dataTermino, tipoNivelEducacional, mesAno,  filtrarPeriodoPor);
		} else {
			consultarMapaReceitaPorFluxoCaixaPainelGestorFinanceiroPorNivelEducacional(painelGestorVO.getPainelGestorPorNivelEducacionalVO(), unidadeEnsinoVOs, dataInicio, dataTermino, tipoNivelEducacional, mesAno);
		}
	...
	public void consultarDadosMapaReceitaPorNivelEducacional(PainelGestorVO painelGestorVO, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino, TipoNivelEducacional tipoNivelEducacional) throws Exception {
	...
	public void consultarDadosMapaReceitaPorTurma(PainelGestorVO painelGestorVO, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino, TipoNivelEducacional tipoNivelEducacional,  Integer codigoCurso, String filtrarPeriodoPor) throws Exception {
...
//		executarCriacaoGraficoPainelGestorAcademicoPorNivelEducacional(painelGestorVO);
	...
	public void executarInicializacaoDadosMapaPainelGestorAcademicoXFinanceiroPorNivelEducacional(PainelGestorVO painelGestorVO, List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino, TipoNivelEducacional tipoNivelEducacional, String mesAno) throws Exception {
		if (!mesAno.isEmpty()) {
			String mes = mesAno.substring(0, mesAno.indexOf("/"));
			String ano = mesAno.substring(mesAno.indexOf("/") + 1, mesAno.length());
			dataInicio = Uteis.gerarDataDiaMesAno(1, Integer.valueOf(mes), Integer.valueOf(ano));
...
//			FILTRO SEMESTRAL
	...
	@Override
	public void executarCriacaoGraficoLinhaRecebimentoPagamento(PainelGestorVO painelGestorVO,
			List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino, Boolean mesmoMesAno)
			throws Exception {
	...
	@Override
	public void executarCriacaoGraficoCategoriaDespesa(PainelGestorVO painelGestorVO,
			List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino,
			String identificadorCategoriaPrincipal, Integer departamento, Boolean telaInicial, Integer limite,
	...
	@Override
	public void executarCriacaoGraficoConsumo(PainelGestorVO painelGestorVO, List<UnidadeEnsinoVO> unidadeEnsinoVOs,
			Date dataInicio, Date dataTermino, Boolean telaInicial) throws Exception {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void executarCriacaoGraficoCategoriaDespesaPorDepartamento(PainelGestorVO painelGestorVO,
			List<UnidadeEnsinoVO> unidadeEnsinoVOs, Date dataInicio, Date dataTermino, Boolean telaInicial,
			Integer departamento, Date dataCompetenciaInicial, Date dataCompetenciaFinal) throws Exception {
		// TODO Auto-generated method stub
