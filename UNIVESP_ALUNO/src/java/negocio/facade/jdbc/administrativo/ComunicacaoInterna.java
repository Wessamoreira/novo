...
//		}
	 ...
	 *         <code>ComunicacaoInternaVO</code> resultantes da consulta.
	 */
	public  List<ComunicacaoInternaVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public  ComunicacaoInternaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		ComunicacaoInternaVO obj = new ComunicacaoInternaVO();
...
//		obj.setComunicadoInternoDestinatarioVOs(getFacadeFactory().getComunicadoInternoDestinatarioFacade().consultarComunicadoInternoDestinatarios(obj.getCodigo(), nivelMontarDados, usuario));
	...
	public  void montarDadosArquivo(ComunicacaoInternaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getArquivoAnexo().getCodigo().intValue() == 0) {
	 ...
	 */
	public  void montarDadosComunicadoInternoOrigem(ComunicacaoInternaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getComunicadoInternoOrigem().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosProfessor(ComunicacaoInternaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getProfessor().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosAluno(ComunicacaoInternaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getAluno().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosUnidadeEnsino(ComunicacaoInternaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getUnidadeEnsino().getCodigo().intValue() == 0) {
	...
	public  void montarDadosTurma(ComunicacaoInternaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getTurma().getCodigo().intValue() == 0) {
...
//		obj.setAreaConhecimento(getFacadeFactory().getAreaConhecimentoFacade().consultarPorChavePrimaria(obj.getAreaConhecimento().getCodigo(), usuario));
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosDepartamento(ComunicacaoInternaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getDepartamento().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosCargo(ComunicacaoInternaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getCargo().getCodigo().intValue() == 0) {
			return;
		}
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosFuncionario(ComunicacaoInternaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getFuncionario().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosResponsavel(ComunicacaoInternaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getResponsavel().getCodigo().intValue() == 0) {
...
//		} while (dadosSQL.next());
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void executarNotificacaoMensagemPreDefinidaTextoPadrao( PessoaVO pessoa,  UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO) throws Exception {
...
//			}
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void executarNotificacaoMatriculaSerasa( PessoaVO func, String textoPadrao, UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO) throws Exception {
	...
	public ComunicacaoInternaVO realizarMontagemNotificacaoAlteracaoDataProva( ConfiguracaoGeralSistemaVO configuracaoSistema, UsuarioVO usuario, String corpoMensagemSMS, String corpoMensagem, Boolean enviarSmsInformativoAlteracaoDataProva,String assuntoEmail) throws Exception {
		ComunicacaoInternaVO comunicacaoInternaVO = new ComunicacaoInternaVO();
...
//			corpoMensagemSMS = obterMensagemFormatadaMensagemNotificacaoAlteracaoDataProva(inscricaoVO, corpoMensagemSMS);
	...
	public String obterMensagemFormatadaMensagemNotificacaoAlteracaoDataProva(final String mensagemTemplate) {
...
//		}
	...
	@Override
	public ComunicacaoInternaVO realizarMontagemNotificacaoAlteracaoDataProva(InscricaoVO inscricaoVO,
			ConfiguracaoGeralSistemaVO configuracaoSistema, UsuarioVO usuario, String corpoMensagemSMS,
			String corpoMensagem, Boolean enviarSmsInformativoAlteracaoDataProva, String assuntoEmail)
			throws Exception {
