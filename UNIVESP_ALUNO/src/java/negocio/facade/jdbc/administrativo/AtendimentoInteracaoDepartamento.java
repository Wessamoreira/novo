...
@Scope("singleton")
@Lazy
public class AtendimentoInteracaoDepartamento extends ControleAcesso  {
...
//		}
	 ...
	 */
	public  AtendimentoInteracaoDepartamentoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     */
    public  void montarDadosFuncionario(AtendimentoInteracaoDepartamentoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     * @param obj  Objeto no qual será montado os dados consultados.
     */
    public  void montarDadosDepartamento(AtendimentoInteracaoDepartamentoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
