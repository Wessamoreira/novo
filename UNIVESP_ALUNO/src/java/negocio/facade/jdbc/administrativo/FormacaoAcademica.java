...
//                }
     ...
     * @return  List Contendo vários objetos da classe <code>FormacaoAcademicaVO</code> resultantes da consulta.
     */
    public  List<FormacaoAcademicaVO> montarDadosConsulta(SqlRowSet tabelaResultado, UsuarioVO usuario) throws Exception {
     ...
     */
    public  FormacaoAcademicaVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
        FormacaoAcademicaVO obj = new FormacaoAcademicaVO();
...
//        obj.setDescricaoAreaConhecimento(obj.getAreaConhecimento().getNome());
    ...
    public  void montarDadosCidade(FormacaoAcademicaVO obj, UsuarioVO usuario) throws Exception {
...
//		obj.setAreaConhecimento(matriculaVO.getCurso().getAreaConhecimento());
     ...
     * @exception Exception  Erro de conexão com o BD ou restrição de acesso a esta operação.
     */
    public  List consultarFormacaoAcademicas(Integer pessoa, boolean controlarAcesso, UsuarioVO usuario) throws Exception {
        return consultarFormacaoAcademicas(pessoa, controlarAcesso, false, usuario);
    }
    
    public  List consultarFormacaoAcademicas(Integer pessoa, boolean controlarAcesso, boolean funcionario, UsuarioVO usuario) throws Exception {
