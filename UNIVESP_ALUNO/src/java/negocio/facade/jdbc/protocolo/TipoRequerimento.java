...
//        }
     ...
     * @return  List Contendo vários objetos da classe <code>TipoRequerimentoVO</code> resultantes da consulta.
     */
    public  List<TipoRequerimentoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        List<TipoRequerimentoVO> vetResultado = new ArrayList<>(0);
        while (tabelaResultado.next()) {
     ...
     */
    public  TipoRequerimentoVO montarDados(SqlRowSet dadosSQL,  int nivelMontarDados, UsuarioVO usuario) throws Exception {
        TipoRequerimentoVO obj = new TipoRequerimentoVO();
        obj.setNovoObj(Boolean.FALSE);
...
//        obj.getTaxa().setCodigo(dadosSQL.getInt("taxa"));
     ...
     */
    public  void montarDadosDepartamentoResponsavel(TipoRequerimentoVO obj, UsuarioVO usuario) throws Exception {
