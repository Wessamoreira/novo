...
public class TipoRequerimentoCurso extends ControleAcesso implements TipoRequerimentoCursoInterfaceFacade {
	...
	public  List<TipoRequerimentoCursoVO> montarDadosConsulta(SqlRowSet tabelaResultado, UsuarioVO usuario) throws Exception {
	...
	public  TipoRequerimentoCursoVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
		TipoRequerimentoCursoVO obj = new TipoRequerimentoCursoVO();
