...
//		CidTipoRequerimentoVO.validarDados(obj);
	...
	public void inicializarDadosArquivoImportarCid(CidTipoRequerimentoVO cidTipoRequerimentoVO, FileUploadEvent fileUploadEvent, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuarioVO) throws Exception {
		cidTipoRequerimentoVO.getArquivoVO().setNome(ArquivoHelper.criarNomeArquivo(usuarioVO, ArquivoHelper.getExtensaoArquivo(fileUploadEvent.getFile().getFileName())));
		cidTipoRequerimentoVO.getArquivoVO().setExtensao(ArquivoHelper.getExtensaoArquivo(fileUploadEvent.getFile().getFileName()));
		cidTipoRequerimentoVO.getArquivoVO().setDescricao(fileUploadEvent.getFile().getFileName());
