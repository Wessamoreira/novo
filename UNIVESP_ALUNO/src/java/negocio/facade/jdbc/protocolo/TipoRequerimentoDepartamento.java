...
public class TipoRequerimentoDepartamento extends ControleAcesso implements TipoRequerimentoDepartamentoInterfaceFacade {
	...
	public  List<TipoRequerimentoDepartamentoVO> montarDadosConsulta(SqlRowSet tabelaResultado, UsuarioVO usuario) throws Exception {
	...
	public  TipoRequerimentoDepartamentoVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
		TipoRequerimentoDepartamentoVO obj = new TipoRequerimentoDepartamentoVO();
