...
public class AlterarResponsavelRequerimento extends ControleAcesso implements AlterarResponsavelRequerimentoInterfaceFacade {
	...
	public AlterarResponsavelRequerimentoVO consultarPorChavePrimaria(Integer codigoPrm, int nivelMontarDados, UsuarioVO usuario ) throws Exception {
	...
	@Override
	public List<AlterarResponsavelRequerimentoVO> consultarOtimizado(AlterarResponsavelRequerimentoVO alterarResponsavelRequerimentoVO, Date dataIni, Date dataFim, boolean todoPeriodo, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario, int limit, int offset ) throws Exception {
	...
	public  List<AlterarResponsavelRequerimentoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario ) throws Exception {
	...
	public  AlterarResponsavelRequerimentoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario ) throws Exception {
		...
		montarRequisitos(obj, usuario);
		return obj;
	}
	
	public  void montarRequisitos(AlterarResponsavelRequerimentoVO obj, UsuarioVO usuario ) throws Exception {
		if (!obj.getRequerimentos().isEmpty()) {
			obj.setRequerimentoVOs(getFacadeFactory().getRequerimentoFacade().consultarPorCodigo(obj.getRequerimentos(), false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuario));
		}
	}
