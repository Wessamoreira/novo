...
public class UsuarioPerfilAcesso extends ControleAcesso implements UsuarioPerfilAcessoInterfaceFacade {
	...
	public List consultarPorNomeUsuario(String valorConsulta, boolean verificaPermissao, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		consultar(getIdEntidade(), verificaPermissao, usuario);
	 ...
	 */
	public  UsuarioPerfilAcessoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		UsuarioPerfilAcessoVO obj = new UsuarioPerfilAcessoVO();
	 ...
	 */
	public  void montarDadosUnidadeEnsino(UsuarioPerfilAcessoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getUnidadeEnsinoVO().getCodigo().intValue() == 0) {
			return;
		}
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosPerfilAcesso(UsuarioPerfilAcessoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public List consultarUsuarioPerfilAcesso(Integer usuario, int nivelMontarDados, UsuarioVO usuarioVO) throws Exception {
		...
		while (resultado.next()) {
			objetos.add(montarDados(resultado, nivelMontarDados, usuarioVO));
		}
		return objetos;
	}
