...
//                    Uteis.setValuePreparedStatement(obj.getCentroResultadoVO(), ++i, sqlAlterar);
     ...
     */
    public  BibliotecaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        BibliotecaVO obj = new BibliotecaVO();
...
//        obj.setCentroResultadoVO(Uteis.montarDadosVO(dadosSQL.getInt("centroresultado"),  p -> getFacadeFactory().getCentroResultadoFacade().consultarPorChavePrimaria(p, false, Uteis.NIVELMONTARDADOS_COMBOBOX, usuario)));
    ...
    public  void montarDadosTurno(BibliotecaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     */
    public  void montarDadosBibliotecaria(BibliotecaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getBibliotecaria().getCodigo().intValue() == 0) {
     ...
     *            Objeto no qual será montado os dados consultados.
     */
    public  void montarDadosConfiguracaoBiblioteca(BibliotecaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getConfiguracaoBiblioteca().getCodigo().intValue() == 0) {
     ...
     *            Objeto no qual será montado os dados consultados.
     */
    public  void montarDadosCidade(BibliotecaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getCidade().getCodigo().intValue() == 0) {
