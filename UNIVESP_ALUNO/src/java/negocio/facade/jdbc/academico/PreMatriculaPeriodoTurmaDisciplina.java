...
public class PreMatriculaPeriodoTurmaDisciplina extends ControleAcesso implements PreMatriculaPeriodoTurmaDisciplinaInterfaceFacade {
     ...
     */
    public  List consultarPreMatriculaPeriodoTurmaDisciplinas(Integer matriculaPeriodo, boolean controlarAcesso, int nivelMontarDados,UsuarioVO usuario) throws Exception {
        consultar(getIdEntidade(), controlarAcesso,usuario);
