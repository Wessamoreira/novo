...
public class CalendarioAberturaTipoRequerimentoraPrazo extends ControleAcesso implements CalendarioAberturaTipoRequerimentoraPrazoInterfaceFacade {
	...
	public  List<CalendarioAberturaTipoRequerimentoraPrazoVO> montarDadosConsulta(SqlRowSet tabelaResultado, UsuarioVO usuario) throws Exception {
	...
	public  CalendarioAberturaTipoRequerimentoraPrazoVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
