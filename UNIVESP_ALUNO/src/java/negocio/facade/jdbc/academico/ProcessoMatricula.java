...
//            getFacadeFactory().getProcessoMatriculaCalendarioFacade().excluirProcessoMatriculaCalendarios(obj, usuario);
     ...
     * @return List Contendo vários objetos da classe <code>ProcessoMatriculaVO</code> resultantes da consulta.
     */
    public  List<ProcessoMatriculaVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     */
    public  ProcessoMatriculaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        ProcessoMatriculaVO obj = new ProcessoMatriculaVO();
...
//        obj.setProcessoMatriculaCalendarioVOs(getFacadeFactory().getProcessoMatriculaCalendarioFacade().consultarProcessoMatriculaCalendarios(obj.getCodigo(), false, nivelMontarDados, usuario));
...
//            }
            ...
            if (!listaMatriculaPeriodo.isEmpty()) {
                for (MatriculaPeriodoVO matriculaPeriodoVO : listaMatriculaPeriodo) {
                    matriculaPeriodoVO = getFacadeFactory().getMatriculaPeriodoFacade().consultarPorChavePrimaria(matriculaPeriodoVO.getCodigo(), Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuario);
                    ...
                    getFacadeFactory().getMatriculaPeriodoFacade().inicializarDadosParaProcessarGeracaoContasReceberReferentesParcelasMatriculaPeriodo(matriculaPeriodoVO.getMatriculaVO(), matriculaPeriodoVO, matriculaPeriodoVO.getProcessoMatriculaCalendarioVO(), usuario);
                    getFacadeFactory().getMatriculaPeriodoFacade().validarMatriculaPeriodoPodeSerAtivada(matriculaPeriodoVO.getMatriculaVO(), matriculaPeriodoVO, usuario);
                    getFacadeFactory().getMatriculaFacade().alterarSituacaoMatriculaVOParaAtivada(matriculaPeriodoVO.getMatriculaVO(), matriculaPeriodoVO, usuario);
                }
            }
        } catch (Exception e) {
            throw e;
