...
public class Arquivo extends ControleAcesso implements ArquivoInterfaceFacade {
	...
	public void validarDownloadArquivoAluno(UsuarioVO usuario) throws Exception {
		consultar("DownloadArquivo", true, usuario);		
	}
...
//	}
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = { Throwable.class }, propagation = Propagation.REQUIRED)
	public void incluirArquivoSetransp( UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO) throws Exception {
//		try {
...
//	}
	...
	public void excluirRegistroArquivoAmazonPorDocumentacaoMatricula(ArquivoVO obj, boolean verificarAcesso, UsuarioVO usuario) throws Exception {
		try {
			excluir(idEntidade, verificarAcesso, usuario);
			String sql = "DELETE FROM arquivo WHERE ((codigo = ?))" + adicionarUsuarioLogadoComoComentarioParaLogTrigger(usuario);
			getFacadeFactory().getDownloadFacade().excluirDownloadsArquivo(obj, usuario);
//			getFacadeFactory().getLogExclusaoArquivo().realizarRegistroLogExclusaoArquivo(obj, usuario.getVisaoLogar(), usuario);
			getConexao().getJdbcTemplate().update(sql, new Object[] { obj.getCodigo() });
...
//	}
	...
	public void alterarManterDisponibilizacao(ArquivoVO obj, boolean verificarAcesso, String nomeEntidade, UsuarioVO usuario) throws Exception {
		try {
			excluir(nomeEntidade, verificarAcesso, usuario);
...
//		}
	...
	public List<ArquivoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		List<ArquivoVO> vetResultado = new ArrayList<ArquivoVO>(0);
		while (tabelaResultado.next()) {
	...
	public  ArquivoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		ArquivoVO obj = new ArquivoVO();
		obj.setNovoObj(false);
		obj.setCodigo(new Integer(dadosSQL.getInt("codigo")));
	...
	public  void montarDadosPessoa(ArquivoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPessoaVO().getCodigo().intValue() == 0) {
	...
	public  void montarDadosProfessor(ArquivoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getProfessor().getCodigo().intValue() == 0) {
	...
	public  void montarDadosCurso(ArquivoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getCurso().getCodigo().intValue() == 0) {
	 ...
	 */
	public void montarDadosTurma(ArquivoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getTurma().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosDisciplina(ArquivoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getDisciplina().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosResponsavelUpload(ArquivoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getResponsavelUpload().getCodigo().intValue() == 0) {
	...
	public void excluirArquivoSetransp(UsuarioVO usuario) throws Exception {
//		try {
//			getFacadeFactory().getSetranspFacade().excluir(usuario);
...
//	}
	...
	@Override
	public void incluir(ArquivoVO obj, boolean verificarAcesso, UsuarioVO usuario,
	...
	@Override
	public void excluir(ArquivoVO obj, boolean verificarAcesso, String nomeEntidade, UsuarioVO usuario,
			ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO) throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public void excluirPorDocumentacaoMatriculaRequerimento(ArquivoVO obj, boolean verificarAcesso, String nomeEntidade,
	...
	@Override
	public void incluirBackUp(ArquivoVO obj, UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO)
			throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public void excluirBackUp(ArquivoVO obj, boolean verificarAcesso, String nomeEntidade, UsuarioVO usuario,
			ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO) throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public List<File> consultarArquivosNaoVinculadosSistema(ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO,
			boolean filtrarPastaArquivo, boolean filtrarPastaImagem, Integer loteFile) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public void excluirArquivoQueNaoEstaNaListaComCodigoOrigemComOrigemArquivo(List<ArquivoVO> listaArquivo,
