...
//				}
	 ...
	 */
	public  List<GradeCurricularVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public  GradeCurricularVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		GradeCurricularVO obj = new GradeCurricularVO();
	...
	public  void montarDadosResponsavelAtivacao(GradeCurricularVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getResponsavelAtivacao().getCodigo().intValue() == 0) {
	...
	public  void montarDadosResponsavelDesativacao(GradeCurricularVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getResponsavelDesativacao().getCodigo().intValue() == 0) {
	...
	public void ativarGrade(GradeCurricularVO obj, UsuarioVO usuario) throws Exception {
		getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("GradeCurricular_ativarGrade", usuario);
	}

	public void desativarGrade(GradeCurricularVO obj, UsuarioVO usuario) throws Exception {
		getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("GradeCurricular_desativarGrade", usuario);
	}
