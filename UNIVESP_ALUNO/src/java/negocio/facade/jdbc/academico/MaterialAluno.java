...
public class MaterialAluno extends ControleAcesso implements MaterialAlunoInterfaceFacade {
     ...
     * @return List Contendo vários objetos da classe <code>MaterialAlunoVO</code> resultantes da consulta.
     */
    public  List<MaterialAlunoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados) throws Exception {
     ...
     */
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    public  MaterialAlunoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados) throws Exception {
    ...
    public  void montarDadosArquivo(MaterialAlunoVO obj) throws Exception {
