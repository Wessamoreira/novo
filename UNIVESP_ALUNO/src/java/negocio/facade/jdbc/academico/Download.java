...
//        sb.append(" AND matriculaperiodo.semestre = '").append(semestre).append("'");
     ...
     */
    public  DownloadVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        DownloadVO obj = new DownloadVO();
     ...
     */
    public  void montarDadosPesssoa(DownloadVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getPessoa().getCodigo().intValue() == 0) {
     ...
     *            Objeto no qual será montado os dados consultados.
     */
    public  void montarDadosArquivo(DownloadVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getArquivo().getCodigo().intValue() == 0) {
