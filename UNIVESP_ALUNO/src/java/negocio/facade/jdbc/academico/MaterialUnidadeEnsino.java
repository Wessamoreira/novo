...
public class MaterialUnidadeEnsino extends ControleAcesso implements MaterialUnidadeEnsinoInterfaceFacade {
     ...
     * @return List Contendo vários objetos da classe <code>MaterialUnidadeEnsinoVO</code> resultantes da consulta.
     */
    public  List<MaterialUnidadeEnsinoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados) throws Exception {
     ...
     */
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    public  MaterialUnidadeEnsinoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados) throws Exception {
    ...
    public  void montarDadosArquivo(MaterialUnidadeEnsinoVO obj) throws Exception {
