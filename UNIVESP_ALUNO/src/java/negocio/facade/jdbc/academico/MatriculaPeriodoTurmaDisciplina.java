...
//import negocio.interfaces.academico.FrequenciaAulaVO;
//import negocio.interfaces.academico.HorarioAlunoTurnoVO;
...
public class MatriculaPeriodoTurmaDisciplina extends ControleAcesso implements MatriculaPeriodoTurmaDisciplinaInterfaceFacade {
	...
	@Override
	public void realizarSugestaoTurmaPraticaTeorica(MatriculaPeriodoVO matriculaPeriodoVO, MatriculaPeriodoTurmaDisciplinaVO matriculaPeriodoTurmaDisciplinaVO, DisciplinaVO disciplina, ConfiguracaoAcademicoVO configuracaoAcademicoVO,  Boolean considerarVagasReposicao, UsuarioVO usuarioVO) throws Exception{		
		if(Uteis.isAtributoPreenchido(configuracaoAcademicoVO) && configuracaoAcademicoVO.getHabilitarDistribuicaoTurmaPraticaTeoricaRenovacao() && !matriculaPeriodoTurmaDisciplinaVO.getDisciplinaComposta() && !matriculaPeriodoTurmaDisciplinaVO.getSugestaoTurmaPraticaTeoricaRealizada() && !Uteis.isAtributoPreenchido(matriculaPeriodoTurmaDisciplinaVO.getCodigo())){
			...
			if(!sql.toString().isEmpty()){
				...
				if(turmasPraticas != null || turmasTeoricas != null){
					realizarValidacaoChoqueHorarioCombinacaoTurmaTeoricaComPratica(matriculaPeriodoVO, matriculaPeriodoTurmaDisciplinaVO, disciplina, turmasPraticas, turmasTeoricas, configuracaoAcademicoVO,  usuarioVO);
	...
	public void incluir(final MatriculaPeriodoTurmaDisciplinaVO obj,  GradeCurricularVO gradeCurricularVO, UsuarioVO usuario) throws Exception {
//		incluir(null, null, obj,  usuario);
	}
...
//			}			
			...
			if ((matriculaPeriodoVO == null) || (matriculaPeriodoVO.getMatricula().equals(""))) {
				matriculaPeriodoVO = getFacadeFactory().getMatriculaPeriodoFacade().consultarPorChavePrimaria(obj.getMatriculaPeriodo(), Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuario);
			}
			if ((matriculaVO == null) || (matriculaVO.getMatricula().equals(""))) {
				matriculaVO = getFacadeFactory().getMatriculaFacade().consultarPorChavePrimaria(obj.getMatricula(), 0, Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuario);
			}
			// //
			// System.out.println("++++++++++++++++++++++ INCLUI MATRICULA PERIODO TURMA DISCIPLINA  (FINAL) +++++++++++++++++++++++++++");
			getFacadeFactory().getHistoricoFacade().incluirHistorico(obj, matriculaPeriodoVO, matriculaVO,  gradeCurricularVO, usuario);
	...
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void alterar(final MatriculaPeriodoTurmaDisciplinaVO obj,  UsuarioVO usuario) throws Exception {
		alterar(obj.getMatriculaObjetoVO(), obj.getMatriculaPeriodoObjetoVO(), obj,  usuario);
	}
	 ...
	 */
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void alterar(final MatriculaVO matriculaVO, final MatriculaPeriodoVO matriculaPeriodoVO, final MatriculaPeriodoTurmaDisciplinaVO obj,  UsuarioVO usuario) throws Exception {
		MatriculaPeriodoTurmaDisciplinaVO.validarDados(obj);
		if (obj.getModalidadeDisciplina().equals(ModalidadeDisciplinaEnum.ON_LINE) && obj.getConteudo().getCodigo() == 0) {
			obj.getConteudo().setCodigo(getFacadeFactory().getConteudoFacade().consultarCodigoConteudoAtivoTurmaDisciplinaConteudoPorCodigoTurmaDisciplinaAnoSemestre(obj.getTurma().getCodigo(), obj.getDisciplina().getCodigo(), obj.getAno(), obj.getSemestre()));
		}
//		getFacadeFactory().getTrabalhoConclusaoCursoFacade().realizarCriacaoTrabalhoConclusaoCursoAluno(matriculaVO.getCurso().getCodigo(), matriculaVO.getAluno().getCodigo(), matriculaPeriodoVO.getGradeCurricular().getCodigo(), obj, usuario);
		...
		if(getConexao().getJdbcTemplate().update(new PreparedStatementCreator() {
			...
			incluir(obj, matriculaVO.getGradeCurricularAtual(), usuario);
			return;
		}
		getFacadeFactory().getHistoricoFacade().incluirHistorico(obj, matriculaPeriodoVO, matriculaVO,  matriculaVO.getGradeCurricularAtual(), usuario);
	}
	...
	public void excluir(MatriculaPeriodoTurmaDisciplinaVO obj, boolean validarAcesso, UsuarioVO usuario) throws Exception {
		excluir(getIdEntidade(), validarAcesso, usuario);
...
//			System.out.println(sqlStr.toString());
	 ...
	 *         consulta.
	 */
	public  List<MatriculaPeriodoTurmaDisciplinaVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		List<MatriculaPeriodoTurmaDisciplinaVO> vetResultado = new ArrayList<MatriculaPeriodoTurmaDisciplinaVO>(0);
		while (tabelaResultado.next()) {
			MatriculaPeriodoTurmaDisciplinaVO obj = new MatriculaPeriodoTurmaDisciplinaVO();
...
//		obj.getTurma().getChancelaVO().setInstituicaoChanceladora(dadosSQL.getString("Chancela.instituicaoChanceladora"));
	...
	public  MatriculaPeriodoTurmaDisciplinaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		// //
		// System.out.println(">> Montar dados(MatriculaPeriodoTurmaDisciplina) - "
		// + new Date());
		MatriculaPeriodoTurmaDisciplinaVO obj = new MatriculaPeriodoTurmaDisciplinaVO();
...
//			obj.setMatriculaPeriodoObjetoVO(getFacadeFactory().getMatriculaPeriodoFacade().consultarPorChavePrimaria(obj.getMatriculaPeriodo(), Uteis.NIVELMONTARDADOS_DADOSBASICOS, null, usuario));
	 ...
	 */
	public  void montarDadosTurma(MatriculaPeriodoTurmaDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getTurma().getCodigo().intValue() != 0) {
			if(nivelMontarDados == Uteis.NIVELMONTARDADOS_TODOS){
	...
	public  void montarDadosDisciplina(MatriculaPeriodoTurmaDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public  void montarDadosGradeDisciplina(MatriculaPeriodoTurmaDisciplinaVO obj, UsuarioVO usuario) throws Exception {
		if (obj.getGradeDisciplinaVO().getCodigo().intValue() == 0) {
			return;
		}
	...
	public  void montarDadosGradeCurricularGrupoOptativaDisciplina(MatriculaPeriodoTurmaDisciplinaVO obj, UsuarioVO usuario) throws Exception {
		if (obj.getGradeCurricularGrupoOptativaDisciplinaVO().getCodigo().intValue() == 0) {
			return;
		}
	...
	public  void montarDadosGradeDisciplinaComposta(MatriculaPeriodoTurmaDisciplinaVO obj, UsuarioVO usuario) throws Exception {
		if (obj.getGradeDisciplinaCompostaVO().getCodigo().intValue() == 0) {
			return;
		}
	...
	public  void montarDadosMapaEquivalenciaDisciplina(MatriculaPeriodoTurmaDisciplinaVO obj, UsuarioVO usuario) throws Exception {
		if (obj.getMapaEquivalenciaDisciplinaVOIncluir().getCodigo().intValue() == 0) {
			return;
		}
	...
	public  void montarDadosDisciplinaEquivalente(MatriculaPeriodoTurmaDisciplinaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public void excluirMatriculaPeriodoTurmaDisciplinasPorMatricula(String matricula,   UsuarioVO usuario) throws Exception {
		List matriculaPeriodos = getFacadeFactory().getMatriculaPeriodoFacade().consultarUltimaMatriculaPeriodoPorMatricula(matricula, false, Uteis.NIVELMONTARDADOS_DADOSBASICOS,  usuario);
...
//				getFacadeFactory().getHistoricoFacade().excluirHistoricoForaPrazoVerificandoHistoricoPorEquivalencia(obj, null, usuario);
	...
	public void alterarMatriculaPeriodos(Integer matriculaPeriodo, String matricula, List<MatriculaPeriodoTurmaDisciplinaVO> objetos, GradeCurricularVO gradeCurricularVO, UsuarioVO usuario) throws Exception {
		...
		incluirMatriculaPeriodoTurmaDisciplinas(matriculaPeriodo, matricula, objetos,  gradeCurricularVO, usuario);
	}
	...
	public void incluirMatriculaPeriodosForaPrazo(Integer matriculaPeriodo, String matricula, List<MatriculaPeriodoTurmaDisciplinaVO> objetos,  GradeCurricularVO gradeCurricularVO, UsuarioVO usuario) throws Exception {
		...
		incluirMatriculaPeriodoTurmaDisciplinasForaPrazo(matriculaPeriodo, matricula, objetos,  gradeCurricularVO, usuario);
	}
	 ...
	 */
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)	
	public void incluirMatriculaPeriodoTurmaDisciplinasForaPrazo(Integer matriculaPrm, String matricula, List<MatriculaPeriodoTurmaDisciplinaVO> objetos,  GradeCurricularVO gradeCurricularVO, UsuarioVO usuario) throws Exception {
		...
		while (e.hasNext()) {
			...
			if (obj.getCodigo().intValue() != 0) {
				...
				incluir(obj,  gradeCurricularVO, usuario);
			}
		}
	}

	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void incluirMatriculaPeriodoTurmaDisciplinas(Integer matriculaPrm, String matricula, List objetos,  GradeCurricularVO gradeCurricularVO, UsuarioVO usuario) throws Exception {
		...
		try {
			...
			while (e.hasNext()) {
				...
				if (!obj.getNovoObj()) {
					...
					alterar(matriculaVO, matriculaPeriodoVO, obj, usuario);
				} else {

					// //
					// System.out.println("++++++++++++++++++++++ INCLUI MATRICULA PERIODO TURMA DISCIPLINA +++++++++++++++++++++++++++");
					incluir(matriculaVO, matriculaPeriodoVO, obj,  gradeCurricularVO, usuario);
...
//	}
	...
	public List<MatriculaPeriodoTurmaDisciplinaVO> consultarRapidaDisciplinaFazParteComposicaoPorMatriculaPeriodoGradeDisciplina(Integer matriculaPeriodo, Integer gradeDisciplina, boolean verificarAcesso, UsuarioVO usuarioVO) throws Exception {
		getFacadeFactory().getControleAcessoFacade().consultar(getIdEntidade(), verificarAcesso, usuarioVO);
		StringBuffer sqlStr = getSQLPadraoConsultaCompleta();
...
//							if (!getFacadeFactory().getHorarioAlunoFacade().realizarVerificaoChoqueHorarioPorMatriculaPeriodoTurmaDisciplinaVOs(matriculaPeriodoVO, matriculaPeriodoTurmaDisciplinaVOs, matriculaPeriodoTurmaDisciplinaVO.getTurma().getCodigo(), Integer.valueOf(turmaPratica), Integer.valueOf(turmaTeorica), disciplinaVO.getCodigo(), usuarioVO, configuracaoAcademicoVO.getRemoverDisciplinaTurmaPraticaTeoricaComChoqueHorario(), configuracaoAcademicoVO.getValidarChoqueHorarioOutraMatriculaAluno())) {
//								for (Iterator<MatriculaPeriodoTurmaDisciplinaVO> iterator = matriculaPeriodoTurmaDisciplinaVOs.iterator(); iterator.hasNext();) {
//									MatriculaPeriodoTurmaDisciplinaVO matriculaPeriodoTurmaDisciplinaVO2 = (MatriculaPeriodoTurmaDisciplinaVO) iterator.next();
//									if(matriculaPeriodoTurmaDisciplinaVO2.getDisciplina().getCodigo().equals(disciplinaVO.getCodigo())){
//										iterator.remove();
...
//								
//								if (!getFacadeFactory().getHorarioAlunoFacade().realizarVerificaoChoqueHorarioPorMatriculaPeriodoTurmaDisciplinaVOs(matriculaPeriodoVO, matriculaPeriodoTurmaDisciplinaVOs, matriculaPeriodoTurmaDisciplinaVO.getTurma().getCodigo(), Integer.valueOf(turmaPratica), 0, disciplinaVO.getCodigo(), usuarioVO, configuracaoAcademicoVO.getRemoverDisciplinaTurmaPraticaTeoricaComChoqueHorario(), configuracaoAcademicoVO.getValidarChoqueHorarioOutraMatriculaAluno())) {
...
//					if (!getFacadeFactory().getHorarioAlunoFacade().realizarVerificaoChoqueHorarioPorMatriculaPeriodoTurmaDisciplinaVOs(matriculaPeriodoVO, matriculaPeriodoTurmaDisciplinaVOs, matriculaPeriodoTurmaDisciplinaVO.getTurma().getCodigo(), 0, Integer.valueOf(turmaTeorica), disciplinaVO.getCodigo(), usuarioVO, configuracaoAcademicoVO.getRemoverDisciplinaTurmaPraticaTeoricaComChoqueHorario(), configuracaoAcademicoVO.getValidarChoqueHorarioOutraMatriculaAluno())) {
//						Uteis.liberarListaMemoria(matriculaPeriodoTurmaDisciplinaVOs);
//						getFacadeFactory().getTurmaFacade().carregarDados(matriculaPeriodoTurmaDisciplinaVO.getTurmaTeorica(), NivelMontarDados.BASICO, usuarioVO);
//						return;
//					}
...
//		}
	...
	@Override
	public List<MatriculaPeriodoTurmaDisciplinaVO> consultarDisciplinaDoAlunoPorMatricula(String matricula, String anoSemestre, PermissaoAcessoMenuVO permissaoAcessoMenuVOs, Integer matriculaPeriodoTurmaDisciplina, int nivelMontarDados, UsuarioVO usuario) throws SQLException, Exception {
		StringBuilder sqlStr = new StringBuilder();		
...
//       	MatriculaVO matriculaVO = getFacadeFactory().getMatriculaFacade().consultarPorChavePrimaria(matriculaRSVO.getMatricula(), matriculaRSVO.getUnidadeEnsinoRSVO().getCodigo(), Uteis.NIVELMONTARDADOS_TODOS,  usuarioVO);
...
//			
//			realizarMontagenDadosMatriculaPeriodoTurmaDisciplinaDasDisciplinasProcessoSeletivo(usuarioVO, matriculaVO, matriculaPeriodoVO, listaDisciplina);		
//			getFacadeFactory().getMatriculaPeriodoTurmaDisciplinaFacade().incluirMatriculaPeriodoTurmaDisciplinas(matriculaVO, matriculaPeriodoVO, matriculaPeriodoVO.getMatriculaPeriodoTumaDisciplinaVOs(),  matriculaVO.getGradeCurricularAtual(), usuarioVO);
//		    
//		}	
	...
	public void realizarMontagenDadosMatriculaPeriodoTurmaDisciplinaDasDisciplinasProcessoSeletivo(
			UsuarioVO usuarioVO,  MatriculaVO matriculaVO,
