...
//			}
	 ...
	 * @return List Contendo vários objetos da classe <code>CursoVO</code> resultantes da consulta.
	 */
	public  List<CursoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public  CursoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, boolean montarListaGradeCurricularNivelDadosBasicos, UsuarioVO usuario) throws Exception {
		CursoVO obj = new CursoVO();
...
//		obj.getAreaConhecimento().setCodigo(dadosSQL.getInt("areaConhecimento"));
	 ...
	 */
	public  void montarDadosConfiguracaoAcademico(CursoVO obj, UsuarioVO usuario) throws Exception {
	...
	public  void montarDadosConfiguracaoTCC(CursoVO obj, int nivelMontarDados) throws Exception {
...
//		obj.setAreaConhecimento(getFacadeFactory().getAreaConhecimentoFacade().consultarPorChavePrimaria(obj.getAreaConhecimento().getCodigo(), usuario));
	...
	public  void montarDadosFuncionarioRespPreInscricao(CursoVO obj, UsuarioVO usuario) throws Exception {
...
//		obj.getAreaConhecimento().setNome(dadosSQL.getString("areaconhecimento.nome"));
	...
	public List<CursoVO> consultaRapidaPorNomePorCodigoUnidadeEnsinoCondicaoRenegociacao(String nome,  Integer turno, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		getFacadeFactory().getControleAcessoFacade().consultar(getIdEntidade(), controlarAcesso, usuario);
		StringBuffer sqlStr = getSQLPadraoConsultaBasica();
		String and = "";
		sqlStr.append(" LEFT JOIN unidadeensinocurso ON unidadeensinocurso.curso = curso.codigo ");
...
//		}
	...
	public List<CursoVO> consultaRapidaPorCodigoPorCodigoUnidadeEnsinoCondicaoRenegociacao(Integer codigo,  Integer turno, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		getFacadeFactory().getControleAcessoFacade().consultar(getIdEntidade(), controlarAcesso, usuario);
		StringBuffer sqlStr = getSQLPadraoConsultaBasica();
		String and = "";
		sqlStr.append(" LEFT JOIN unidadeensinocurso ON unidadeensinocurso.curso = curso.codigo ");
...
//		}
	...
	public  void montarDadosTextoPadraoContratoMatriculaCalouro(CursoVO obj, int nivelMontarDados ,UsuarioVO usuario) throws Exception {
