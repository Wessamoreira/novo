...
public class AbonoFalta extends ControleAcesso implements AbonoFaltaInterfaceFacade {
	...
	public void incluir(final AbonoFaltaVO obj, UsuarioVO usuario) throws Exception {
		try {
			...
			getFacadeFactory().getControleAcessoFacade().incluir(getIdEntidade(), true, usuario);
...
//		}
	...
	public void alterar(final AbonoFaltaVO obj, UsuarioVO usuario) throws Exception {
		try {
			...
			// getFacadeFactory().getPeriodoLetivoAtivoUnidadeEnsinoCursoFacade().consultarPeriodoLetivoAtivo(obterUnidadeEnsinoCurso(obj,
			// usuario), obterSemestre(obj), obterAno(obj));
			getFacadeFactory().getControleAcessoFacade().alterar(getIdEntidade(), true, usuario);
...
//		}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see negocio.facade.jdbc.academico.AbonoFaltaInterfaceFacade#T
...
//	}
	 ...
	 */
	public  List<AbonoFaltaVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		try {
	 ...
	 *         montados.
	 */
	public  AbonoFaltaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		AbonoFaltaVO obj = new AbonoFaltaVO();
...
//		obj.setDisciplinaAbonoVOs(getFacadeFactory().getDisciplinaAbonoFacade().consultarProAbonoFalta(obj.getCodigo().intValue(), Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuario));
	...
	public  void montarDadosMatricula(AbonoFaltaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public  void montarDadosPessoa(AbonoFaltaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPessoa().getCodigo().intValue() == 0) {
	...
	public  void montarDadosResponsavel(AbonoFaltaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getResponsavel().getCodigo().intValue() == 0) {
