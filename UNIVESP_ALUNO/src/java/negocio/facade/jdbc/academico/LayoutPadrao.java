...
public class LayoutPadrao extends ControleAcesso implements LayoutPadraoInterfaceFacade {
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void persistirFiltroSituacaoAcademica( String entidade, UsuarioVO usuarioVO) throws Exception{
...
//		persistirLayoutPadrao2(filtroRelatorioAcademicoVO.getJubilado().toString(), entidade, "jubilado", usuarioVO);
	...
	@Override	
	public void consultarPadraoFiltroSituacaoAcademica( String entidade, UsuarioVO usuarioVO) throws Exception{
...
//		}
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void persistirFiltroSituacaoHistorico( String entidade, UsuarioVO usuarioVO) throws Exception{
...
//		persistirLayoutPadrao2(filtroRelatorioAcademicoVO.getPreMatriculaHistorico().toString(), entidade, "preMatriculaHistorico", usuarioVO);		
	...
	@Override	
	public void consultarPadraoFiltroSituacaoHistorico( String entidade, UsuarioVO usuarioVO) throws Exception{
...
//	@Override
//	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
//	public void persistirFiltroTipoOrigemContaReceber( String entidade, UsuarioVO usuarioVO) throws Exception{
...
//	@Override	
//	public void consultarPadraoFiltroTipoOrigemContaReceber( String entidade, UsuarioVO usuarioVO) throws Exception{
