...
//        }
     ...
     * resultantes da consulta.
     */
    public  List<DisciplinaVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        try {
            List<DisciplinaVO> vetResultado = new ArrayList<DisciplinaVO>(0);
            while (tabelaResultado.next()) {
    ...
    public  List<DisciplinaVO> montarDadosConsultaUnificacaoDisciplina(SqlRowSet tabelaResultado, UsuarioVO usuario) throws Exception {
        try {
            List<DisciplinaVO> vetResultado = new ArrayList<DisciplinaVO>(0);
            while (tabelaResultado.next()) {
    ...
    public  DisciplinaVO montarDadosUnificacaoDisciplina(SqlRowSet dadosSQL, UsuarioVO usuarioVO) {
        DisciplinaVO obj = new DisciplinaVO();
    ...
    public  List<DisciplinaVO> montarDadosConsultaComNomeGrade(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        List<DisciplinaVO> vetResultado = new ArrayList<DisciplinaVO>(0);
     ...
     */
    public  DisciplinaVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        try {
            DisciplinaVO obj = new DisciplinaVO();
            obj.setCodigo(new Integer(dadosSQL.getInt("codigo")));
            obj.setNome(dadosSQL.getString("nome"));
...
//		sqlStr.append(" ORDER BY disciplina.nome ");
    ...
    public  DisciplinaVO montarDadosPreRequisito(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        DisciplinaVO obj = new DisciplinaVO();
        obj.setCodigo(new Integer(dadosSQL.getInt("codigo")));
        obj.setNome(dadosSQL.getString("nome"));
        obj.setAbreviatura(dadosSQL.getString("abreviatura"));
...
//        }
    ...
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    private void alterarReferenciaTabelaMatriculaPeriodoTurmaDisciplina(final Integer codigoExcluir, final Integer codigoPermanecer,  UsuarioVO usuarioVO) throws Exception {
        ...
        try {
            ...
            if (!listaMatriculaPeriodoTurmaDisciplina.isEmpty()) {
                for (MatriculaPeriodoTurmaDisciplinaVO mptd : listaMatriculaPeriodoTurmaDisciplina) {
                    excluirMatriculaPeriodoTurmaDisciplinaPorDisciplina(mptd, mptd.getMatriculaPeriodo(), codigoPermanecer, codigoExcluir, usuarioVO);
                }
            }
    ...
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    private void alterarReferenciaTabelaMatriculaPeriodoTurmaDisciplinaParaDisciplinaEquivalente(final Integer codigoExcluir, final Integer codigoPermanecer,  UsuarioVO usuarioVO) throws Exception {
    ...
    public void excluirMatriculaPeriodoTurmaDisciplinaPorDisciplina(MatriculaPeriodoTurmaDisciplinaVO mptdExcluir, Integer matriculaPeriodo, Integer codigoPermanecer, Integer codigoExcluir,  UsuarioVO usuarioVO) throws Exception {
        ...
        getFacadeFactory().getMatriculaPeriodoTurmaDisciplinaFacade().alterar(mptdPermanecer, usuarioVO);
        getFacadeFactory().getMatriculaPeriodoTurmaDisciplinaFacade().excluir(mptdExcluir, false, usuarioVO);
    }

    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    private void alterarReferenciaTabelaHistorico(final Integer codigoExcluir, final Integer codigoPermanecer,  UsuarioVO usuario) throws Exception {
        List<HistoricoVO> listaHistorico = getFacadeFactory().getHistoricoFacade().consultarPorCodigoDisciplinaExcluirDisciplinaPermanecerUnificacaoDisciplina(codigoExcluir, codigoPermanecer, Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuario);

        try {

            if (!listaHistorico.isEmpty()) {
                for (HistoricoVO obj : listaHistorico) {
                    excluirHistoricoPorDisciplina(obj, obj.getMatriculaPeriodo().getCodigo(), codigoPermanecer, codigoExcluir, usuario);
                }
            }
    ...
    public void excluirHistoricoPorDisciplina(HistoricoVO historicoExcluir, Integer matriculaPeriodo, Integer codigoPermanecer, final Integer codigoExcluir,  UsuarioVO usuarioVO) throws Exception {
        HistoricoVO historicoPermanecer = getFacadeFactory().getHistoricoFacade().consultarPorMatriculaPeriodoDisciplina(matriculaPeriodo, codigoPermanecer, false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, usuarioVO);
...
//        }
    ...
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    private void alterarReferenciasDisciplinasRemoverParaDisciplinaFinal(Integer codigoExcluir, Integer codigoPermanecer,  UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO) throws Exception {
        try {
            ...
            alterarReferenciaTabelaHistorico(codigoExcluir, codigoPermanecer, usuario);
            ...
            alterarReferenciaTabelaMatriculaPeriodoTurmaDisciplina(codigoExcluir, codigoPermanecer, usuario);
            alterarReferenciaTabelaMatriculaPeriodoTurmaDisciplinaParaDisciplinaEquivalente(codigoExcluir, codigoPermanecer, usuario);
    ...
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    private void processarDisicpliaEspecificaEliminandoDisciplinasRedundantesDoBD(DisciplinaVO disciplinaVO,  UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO) throws Exception {
        try {
            ...
            for (DisciplinaVO disciplinaRemover : listaDisciplinaRemoverBD) {
                ...
                alterarReferenciasDisciplinasRemoverParaDisciplinaFinal(disciplinaRemover.getCodigo(), disciplinaVO.getCodigo(), usuario, configuracaoGeralSistemaVO);
    ...
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    public void executarUnificacaoDeDisciplinasIdenticadas( Integer disciplinaDefazada, UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO) throws Exception {
        ...
        for (DisciplinaVO obj : listaDisciplinasParaProcessamento) {
            ...
            try {
                processarDisicpliaEspecificaEliminandoDisciplinasRedundantesDoBD(obj, usuario, configuracaoGeralSistemaVO);
            } catch (Exception e) {
                // //System.out.print(" +++ >" + e.getMessage());
            }
            // System.out.println("-------------------------------");
...
//		}
    ...
    public Integer consultarTotalCargaHorariaCursadaInclusaoForaGradeTransferenciaMatrizCurricularConcessaoCredito(String matricula, Integer codigoGradeCurricular, UsuarioVO usuario) throws Exception {
        ...
        sqlStr.append(") as t");
        try {
        	Integer result = getConexao().getJdbcTemplate().queryForObject(sqlStr.toString(), Integer.class);
...
//        sb.append(MatriculaPeriodoTurmaDisciplina.getSqlFiltroBaseGradeCurricularAtual(" and "));
    ...
    public  List<DisciplinaVO> montarDadosConsultaCHPrevista(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        try {
            List<DisciplinaVO> vetResultado = new ArrayList<DisciplinaVO>(0);
            while (tabelaResultado.next()) {
    ...
    public  DisciplinaVO montarDadosComCHPrevista(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        try {
