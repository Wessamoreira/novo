...
public class PeriodoLetivo extends ControleAcesso implements PeriodoLetivoInterfaceFacade {
	 ...
	 */
	public  List<PeriodoLetivoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public  PeriodoLetivoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 *                operação.
	 */
	public  PeriodoLetivoVO consultarPorCursoPorPerioLetivo(Integer periodoLetivo, Integer curso, Integer gradeCurricular, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		getFacadeFactory().getControleAcessoFacade().consultar(getIdEntidade(), controlarAcesso, usuario);
...
//						getFacadeFactory().getLogGradeCurricularInterfaceFacade().realizarCriacaoLogExclusaoGradeDisciplina(periodoLetivoVO.getGradeCurricular(), periodoLetivoVO, grade, usuario);
	...
	public PeriodoLetivoVO realizarDefinicaoPeriodoLetivoCursarBaseadoDisciplinasAprovadasMatriculasAntigas(PessoaVO aluno, Integer gradeCurricular ,
            MatriculaPeriodoVO matriculaPeriodoVO, UsuarioVO usuario) throws Exception {
				...
				List<HistoricoVO> historicosMapa  = getFacadeFactory().getMatriculaFacade().realizarCriacaoHistoricoApartirDisciplinasAprovadasMesmaGradeCurricularMatriculaOnline("",aluno.getCodigo() ,gradeCurricular,  matriculaPeriodoVO.getTurma()    , NivelMontarDados.TODOS ,usuario);
	...
	@Override
	public PeriodoLetivoRSVO consultarPeriodoLetivoMatriculaOnline(PessoaVO aluno, Integer gradeCurricular, MatriculaPeriodoVO matriculaPeriodoVO,  UsuarioVO usuarioVO) {
		...
		try {
			PeriodoLetivoVO periodoLetivo = getFacadeFactory().getPeriodoLetivoFacade()
					.realizarDefinicaoPeriodoLetivoCursarBaseadoDisciplinasAprovadasMatriculasAntigas(aluno,
							gradeCurricular, matriculaPeriodoVO, usuarioVO);
