...
public class ConfiguracaoLayoutHistorico extends ControleAcesso implements ConfiguracaoLayoutHistoricoInterfaceFacade {
	...
	public void adicionarLayout(FileUploadEvent uploadEvent, TipoRelatorioEnum tipoRelatorio, ConfiguracaoHistoricoVO configuracaoHistoricoVO, ConfiguracaoLayoutHistoricoVO  configuracaoLayoutHistoricoVO, UsuarioVO usuarioVO) throws Exception{
		if((tipoRelatorio.equals(TipoRelatorioEnum.EXCEL) && configuracaoLayoutHistoricoVO.getArquivoExcelVOs().stream().anyMatch(l -> l.getNome().equals(uploadEvent.getFile().getFileName()))) 
				|| (tipoRelatorio.equals(TipoRelatorioEnum.PDF) && configuracaoLayoutHistoricoVO.getArquivoPdfVOs().stream().anyMatch(l -> l.getNome().equals(uploadEvent.getFile().getFileName())))) {
		...
		arquivoVO.setNome(uploadEvent.getFile().getFileName());
		arquivoVO.setDescricao(uploadEvent.getFile().getFileName());
