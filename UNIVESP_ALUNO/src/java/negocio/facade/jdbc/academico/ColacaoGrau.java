...
public class ColacaoGrau extends ControleAcesso implements ColacaoGrauInterfaceFacade {
	...
	public void incluirComProgramacaoFormaturaAluno(MatriculaVO matriculaVO, ProgramacaoFormaturaAlunoVO programacaoFormaturaAlunoVO, ColacaoGrauVO colacaoGrauVO,  UsuarioVO usuario) throws Exception {
	 ...
	 * @return List Contendo vários objetos da classe <code>ColacaoGrauVO</code> resultantes da consulta.
	 */
	public  List<ColacaoGrauVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public  ColacaoGrauVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		ColacaoGrauVO obj = new ColacaoGrauVO();
	 ...
	 */
	public  void montarDadosSecretariaAcademica(ColacaoGrauVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getSecretariaAcademica().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual será montado os dados consultados.
	 */
	public  void montarDadosPresidenteMesa(ColacaoGrauVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPresidenteMesa().getCodigo().intValue() == 0) {
