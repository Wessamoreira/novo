...
public class TurmaAgrupada extends ControleAcesso implements TurmaAgrupadaInterfaceFacade {
     ...
     *         <code>TurmaAgrupadaVO</code> resultantes da consulta.
     */
    public  List<TurmaAgrupadaVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     */
    public  TurmaAgrupadaVO montarDados(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        TurmaAgrupadaVO obj = new TurmaAgrupadaVO();
    ...
    public  void montarDadosTurma(TurmaAgrupadaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     *                operação.
     */
    public  List<TurmaAgrupadaVO> consultarTurmaAgrupadas(Integer turma, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
