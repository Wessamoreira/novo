...
public class ObservacaoComplementarDiploma extends ControleAcesso implements ObservacaoComplementarDiplomaInterfaceFacade {
	...
	public  List<ObservacaoComplementarDiplomaVO> montarDadosConsulta(SqlRowSet tabelaResultado, UsuarioVO usuario) throws Exception {
	...
	public  ObservacaoComplementarDiplomaVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
		ObservacaoComplementarDiplomaVO obj = new ObservacaoComplementarDiplomaVO();
