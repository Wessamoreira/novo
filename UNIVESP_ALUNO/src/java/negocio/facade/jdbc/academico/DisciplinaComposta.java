...
public class DisciplinaComposta extends ControleAcesso implements DisciplinaCompostaInterfaceFacade {
     ...
     */
    public  DisciplinaCompostaVO montarDados(SqlRowSet dadosSQL, UsuarioVO usuario) throws Exception {
     ...
     */
    public  void montarDadosDisciplinaComposta(DisciplinaCompostaVO obj, UsuarioVO usuario) throws Exception {
