...
public class DisciplinasAproveitadas extends ControleAcesso implements DisciplinasAproveitadasInterfaceFacade {
     ...
     */
    public  List<DisciplinasAproveitadasVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    public  List<DisciplinasAproveitadasVO> montarDadosConsultaComResumoHistorico(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        List<DisciplinasAproveitadasVO> vetResultado = new ArrayList<>(0);
        while (tabelaResultado.next()) {
    ...
    public  DisciplinasAproveitadasVO montarDadosComResumoHistorico(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
     ...
     */
    public  DisciplinasAproveitadasVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        DisciplinasAproveitadasVO obj = new DisciplinasAproveitadasVO();
    ...
    public  void montarDadosPeriodoLetivoGrupoOptativa(DisciplinasAproveitadasVO obj, int nivelMontarDados, UsuarioVO usuarioVO) throws Exception {
    ...
    public  void montarDadosDisciplina(DisciplinasAproveitadasVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
    ...
    public  void montarDadosCidade(DisciplinasAproveitadasVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
