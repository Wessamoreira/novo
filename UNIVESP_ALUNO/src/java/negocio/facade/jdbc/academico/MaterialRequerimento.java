...
public class MaterialRequerimento extends ControleAcesso implements MaterialRequerimentoInterfaceFacade {
     ...
     * @return List Contendo vários objetos da classe <code>MaterialRequerimentoVO</code> resultantes da consulta.
     */
    public  List<MaterialRequerimentoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados) throws Exception {
     ...
     */
    @Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
    public  MaterialRequerimentoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados) throws Exception {
    ...
    public  void montarDadosArquivo(MaterialRequerimentoVO obj) throws Exception {
    ...
    public  void montarDadosUsuarioDisponibilizouArquivo(MaterialRequerimentoVO obj) throws Exception {
        if (obj.getArquivoVO().getCodigo().intValue() == 0) {
            return;
        }
