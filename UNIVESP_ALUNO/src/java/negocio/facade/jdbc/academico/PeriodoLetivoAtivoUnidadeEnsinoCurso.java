...
//		getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade(funcionalidade);
	}
...
//		getFacadeFactory().getControleAcessoFacade().consultar(getIdEntidade(), controlarAcesso, usuario);
	 ...
	 */
	public  PeriodoLetivoAtivoUnidadeEnsinoCursoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		PeriodoLetivoAtivoUnidadeEnsinoCursoVO obj = new PeriodoLetivoAtivoUnidadeEnsinoCursoVO();
		obj.setCodigo(new Integer(dadosSQL.getInt("codigo")));
	...
	public  void montarDadosUnidadeEnsinoCurso(PeriodoLetivoAtivoUnidadeEnsinoCursoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public  void montarDadosResponsavelAbertura(PeriodoLetivoAtivoUnidadeEnsinoCursoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	...
	public  void montarDadosResponsavelFechamento(PeriodoLetivoAtivoUnidadeEnsinoCursoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
