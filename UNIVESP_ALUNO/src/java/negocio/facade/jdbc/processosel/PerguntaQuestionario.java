...
public class PerguntaQuestionario extends ControleAcesso implements PerguntaQuestionarioInterfaceFacade {
	 ...
	 *         <code>PerguntaQuestionarioVO</code> resultantes da consulta.
	 */
	public  List<PerguntaQuestionarioVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
	 ...
	 */
	public  PerguntaQuestionarioVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		PerguntaQuestionarioVO obj = new PerguntaQuestionarioVO();
	 ...
	 */
	public  void montarDadosPergunta(PerguntaQuestionarioVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getPergunta().getCodigo().intValue() == 0) {
	 ...
	 *                operação.
	 */
	public  List consultarPerguntaQuestionarios(Integer questionario, int nivelMontarDados, UsuarioVO usuario) throws Exception {
