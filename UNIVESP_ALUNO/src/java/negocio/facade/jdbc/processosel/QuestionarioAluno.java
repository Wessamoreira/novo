...
//    }
     ...
     */
    public  QuestionarioAlunoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        QuestionarioAlunoVO obj = new QuestionarioAlunoVO();
...
//    }
    public  void montarDadosQuestionario(QuestionarioAlunoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getQuestionario().getCodigo().intValue() == 0) {
    ...
    public  void montarDadosAluno(QuestionarioAlunoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
        if (obj.getAluno().getCodigo().intValue() == 0) {
    ...
    public  void montarDadosRespostaPerguntaAluno(QuestionarioAlunoVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
