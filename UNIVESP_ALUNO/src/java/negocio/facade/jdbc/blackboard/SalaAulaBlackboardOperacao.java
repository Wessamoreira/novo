...
//				incluirPessoaSalaBlack(grupo, sabAluno.getPessoaEmailInstitucionalVO().getPessoaVO().getCodigo(), sabAluno.getTipoSalaAulaBlackboardPessoaEnum(), sabAluno.getMatricula(), sabAluno.getMatriculaPeriodoTurmaDisciplina(), null, msgNotificacao, templateMensagemAutomaticaEnum, sabAluno.getPessoaEmailInstitucionalVO().getEmail(), usuarioVO);
	...
	@Override
	public void realizarOperacaoDeApuracaoNotasAva(String idSalaAulaBlackboard, List<UnidadeEnsinoVO> unidadeEnsinoVOs,
			TipoSalaAulaBlackboardEnum tipoSalaAulaBlackboardEnum, String ano, String semestre, Integer bimestre,
			Integer curso, Integer turma, Integer supervisor, String matricula,
			boolean realizarCalculoMediaApuracaoNotas, boolean realizarBuscarNotaBlackboard, UsuarioVO usuarioLogado,
			String nivelEducacionalApresentar) throws Exception {
