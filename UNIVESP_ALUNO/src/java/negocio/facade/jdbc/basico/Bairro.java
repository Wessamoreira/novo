...
public class Bairro extends ControleAcesso implements BairroInterfaceFacade {
    ...
    */
    public  BairroVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados,UsuarioVO usuario) throws Exception {
        BairroVO obj = new BairroVO();
    ...
    */
    public  void montarDadosCidade(BairroVO obj, int nivelMontarDados,UsuarioVO usuario) throws Exception {
        if (obj.getCidade().getCodigo().intValue() == 0) {
