...
//			getFacadeFactory().getDisciplinasInteresseFacade().setIdEntidade(this.getIdEntidade());
//			getFacadeFactory().getDisciplinasInteresseFacade().alterarDisciplinasInteresses(obj.getCodigo(),  verificarAcesso, usuario);
...
//				obj.setFormacaoAcademicaVOs(getFacadeFactory().getFormacaoAcademicaFacade().consultarFormacaoAcademicas(obj.getCodigo(), false, false, usuario));
//			}
...
//			}
	...
	// return listaProfessores;
	// }
	public List consultarProfessoresDoAluno(Integer codigoAluno, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		consultar(getIdEntidade(), controlarAcesso, usuario);
		...
		listaProfessores = consultarProfessorPorMatriculaPeriodo(codigoAluno, unidadeEnsino, listaProfessores, nivelMontarDados,  usuario);
		return listaProfessores;
	}
	...
	public List consultarProfessorPorMatriculaPeriodo(Integer codigoAluno, Integer unidadeEnsino, List listaProfessores, int nivelMontarDados,  UsuarioVO usuario) throws Exception {
		List<MatriculaVO> matriculas = getFacadeFactory().getMatriculaFacade().consultarMatriculaPorCodigoPessoa(codigoAluno, unidadeEnsino, false, Uteis.NIVELMONTARDADOS_COMBOBOX,  usuario);
...
//		sqlStr.append(" (curso.periodicidade = 'AN' AND matriculaperiodo.ano = '").append(ano).append("' AND matriculaperiodo.semestre = '')) ");
	 ...
	 *         resultantes da consulta.
	 */
	public  List<PessoaVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		List<PessoaVO> vetResultado = new ArrayList<PessoaVO>(0);
		PessoaVO obj = null;
		while (tabelaResultado.next()) {
	 ...
	 *         montados.
	 */
	public  PessoaVO montarDados(SqlRowSet dadosSQL, PessoaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		return montarDados(dadosSQL, obj, false, nivelMontarDados, usuario);
	}

	public  PessoaVO montarDados(SqlRowSet dadosSQL, PessoaVO obj, Boolean funcionario, int nivelMontarDados, UsuarioVO usuario) throws Exception {
...
//		obj.setFormacaoAcademicaVOs(getFacadeFactory().getFormacaoAcademicaFacade().consultarFormacaoAcademicas(obj.getCodigo(), false, funcionario, usuario));
...
//		montarDadosTipoMidiaCaptacao(obj, usuario);
	...
	public  void montarDadosArquivo(PessoaVO obj, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		if (obj.getArquivoImagem().getCodigo().intValue() == 0) {
...
//	}
	 ...
	 */
	public  void montarDadosNacionalidade(PessoaVO obj, UsuarioVO usuario) throws Exception {
		if (obj.getNacionalidade().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual serï¿½ montado os dados consultados.
	 */
	public  void montarDadosNaturalidade(PessoaVO obj, UsuarioVO usuario) throws Exception {
		if (obj.getNaturalidade().getCodigo().intValue() == 0) {
	 ...
	 *            Objeto no qual serï¿½ montado os dados consultados.
	 */
	public  void montarDadosCidade(PessoaVO obj, UsuarioVO usuario) throws Exception {
		if (obj.getCidade().getCodigo().intValue() == 0) {
 ...
 * 		gerando registros órfãos na base. Chamado número 16427*/
	...
	public List<PessoaVO> consultarAlunosTurmaSituacao(Integer curso, Integer turma, String ano, String semestre, String situacao, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception {
...
//			}
	...
	@Override
	public List<PessoaVO> consultarPessoaInteresseAreaProfissinal(List<CidadeVO> cidade, List<EstadoVO> estado, CursoVO curso) {
...
//		}
	...
	@Override
	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void uploadArquivoCurriculum(FileUploadEvent upload, PessoaVO pessoa,  ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuario) throws Exception {
		if (!upload.getFile().getFileName().contains(".pdf")) {
...
//	}
	...
	public  void montarDadosTipoMidiaCaptacao(PessoaVO obj, UsuarioVO usuario) throws Exception {
...
//	@Transactional(readOnly = false, isolation = Isolation.READ_COMMITTED, rollbackFor = { Throwable.class }, propagation = Propagation.REQUIRED)
//	@Override
//	public void alterarApenasDadosPreenchidos( boolean verificarAcesso, final UsuarioVO usuario) throws Exception {
//		getFacadeFactory().getPessoaFacade().inicializarDadosPessoaBaseadoProspect(obj, usuario);
...
//	}
	...
	public List<PessoaVO> consultaRapidaPorRegistroAcademicoAutoComplete(String valorConsulta, List<UnidadeEnsinoVO> unidadeEnsinoVOs, int limit, boolean contrarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception {
		consultar(getIdEntidade(), contrarAcesso, usuario);
		StringBuffer sqlStr = new StringBuffer();
