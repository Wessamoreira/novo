...
public class Estado extends ControleAcesso implements EstadoInterfaceFacade {
     ...
     * @return  List Contendo vários objetos da classe <code>EstadoVO</code> resultantes da consulta.
     */
    public  List<EstadoVO> montarDadosConsulta(SqlRowSet tabelaResultado, int nivelMontarDados,UsuarioVO usuario) throws Exception {
     ...
     */
    public  EstadoVO montarDados(SqlRowSet dadosSQL, int nivelMontarDados,UsuarioVO usuario) throws Exception {
        EstadoVO obj = new EstadoVO();
     ...
     */
    public  void montarDadosPaiz(EstadoVO obj,UsuarioVO usuario) throws Exception {
        if (obj.getPaiz().getCodigo().intValue() == 0) {
