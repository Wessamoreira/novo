...
public class ConfiguracaoGEDVO extends SuperVO {
	...
	private String apiSecretTechCert;
	private String apiClientIdTechCert;
...
//	}
	...
	public String getApiSecretTechCert() {
	    return apiSecretTechCert;
	}

	
	public String getApiClientIdTechCert() {
	    return apiClientIdTechCert;
	}

	
	public void setApiSecretTechCert(String apiSecretTechCert) {
	    this.apiSecretTechCert = apiSecretTechCert;
	}

	public void setApiClientIdTechCert(String apiClientIdTechCert) {
	    this.apiClientIdTechCert = apiClientIdTechCert;
	}
