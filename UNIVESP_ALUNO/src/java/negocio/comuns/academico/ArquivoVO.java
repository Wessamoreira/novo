...
public class ArquivoVO extends SuperVO implements Serializable  {
	...
	private String caminhoPreviewAplicativo;
	...
	@ExcluirJsonAnnotation
    @Expose(deserialize = false, serialize = false)
	private Boolean auxiliarApresentarPortalAluno;
	@ExcluirJsonAnnotation
    @Expose(deserialize = false, serialize = false)
	private Boolean auxiliarApresentarPortalCoordenador;
	@ExcluirJsonAnnotation
    @Expose(deserialize = false, serialize = false)
	private Boolean auxiliarApresentarPortalProfessor;
	@ExcluirJsonAnnotation
    @Expose(deserialize = false, serialize = false)
	...
	private Boolean isProvedorAssinaturaCertisign;
...
//	}
	...
	public Boolean getAuxiliarApresentarPortalAluno() {
		if (auxiliarApresentarPortalAluno == null) {
			auxiliarApresentarPortalAluno = Boolean.FALSE;
		}
		return auxiliarApresentarPortalAluno;
	}

	public void setAuxiliarApresentarPortalAluno(Boolean auxiliarApresentarPortalAluno) {
		this.auxiliarApresentarPortalAluno = auxiliarApresentarPortalAluno;
	}

	public Boolean getAuxiliarApresentarPortalCoordenador() {
		if (auxiliarApresentarPortalCoordenador == null) {
			auxiliarApresentarPortalCoordenador = Boolean.FALSE;
		}
		return auxiliarApresentarPortalCoordenador;
	}

	public void setAuxiliarApresentarPortalCoordenador(Boolean auxiliarApresentarPortalCoordenador) {
		this.auxiliarApresentarPortalCoordenador = auxiliarApresentarPortalCoordenador;
	}

	public Boolean getAuxiliarApresentarPortalProfessor() {
		if (auxiliarApresentarPortalProfessor == null) {
			auxiliarApresentarPortalProfessor = Boolean.FALSE;
		}
		return auxiliarApresentarPortalProfessor;
	}

	public void setAuxiliarApresentarPortalProfessor(Boolean auxiliarApresentarPortalProfessor) {
		this.auxiliarApresentarPortalProfessor = auxiliarApresentarPortalProfessor;
	}
    ...
    public boolean getDownloadValidandoAlunoResponsavel() {
    	return  ((getPastaBaseArquivoEnum() != null && (
    			getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ATIVIDADE_DISCURSIVA_MATERIAL_APOIO)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ATIVIDADE_DISCURSIVA_MATERIAL_APOIO_TMP)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ATIVIDADE_DISCURSIVA_RESPOSTA_ALUNO)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ATIVIDADE_DISCURSIVA_RESPOSTA_ALUNO_TMP)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ARQUIVOSBILIOTECAEXTERNA)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ARQUIVOSBILIOTECAEXTERNA_TMP)
//    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.TAREFA)
//    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.TAREFA_TMP)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.DOCUMENTOS_ASSINADOS)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.DOCUMENTOS_ASSINADOS_TMP)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.DOCUMENTOS_TMP)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.DOCUMENTOS)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ARQUIVO)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ESTAGIO)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ARQUIVO_TMP)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.REQUERIMENTOS)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.REQUERIMENTOS_TMP)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ATIVIDADECOMPLEMENTAR)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.ATIVIDADECOMPLEMENTAR_TMP)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.EAD)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.EAD_TMP)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.EAD_CONTEUDO)
    			|| getPastaBaseArquivoEnum().equals(PastaBaseArquivoEnum.EAD_CONTEUDO_TMP)    			    		
    			))
    			|| (Uteis.isAtributoPreenchido(getOrigem()) && (
    			getOrigem().equals(OrigemArquivo.HISTORICO_ALUNO.getValor())    			
    			|| getOrigem().equals(OrigemArquivo.ALUNO.getValor())
    			|| getOrigem().equals(OrigemArquivo.DOCUMENTACAO_MATRICULA.getValor())
    			|| getOrigem().equals(OrigemArquivo.DOCUMENTACAO_MATRICULA.getValor())
    			|| getOrigem().equals(OrigemArquivo.DOCUMENTO_GED.getValor())
    			|| getOrigem().equals(OrigemArquivo.IMPOSTO_RENDA.getValor())    			
    			|| getOrigem().equals(OrigemArquivo.REQUERIMENTO.getValor())
    			|| getOrigem().equals(OrigemArquivo.PROFESSOR.getValor())
    			|| getOrigem().equals(OrigemArquivo.INSTITUICAO.getValor())
    			|| getOrigem().equals(OrigemArquivo.ATIVIDADE_DISCURSIVA.getValor())
    			)))
    			;
    		 
    }
    
    public boolean getDownloadBloqueado() {
    	return Uteis.isAtributoPreenchido(getOrigem()) && (
    			getOrigem().equals(OrigemArquivo.CERTIFICADO_DIGITAL_PESSOA.getValor())
    			|| getOrigem().equals(OrigemArquivo.CERTIFICADO_DIGITAL_INSTITUICAO.getValor())
    			|| getOrigem().equals(OrigemArquivo.CERTIFICADO_GSUITE.getValor())
    			|| getOrigem().equals(OrigemArquivo.CERTIFICADO_GED.getValor())
    			);    		 
    }
	...
	public Boolean getIsProvedorAssinaturaCertisign() {
		if (isProvedorAssinaturaCertisign == null) {
			isProvedorAssinaturaCertisign = Boolean.FALSE;
		}
		return isProvedorAssinaturaCertisign;
	}
	
	public void setIsProvedorAssinaturaCertisign(Boolean isProvedorAssinaturaCertisign) {
		this.isProvedorAssinaturaCertisign = isProvedorAssinaturaCertisign;
	}

	@XmlElement(name = "caminhoPreviewAplicativo")
	public String getCaminhoPreviewAplicativo() {
		if (caminhoPreviewAplicativo == null) {
			caminhoPreviewAplicativo = "";
		}
		return caminhoPreviewAplicativo;
	}

	public void setCaminhoPreviewAplicativo(String caminhoPreviewAplicativo) {
		this.caminhoPreviewAplicativo = caminhoPreviewAplicativo;
	}
	
	public String getIdentificadorRepositorio() {
		if (identificadorRepositorio == null) {
			identificadorRepositorio = Constantes.EMPTY;
		}
		return identificadorRepositorio;
	}
	
	public void setIdentificadorRepositorio(String identificadorRepositorioAmazonAws) {
		this.identificadorRepositorio = identificadorRepositorioAmazonAws;
	}
	
	public String getNomeAntigo() {
		if (nomeAntigo == null) {
			nomeAntigo = Constantes.EMPTY;
		}
		return nomeAntigo;
	}
