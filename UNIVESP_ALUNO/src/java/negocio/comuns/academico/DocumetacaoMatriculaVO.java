...
//	}
	...
	public void realizarMontagemDadosCurso(MatriculaVO matriculaVO) {
		if (!Uteis.isAtributoPreenchido(getMatriculaVO().getCurso()) && (Objects.nonNull(matriculaVO) && Uteis.isAtributoPreenchido(matriculaVO.getCurso()))) {
			getMatriculaVO().setMatricula(matriculaVO.getMatricula());
			getMatriculaVO().setCurso(matriculaVO.getCurso());
		} else if (!Uteis.isAtributoPreenchido(getMatriculaVO().getCurso().getNivelEducacional()) && (Objects.nonNull(matriculaVO) && Uteis.isAtributoPreenchido(matriculaVO.getCurso().getNivelEducacional()))) {
			getMatriculaVO().getCurso().setNivelEducacional(matriculaVO.getCurso().getNivelEducacional());
		}
	}
}
