...
//    private static final short HSSF_AUTO_INDEX = HSSFColor.HSSFColorPredefined.AUTOMATIC.getIndex();
    private static final short HSSF_AUTO_INDEX = IndexedColors.AUTOMATIC.getIndex();
    ...
    private void styleColor(Formatter out, String attr, short index) {
        ...
        if (index == HSSF_AUTO_INDEX || color == null) {
