...
//        try {
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_tipoMural");
//            getTipoComunicadoInterno().put("MU", "Mural");
//            
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_tipoSomenteLeitura");
//            getTipoComunicadoInterno().put("LE", "Somente Leitura");
//        
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_tipoExigeResposta");
...
//        try {
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaAluno");
//            getTipoDestinatarioComunicadoInterno().put("AL", "Aluno");
//            
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaTodosAlunosAtivos");
//            getTipoDestinatarioComunicadoInterno().put("AA", "Alunos Ativos");
//        
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaProfessor");
//            getTipoDestinatarioComunicadoInterno().put("PR", "Professor");
//        
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaFuncionario");
//            getTipoDestinatarioComunicadoInterno().put("FU", "Funcionário");
//
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaCoordenador");
//            getTipoDestinatarioComunicadoInterno().put("CO", "Coordenador");
//        
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaDepartamento");
//            getTipoDestinatarioComunicadoInterno().put("DE", "Departamento");
//        
//        
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaCargo");
//            getTipoDestinatarioComunicadoInterno().put("CA", "Cargo");
//        
////        try {
////            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaArea");
////            getTipoDestinatarioComunicadoInterno().put("AR", "Área Conhecimento");
////        } catch (Exception e) {
////        }        
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaTurma");
...
//        
//        
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaTodosAlunos");
//            getTipoDestinatarioComunicadoInterno().put("TA", "Todos Alunos");
//        
//        
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaTodosProfessores");
//            getTipoDestinatarioComunicadoInterno().put("TP", "Todos Professores");
//        
//        
//            getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidade("ComunicacaoInterna_enviarParaTodaComunidade");
