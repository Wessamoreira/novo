...
public class Extenso implements Serializable {
    ...
    private boolean usarHoras = false;
    private boolean usarBranco = false;
    private boolean primeiraLetraMaiuscula = false;
    ...
    public String toString() {
        ...
        if (primeiraLetraMaiuscula && !buf.toString().isEmpty() && buf.length() >= 1) {
    ...
    public String toStringNaoMonetario() {
        StringBuffer buf = new StringBuffer();
...
//                buf.append(" e ");
        ...
        if (numero != 0) {
            if (centena != 0) {
                if (!getUsarHoras()) {
                	...
                	if (dezena == 0 && centena == 1) {
	                    buf.append(NumerosFem[2][0]);
	                } else {
	                    buf.append(NumerosFem[2][centena]);
	                }
                }
            }
            ...
            if (!getUsarHoras()) {
            	...
            	if (dezena > 19) {
	                dezena /= 10;
	                buf.append(NumerosFem[1][dezena - 2]);
	                if (unidade != 0) {
	                    buf.append(" e ");
	                    buf.append(NumerosFem[0][unidade]);
	                }
	            } else if (centena == 0 || dezena != 0) {
	                buf.append(NumerosFem[0][dezena]);
	            }
            }
    ...
    public boolean getUsarHoras() {
        return usarHoras;
    }

    public void setUsarHoras(boolean usarHoras) {
        this.usarHoras = usarHoras;
    }

    public boolean isUsarBranco() {
        return usarBranco;
    }

    public void setUsarBranco(boolean usarBranco) {
        this.usarBranco = usarBranco;
    }

	public boolean isPrimeiraLetraMaiuscula() {
		return primeiraLetraMaiuscula;
	}

	public void setPrimeiraLetraMaiuscula(boolean primeiraLetraMaiuscula) {
