...
public class TextoPadraoVO extends TextoPadraoLayoutVO {
	...
	public String substituirTagsTextoPadraoContratoMatricula(ImpressaoContratoVO impressaoContratoVO, MatriculaVO matricula, MatriculaPeriodoVO matriculaPeriodo, DadosComerciaisVO dc, UsuarioVO usuario) throws Exception {
		try {
...
//	}
	...
	public String substituirTagsTextoPadraoContratoFiador(MatriculaVO matricula,   List listaContasReceber, MatriculaPeriodoVO matriculaPeriodo,  DadosComerciaisVO dc, UsuarioVO usuario) throws Exception {
...
//	}
//
//	public String substituirTagDisciplinasMatricula(String texto, MatriculaPeriodoVO matriPer, List<MatriculaPeriodoTurmaDisciplinaVO> listaDisciplinaMatricula) throws Exception {
//		String emBranco = obterStringEmBrancoParaTag(marcador);
//		tagGeral = marcador.getTag();
//
...
//	public String substituirTagMatricula(String texto, ImpressaoContratoVO impressaoContratoVO) throws Exception {
...
//					if (Uteis.isAtributoPreenchido(mat.getContaReceber())) {
//						valorPrimeiraParcela = mat.getContaReceber().getCalcularValorFinal(impressaoContratoVO. usuario);
//					} else {
...
//	}
	...
	public String substituirTagsTextoPadraoContratoInclusaoReposicao(MatriculaVO matricula, List listaContasReceber, MatriculaPeriodoVO matriculaPeriodo,  DadosComerciaisVO dc, Integer qtdeParcela, Double valorTotal, UsuarioVO usuario) throws Exception {
