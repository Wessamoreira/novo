...
public enum TagSEIDecidirFaltasFuncionarioEnum implements PerfilTagSEIDecidirEnum {

	TOTAL_FALTAS("faltasfuncionario", "Faltas", "count(c.codigo)", TipoCampoEnum.INTEIRO , 10);

	private TagSEIDecidirFaltasFuncionarioEnum(String entidade, String atributo, String campo, TipoCampoEnum tipoCampo, Integer tamanhoCampo) {
