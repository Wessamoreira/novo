...
public enum TagSEIDecidirTurmaEnum implements PerfilTagSEIDecidirEnum {
	TURMA_CODIGO("turma","Código Turma", "turma.codigo",TipoCampoEnum.INTEIRO, 20),
	TURMA_IDENTIFACADOR_TURMA("turma", "Identidicador Turma", "turma.identificadorturma", TipoCampoEnum.TEXTO, 30),
	;

	private TagSEIDecidirTurmaEnum(String entidade, String atributo, String campo, TipoCampoEnum tipoCampo, Integer tamanhoCampo) {
