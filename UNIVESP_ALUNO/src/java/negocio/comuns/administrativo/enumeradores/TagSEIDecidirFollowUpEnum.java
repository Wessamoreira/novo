...
public enum TagSEIDecidirFollowUpEnum implements PerfilTagSEIDecidirEnum{
	
	FOLLOWUP_CODIGO("followup", "Código Follow Up", "followup.codigo",TipoCampoEnum.INTEIRO , 20);
	
	private TagSEIDecidirFollowUpEnum(String entidade, String atributo, String campo, TipoCampoEnum tipoCampo, Integer tamanhoCampo) {
