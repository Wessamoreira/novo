 ...
 *
 */
public enum PerfilAcessoPermissaoVisaoParceiroEnum implements PerfilAcessoPermissaoEnumInterface {

	/**
	 * Busca Candidato Vaga
	 *
	 */
	BUSCA_CANDIDATO_VAGA("BuscaCandidatoVaga",
			new PermissaoVisao[] { new PermissaoVisao(TipoVisaoEnum.PARCEIRO,
					UteisJSF.internacionalizar("per_BuscaCandidatoVaga_titulo"),
					UteisJSF.internacionalizar("per_BuscaCandidatoVaga_ajuda"),
					new String[] { "buscaCandidatoVagaCons.xhtml" }) },
			TipoPerfilAcessoPermissaoEnum.ENTIDADE, null, PerfilAcessoSubModuloEnum.VISAO_PARCEIRO);
	...
	private PerfilAcessoPermissaoVisaoParceiroEnum(String valor, PermissaoVisao[] permissaoVisao,
