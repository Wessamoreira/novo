...
public interface TurmaDisciplinaNotaTituloInterfaceFacade {
	...
	void persistir(List<TurmaDisciplinaNotaTituloVO> turmaDisciplinaNotaTituloVOs, List<HistoricoVO> listaHistoricoVOs, TurmaVO turmaLancamentoNotaVO, UsuarioVO usuarioVO,  boolean trazerAlunosTransferenciaMatriz, boolean permiteLancarNotaDisciplinaComposta) throws Exception;
	void excluir(TurmaDisciplinaNotaTituloVO turmaDisciplinaNotaTituloVO, UsuarioVO usuarioVO) throws Exception;
	void incluir(final TurmaDisciplinaNotaTituloVO turmaDisciplinaNotaTituloVO, List<HistoricoVO> listaHistoricoVOs,  TurmaVO turmaLancamentoNotaVO, final UsuarioVO usuarioVO, boolean trazerAlunosTransferenciaMatriz, boolean permiteLancarNotaDisciplinaComposta) throws Exception;
	void alterar(final TurmaDisciplinaNotaTituloVO turmaDisciplinaNotaTituloVO, List<HistoricoVO> listaHistoricoVOs, TurmaVO turmaLancamentoNotaVO, final UsuarioVO usuarioVO, boolean trazerAlunosTransferenciaMatriz, boolean permiteLancarNotaDisciplinaComposta) throws Exception;		
