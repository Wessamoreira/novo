...
public interface CancelamentoInterfaceFacade {
	...
	public void incluir(CancelamentoVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO,  UsuarioVO usuario, Boolean verificarPermissao) throws Exception;
	...
	public CancelamentoVO consultarPorChavePrimaria(Integer codigo, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
...
//	public List<CancelamentoVO> consultaRapidaPorTurma(String valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, UsuarioVO usuario) throws Exception;
	 ...
	 * @throws Exception
	 */
	void persistir(CancelamentoVO cancelamentoVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO,  UsuarioVO usuarioVO) throws Exception;
...
//	List<CancelamentoVO> consultaRapidaPorRegistroAcademicoUltimoCancelamento(String valorConsulta,	Integer unidadeEnsino, boolean controlarAcesso, UsuarioVO usuario) throws Exception;
	...
	void realizarCancelamentoMatriculaAtivaPorOutroCursoMesmoNivelEducacional(MatriculaVO matriculaVO,	ConfiguracaoGeralSistemaVO configuracaoGeralSistema,   UsuarioVO usuarioVO) throws Exception;
	
	public void realizarAlteracaoCodigoRequerimentoCancelamento(final Integer codigoRequerimento) throws Exception;

	void persistirCancelamentoMapaRegistroAbandonoCursoTrancamentoIndividualmente(MapaRegistroEvasaoCursoMatriculaPeriodoVO mrecmp, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO,  UsuarioVO usuarioVO) throws Exception;
