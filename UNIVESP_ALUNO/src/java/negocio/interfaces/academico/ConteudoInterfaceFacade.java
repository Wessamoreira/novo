...
public interface ConteudoInterfaceFacade {
	...
	void uploadImagemBackgroundConteudo(ConteudoVO conteudoVO, FileUploadEvent event, Boolean aplicarBackRecursoEducacional, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuarioVO, Boolean realizandoClonagem) throws Exception;
...
//	public void persistirConteudoBaseSubjectIntegracaoAurea(SubjectsAureaVO subjectsAureaVO, ConteudoVO conteudoVO, Boolean controlarAcesso, ConfiguracaoGeralSistemaVO configuracaoGeralSistema, UsuarioVO usuario) throws Exception;
}
