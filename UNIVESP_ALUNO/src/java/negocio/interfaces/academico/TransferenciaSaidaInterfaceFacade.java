...
public interface TransferenciaSaidaInterfaceFacade {
	...
	public void incluir(TransferenciaSaidaVO obj,  UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistema) throws Exception;

	public void alterar(TransferenciaSaidaVO obj,  UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistema) throws Exception;

	public void excluir(TransferenciaSaidaVO obj, UsuarioVO usuarioVO) throws Exception;

	public TransferenciaSaidaVO consultarPorChavePrimaria(Integer codigo, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public List<TransferenciaSaidaVO> consultarPorDataUnidadeEnsino(Date datainicio, Date dataFim, String unidadeEnsino, boolean b, int nivelmontardadosDadosconsulta,  UsuarioVO usuario) throws Exception;

	List<TransferenciaSaidaVO> consultarPorAluno(String valorConsulta, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
...
//	void executarValidacaoExistePendenciaFinanceiraEPreMatriculaAtiva(MatriculaVO matriculaVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuarioVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	void persistir(TransferenciaSaidaVO obj,  ConfiguracaoGeralSistemaVO configuracaoGeralSistema, UsuarioVO usuario) throws Exception;
