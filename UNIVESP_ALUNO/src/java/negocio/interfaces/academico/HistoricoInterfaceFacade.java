...
public interface HistoricoInterfaceFacade {
	...
	public List consultarPorMatricula_matriculaPeriodoTodos(String matricula, Integer matriculaPeriodo, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;

	public List<HistoricoVO> consultarHistoricoParaAproveitamentoNaTransferenciaInterna(String matriculaAntiga, Integer cursoNovo, int nivelMontarDados,  UsuarioVO usuario) throws Exception;

	public HistoricoVO consultarPorChavePrimaria(Integer codigo, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public List consultarPorMatricula(String valorConsulta, int ordemDisciplinas, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public HistoricoVO consultarPorMatricula_matriculaPeriodo_Disciplina(String matricula, Integer matriculaPeriodo, Integer disciplina, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;

	public List<HistoricoVO> consultarPorMatriculaDisciplina(String matricula, Integer disciplina, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;

	public HistoricoVO consultarPorMatriculaPeriodoDisciplina(Integer matriculaPeriodo, Integer disciplina, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public HistoricoVO consultarPorMatriula_Disciplina_Semestre_Ano(String matricula, Integer disciplina, String semestre, String ano, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;

	public List<HistoricoVO> consultarPorMatriculaPeriodoLetivoBoletim(String matricula, Integer turma, String ano, String semestre, Boolean apresentarDisciplinaComposta, Integer configuracaoAcademico, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario, BimestreEnum bimestre, SituacaoRecuperacaoNotaEnum situacaoRecuperacaoNota, Integer gradeCurricular) throws Exception;
	...
	public List<HistoricoVO> consultarPorMatriculaDisciplinaTurmaSituacaoHistorico(String matricula, Integer disciplina, Integer turma, String situacaoHistorico, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;

	public void setIdEntidade(String aIdEntidade);

	public List<HistoricoVO> consultarPorMatriculaPeriodoLetivo(String matricula, Integer periodoLetivo, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public List consultarDisciplinasDoHistoricoPorMatriculaTipoDisciplinaSituacao(String matricula, String situacao, String tipoDisciplina1, String tipoDisciplina2, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;

	public List consultarPorMatriculaPeriodoSituacao(Integer matriculaPeriodo, String situacao, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;

	public List<HistoricoVO> consultarPorMatriculaPeriodo(Integer matriculaPeriodo, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public List consultarPorMatriculaDisciplinaAproveitamento(String matricula, Integer disciplina, String situacao, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public List consultarPorMatriculaDisciplinaSituacao(String matricula, Integer disciplina, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public List consultarPorMatriculaDisciplinaAprovado_Cursando(String matricula, Integer disciplina, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;

	public List consultarPorMatriculaDisciplinasAprovadas(String valorConsulta, Integer disciplina, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;

	public void incluirHistorico(MatriculaPeriodoTurmaDisciplinaVO obj,  GradeCurricularVO gradeCurricularVO, UsuarioVO usuario) throws Exception;

	public List<HistoricoVO> consultaRapidaPorUnidadeEnsinoCursoDisciplinaTurmaAnoSemestreSituacaoMatSituacaoHist(Integer unidadeEnsino, Integer curso, Integer disciplina, TurmaVO turmaVO, String ano, String semestre, String situacaoMatricula, String situacaoHistorico, boolean verificarDisciplina, boolean controlarAcesso, ConfiguracaoAcademicoVO configuracaoAcademicoVO, int nivelMontarDados,  UsuarioVO usuario, boolean trazerAlunosTransferenciaMatriz, boolean permiteLancarNotaDisciplinaComposta) throws Exception;
	...
	public List<HistoricoVO> excluirHistoricoForaPrazo(HistoricoVO obj,  UsuarioVO usuario) throws Exception;
	...
	public void incluirHistorico(MatriculaPeriodoTurmaDisciplinaVO obj, MatriculaPeriodoVO matriculaPeriodoVO, MatriculaVO matriculaVO,  GradeCurricularVO gradeCurricularVO, UsuarioVO usuario) throws Exception;
	...
	public List<HistoricoVO> consultarHistoricoParaAproveitamentoNaTransferenciaInternaPorCursoGrade(Integer aluno, Integer cursoNovo, Integer gradeCurricular, int nivelMontarDados,  UsuarioVO usuario, ConfiguracaoAcademicoVO configuracaoAcademicoVO) throws Exception;
	...
	public List<HistoricoVO> executarMontagemListaHistoricoAluno(MatriculaVO matriculaVO, Integer periodoLetivo, ConfiguracaoAcademicoVO configuracaoAcademico, CursoVO cursoVO,  String anoSemestre, boolean trazerUltimoHistorico, Boolean validarAcesso,  Boolean trazerQuantidadesDisciplinas , UsuarioVO usuario) throws Exception;

	public void atualizarMediaFinal(HistoricoVO historicoVO) throws Exception;

	public List<HistoricoVO> consultarHistoricoPorListaDeMatriculaPeriodoTurmaDisciplina(List<Integer> listaMPTDs , UsuarioVO usuarioLogado) throws Exception;

	public HistoricoVO consultarHistoricoPorMatriculaPeriodoTurmaDisciplina(Integer codigoMPTD , UsuarioVO usuarioLogado) throws Exception;
	...
	public List<HistoricoVO> consultaRapidaPorTurmaUnidadeEnsinoCursoDisciplinaAnoSemestreDataHistoricoOrdenarDisciplina(Integer unidadeEnsino, Integer curso, Integer disciplina, TurmaVO turmaVO, String ano, String semestre, String situacaoMatricula, String situacaoHistorico, boolean verificarDisciplina, boolean filtroVisaoProfessor, boolean controlarAcesso, int nivelMontarDados,  String tipoAluno, UsuarioVO usuario, boolean permitirRealizarLancamentoAlunosPreMatriculados) throws Exception;

	public List<HistoricoVO> consultarPorCodigoDisciplinaExcluirDisciplinaPermanecerUnificacaoDisciplina(Integer disciplinaExcluir, Integer disciplinaPermanecer, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public List consultarPeriodoLetivoPorMatriculaPeriodoLetivoBoletim(String matricula, Integer turma, Integer periodoLetivo, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public void excluirComBaseNaMatriculaPeriodo(Integer codMatriculaPeriodo , UsuarioVO usuarioLogado) throws Exception;
	...
	SqlRowSet consultarPorMatriculaPeriodoLetivoBoletimEnsinoMedio(String matricula, Integer turma, String ano, String semestre, Boolean apresentarDisciplinaComposta, Integer configuracaoAcademico,  UsuarioVO usuario, BimestreEnum bimestre, SituacaoRecuperacaoNotaEnum situacaoRecuperacaoNota, Integer gradeCurricular, List<String> listaNotas, Boolean transferenciaGradeCurricular) throws Exception;

	public List consultarPorMatriculaDisciplinaTurmaSituacaoHistoricoAnoSemestre(String matricula, Integer gradeCurricular, Integer disciplina, TurmaVO turmaVO, String situacaoHistorico, String ano, String semestre,  boolean permiteLancarNotaDisciplinaComposta, boolean controlarAcesso, int nivelMontarDados,  Integer matriculaPeriodoTurmaDisciplina, UsuarioVO usuario) throws Exception;
	...
	public HistoricoVO gerarHistoricoVOComBaseMatriculaPeriodoTurmaDisciplina(MatriculaPeriodoTurmaDisciplinaVO obj, MatriculaPeriodoVO matriculaPeriodoVO, MatriculaVO matriculaVO,  GradeCurricularVO gradeCurricular, UsuarioVO usuario) throws Exception;
	...
	public List<HistoricoVO> excluirDisciplinaAlunoPorDisciplina(HistoricoVO obj, boolean realizandoExclusaoDisciplinaForaPrazo,  UsuarioVO usuarioVO) throws Exception;

	void excluirHistoricoForaPrazo(List<HistoricoVO> historicoVOs, HistoricoVO historicoVO,  UsuarioVO usuario) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<HistoricoVO> excluirHistoricoForaPrazoVerificandoHistoricoPorEquivalencia(HistoricoVO obj,  UsuarioVO usuario) throws Exception;
	...
	public void excluirComBaseNaMatriculaPeriodoCodDisciplinaSituacaoHistorico(Integer codMatriculaPeriodo, Integer codDisciplina, String situacao, Integer gradeCurricularAtual , UsuarioVO usuarioLogado) throws Exception;
...
List<HistoricoVO> consultarPorMatriculaPeriodoSituacoes(Integer matriculaPeriodo, String situacoes,
	 ...
	 * @throws Exception
	 */
	List<HistoricoVO> executarMontagemListaHistoricoAlunoPorCodigoHistorico(Integer codigoHistorico, MatriculaVO matriculaVO, Integer periodoLetivo, ConfiguracaoAcademicoVO configuracaoAcademico, CursoVO cursoVO,  String anoSemestre, boolean trazerUltimoHistorico, Boolean validarAcesso,Boolean trazerQuantidadesDisciplinas , UsuarioVO usuario) throws Exception;
	 ...
	 * @throws Exception
	 */
	void excluirComBaseNaMatriculaPeriodoMatrizCurricularCodDisciplinaSituacaoHistorico(Integer codMatriculaPeriodo, Integer matrizCurricular, Integer codDisciplina, String situacao , UsuarioVO usuarioLogado) throws Exception;
	...
	public List<HistoricoVO> consultaHistoricoParaFechamentoNotasPorBlackboard(BlackboardFechamentoNotaOperacaoVO obj,  UsuarioVO usuarioLogado) throws Exception;
