...
public interface TransferenciaEntradaInterfaceFacade {
	...
	public void incluir(TransferenciaEntradaVO obj, ConfiguracaoGeralSistemaVO configuracaoGeralSistema, Boolean criarHistoricoTransferenciaEntrada, Boolean controleAcesso,   UsuarioVO usuario) throws Exception;

	public void alterar(TransferenciaEntradaVO obj,  UsuarioVO usuario) throws Exception;

	void alterarTransferenciaEntradaEfetivada(final TransferenciaEntradaVO obj,  UsuarioVO usuario) throws Exception;
	...
	public TransferenciaEntradaVO consultarPorChavePrimaria(Integer codigo, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	public TransferenciaEntradaVO montarDadosTransferenciaInternaPeloCodigoRequerimento(Integer codigo, Integer codigo2,  Boolean possuiPermissaoTransferirInternamenteMesmoCursoMatriculaIntegral, UsuarioVO usuario) throws Exception;
	...
	public List<TransferenciaEntradaVO> consultarTodosTiposPorData(Date datainicio, Date dataFim, String unidadeEnsino, boolean b, int nivelmontardadosDadosconsulta,  UsuarioVO usuario) throws Exception;

	public List<TransferenciaEntradaVO> consultarPorDataUnidadeEnsino(Date datainicio, Date dataFim, String unidadeEnsino, boolean matriculado, TipoTransferenciaEntrada tipoTransferenciaEntrada, boolean b, int nivelmontardadosDadosconsulta,  UsuarioVO usuario) throws Exception;
	...
	List<TransferenciaEntradaVO> consultarPorMatriculaETipo(String valorConsulta, String situacaoMatriculado, TipoTransferenciaEntrada tipoTransferenciaEntrada, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
	...
	void realizarVinculoTransferenciaInternaMatriculaExistente(TransferenciaEntradaVO transferenciaEntrada,
			MatriculaVO matriculaVO,  UsuarioVO usuarioVO) throws Exception;
