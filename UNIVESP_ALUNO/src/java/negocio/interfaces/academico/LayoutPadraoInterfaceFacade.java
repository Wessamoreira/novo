...
public interface LayoutPadraoInterfaceFacade {
	 ...
	 * @throws Exception
	 */
	void persistirFiltroSituacaoAcademica( String entidade, UsuarioVO usuarioVO) throws Exception;
	
	void persistirFiltroSituacaoHistorico( String entidade, UsuarioVO usuarioVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	void consultarPadraoFiltroSituacaoAcademica( String entidade, UsuarioVO usuarioVO) throws Exception;
	
	void consultarPadraoFiltroSituacaoHistorico( String entidade, UsuarioVO usuarioVO) throws Exception;
