...
//    void alterarConteudoUnidadePagina(UnidadeConteudoVO unidadeConteudoVO, DisciplinaVO disciplina, Boolean controlarAcesso, UsuarioVO usuario) throws Exception;
    ...
    void upLoadIconeConteudoUnidadePagina(FileUploadEvent upload, ConteudoUnidadePaginaVO conteudoUnidadePagina, boolean iconeVoltar, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuarioVO) throws Exception;
	...
	void uploadImagemBackgroundConteudoUnidadePagina(ConteudoUnidadePaginaVO conteudoUnidadePaginaVO, Integer disciplina,FileUploadEvent event, Boolean aplicarBackRecursoEducacional, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuarioVO) throws Exception;
...
//	public void preencherDadosConteudoUnidadePaginaSubjectItemsAurea(SubjectsAureaVO subjectsAureaVO, UnidadeConteudoVO unidadeConteudoVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistema, UsuarioVO usuario) throws Exception;
//
//	public void preencherDadosConteudoUnidadePaginaCategoriesAurea(CategoriesAureaVO categoriesAureaVO, ConteudoUnidadePaginaVO conteudoUnidadePaginaVO, UnidadeConteudoVO unidadeConteudoVO) throws Exception;
