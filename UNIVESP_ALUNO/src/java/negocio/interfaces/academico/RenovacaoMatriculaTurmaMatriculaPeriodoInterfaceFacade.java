...
public interface RenovacaoMatriculaTurmaMatriculaPeriodoInterfaceFacade {
	...
	void realizarConsultarMatriculaPeriodoAptaRenovar(RenovacaoMatriculaTurmaVO renovacaoMatriculaTurmaVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, Boolean permitirRealizarMatriculaDisciplinaPreRequisito, UsuarioVO usuarioVO, List<GradeDisciplinaCompostaVO> gradeDisciplinaCompostaVOs) throws Exception;
	
	void realizarConsultarMatriculaPeriodoAptaRenovarPorTurma(RenovacaoMatriculaTurmaVO renovacaoMatriculaTurmaVO, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, Boolean permitirRealizarMatriculaDisciplinaPreRequisito, UsuarioVO usuarioVO, List<GradeDisciplinaCompostaVO> gradeDisciplinaCompostaVOs, ProgressBarVO progressBarVO) throws Exception;
