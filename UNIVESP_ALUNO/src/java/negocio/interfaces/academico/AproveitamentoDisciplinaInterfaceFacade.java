...
public interface AproveitamentoDisciplinaInterfaceFacade {
	...
	public void incluir(AproveitamentoDisciplinaVO obj, boolean controleAcesso, UsuarioVO usuario) throws Exception;

	public void alterar(AproveitamentoDisciplinaVO obj, UsuarioVO usuario) throws Exception;
	...
	public AproveitamentoDisciplinaVO consultarPorChavePrimaria(Integer codigo, int nivelMontarDados, UsuarioVO usuario) throws Exception;
	...
	public List consultaRapidaPorCodigo(Integer valorConsulta, Integer unidadeEnsino, boolean controlarAcesso, UsuarioVO usuario) throws Exception;
        ...
        public void adicionarConcessaoCreditoDisciplina(AproveitamentoDisciplinaVO obj,  UsuarioVO usuarioLogado) throws Exception;

        public void excluirObjConcessaoCreditoDisciplinaVOs(AproveitamentoDisciplinaVO obj, Integer disciplina) throws Exception;

//        public void inicializarDadosAdicionarConcessaoCargaHorariaDisciplina(AproveitamentoDisciplinaVO obj,  UsuarioVO usuarioLogado) throws Exception;
...
//        public void adicionarConcessaoCargaHorariaDisciplina(AproveitamentoDisciplinaVO obj, ConcessaoCargaHorariaDisciplinaVO concessaoCargaHorariaDisciplinaVO, UsuarioVO usuarioLogado) throws Exception;
	...
	void excluirComBaseNaMatriculaPeriodo(Integer matriculaPeriodo, UsuarioVO usuario) throws Exception;

	void excluirComBaseNaMatricula(String matricula,  UsuarioVO usuario) throws Exception;
