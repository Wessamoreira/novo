...
public interface ConteudoPlanejamentoInterfaceFacade {

	/**
	 * Operação responsável por retornar um novo objeto da classe
	 * <code>ConteudoPlanejamentoVO</code>.
	 */
	public ConteudoPlanejamentoVO novo() throws Exception;

	/**
	 * Operação responsável por incluir no banco de dados um objeto da classe
	 * <code>ConteudoPlanejamentoVO</code>. Primeiramente valida os dados (
	 ...
	 *                validação de dados.
	 */
	public void incluir(ConteudoPlanejamentoVO obj, UsuarioVO usuario) throws Exception;

	/**
	 * Operação responsável por alterar no BD os dados de um objeto da classe
	 * <code>ConteudoPlanejamentoVO</code>. Sempre utiliza a chave primária da
	 ...
	 *                validação de dados.
	 */
	public void alterar(ConteudoPlanejamentoVO obj, UsuarioVO usuario) throws Exception;

	/**
	 * Operação responsável por excluir no BD um objeto da classe
	 * <code>ConteudoPlanejamentoVO</code>. Sempre localiza o registro a ser
	 ...
	 * <code>ConteudoPlanejamento</code> através do valor do atributo
	 ...
	 *         <code>ConteudoPlanejamentoVO</code> resultantes da consulta.
	 * @exception Exception
	 *                Caso haja problemas de conexão ou restrição de acesso.
	 */
	 ...
	 * <code>ConteudoPlanejamentoVO</code> através de sua chave primária.
	 * 
	 * @exception Exception
	...
	void incluirConteudoPlanejamentoVOs(PlanoEnsinoVO planoEnsinoVO, UsuarioVO usuarioVO) throws Exception;

	void alterarConteudoPlanejamentoVOs(PlanoEnsinoVO planoEnsinoVO, UsuarioVO usuarioVO) throws Exception;

	List<ConteudoPlanejamentoVO> consultarConteudoPlanejamentoPorPlanoEnsino(Integer planoEnsino, boolean controlarAcesso, UsuarioVO usuario) throws Exception;

	void excluirConteudoPlanejamentoVOs(PlanoEnsinoVO planoEnsinoVO, UsuarioVO usuarioVO) throws Exception;
