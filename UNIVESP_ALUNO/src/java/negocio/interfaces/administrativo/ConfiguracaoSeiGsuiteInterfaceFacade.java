...
public interface ConfiguracaoSeiGsuiteInterfaceFacade {
	...
	HttpResponse<JsonNode> realizarGeracaoUsuarioGsuiteLote(ConfiguracaoSeiGsuiteVO obj,  UsuarioVO usuario);
	
	HttpResponse<JsonNode> realizarImportacaoUsuarioGsuiteLote(ConfiguracaoSeiGsuiteVO obj,  UsuarioVO usuario);
