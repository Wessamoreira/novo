...
//	void realizarGeracaoSalaAulaBlackboardPorHorarioTurma( UsuarioVO usuarioVO) throws Exception;
...
//	void consultarAlunosPorSalaAulaBlackboardOtimizado(SalaAulaBlackboardVO obj, FiltroRelatorioAcademicoVO filtroRelatorioAcademicoVO, int nivelMontarDados, UsuarioVO usuarioVO);
	...
	HttpResponse<JsonNode> realizarProcessamentoLoteSalaAulaBlackboardPorHorarioTurma( UsuarioVO usuarioVO) throws Exception;
...
//	void apurarNotas(ProgressBarVO progressBarVO, List<UnidadeEnsinoVO> unidadeEnsinoVOs, TipoSalaAulaBlackboardEnum tipoSalaAulaBlackboardEnum, String ano, String semestre, Integer bimestre, Integer curso, Integer turma, Integer disciplina, String matricula,  boolean realizarCalculoMediaApuracaoNotas, UsuarioVO usuarioLogado) throws Exception;
