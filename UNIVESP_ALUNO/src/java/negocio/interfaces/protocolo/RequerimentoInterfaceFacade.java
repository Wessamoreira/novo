...
public interface RequerimentoInterfaceFacade {
	...
	public void incluir(RequerimentoVO obj, UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistema) throws Exception;
	...
	public RequerimentoVO consultarPorChavePrimaria(Integer codigo, int nivelMontarDados, UsuarioVO usuario) throws Exception;

	public RequerimentoVO consultarPorChavePrimariaFiltrandoPorUnidadeEnsino(Integer codigoPrm, String filtro, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception;
	...
	List<RequerimentoVO> consultarPorCodigo(String listaCodigos, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception;
	...
	public List<RequerimentoVO> consultarPorDataFinalizacao(Date prmIni, Date prmFim, String tipo, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception;

	public List<RequerimentoVO> consultarPorSituacao(String valorConsulta, String tipo, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception;

	public List<RequerimentoVO> consultarPorSituacaoFinanceira(String valorConsulta, String tipo, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception;

	public List<RequerimentoVO> consultarPorNomePessoa(String valorConsulta, String tipo, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception;

	public List<RequerimentoVO> consultarPorMatriculaMatricula(String valorConsulta, String tipo, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados, UsuarioVO usuario) throws Exception;
	...
	public void registrarRecebimentoDoc(RequerimentoVO obj, UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistema) throws Exception;
	...
	public List<RequerimentoVO> consultarPorMatriculaSituacaoDiferenteDe(String matricula, String string, String string2, Integer codigo, boolean b, int nivelmontardadosDadosbasicos, UsuarioVO usuario) throws Exception;

	public List<RequerimentoVO> consultarPorCodigoSemProgramacaoFormatura(Integer valorInt, String string, List<ProgramacaoFormaturaUnidadeEnsinoVO> proFormaturaUnidadeEnsinoVOs, boolean b, int nivelmontardadosDadosbasicos, UsuarioVO usuario) throws Exception;

	public List<RequerimentoVO> consultarPorDataSemProgramacaoFormatura(Date dateTime, Date dateTime2, String string, List<ProgramacaoFormaturaUnidadeEnsinoVO> proFormaturaUnidadeEnsinoVOs, boolean b, int nivelmontardadosDadosbasicos, UsuarioVO usuario) throws Exception;

	public List<RequerimentoVO> consultarPorSituacaoSemProgramacaoFormatura(String valorConsultarRequerimento, String string, List<ProgramacaoFormaturaUnidadeEnsinoVO> proFormaturaUnidadeEnsinoVOs, boolean b, int nivelmontardadosDadosbasicos, UsuarioVO usuario) throws Exception;

	public List<RequerimentoVO> consultarPorResponsavelSemProgramacaoFormatura(String valorConsultarRequerimento, String string, List<ProgramacaoFormaturaUnidadeEnsinoVO> proFormaturaUnidadeEnsinoVOs, boolean b, int nivelmontardadosDadosbasicos, UsuarioVO usuario) throws Exception;

	public Integer consultaRapidaRequerimentoPendenteUsuario(Integer codUsuarioLogado) throws Exception;

	public List<RequerimentoVO> consultarPorMatriculaMatriculaSemProgramacaoFormatura(String valorConsultarRequerimento, String string, List<ProgramacaoFormaturaUnidadeEnsinoVO> proFormaturaUnidadeEnsinoVOs, boolean b, int nivelmontardadosDadosbasicos, UsuarioVO usuario) throws Exception;
	...
	public List<RequerimentoVO> consultarRequerimentoAtrasadosParaExclusao(UsuarioVO usuarioVO) throws Exception;
...
//	void persistirRequerimento(RequerimentoVO requerimento, RequerimentoHistoricoVO requerimentoHistoricoVO, Boolean visaoAluno, Boolean exigePagamento, ConfiguracaoGeralSistemaVO configuracaoGeralSistema, UnidadeEnsinoVO unidadeEnsinoLogado, UsuarioVO usuarioLogado) throws Exception;
	...
	void realizarAutorizacaoPagamentoRequerimento(RequerimentoVO requerimentoVO, UsuarioVO usuario) throws Exception;
	...
	void realizarRegistroDeferimentoIndeferimentoSolicitacaoIsencaoTaxa(RequerimentoVO requerimentoVO, UsuarioVO usuarioVO) throws Exception;
	...
	void realizarValidacaoChoqueHorarioEVagaTurmaRequerimentoReposicao(RequerimentoVO requerimentoVO, UsuarioVO usuarioVO) throws Exception;
...
//	public void excluirContaReceber(RequerimentoVO obj, UsuarioVO usuario) throws Exception;
...
//			 UnidadeEnsinoVO unidadeEnsinoLogado,
