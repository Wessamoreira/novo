...
public interface RespostaAvaliacaoInstitucionalDWInterfaceFacade {
	...
	/**
	 * Operao responsvel por retornar um novo objeto da classe <code>RespostaAvaliacaoInstitucionalDWVO</code>.
	 */
	public RespostaAvaliacaoInstitucionalDWVO novo() throws Exception;

	/**
	 * Operao responsvel por incluir no banco de dados um objeto da classe <code>RespostaAvaliacaoInstitucionalDWVO</code>.
	 * Primeiramente valida os dados (<code>validarDados</code>) do objeto. Verifica a conexo com o banco de dados e a permisso do usurio
	 * para realizar esta operaco na entidade.
	 * Isto, atravs da operao <code>incluir</code> da superclasse.
	 * @param obj  Objeto da classe <code>RespostaAvaliacaoInstitucionalDWVO</code> que ser gravado no banco de dados.
	 * @exception Exception Caso haja problemas de conexo, restrio de acesso ou validao de dados.
	 */
	...
	/**
	 * Operao responsvel por alterar no BD os dados de um objeto da classe <code>RespostaAvaliacaoInstitucionalDWVO</code>.
	 * Sempre utiliza a chave primria da classe como atributo para localizao do registro a ser alterado.
	 * Primeiramente valida os dados (<code>validarDados</code>) do objeto. Verifica a conexo com o banco de dados e a permisso do usurio
	 * para realizar esta operaco na entidade.
	 * Isto, atravs da operao <code>alterar</code> da superclasse.
	 * @param obj    Objeto da classe <code>RespostaAvaliacaoInstitucionalDWVO</code> que ser alterada no banco de dados.
	 * @exception Execption Caso haja problemas de conexo, restrio de acesso ou validao de dados.
	 */
	public void alterar(RespostaAvaliacaoInstitucionalDWVO obj) throws Exception;

	/**
	 * Operao responsvel por excluir no BD um objeto da classe <code>RespostaAvaliacaoInstitucionalDWVO</code>.
	 * Sempre localiza o registro a ser excludo atravs da chave primria da entidade.
	 * Primeiramente verifica a conexo com o banco de dados e a permisso do usurio
	 * para realizar esta operaco na entidade.
	 * Isto, atravs da operao <code>excluir</code> da superclasse.
	 * @param obj    Objeto da classe <code>RespostaAvaliacaoInstitucionalDWVO</code> que ser removido no banco de dados.
	 * @exception Execption Caso haja problemas de conexo ou restrio de acesso.
	 */
	...
	/**
	 * Operao responsvel por localizar um objeto da classe <code>RespostaAvaliacaoInstitucionalDWVO</code>
	 * atravs de sua chave primria. 
	 * @exception Exception Caso haja problemas de conexo ou localizao do objeto procurado.
	 */
	...
	/**
	 * Operao reponsvel por definir um novo valor para o identificador desta classe.
	 * Esta alterao deve ser possvel, pois, uma mesma classe de negcio pode ser utilizada com objetivos
