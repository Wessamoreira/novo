...
/**
 * Interface reponsvel por criar uma estrutura padro de comunidao entre a camada de controle e camada de negcio (em especial com a classe Faade). Com a utilizao desta interface  possvel
 * substituir tecnologias de uma camada da aplicao com mnimo de impacto nas demais. Alm de padronizar as funcionalidades que devem ser disponibilizadas pela camada de negcio, por intermdio de
 * sua classe Faade (responsvel por persistir os dados das classes VO).
 */
public interface PessoaInterfaceFacade {
	
	void montarDadosNaturalidade(PessoaVO obj, UsuarioVO usuario) throws Exception;
	void montarDadosNacionalidade(PessoaVO obj, UsuarioVO usuario) throws Exception;
    ...
    public List<PessoaVO> consultarProfessoresDoAluno(Integer codigoAluno, Integer unidadeEnsino, boolean controlarAcesso, int nivelMontarDados,  UsuarioVO usuario) throws Exception;
...
//    void alterarPessoaConformeProspect(ProspectsVO obj, boolean verificarAcesso, UsuarioVO usuario, ConfiguracaoGeralSistemaVO configuracaoGeralSistema, Boolean editadoPorAluno, Boolean origemPreInscricao) throws Exception;
    ...
    void uploadArquivoCurriculum(FileUploadEvent upload, PessoaVO pessoa, ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuario) throws Exception;

//    void deletarArquivoCurriculum(PessoaVO pessoaVO,  ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuario) throws Exception;

//    void adicionarArquivoCurriculum(PessoaVO pessoa,  ConfiguracaoGeralSistemaVO configuracaoGeralSistemaVO, UsuarioVO usuario) throws Exception;
...
//	ProspectsVO realizarVinculoPessoaProspect(PessoaVO obj, UsuarioVO usuario) throws Exception;
	 ...
	 */
//	public void alterarPessoaPelaTelaDeFollowUpProspect( UsuarioVO usuarioVO);
...
//	void alterarApenasDadosPreenchidos(boolean verificarAcesso, UsuarioVO usuario) throws Exception;
