...
private String tagRelatorio;
	...
	public void liberarDadosUsuarioAlunoMemoria() {
		...
		getAplicacaoControle().getLinksUteisUsuarioCache();
		getAplicacaoControle().getMatriculaEstagioDeferidoCache();
		getAplicacaoControle().getPreferenciaSistemaUsuarioCache();		
		setMensagemID("msg_acao_realizadaComSucesso", Uteis.SUCESSO);
	}
