...
//		}
	...
	public void consultarAlunoVisaoCoordenador() throws Exception {
		try {
			...
			if (getCampoConsultaAluno().equals("matricula")) {
				MatriculaVO matriculaVO = getFacadeFactory().getMatriculaFacade().consultarPorObjetoMatricula(getValorConsultaAluno(), this.getUnidadeEnsinoLogado().getCodigo(), false, Uteis.NIVELMONTARDADOS_DADOSMINIMOS, getUsuarioLogado());
	...
	public void consultarAlunoPorMatriculaVisaoCoordenador() throws Exception {
		try {
			MatriculaVO matriculaVO = getFacadeFactory().getMatriculaFacade().consultarPorObjetoMatricula(getAdvertenciaVO().getMatriculaVO().getMatricula(), this.getUnidadeEnsinoLogado().getCodigo(), false, Uteis.NIVELMONTARDADOS_DADOSMINIMOS, getUsuarioLogado());
			if (matriculaVO.getMatricula().equals("")) {
