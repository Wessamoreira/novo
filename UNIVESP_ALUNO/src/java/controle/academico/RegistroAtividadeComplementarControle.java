...
//		}
	...
	public void validarLiberarOperacaoFuncionalidade() {
		try {
			...
			getFacadeFactory().getControleAcessoFacade().verificarPermissaoUsuarioFuncionalidadeComUsuarioVOEspecifico("PermitirLiberarCargaHorariaMaximaPeriodoLetivo", usuarioVerif);
