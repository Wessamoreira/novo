...
//	}
	...
	public void selecionarRecursoEducacionalGatilho(NodeSelectEvent event) {
	    
	    Object data = event.getTreeNode().getData();

	    
	    if (data instanceof RecursoEducacionalVO) {
	        getConteudoUnidadePaginaRecursoEducacional().setRecursoEducacional((RecursoEducacionalVO) data);
	    }
	}
...
//	}
//	
	public void selecionarRecursoEducacionalConteudoUnidadePagina(NodeSelectEvent event) {
		 Object data = event.getTreeNode().getData();
		
		if (data instanceof RecursoEducacionalVO) {
			getConteudoUnidadePagina().setRecursoEducacional((RecursoEducacionalVO) data);
		}
	}

	public void dropIcone(DragDropEvent<?> dropEvent) {
		try {
			if (dropEvent.getData() instanceof IconeVO) {
				IconeVO icone = (IconeVO) dropEvent.getData();
	...
	public void dropRecursoEducacionalGatilho(DragDropEvent <?> dropEvent) {
		try {
			if (dropEvent.getData() instanceof ForumVO) {
				getConteudoUnidadePaginaRecursoEducacional().setRecursoEducacional(new RecursoEducacionalVO());
				getConteudoUnidadePaginaRecursoEducacional().setForum((ForumVO) dropEvent.getData());
				getConteudoUnidadePaginaRecursoEducacional().getForum().setNovoObj(false);
			} else if (dropEvent.getData() instanceof RecursoEducacionalVO) {
				RecursoEducacionalVO re = (RecursoEducacionalVO) dropEvent.getData();
	...
	public void alterarOrdemApresentacaoUnidadeConteudo(DragDropEvent <?> dropEvent) {
		try {

			if (dropEvent.getData() instanceof UnidadeConteudoVO && dropEvent.getData() instanceof UnidadeConteudoVO) {
				UnidadeConteudoVO unidadeConteudo1 = (UnidadeConteudoVO) dropEvent.getData();
				UnidadeConteudoVO unidadeConteudo2 = (UnidadeConteudoVO) dropEvent.getData();
			...
			if (dropEvent.getData() instanceof UnidadeConteudoVO && dropEvent.getData() instanceof ConteudoUnidadePaginaVO) {

				ConteudoUnidadePaginaVO conteudoUnidadePaginaVO = (ConteudoUnidadePaginaVO) dropEvent.getData();
				UnidadeConteudoVO unidadeConteudo1 = (UnidadeConteudoVO) dropEvent.getData();
	...
	public void alterarOrdemApresentacaoConteudoUnidadePaginaRecursoEducacional(DragDropEvent<?> dropEvent) {
		try {
			if (dropEvent.getData() instanceof ConteudoUnidadePaginaRecursoEducacionalVO && (dropEvent.getData() instanceof ConteudoUnidadePaginaRecursoEducacionalVO || dropEvent.getData() == null)) {
				ConteudoUnidadePaginaRecursoEducacionalVO unidadeConteudoUnidadePaginaRecursoEducacional1 = (ConteudoUnidadePaginaRecursoEducacionalVO) dropEvent.getData();
				ConteudoUnidadePaginaRecursoEducacionalVO unidadeConteudoUnidadePaginaRecursoEducacional2 = null;
				if (dropEvent.getData() != null) {
					unidadeConteudoUnidadePaginaRecursoEducacional2 = (ConteudoUnidadePaginaRecursoEducacionalVO) dropEvent.getData();
				}
	...
	public void alterarOrdemApresentacaoConteudoUnidadePaginaRecursoEducacionalProfessor(DragDropEvent <?> dropEvent) {
		try {
			if (dropEvent.getData() instanceof ConteudoUnidadePaginaRecursoEducacionalVO && (dropEvent.getData() instanceof ConteudoUnidadePaginaRecursoEducacionalVO || dropEvent.getData() == null)) {
				ConteudoUnidadePaginaRecursoEducacionalVO unidadeConteudoUnidadePaginaRecursoEducacional1 = (ConteudoUnidadePaginaRecursoEducacionalVO) dropEvent.getData();
				ConteudoUnidadePaginaRecursoEducacionalVO unidadeConteudoUnidadePaginaRecursoEducacional2 = null;
	...
	public void alterarOrdemApresentacaoConteudoUnidadePagina(DragDropEvent<?> dropEvent) {
		try {
			if (dropEvent.getData() instanceof ConteudoUnidadePaginaVO && (dropEvent.getData() instanceof ConteudoUnidadePaginaVO || dropEvent.getData() instanceof UnidadeConteudoVO)) {

				ConteudoUnidadePaginaVO unidadeConteudoUnidadePagina1 = (ConteudoUnidadePaginaVO) dropEvent.getData();
				ConteudoUnidadePaginaVO unidadeConteudoUnidadePagina2 = dropEvent.getData() instanceof ConteudoUnidadePaginaVO ? (ConteudoUnidadePaginaVO) dropEvent.getData() : null;
				...
				UnidadeConteudoVO unidadeConteudoVO2 = dropEvent.getData() instanceof UnidadeConteudoVO ? (UnidadeConteudoVO) dropEvent.getData() : null;;
	...
	public void dropRecursoEducacionalConteudoUnidadePagina(DragDropEvent<?> dropEvent) {
		try {
			if (dropEvent.getData() instanceof RecursoEducacionalVO) {
				RecursoEducacionalVO re = (RecursoEducacionalVO) dropEvent.getData();
				...
				if (!re.getTipoRecursoEducacional().equals(getConteudoUnidadePagina().getTipoRecursoEducacional()) && getConteudoUnidadePagina().getTipoRecursoEducacional().equals(TipoRecursoEducacionalEnum.TEXTO_HTML)) {
					...
					getConteudoUnidadePagina().setRecursoEducacional((RecursoEducacionalVO) dropEvent.getData());
	...
	public String getFecharModalAdicionarConteudoUnidadePaginaRecursoEducacional() {
		if (getRecursoAdicionadoComSucesso()) {
			return "PF('panelAddRecursoEducacional').hide()";
		}
		return "";
	}
	...
	public void alterarOrdemApresentacaoQuestaoListaExercicio(DragDropEvent<?> dropEvent) {
		try {
			if (dropEvent.getData() instanceof QuestaoListaExercicioVO && dropEvent.getData() instanceof QuestaoListaExercicioVO) {
				...
				if (getConteudoUnidadePaginaRecursoEducacional().getTipoRecursoEducacional().equals(TipoRecursoEducacionalEnum.EXERCICIO)) {
					getFacadeFactory().getListaExercicioFacade().alterarOrdemApresentacaoQuestaoListaExercicio(getConteudoUnidadePaginaRecursoEducacional().getListaExercicio(), (QuestaoListaExercicioVO) dropEvent.getData(), (QuestaoListaExercicioVO) dropEvent.getData());
				} else if (getConteudoUnidadePagina().getTipoRecursoEducacional().equals(TipoRecursoEducacionalEnum.EXERCICIO)) {
					getFacadeFactory().getListaExercicioFacade().alterarOrdemApresentacaoQuestaoListaExercicio(getConteudoUnidadePagina().getListaExercicio(), (QuestaoListaExercicioVO) dropEvent.getData(), (QuestaoListaExercicioVO) dropEvent.getData());
				}
				limparMensagem();
			}
		} catch (Exception e) {
	...
	public void consultarQuestao() {
		try {
			...
			if (getCampoConsulta().equals("codigo")) {
				...
				getControleConsultaQuestao().setListaConsulta(
					    getFacadeFactory().getQuestaoFacade().consultar(
					        getQuestaoVO().getEnunciado(), 
					        new TemaAssuntoVO(), 
					        getConteudo().getDisciplina().getCodigo(), 
					        SituacaoQuestaoEnum.ATIVA, 
					        isUsoOnline(), 
					        isUsoPresencial(), 
					        isUsoExercicio(), 
					        false, 
					        getQuestaoVO().getTipoQuestaoEnum(), 
					        getQuestaoVO().getNivelComplexidadeQuestao(), 
					        false, 
					        "", 
					        getUsuarioLogado(), 
					        getControleConsultaQuestao().getLimitePorPagina(), 
					        getControleConsultaQuestao().getOffset(), 
					        getConteudo().getCodigo(), 
					        getConteudoUnidadePaginaRecursoEducacional().getListaExercicio().getPoliticaSelecaoQuestaoEnum(), 
					        null, 
					        null, 
					        null, 
					        false 
	...
	public String getAcaoModalNovaPagina() {
		if (getPaginaGravadaComSucesso()) {
			return "PF('panelNovaPagina').hide()";
		}
		return "";
	}
	...
	public void selecionarDisciplina() throws Exception {
		try {
			...
			if(!getFacadeFactory().getConteudoFacade().validarDadosAlteracaoDisciplina(getConteudo(), disciplina)){
				setModalPanelDisciplinaConteudoClone("PF('panelDisciplinaConteudoClone').show();");
				setDisciplinaModalConteudoClone(disciplina);
			}else{
				setModalPanelDisciplinaConteudoClone("PF('panelDisciplina').hide();");	
	...
	public void scrollerListenerConteudista() throws Exception {
...
//			return getConteudoUnidadePagina().getConteudoPaginaApresentar(getConfiguracaoGeralPadraoSistema(), "calc(100vh - 230px)", getUsuarioLogado());
//		}else {
//			return getConteudoUnidadePagina().getConteudoPaginaApresentar(getConfiguracaoGeralPadraoSistema(), "360px", getUsuarioLogado());
//		}
//		
		return "";
	}
...
//		if(getNomeTelaAtual().contains("conteudoAlunoForm.xhtml")) {
//			if(isMaximizarTela()) {
//				return getConteudoUnidadePaginaRecursoEducacional().getConteudoPaginaApresentar(getConfiguracaoGeralPadraoSistema(), getConteudoUnidadePaginaRecursoEducacional().getTipoRecursoEducacional().equals(TipoRecursoEducacionalEnum.VIDEO_URL) ? 88 : 64, getUsuarioLogado());
//			}else {
//				return getConteudoUnidadePaginaRecursoEducacional().getConteudoPaginaApresentar(getConfiguracaoGeralPadraoSistema(), 240, getUsuarioLogado());
//			}
//		}
//		if(isMaximizarTela()) {
//			return getConteudoUnidadePaginaRecursoEducacional().getConteudoPaginaApresentar(getConfiguracaoGeralPadraoSistema(), 150, getUsuarioLogado());
//		}else {
//			return getConteudoUnidadePaginaRecursoEducacional().getConteudoPaginaApresentar(getConfiguracaoGeralPadraoSistema(), 350, getUsuarioLogado());
//		}
		return "";
	}
	...
	public void scrollListenerInteracao() {
		...
		try {
			...
			setModalMensagemAvisoAluno("PF('panelMensagem').show();");
			setMensagemDetalhada("msg_erro", e.getMessage(), Uteis.ERRO);
		}
...
//				getFacadeFactory().getCalendarioAtividadeMatriculaInterfaceFacade().realizarGeracaoCalendarioAtividadeMatriculaPeriodoRealizacaoAvaliacaoOnline(getVisaoAlunoControle().getMatriculaPeriodoTurmaDisciplinaVO(),percentualPontoAtingido, null,  getConfiguracaoEADVO(), getUsuarioLogado());
	...
	public void fecharModalRecursoEducacionalApoioProfessor() {
		if(Uteis.isAtributoPreenchido(getConteudoUnidadePaginaRecursoEducacionalAntesAlteracao()) && getApresentarGatilho()){
			setConteudoUnidadePaginaRecursoEducacional(getConteudoUnidadePaginaRecursoEducacionalAntesAlteracao());
			setModalMensagemAvisoAluno("PF('panelAddRecursoEducacionalApoioProfessor').hide(); PF('panelAddRecursoEducacional').show();");
		}else{
			setConteudoUnidadePaginaRecursoEducacional(new ConteudoUnidadePaginaRecursoEducacionalVO());
			setModalMensagemAvisoAluno("PF('panelAddRecursoEducacionalApoioProfessor').hide(); PF('panelAddRecursoEducacional').hide();");
		}
		setConteudoUnidadePaginaRecursoEducacionalAntesAlteracao(new ConteudoUnidadePaginaRecursoEducacionalVO());
	}
...
//				}
	...
	public void visualizarGatilho() {
		try {
			...
			setApresentarGatilho(true);
			setApresentarOpcaoFecharGatilho(true);
			setModalPanelAddRecursoEducacional("PF('panelAddRecursoEducacional').show();");
			inicializarMensagemVazia();
		} catch (ConsistirException e) {
			setApresentarModalMensagemAvisoAluno(true);
			setModalMensagemAvisoAluno("PF('panelMensagem').show();");
			setApresentarGatilho(false);
			setModalPanelAddRecursoEducacional("PF('panelAddRecursoEducacional').hide();");
			setConsistirExceptionMensagemDetalhada("msg_erro", e, Uteis.ERRO);
		} catch (Exception e) {
			setApresentarModalMensagemAvisoAluno(true);
			setModalMensagemAvisoAluno("PF('panelMensagem').show();");
	...
	public String getAcaoModalRecursoEducacional() {
		if (getApresentarGatilho()) {
			return "PF('panelAddRecursoEducacional').show();";
		} else if (getApresentarResumoFinalConteudo()) {
			return "PF('panelAddRecursoEducacional').hide(); PF('panelTerminoConteudo').show();";
		}
		return "PF('panelAddRecursoEducacional').hide(); PF('panelTerminoConteudo').hide();";
	}
	...
	public Boolean getExisteRecursoEducacionalGatilho() {
		return (getConteudoUnidadePaginaRecursoEducacional().getTipoRecursoEducacional() != null && getConteudoUnidadePaginaRecursoEducacional().getTipoRecursoEducacional().equals(TipoRecursoEducacionalEnum.FORUM) && !getForumVOs().isEmpty()) 
				...
				|| (getConteudoUnidadePaginaRecursoEducacional().getTipoRecursoEducacional() != null && !getConteudoUnidadePaginaRecursoEducacional().getTipoRecursoEducacional().equals(TipoRecursoEducacionalEnum.EXERCICIO) && !getConteudoUnidadePaginaRecursoEducacional().getTipoRecursoEducacional().equals(TipoRecursoEducacionalEnum.FORUM) && getTreeNodeCustomizado() != null && getTreeNodeCustomizado().getData() != null && !getTreeNodeCustomizado().getFilhos().isEmpty());
	}
	...
	public void inicializarDadosSimulacaoVisualizacaoAvaliacaoOnlineAluno() {
		try {
			...
			if(getConteudoUnidadePaginaRecursoEducacional().getAvaliacaoOnlineVO().getTipoGeracaoProvaOnline().equals(TipoGeracaoProvaOnlineEnum.FIXO)) {
				...
				setOncompleteModal("PF('panelAddRecursoEducacional').hide();PF('panelSimularAvaliacao').show();");
			}
		} catch (Exception e) {
			setMensagemDetalhada("msg_erro", e.getMessage(), Uteis.ERRO);
		}
	...
	public void realizarSimulacaoVisualizacaoAvaliacaoOnlineAluno(boolean fecharPanelAddRecursoEducacional) {
		try {
			...
			if (fecharPanelAddRecursoEducacional) {
				setOncompleteModal("PF('panelAvaliacaoOnlineMatricula').show();PF('panelSimularAvaliacao').hide();PF('panelAddRecursoEducacional').hide()");
			} else {
	...
	public String getOncompletePanelAvaliacaoOnlineMatricula() {
		if (getConteudoUnidadePaginaRecursoEducacional().getAvaliacaoOnlineVO().getTipoGeracaoProvaOnline().equals(TipoGeracaoProvaOnlineEnum.FIXO)) {
			return "PF('panelAvaliacaoOnlineMatricula').hide(); PF('panelAddRecursoEducacional').show()";
		}
		return "PF('panelAvaliacaoOnlineMatricula').hide(); PF('panelSimularAvaliacao').show()";
	}
