...
//			curso = null;
	...
	public void montarListaHistoricoAluno(CursoVO curso) throws Exception {
		try {
			...
			getListaPrincipalHistoricos().clear();
			setHistoricoVOs(getFacadeFactory().getHistoricoFacade().executarMontagemListaHistoricoAluno(getMatricula(), getPeriodoLetivo(), getConfiguracaoAcademico(), curso, "", true, true, true , getUsuarioLogado()));
