	...
	public void consultarRequerimentoPorChavePrimaria() {
		try {
			if (Uteis.isAtributoPreenchido(getRequerimento().getCodigo())) {
				setRequerimento(getFacadeFactory().getRequerimentoFacade().consultarPorChavePrimariaFiltrandoPorUnidadeEnsino(getRequerimento().getCodigo(), "", getUnidadeEnsinoVO().getCodigo(), false, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
	...
	public void consultarRequerimento() {
		try {
			...
			if (getCampoConsultaRequerimento().equals("codigo")) {
				...
				setListaConsultaRequerimento(getFacadeFactory().getRequerimentoFacade().consultarPorCodigo(new Integer(valorInt), getTipoRequerimento(), getUnidadeEnsinoVO().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
			}
			if (getCampoConsultaRequerimento().equals("data")) {
				Date valorData = Uteis.getDate(getValorConsultaRequerimento());
				setListaConsultaRequerimento(getFacadeFactory().getRequerimentoFacade().consultarPorData(Uteis.getDateTime(valorData, 0, 0, 0), Uteis.getDateTime(valorData, 23, 59, 59), getTipoRequerimento(), getUnidadeEnsinoVO().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
			}
			if (getCampoConsultaRequerimento().equals("nomeTipoRequerimento")) {
				setListaConsultaRequerimento(getFacadeFactory().getRequerimentoFacade().consultarPorNomeTipoRequerimento(getValorConsultaRequerimento(), getUnidadeEnsinoVO().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
			}
			if (getCampoConsultaRequerimento().equals("situacao")) {
				setListaConsultaRequerimento(getFacadeFactory().getRequerimentoFacade().consultarPorSituacao(getValorConsultaRequerimento(), getTipoRequerimento(), getUnidadeEnsinoVO().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
			}
			if (getCampoConsultaRequerimento().equals("situacaoFinanceira")) {
				setListaConsultaRequerimento(getFacadeFactory().getRequerimentoFacade().consultarPorSituacaoFinanceira(getValorConsultaRequerimento(), getTipoRequerimento(), getUnidadeEnsinoVO().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
			}
			if (getCampoConsultaRequerimento().equals("nomePessoa")) {
				setListaConsultaRequerimento(getFacadeFactory().getRequerimentoFacade().consultarPorNomePessoa(getValorConsultaRequerimento(), getTipoRequerimento(), getUnidadeEnsinoVO().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
			}
			if (getCampoConsultaRequerimento().equals("cpfPessoa")) {
				setListaConsultaRequerimento(getFacadeFactory().getRequerimentoFacade().consultarPorNomeCPFPessoa(getValorConsultaRequerimento(), getTipoRequerimento(), getUnidadeEnsinoVO().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
			}
			if (getCampoConsultaRequerimento().equals("matriculaMatricula")) {
				setListaConsultaRequerimento(getFacadeFactory().getRequerimentoFacade().consultarPorMatriculaMatricula(getValorConsultaRequerimento(), getTipoRequerimento(), getUnidadeEnsinoVO().getCodigo(), true, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
			}
			setMensagemID("msg_dados_consultados");
		} catch (Exception e) {
...
//	}
	...
	public void consultarAluno() {
		try {
			...
			if (getCampoConsultaAluno().equals("matricula")) {
				MatriculaVO obj = getFacadeFactory().getMatriculaFacade().consultarPorChavePrimaria(getValorConsultaAluno(), getUnidadeEnsinoVO().getCodigo(), getCursoVO().getCodigo(), Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado());
	...
	public void consultarAlunoPorMatricula() {
		try {
			setMatriculaVO(getFacadeFactory().getMatriculaFacade().consultarPorChavePrimaria(getMatriculaVO().getMatricula(), getUnidadeEnsinoVO().getCodigo(), 0, Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
			...
			MatriculaPeriodoVO obj = getFacadeFactory().getMatriculaPeriodoFacade().consultarUltimaMatriculaPeriodoAtivaPreMatriculaPorMatricula(getMatriculaVO().getMatricula(), false, Uteis.NIVELMONTARDADOS_DADOSMINIMOS, getUsuarioLogado());
...
//			setUnidadeEnsinoVO(null);
	...
	public String getApresentarModalTituloCracha() {
		return "PF('panelTituloCracha').show()";
	}
