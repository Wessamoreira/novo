    ...
    public void inicializarDados() throws Exception {
    	try {
	        if ((getUsuarioLogado().getIsApresentarVisaoAluno() || getUsuarioLogado().getIsApresentarVisaoPais())) {
	            ...
	            setMatriculaPeriodoVO(getFacadeFactory().getMatriculaPeriodoFacade().consultarPorChavePrimaria(visaoAlunoControle.getMatriculaPeriodoTurmaDisciplinaVO().getMatriculaPeriodo(), Uteis.NIVELMONTARDADOS_DADOSBASICOS, getUsuarioLogado()));
	        }
...
//                inicializarTelaConsultaDuvidaProfessorVisaoProfessor();
    ...
    public void paginarDuvidaProfessorAluno() {
    ...
    public void paginarDuvidaProfessorFrequente() {
    ...
    public void paginarDuvidaProfessorColegas() {
    ...
    public void paginarDuvidaProfessor() {
